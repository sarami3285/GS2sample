...
namespace Gs2.Unity.UiKit.Gs2Mission
{
    ...
    public partial class Gs2MissionOwnCounterList
    {
        ...
        public void Awake()
        {
            ...
            this._fetcher = GetComponent<Gs2MissionOwnCounterListFetcher>() ?? GetComponentInParent<Gs2MissionOwnCounterListFetcher>();
            if (this._fetcher == null) {
                Debug.LogError($"{gameObject.GetFullPath()}: Couldn't find the Gs2MissionOwnCounterListFetcher.");
                enabled = false;
            }

            this._children = new List<Gs2MissionOwnCounterContext>();
        ...
        public virtual bool HasError()
        {
            ...
            this._fetcher = GetComponent<Gs2MissionOwnCounterListFetcher>() ?? GetComponentInParent<Gs2MissionOwnCounterListFetcher>(true);
            if (this._fetcher == null) {
                return true;
            }
            return false;
