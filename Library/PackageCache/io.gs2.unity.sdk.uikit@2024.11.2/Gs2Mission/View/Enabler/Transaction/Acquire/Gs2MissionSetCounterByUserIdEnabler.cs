...
namespace Gs2.Unity.UiKit.Gs2Mission
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Counter/View/Enabler/Transaction/Gs2MissionSetCounterByUserIdEnabler")]
    public partial class Gs2MissionSetCounterByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Mission:SetCounterByUserId") == 0) {
    ...
    public partial class Gs2MissionSetCounterByUserIdEnabler
    {
