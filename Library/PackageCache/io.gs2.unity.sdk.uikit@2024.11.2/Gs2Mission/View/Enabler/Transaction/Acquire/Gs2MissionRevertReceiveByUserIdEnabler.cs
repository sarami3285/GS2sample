...
namespace Gs2.Unity.UiKit.Gs2Mission
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Complete/View/Enabler/Transaction/Gs2MissionRevertReceiveByUserIdEnabler")]
    public partial class Gs2MissionRevertReceiveByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Mission:RevertReceiveByUserId") == 0) {
    ...
    public partial class Gs2MissionRevertReceiveByUserIdEnabler
    {
