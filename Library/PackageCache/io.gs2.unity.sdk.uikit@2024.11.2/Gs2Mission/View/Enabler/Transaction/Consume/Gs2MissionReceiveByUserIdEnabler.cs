...
namespace Gs2.Unity.UiKit.Gs2Mission
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Complete/View/Enabler/Transaction/Gs2MissionReceiveByUserIdEnabler")]
    public partial class Gs2MissionReceiveByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Mission:ReceiveByUserId") == 0) {
    ...
    public partial class Gs2MissionReceiveByUserIdEnabler
    {
