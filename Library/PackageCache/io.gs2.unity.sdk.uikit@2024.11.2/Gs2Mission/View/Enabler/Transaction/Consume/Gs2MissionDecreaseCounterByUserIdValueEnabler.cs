...
namespace Gs2.Unity.UiKit.Gs2Mission.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Counter/View/Enabler/Transaction/Gs2MissionDecreaseCounterByUserIdValueEnabler")]
    public partial class Gs2MissionDecreaseCounterByUserIdValueEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this._fetcher.Request.Value != null && this.enableValues.Contains(this._fetcher.Request.Value.Value));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(this._fetcher.Request.Value != null && !this.enableValues.Contains(this._fetcher.Request.Value.Value));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableValue > this._fetcher.Request.Value);
                    break;
    ...
    public partial class Gs2MissionDecreaseCounterByUserIdValueEnabler
    {
