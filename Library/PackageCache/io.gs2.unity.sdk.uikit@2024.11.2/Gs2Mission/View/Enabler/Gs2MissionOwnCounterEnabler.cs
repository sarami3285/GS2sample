...
namespace Gs2.Unity.UiKit.Gs2Mission
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Counter/View/Enabler/Gs2MissionOwnCounterEnabler")]
    public partial class Gs2MissionOwnCounterEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Counter == null)
            {
    ...
    public partial class Gs2MissionOwnCounterEnabler
    {
