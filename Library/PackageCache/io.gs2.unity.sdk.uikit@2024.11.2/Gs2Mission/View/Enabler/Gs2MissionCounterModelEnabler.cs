...
namespace Gs2.Unity.UiKit.Gs2Mission
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/CounterModel/View/Enabler/Gs2MissionCounterModelEnabler")]
    public partial class Gs2MissionCounterModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.CounterModel == null)
            {
    ...
    public partial class Gs2MissionCounterModelEnabler
    {
