...
namespace Gs2.Unity.UiKit.Gs2Mission.Label
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Complete/View/Label/Transaction/Gs2MissionBatchReceiveByUserIdLabel")]
    public partial class Gs2MissionBatchReceiveByUserIdLabel : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            this.onUpdate?.Invoke(
                this.format.Replace(
                    ...
                    "{missionTaskNames}",
                    $"{this._fetcher.Request.MissionTaskNames}"
                ).Replace(
                    "{timeOffsetToken}",
    ...
    public partial class Gs2MissionBatchReceiveByUserIdLabel
    {
