...
namespace Gs2.Unity.UiKit.Gs2Mission.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/MissionGroupModel/View/SpriteSwitcher/Properties/ResetDayOfWeek/Gs2MissionMissionGroupModelResetDayOfWeekSpriteTableSwitcher")]
    public partial class Gs2MissionMissionGroupModelResetDayOfWeekSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.MissionGroupModel.ResetDayOfWeek) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.MissionGroupModel.ResetDayOfWeek).sprite);
            }
            else {
    ...
    public partial class Gs2MissionMissionGroupModelResetDayOfWeekSpriteTableSwitcher
    {
