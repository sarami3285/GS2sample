...
namespace Gs2.Unity.UiKit.Gs2Mission.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Counter/View/SpriteSwitcher/Properties/Name/Gs2MissionOwnCounterNameSpriteSwitcher")]
    public partial class Gs2MissionOwnCounterNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.Counter?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.Counter?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.Counter?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2MissionOwnCounterNameSpriteSwitcher
    {
