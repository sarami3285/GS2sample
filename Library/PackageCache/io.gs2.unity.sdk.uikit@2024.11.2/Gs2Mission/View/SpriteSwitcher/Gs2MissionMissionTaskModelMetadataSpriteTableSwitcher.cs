...
namespace Gs2.Unity.UiKit.Gs2Mission.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/MissionTaskModel/View/SpriteSwitcher/Properties/Metadata/Gs2MissionMissionTaskModelMetadataSpriteTableSwitcher")]
    public partial class Gs2MissionMissionTaskModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.MissionTaskModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.MissionTaskModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2MissionMissionTaskModelMetadataSpriteTableSwitcher
    {
