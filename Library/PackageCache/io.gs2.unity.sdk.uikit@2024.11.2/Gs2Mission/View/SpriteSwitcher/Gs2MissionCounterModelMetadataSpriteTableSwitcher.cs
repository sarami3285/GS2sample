...
namespace Gs2.Unity.UiKit.Gs2Mission.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/CounterModel/View/SpriteSwitcher/Properties/Metadata/Gs2MissionCounterModelMetadataSpriteTableSwitcher")]
    public partial class Gs2MissionCounterModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.CounterModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.CounterModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2MissionCounterModelMetadataSpriteTableSwitcher
    {
