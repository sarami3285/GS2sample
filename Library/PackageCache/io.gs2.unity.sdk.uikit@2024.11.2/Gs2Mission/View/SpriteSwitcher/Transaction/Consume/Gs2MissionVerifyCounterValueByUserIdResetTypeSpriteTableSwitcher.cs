...
namespace Gs2.Unity.UiKit.Gs2Mission.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Counter/View/SpriteSwitcher/Transaction/Properties/ResetType/Gs2MissionVerifyCounterValueByUserIdResetTypeSpriteTableSwitcher")]
    public partial class Gs2MissionVerifyCounterValueByUserIdResetTypeSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.ResetType) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.ResetType).sprite);
            }
            else {
    ...
    public partial class Gs2MissionVerifyCounterValueByUserIdResetTypeSpriteTableSwitcher
    {
