...
namespace Gs2.Unity.UiKit.Gs2Mission.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/MissionGroupModel/View/SpriteSwitcher/Properties/ResetType/Gs2MissionMissionGroupModelResetTypeSpriteTableSwitcher")]
    public partial class Gs2MissionMissionGroupModelResetTypeSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.MissionGroupModel.ResetType) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.MissionGroupModel.ResetType).sprite);
            }
            else {
    ...
    public partial class Gs2MissionMissionGroupModelResetTypeSpriteTableSwitcher
    {
