...
namespace Gs2.Unity.UiKit.Gs2Mission.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Complete/View/SpriteSwitcher/Properties/MissionGroupName/Gs2MissionOwnCompleteMissionGroupNameSpriteTableSwitcher")]
    public partial class Gs2MissionOwnCompleteMissionGroupNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Complete.MissionGroupName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Complete.MissionGroupName).sprite);
            }
            else {
    ...
    public partial class Gs2MissionOwnCompleteMissionGroupNameSpriteTableSwitcher
    {
