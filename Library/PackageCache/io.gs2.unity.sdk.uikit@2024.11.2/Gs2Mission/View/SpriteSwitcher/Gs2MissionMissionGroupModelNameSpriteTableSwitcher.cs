...
namespace Gs2.Unity.UiKit.Gs2Mission.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/MissionGroupModel/View/SpriteSwitcher/Properties/Name/Gs2MissionMissionGroupModelNameSpriteTableSwitcher")]
    public partial class Gs2MissionMissionGroupModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.MissionGroupModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.MissionGroupModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2MissionMissionGroupModelNameSpriteTableSwitcher
    {
