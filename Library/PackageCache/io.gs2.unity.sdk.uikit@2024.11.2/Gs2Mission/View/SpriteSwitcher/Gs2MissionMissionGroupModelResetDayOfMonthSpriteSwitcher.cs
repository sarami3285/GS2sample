...
namespace Gs2.Unity.UiKit.Gs2Mission
{
    ...
    public partial class Gs2MissionMissionGroupModelResetDayOfMonthSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyResetDayOfMonths.Contains(this._fetcher.MissionGroupModel.ResetDayOfMonth)) {
                ...
                case Expression.Less:
                    if (this.applyResetDayOfMonth > this._fetcher.MissionGroupModel.ResetDayOfMonth) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
