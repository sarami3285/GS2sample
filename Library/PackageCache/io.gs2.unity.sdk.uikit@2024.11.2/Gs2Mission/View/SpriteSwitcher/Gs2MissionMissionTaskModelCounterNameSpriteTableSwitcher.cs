...
namespace Gs2.Unity.UiKit.Gs2Mission.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/MissionTaskModel/View/SpriteSwitcher/Properties/CounterName/Gs2MissionMissionTaskModelCounterNameSpriteTableSwitcher")]
    public partial class Gs2MissionMissionTaskModelCounterNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.MissionTaskModel.CounterName) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.MissionTaskModel.CounterName).sprite);
            }
            else {
    ...
    public partial class Gs2MissionMissionTaskModelCounterNameSpriteTableSwitcher
    {
