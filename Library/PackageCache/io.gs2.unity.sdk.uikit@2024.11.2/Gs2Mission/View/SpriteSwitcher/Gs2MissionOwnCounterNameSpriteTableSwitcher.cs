...
namespace Gs2.Unity.UiKit.Gs2Mission.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Counter/View/SpriteSwitcher/Properties/Name/Gs2MissionOwnCounterNameSpriteTableSwitcher")]
    public partial class Gs2MissionOwnCounterNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Counter.Name) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Counter.Name).sprite);
            }
            else {
    ...
    public partial class Gs2MissionOwnCounterNameSpriteTableSwitcher
    {
