...
namespace Gs2.Unity.UiKit.Gs2Mission.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Complete/Fetcher/Consume/Gs2MissionBatchReceiveByUserIdFetcher")]
    public partial class Gs2MissionBatchReceiveByUserIdFetcher : Gs2MissionOwnCompleteContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Mission:BatchReceiveByUserId") {
                    Request = BatchReceiveByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Complete == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Mission:BatchReceiveByUserId");
                if (action != null) {
                    Request = BatchReceiveByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Complete == null || (
                            Complete.NamespaceName == Request.NamespaceName &&
                            Complete.MissionGroupName == Request.MissionGroupName)
                    ) {
    ...
    public partial class Gs2MissionBatchReceiveByUserIdFetcher
    {
    ...
    public partial class Gs2MissionBatchReceiveByUserIdFetcher
    {
        public BatchReceiveByUserIdRequest Request { get; protected set; }
