    ...
    public partial class Gs2MissionDecreaseCounterByUserIdFetcher : Gs2MissionOwnCounterContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Mission:DecreaseCounterByUserId") {
                    Request = DecreaseCounterByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Counter == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Mission:DecreaseCounterByUserId");
                if (action != null) {
