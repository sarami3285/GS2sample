    ...
    public partial class Gs2MissionReceiveByUserIdFetcher : Gs2MissionOwnCompleteContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Mission:ReceiveByUserId") {
                    Request = ReceiveByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Complete == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Mission:ReceiveByUserId");
                if (action != null) {
