...
namespace Gs2.Unity.UiKit.Gs2Mission.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Complete/Fetcher/Acquire/Gs2MissionRevertReceiveByUserIdFetcher")]
    public partial class Gs2MissionRevertReceiveByUserIdFetcher : Gs2MissionOwnCompleteContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Mission:RevertReceiveByUserId") {
                    Request = RevertReceiveByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Complete == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Mission:RevertReceiveByUserId");
                if (action != null) {
                    Request = RevertReceiveByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Complete == null || (
                            Complete.NamespaceName == Request.NamespaceName &&
                            Complete.MissionGroupName == Request.MissionGroupName)
                    ) {
    ...
    public partial class Gs2MissionRevertReceiveByUserIdFetcher
    {
    ...
    public partial class Gs2MissionRevertReceiveByUserIdFetcher
    {
        public RevertReceiveByUserIdRequest Request { get; protected set; }
