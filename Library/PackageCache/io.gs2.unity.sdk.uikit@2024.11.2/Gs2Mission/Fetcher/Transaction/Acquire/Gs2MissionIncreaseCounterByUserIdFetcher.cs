    ...
    public partial class Gs2MissionIncreaseCounterByUserIdFetcher : Gs2MissionOwnCounterContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Mission:IncreaseCounterByUserId") {
                    Request = IncreaseCounterByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Counter == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Mission:IncreaseCounterByUserId");
                if (action != null) {
