...
namespace Gs2.Unity.UiKit.Gs2Mission.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Counter/Fetcher/Acquire/Gs2MissionSetCounterByUserIdFetcher")]
    public partial class Gs2MissionSetCounterByUserIdFetcher : Gs2MissionOwnCounterContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Mission:SetCounterByUserId") {
                    Request = SetCounterByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Counter == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Mission:SetCounterByUserId");
                if (action != null) {
                    Request = SetCounterByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Counter == null || (
                            Counter.NamespaceName == Request.NamespaceName &&
                            Counter.CounterName == Request.CounterName)
                    ) {
    ...
    public partial class Gs2MissionSetCounterByUserIdFetcher
    {
    ...
    public partial class Gs2MissionSetCounterByUserIdFetcher
    {
        public SetCounterByUserIdRequest Request { get; protected set; }
