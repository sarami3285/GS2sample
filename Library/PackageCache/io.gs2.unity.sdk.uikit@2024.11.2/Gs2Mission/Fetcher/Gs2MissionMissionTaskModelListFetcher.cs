...
namespace Gs2.Unity.UiKit.Gs2Mission.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/MissionTaskModel/Fetcher/Gs2MissionMissionTaskModelListFetcher")]
    public partial class Gs2MissionMissionTaskModelListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var items = new List<Gs2.Unity.Gs2Mission.Model.EzMissionTaskModel>();
            while (it.HasNext())
            {
        ...
        private IEnumerator Fetch()
        {
            ...
            yield return new WaitUntil(() => Context != null && Context.MissionGroupModel != null);
            ...
            this._callbackId = this._domain.SubscribeMissionTaskModels(
                items =>
                {
                    MissionTaskModels = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2MissionMissionTaskModelListFetcher
    {
    ...
    public partial class Gs2MissionMissionTaskModelListFetcher
    {
        public List<Gs2.Unity.Gs2Mission.Model.EzMissionTaskModel> MissionTaskModels { get; private set; }
