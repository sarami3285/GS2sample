...
namespace Gs2.Unity.UiKit.Gs2Mission.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/MissionGroupModel/Fetcher/Gs2MissionMissionGroupModelListFetcher")]
    public partial class Gs2MissionMissionGroupModelListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var items = new List<Gs2.Unity.Gs2Mission.Model.EzMissionGroupModel>();
            while (it.HasNext())
            {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeMissionGroupModels(
                items =>
                {
                    MissionGroupModels = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2MissionMissionGroupModelListFetcher
    {
    ...
    public partial class Gs2MissionMissionGroupModelListFetcher
    {
        public List<Gs2.Unity.Gs2Mission.Model.EzMissionGroupModel> MissionGroupModels { get; private set; }
