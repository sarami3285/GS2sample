...
namespace Gs2.Unity.UiKit.Gs2Version.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Version/VersionModel/View/SpriteSwitcher/Properties/Name/Gs2VersionVersionModelNameSpriteSwitcher")]
    public partial class Gs2VersionVersionModelNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.VersionModel?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.VersionModel?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.VersionModel?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2VersionVersionModelNameSpriteSwitcher
    {
