...
namespace Gs2.Unity.UiKit.Gs2Version.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Version/VersionModel/View/SpriteSwitcher/Properties/Scope/Gs2VersionVersionModelScopeSpriteTableSwitcher")]
    public partial class Gs2VersionVersionModelScopeSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.VersionModel.Scope) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.VersionModel.Scope).sprite);
            }
            else {
    ...
    public partial class Gs2VersionVersionModelScopeSpriteTableSwitcher
    {
