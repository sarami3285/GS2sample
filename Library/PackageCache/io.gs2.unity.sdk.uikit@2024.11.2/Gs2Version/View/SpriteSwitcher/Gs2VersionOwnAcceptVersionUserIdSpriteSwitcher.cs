...
namespace Gs2.Unity.UiKit.Gs2Version.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Version/AcceptVersion/View/SpriteSwitcher/Properties/UserId/Gs2VersionOwnAcceptVersionUserIdSpriteSwitcher")]
    public partial class Gs2VersionOwnAcceptVersionUserIdSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyUserIds.Contains(this._fetcher.AcceptVersion?.UserId ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.AcceptVersion?.UserId ?? "").StartsWith(this.applyUserId)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.AcceptVersion?.UserId ?? "").EndsWith(this.applyUserId)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2VersionOwnAcceptVersionUserIdSpriteSwitcher
    {
