...
namespace Gs2.Unity.UiKit.Gs2Version.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Version/VersionModel/View/SpriteSwitcher/Properties/Metadata/Gs2VersionVersionModelMetadataSpriteTableSwitcher")]
    public partial class Gs2VersionVersionModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.VersionModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.VersionModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2VersionVersionModelMetadataSpriteTableSwitcher
    {
