...
namespace Gs2.Unity.UiKit.Gs2Version.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Version/AcceptVersion/View/SpriteSwitcher/Properties/UserId/Gs2VersionOwnAcceptVersionUserIdSpriteTableSwitcher")]
    public partial class Gs2VersionOwnAcceptVersionUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.AcceptVersion.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.AcceptVersion.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2VersionOwnAcceptVersionUserIdSpriteTableSwitcher
    {
