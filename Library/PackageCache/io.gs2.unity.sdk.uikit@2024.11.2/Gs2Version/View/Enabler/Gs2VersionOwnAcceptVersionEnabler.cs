...
namespace Gs2.Unity.UiKit.Gs2Version
{
	...
	[AddComponentMenu("GS2 UIKit/Version/AcceptVersion/View/Enabler/Gs2VersionOwnAcceptVersionEnabler")]
    public partial class Gs2VersionOwnAcceptVersionEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcceptVersion == null)
            {
    ...
    public partial class Gs2VersionOwnAcceptVersionEnabler
    {
