...
namespace Gs2.Unity.UiKit.Gs2Version
{
	...
	[AddComponentMenu("GS2 UIKit/Version/VersionModel/View/Enabler/Gs2VersionVersionModelEnabler")]
    public partial class Gs2VersionVersionModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.VersionModel == null)
            {
    ...
    public partial class Gs2VersionVersionModelEnabler
    {
