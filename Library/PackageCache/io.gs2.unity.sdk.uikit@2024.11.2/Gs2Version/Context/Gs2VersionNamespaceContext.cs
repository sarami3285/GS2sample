...
namespace Gs2.Unity.UiKit.Gs2Version.Context
{
	...
	[AddComponentMenu("GS2 UIKit/Version/Namespace/Context/Gs2VersionNamespaceContext")]
    public partial class Gs2VersionNamespaceContext : MonoBehaviour
    {
        public void Start() {
            if (Namespace == null) {
                Debug.LogWarning($"{gameObject.GetFullPath()}: Namespace is not set in Gs2VersionNamespaceContext.");
            }
        }
    ...
    public partial class Gs2VersionNamespaceContext
    {
