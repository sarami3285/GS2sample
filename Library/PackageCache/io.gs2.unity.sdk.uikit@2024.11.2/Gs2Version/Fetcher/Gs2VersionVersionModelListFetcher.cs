...
namespace Gs2.Unity.UiKit.Gs2Version.Fetcher
{
    ...
    public partial class Gs2VersionVersionModelListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeVersionModels(
                items =>
                {
                    VersionModels = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    {
        public Gs2VersionNamespaceContext Context { get; private set; }
        ...
        {
            Context = GetComponent<Gs2VersionNamespaceContext>() ?? GetComponentInParent<Gs2VersionNamespaceContext>(true);
            if (Context == null) {
                return true;
            }
            return false;
