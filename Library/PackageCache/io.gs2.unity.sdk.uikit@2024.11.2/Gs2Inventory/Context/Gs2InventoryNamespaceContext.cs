...
namespace Gs2.Unity.UiKit.Gs2Inventory.Context
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/Namespace/Context/Gs2InventoryNamespaceContext")]
    public partial class Gs2InventoryNamespaceContext : MonoBehaviour
    {
        public void Start() {
            if (Namespace == null) {
                Debug.LogWarning($"{gameObject.GetFullPath()}: Namespace is not set in Gs2InventoryNamespaceContext.");
            }
        }
