...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemModel/View/SpriteSwitcher/Properties/SortValue/Gs2InventoryItemModelSortValueSpriteSwitcher")]
    public partial class Gs2InventoryItemModelSortValueSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applySortValues.Contains(this._fetcher.ItemModel.SortValue)) {
                ...
                case Expression.Less:
                    if (this.applySortValue > this._fetcher.ItemModel.SortValue) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
    ...
    public partial class Gs2InventoryItemModelSortValueSpriteSwitcher
    {
