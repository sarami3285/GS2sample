...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/SpriteSwitcher/Transaction/Properties/GradeModelId/Gs2InventoryAcquireItemSetWithGradeByUserIdGradeModelIdSpriteTableSwitcher")]
    public partial class Gs2InventoryAcquireItemSetWithGradeByUserIdGradeModelIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.GradeModelId) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.GradeModelId).sprite);
            }
            else {
    ...
    public partial class Gs2InventoryAcquireItemSetWithGradeByUserIdGradeModelIdSpriteTableSwitcher
    {
