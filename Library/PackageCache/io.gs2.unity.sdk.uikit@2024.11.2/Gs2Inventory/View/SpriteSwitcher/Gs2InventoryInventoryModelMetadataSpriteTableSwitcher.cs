...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/InventoryModel/View/SpriteSwitcher/Properties/Metadata/Gs2InventoryInventoryModelMetadataSpriteTableSwitcher")]
    public partial class Gs2InventoryInventoryModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.InventoryModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.InventoryModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2InventoryInventoryModelMetadataSpriteTableSwitcher
    {
