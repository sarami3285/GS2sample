...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/View/SpriteSwitcher/Properties/Count/Gs2InventoryOwnBigItemCountSpriteTableSwitcher")]
    public partial class Gs2InventoryOwnBigItemCountSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.BigItem.Count.ToString("0")) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.BigItem.Count.ToString("0")).sprite);
            }
            else {
    ...
    public partial class Gs2InventoryOwnBigItemCountSpriteTableSwitcher
    {
