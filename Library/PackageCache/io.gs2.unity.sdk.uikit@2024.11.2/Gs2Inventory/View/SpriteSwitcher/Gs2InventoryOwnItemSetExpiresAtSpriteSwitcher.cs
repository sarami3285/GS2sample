...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/SpriteSwitcher/Properties/ExpiresAt/Gs2InventoryOwnItemSetExpiresAtSpriteSwitcher")]
    public partial class Gs2InventoryOwnItemSetExpiresAtSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyExpiresAts.Contains(this._fetcher.ItemSet[index].ExpiresAt)) {
                ...
                case Expression.Less:
                    if (this.applyExpiresAt > this._fetcher.ItemSet[index].ExpiresAt) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
    ...
    public partial class Gs2InventoryOwnItemSetExpiresAtSpriteSwitcher
    {
