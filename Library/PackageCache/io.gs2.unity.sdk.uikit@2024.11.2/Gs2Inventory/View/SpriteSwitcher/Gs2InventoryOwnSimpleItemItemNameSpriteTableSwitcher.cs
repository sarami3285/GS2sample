...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/SimpleItem/View/SpriteSwitcher/Properties/ItemName/Gs2InventoryOwnSimpleItemItemNameSpriteTableSwitcher")]
    public partial class Gs2InventoryOwnSimpleItemItemNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.SimpleItem.ItemName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.SimpleItem.ItemName).sprite);
            }
            else {
    ...
    public partial class Gs2InventoryOwnSimpleItemItemNameSpriteTableSwitcher
    {
