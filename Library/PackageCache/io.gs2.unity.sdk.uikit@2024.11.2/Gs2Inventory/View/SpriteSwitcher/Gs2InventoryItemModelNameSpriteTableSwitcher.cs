...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemModel/View/SpriteSwitcher/Properties/Name/Gs2InventoryItemModelNameSpriteTableSwitcher")]
    public partial class Gs2InventoryItemModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.ItemModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.ItemModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2InventoryItemModelNameSpriteTableSwitcher
    {
