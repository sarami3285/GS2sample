...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/SpriteSwitcher/Properties/Name/Gs2InventoryOwnItemSetNameSpriteTableSwitcher")]
    public partial class Gs2InventoryOwnItemSetNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.ItemSet[index].Name) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.ItemSet[index].Name).sprite);
            }
            else {
    ...
    public partial class Gs2InventoryOwnItemSetNameSpriteTableSwitcher
    {
