...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/SpriteSwitcher/Properties/ItemName/Gs2InventoryOwnItemSetItemNameSpriteTableSwitcher")]
    public partial class Gs2InventoryOwnItemSetItemNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.ItemSet[index].ItemName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.ItemSet[index].ItemName).sprite);
            }
            else {
    ...
    public partial class Gs2InventoryOwnItemSetItemNameSpriteTableSwitcher
    {
