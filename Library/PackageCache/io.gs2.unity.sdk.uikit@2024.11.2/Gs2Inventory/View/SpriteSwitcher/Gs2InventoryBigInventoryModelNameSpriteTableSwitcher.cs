...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigInventoryModel/View/SpriteSwitcher/Properties/Name/Gs2InventoryBigInventoryModelNameSpriteTableSwitcher")]
    public partial class Gs2InventoryBigInventoryModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.BigInventoryModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.BigInventoryModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2InventoryBigInventoryModelNameSpriteTableSwitcher
    {
