...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/SimpleItem/View/SpriteSwitcher/Properties/Count/Gs2InventoryOwnSimpleItemCountSpriteSwitcher")]
    public partial class Gs2InventoryOwnSimpleItemCountSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyCounts.Contains(this._fetcher.SimpleItem.Count)) {
                ...
                case Expression.Less:
                    if (this.applyCount > this._fetcher.SimpleItem.Count) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
    ...
    public partial class Gs2InventoryOwnSimpleItemCountSpriteSwitcher
    {
