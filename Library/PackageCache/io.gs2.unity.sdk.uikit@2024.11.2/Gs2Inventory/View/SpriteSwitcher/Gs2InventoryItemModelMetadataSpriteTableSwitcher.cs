...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemModel/View/SpriteSwitcher/Properties/Metadata/Gs2InventoryItemModelMetadataSpriteTableSwitcher")]
    public partial class Gs2InventoryItemModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.ItemModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.ItemModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2InventoryItemModelMetadataSpriteTableSwitcher
    {
