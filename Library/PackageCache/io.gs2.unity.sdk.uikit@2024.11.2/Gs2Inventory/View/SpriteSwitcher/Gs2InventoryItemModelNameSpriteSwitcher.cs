...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemModel/View/SpriteSwitcher/Properties/Name/Gs2InventoryItemModelNameSpriteSwitcher")]
    public partial class Gs2InventoryItemModelNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.ItemModel?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.ItemModel?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.ItemModel?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2InventoryItemModelNameSpriteSwitcher
    {
