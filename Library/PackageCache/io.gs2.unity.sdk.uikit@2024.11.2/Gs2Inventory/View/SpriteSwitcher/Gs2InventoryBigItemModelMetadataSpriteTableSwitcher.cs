...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItemModel/View/SpriteSwitcher/Properties/Metadata/Gs2InventoryBigItemModelMetadataSpriteTableSwitcher")]
    public partial class Gs2InventoryBigItemModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.BigItemModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.BigItemModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2InventoryBigItemModelMetadataSpriteTableSwitcher
    {
