...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/View/SpriteSwitcher/Properties/ItemName/Gs2InventoryOwnBigItemItemNameSpriteTableSwitcher")]
    public partial class Gs2InventoryOwnBigItemItemNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.BigItem.ItemName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.BigItem.ItemName).sprite);
            }
            else {
    ...
    public partial class Gs2InventoryOwnBigItemItemNameSpriteTableSwitcher
    {
