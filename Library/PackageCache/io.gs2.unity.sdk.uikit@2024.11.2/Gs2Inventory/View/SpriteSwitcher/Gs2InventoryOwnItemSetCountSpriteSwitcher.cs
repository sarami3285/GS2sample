...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/SpriteSwitcher/Properties/Count/Gs2InventoryOwnItemSetCountSpriteSwitcher")]
    public partial class Gs2InventoryOwnItemSetCountSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyCounts.Contains(this._fetcher.ItemSet[index].Count)) {
                ...
                case Expression.Less:
                    if (this.applyCount > this._fetcher.ItemSet[index].Count) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
    ...
    public partial class Gs2InventoryOwnItemSetCountSpriteSwitcher
    {
