...
namespace Gs2.Unity.UiKit.Gs2Inventory.Localization
{
    ...
    [AddComponentMenu("GS2 UIKit/Inventory/BigItemModel/View/Localization/Gs2InventoryBigItemModelLocalizationVariables")]
    public partial class Gs2InventoryBigItemModelLocalizationVariables : MonoBehaviour
    {
        private void OnFetched()
        {
            this.target.StringReference["name"] = new StringVariable {
                Value = _fetcher?.BigItemModel?.Name ?? "",
            };
            this.target.StringReference["metadata"] = new StringVariable {
                Value = _fetcher?.BigItemModel?.Metadata ?? "",
            };
    ...
    public partial class Gs2InventoryBigItemModelLocalizationVariables
    {
