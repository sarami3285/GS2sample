...
namespace Gs2.Unity.UiKit.Gs2Inventory.Label
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/View/Label/Transaction/Gs2InventoryConsumeBigItemByUserIdLabel")]
    public partial class Gs2InventoryConsumeBigItemByUserIdLabel : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            this.onUpdate?.Invoke(
                this.format.Replace(
                    ...
                    $"{this._userDataFetcher.BigItem.Count + this._fetcher.Request.ConsumeCount}"
                )
            );
        }
    }
    ...
    public partial class Gs2InventoryConsumeBigItemByUserIdLabel
    {
