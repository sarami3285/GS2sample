...
namespace Gs2.Unity.UiKit.Gs2Inventory.Label
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/SimpleItem/View/Label/Transaction/Gs2InventoryVerifySimpleItemByUserIdLabel")]
    public partial class Gs2InventoryVerifySimpleItemByUserIdLabel : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._userDataFetcher == null) {
                var context = gameObject.AddComponent<Gs2InventoryOwnSimpleItemContext>();
                context.SetOwnSimpleItem(
                    OwnSimpleItem.New(
    ...
    public partial class Gs2InventoryVerifySimpleItemByUserIdLabel
    {
