...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/SimpleItem/View/Enabler/Gs2InventoryOwnSimpleItemEnabler")]
    public partial class Gs2InventoryOwnSimpleItemEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.SimpleItem == null)
            {
    ...
    public partial class Gs2InventoryOwnSimpleItemEnabler
    {
