...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/InventoryModel/View/Enabler/Properties/InitialCapacity/Gs2InventoryInventoryModelInitialCapacityEnabler")]
    public partial class Gs2InventoryInventoryModelInitialCapacityEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableInitialCapacities.Contains(this._fetcher.InventoryModel.InitialCapacity));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableInitialCapacities.Contains(this._fetcher.InventoryModel.InitialCapacity));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableInitialCapacity > this._fetcher.InventoryModel.InitialCapacity);
                    break;
