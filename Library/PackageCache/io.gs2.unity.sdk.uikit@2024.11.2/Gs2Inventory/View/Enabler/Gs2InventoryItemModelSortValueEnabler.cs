...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemModel/View/Enabler/Properties/SortValue/Gs2InventoryItemModelSortValueEnabler")]
    public partial class Gs2InventoryItemModelSortValueEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableSortValues.Contains(this._fetcher.ItemModel.SortValue));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableSortValues.Contains(this._fetcher.ItemModel.SortValue));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableSortValue > this._fetcher.ItemModel.SortValue);
                    break;
