...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/View/Enabler/Gs2InventoryOwnBigItemEnabler")]
    public partial class Gs2InventoryOwnBigItemEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.BigItem == null)
            {
    ...
    public partial class Gs2InventoryOwnBigItemEnabler
    {
