...
namespace Gs2.Unity.UiKit.Gs2Inventory.Enabler
{
    ...
    public partial class Gs2InventoryConsumeBigItemByUserIdValueEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this._fetcher.Request.ConsumeCount != null && this.enableConsumeCounts.Contains(this._fetcher.Request.ConsumeCount));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(this._fetcher.Request.ConsumeCount != null && !this.enableConsumeCounts.Contains(this._fetcher.Request.ConsumeCount));
                    break;
                case Expression.Less:
                    this.target.SetActive(BigInteger.Parse(this.enableConsumeCount) > BigInteger.Parse(this._fetcher.Request.ConsumeCount));
                    break;
