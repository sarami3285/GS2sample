...
namespace Gs2.Unity.UiKit.Gs2Inventory.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/View/Enabler/Transaction/Gs2InventoryVerifyBigItemByUserIdValueEnabler")]
    public partial class Gs2InventoryVerifyBigItemByUserIdValueEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this._fetcher.Request.Count != null && this.enableCounts.Contains(this._fetcher.Request.Count));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(this._fetcher.Request.Count != null && !this.enableCounts.Contains(this._fetcher.Request.Count));
                    break;
                case Expression.Less:
                    this.target.SetActive(BigInteger.Parse(this.enableCount) > BigInteger.Parse(this._fetcher.Request.Count));
                    break;
    ...
    public partial class Gs2InventoryVerifyBigItemByUserIdValueEnabler
    {
