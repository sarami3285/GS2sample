...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/Inventory/View/Enabler/Transaction/Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdEnabler")]
    public partial class Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Inventory:VerifyInventoryCurrentMaxCapacityByUserId") == 0) {
    ...
    public partial class Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdEnabler
    {
