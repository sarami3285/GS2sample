...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/View/Enabler/Transaction/Gs2InventoryVerifyBigItemByUserIdEnabler")]
    public partial class Gs2InventoryVerifyBigItemByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Inventory:VerifyBigItemByUserId") == 0) {
    ...
    public partial class Gs2InventoryVerifyBigItemByUserIdEnabler
    {
