...
namespace Gs2.Unity.UiKit.Gs2Inventory.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/Enabler/Transaction/Gs2InventoryConsumeItemSetByUserIdValueEnabler")]
    public partial class Gs2InventoryConsumeItemSetByUserIdValueEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this._fetcher.Request.ConsumeCount != null && this.enableConsumeCounts.Contains(this._fetcher.Request.ConsumeCount.Value));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(this._fetcher.Request.ConsumeCount != null && !this.enableConsumeCounts.Contains(this._fetcher.Request.ConsumeCount.Value));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableConsumeCount > this._fetcher.Request.ConsumeCount);
                    break;
    ...
    public partial class Gs2InventoryConsumeItemSetByUserIdValueEnabler
    {
