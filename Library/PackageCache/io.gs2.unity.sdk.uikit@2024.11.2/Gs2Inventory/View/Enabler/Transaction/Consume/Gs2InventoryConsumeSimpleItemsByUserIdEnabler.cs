...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/SimpleItem/View/Enabler/Transaction/Gs2InventoryConsumeSimpleItemsByUserIdEnabler")]
    public partial class Gs2InventoryConsumeSimpleItemsByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Inventory:ConsumeSimpleItemsByUserId") == 0) {
    ...
    public partial class Gs2InventoryConsumeSimpleItemsByUserIdEnabler
    {
