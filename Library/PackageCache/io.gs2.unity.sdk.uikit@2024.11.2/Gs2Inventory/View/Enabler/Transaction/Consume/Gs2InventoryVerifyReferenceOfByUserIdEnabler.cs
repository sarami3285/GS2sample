...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ReferenceOf/View/Enabler/Transaction/Gs2InventoryVerifyReferenceOfByUserIdEnabler")]
    public partial class Gs2InventoryVerifyReferenceOfByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Inventory:VerifyReferenceOfByUserId") == 0) {
    ...
    public partial class Gs2InventoryVerifyReferenceOfByUserIdEnabler
    {
