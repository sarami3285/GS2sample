...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/Enabler/Transaction/Gs2InventoryVerifyItemSetByUserIdEnabler")]
    public partial class Gs2InventoryVerifyItemSetByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Inventory:VerifyItemSetByUserId") == 0) {
    ...
    public partial class Gs2InventoryVerifyItemSetByUserIdEnabler
    {
