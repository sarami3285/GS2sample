...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ReferenceOf/View/Enabler/Transaction/Gs2InventoryAddReferenceOfByUserIdEnabler")]
    public partial class Gs2InventoryAddReferenceOfByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Inventory:AddReferenceOfByUserId") == 0) {
    ...
    public partial class Gs2InventoryAddReferenceOfByUserIdEnabler
    {
