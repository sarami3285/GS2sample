...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
    ...
    public partial class Gs2InventoryAddCapacityByUserIdValueEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this._fetcher.Request.AddCapacityValue != null && this.enableAddCapacityValues.Contains(this._fetcher.Request.AddCapacityValue.Value));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(this._fetcher.Request.AddCapacityValue != null && !this.enableAddCapacityValues.Contains(this._fetcher.Request.AddCapacityValue.Value));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableAddCapacityValue > this._fetcher.Request.AddCapacityValue);
                    break;
