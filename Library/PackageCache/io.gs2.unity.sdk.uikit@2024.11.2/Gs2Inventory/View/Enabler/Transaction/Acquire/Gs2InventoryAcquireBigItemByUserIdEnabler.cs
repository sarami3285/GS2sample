...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/View/Enabler/Transaction/Gs2InventoryAcquireBigItemByUserIdEnabler")]
    public partial class Gs2InventoryAcquireBigItemByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Inventory:AcquireBigItemByUserId") == 0) {
    ...
    public partial class Gs2InventoryAcquireBigItemByUserIdEnabler
    {
