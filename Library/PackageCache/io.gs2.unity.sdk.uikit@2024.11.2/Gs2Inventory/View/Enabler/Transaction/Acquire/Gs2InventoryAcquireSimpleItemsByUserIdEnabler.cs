...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/SimpleItem/View/Enabler/Transaction/Gs2InventoryAcquireSimpleItemsByUserIdEnabler")]
    public partial class Gs2InventoryAcquireSimpleItemsByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Inventory:AcquireSimpleItemsByUserId") == 0) {
    ...
    public partial class Gs2InventoryAcquireSimpleItemsByUserIdEnabler
    {
