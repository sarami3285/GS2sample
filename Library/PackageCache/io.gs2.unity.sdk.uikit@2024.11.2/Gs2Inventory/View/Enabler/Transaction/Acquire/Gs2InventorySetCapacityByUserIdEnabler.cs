...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/Inventory/View/Enabler/Transaction/Gs2InventorySetCapacityByUserIdEnabler")]
    public partial class Gs2InventorySetCapacityByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Inventory:SetCapacityByUserId") == 0) {
    ...
    public partial class Gs2InventorySetCapacityByUserIdEnabler
    {
