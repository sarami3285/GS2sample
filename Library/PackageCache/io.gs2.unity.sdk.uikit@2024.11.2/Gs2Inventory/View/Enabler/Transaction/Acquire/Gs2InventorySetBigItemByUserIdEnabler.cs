...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/View/Enabler/Transaction/Gs2InventorySetBigItemByUserIdEnabler")]
    public partial class Gs2InventorySetBigItemByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Inventory:SetBigItemByUserId") == 0) {
    ...
    public partial class Gs2InventorySetBigItemByUserIdEnabler
    {
