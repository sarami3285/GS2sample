...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
    ...
    public partial class Gs2InventoryAcquireItemSetByUserIdValueEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this._fetcher.Request.AcquireCount != null && this.enableAcquireCounts.Contains(this._fetcher.Request.AcquireCount.Value));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(this._fetcher.Request.AcquireCount != null && !this.enableAcquireCounts.Contains(this._fetcher.Request.AcquireCount.Value));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableAcquireCount > this._fetcher.Request.AcquireCount);
                    break;
