...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/SimpleItem/View/Enabler/Transaction/Gs2InventorySetSimpleItemsByUserIdEnabler")]
    public partial class Gs2InventorySetSimpleItemsByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Inventory:SetSimpleItemsByUserId") == 0) {
    ...
    public partial class Gs2InventorySetSimpleItemsByUserIdEnabler
    {
