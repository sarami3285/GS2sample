...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/Enabler/Transaction/Gs2InventoryAcquireItemSetWithGradeByUserIdEnabler")]
    public partial class Gs2InventoryAcquireItemSetWithGradeByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Inventory:AcquireItemSetWithGradeByUserId") == 0) {
    ...
    public partial class Gs2InventoryAcquireItemSetWithGradeByUserIdEnabler
    {
