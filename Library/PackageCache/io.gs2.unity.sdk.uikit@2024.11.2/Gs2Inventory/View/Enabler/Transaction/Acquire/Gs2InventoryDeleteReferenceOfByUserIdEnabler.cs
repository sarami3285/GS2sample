...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ReferenceOf/View/Enabler/Transaction/Gs2InventoryDeleteReferenceOfByUserIdEnabler")]
    public partial class Gs2InventoryDeleteReferenceOfByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Inventory:DeleteReferenceOfByUserId") == 0) {
    ...
    public partial class Gs2InventoryDeleteReferenceOfByUserIdEnabler
    {
