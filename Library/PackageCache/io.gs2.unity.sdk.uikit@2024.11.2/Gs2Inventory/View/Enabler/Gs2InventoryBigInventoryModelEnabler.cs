...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigInventoryModel/View/Enabler/Gs2InventoryBigInventoryModelEnabler")]
    public partial class Gs2InventoryBigInventoryModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.BigInventoryModel == null)
            {
    ...
    public partial class Gs2InventoryBigInventoryModelEnabler
    {
