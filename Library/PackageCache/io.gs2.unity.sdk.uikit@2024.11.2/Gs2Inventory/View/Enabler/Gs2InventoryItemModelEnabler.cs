...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemModel/View/Enabler/Gs2InventoryItemModelEnabler")]
    public partial class Gs2InventoryItemModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ItemModel == null)
            {
    ...
    public partial class Gs2InventoryItemModelEnabler
    {
