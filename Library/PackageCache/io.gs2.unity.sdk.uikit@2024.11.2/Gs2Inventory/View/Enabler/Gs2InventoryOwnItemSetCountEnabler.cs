...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/Enabler/Properties/Count/Gs2InventoryOwnItemSetCountEnabler")]
    public partial class Gs2InventoryOwnItemSetCountEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableCounts.Contains(this._fetcher.ItemSet[index].Count));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableCounts.Contains(this._fetcher.ItemSet[index].Count));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableCount > this._fetcher.ItemSet[index].Count);
                    break;
    ...
    public partial class Gs2InventoryOwnItemSetCountEnabler
    {
