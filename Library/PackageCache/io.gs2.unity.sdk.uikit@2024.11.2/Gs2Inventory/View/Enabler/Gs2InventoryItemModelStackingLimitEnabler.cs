...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemModel/View/Enabler/Properties/StackingLimit/Gs2InventoryItemModelStackingLimitEnabler")]
    public partial class Gs2InventoryItemModelStackingLimitEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableStackingLimits.Contains(this._fetcher.ItemModel.StackingLimit));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableStackingLimits.Contains(this._fetcher.ItemModel.StackingLimit));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableStackingLimit > this._fetcher.ItemModel.StackingLimit);
                    break;
