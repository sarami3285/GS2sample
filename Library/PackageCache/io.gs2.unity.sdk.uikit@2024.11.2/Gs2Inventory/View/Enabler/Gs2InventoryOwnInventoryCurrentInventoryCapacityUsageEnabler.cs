...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
    ...
    public partial class Gs2InventoryOwnInventoryCurrentInventoryCapacityUsageEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableCurrentInventoryCapacityUsages.Contains(this._fetcher.Inventory.CurrentInventoryCapacityUsage));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableCurrentInventoryCapacityUsages.Contains(this._fetcher.Inventory.CurrentInventoryCapacityUsage));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableCurrentInventoryCapacityUsage > this._fetcher.Inventory.CurrentInventoryCapacityUsage);
                    break;
