...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/InventoryModel/View/Enabler/Properties/MaxCapacity/Gs2InventoryInventoryModelMaxCapacityEnabler")]
    public partial class Gs2InventoryInventoryModelMaxCapacityEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableMaxCapacities.Contains(this._fetcher.InventoryModel.MaxCapacity));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableMaxCapacities.Contains(this._fetcher.InventoryModel.MaxCapacity));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableMaxCapacity > this._fetcher.InventoryModel.MaxCapacity);
                    break;
