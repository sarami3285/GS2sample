...
namespace Gs2.Unity.UiKit.Gs2Inventory.Fetcher
{
    ...
    public partial class Gs2InventoryAcquireItemSetByUserIdFetcher : Gs2InventoryOwnItemSetContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Inventory:AcquireItemSetByUserId") {
                    Request = AcquireItemSetByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (ItemSet == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Inventory:AcquireItemSetByUserId");
                if (action != null) {
