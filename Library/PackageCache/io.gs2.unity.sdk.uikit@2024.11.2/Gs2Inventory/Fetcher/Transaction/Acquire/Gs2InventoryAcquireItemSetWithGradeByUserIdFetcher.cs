...
namespace Gs2.Unity.UiKit.Gs2Inventory.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/Fetcher/Acquire/Gs2InventoryAcquireItemSetWithGradeByUserIdFetcher")]
    public partial class Gs2InventoryAcquireItemSetWithGradeByUserIdFetcher : Gs2InventoryOwnInventoryContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Inventory:AcquireItemSetWithGradeByUserId") {
                    Request = AcquireItemSetWithGradeByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Inventory == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Inventory:AcquireItemSetWithGradeByUserId");
                if (action != null) {
                    Request = AcquireItemSetWithGradeByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Inventory == null || (
                            Inventory.NamespaceName == Request.NamespaceName &&
                            Inventory.InventoryName == Request.InventoryName)
                    ) {
    ...
    public partial class Gs2InventoryAcquireItemSetWithGradeByUserIdFetcher
    {
    ...
    public partial class Gs2InventoryAcquireItemSetWithGradeByUserIdFetcher
    {
        public AcquireItemSetWithGradeByUserIdRequest Request { get; protected set; }
