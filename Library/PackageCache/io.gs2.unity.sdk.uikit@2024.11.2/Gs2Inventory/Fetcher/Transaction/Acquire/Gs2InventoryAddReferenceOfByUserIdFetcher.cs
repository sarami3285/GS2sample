...
namespace Gs2.Unity.UiKit.Gs2Inventory.Fetcher
{
    ...
    public partial class Gs2InventoryAddReferenceOfByUserIdFetcher : Gs2InventoryOwnItemSetContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Inventory:AddReferenceOfByUserId") {
                    Request = AddReferenceOfByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (ItemSet == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Inventory:AddReferenceOfByUserId");
                if (action != null) {
    ...
    public partial class Gs2InventoryAddReferenceOfByUserIdFetcher
    {
        public AddReferenceOfByUserIdRequest Request { get; protected set; }
