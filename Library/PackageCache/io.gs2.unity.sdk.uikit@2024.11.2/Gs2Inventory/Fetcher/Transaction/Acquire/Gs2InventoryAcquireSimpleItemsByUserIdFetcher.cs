...
namespace Gs2.Unity.UiKit.Gs2Inventory.Fetcher
{
    ...
    public partial class Gs2InventoryAcquireSimpleItemsByUserIdFetcher : Gs2InventoryOwnSimpleInventoryContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Inventory:AcquireSimpleItemsByUserId") {
                    Request = AcquireSimpleItemsByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Inventory:AcquireSimpleItemsByUserId");
                if (action != null) {
    ...
    public partial class Gs2InventoryAcquireSimpleItemsByUserIdFetcher
    {
        public AcquireSimpleItemsByUserIdRequest Request { get; protected set; }
