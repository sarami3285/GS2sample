    ...
    public partial class Gs2InventoryAddCapacityByUserIdFetcher : Gs2InventoryOwnInventoryContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Inventory:AddCapacityByUserId") {
                    Request = AddCapacityByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Inventory == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Inventory:AddCapacityByUserId");
                if (action != null) {
