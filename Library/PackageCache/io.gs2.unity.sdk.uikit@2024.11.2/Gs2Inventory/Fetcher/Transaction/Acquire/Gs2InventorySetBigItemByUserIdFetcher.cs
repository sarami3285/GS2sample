...
namespace Gs2.Unity.UiKit.Gs2Inventory.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/Fetcher/Acquire/Gs2InventorySetBigItemByUserIdFetcher")]
    public partial class Gs2InventorySetBigItemByUserIdFetcher : Gs2InventoryOwnBigItemContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Inventory:SetBigItemByUserId") {
                    Request = SetBigItemByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (BigItem == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Inventory:SetBigItemByUserId");
                if (action != null) {
                    Request = SetBigItemByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (BigItem == null || (
                            BigItem.NamespaceName == Request.NamespaceName &&
                            BigItem.InventoryName == Request.InventoryName &&
                            BigItem.ItemName == Request.ItemName)
    ...
    public partial class Gs2InventorySetBigItemByUserIdFetcher
    {
    ...
    public partial class Gs2InventorySetBigItemByUserIdFetcher
    {
        public SetBigItemByUserIdRequest Request { get; protected set; }
