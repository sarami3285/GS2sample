...
namespace Gs2.Unity.UiKit.Gs2Inventory.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/Inventory/Fetcher/Acquire/Gs2InventorySetCapacityByUserIdFetcher")]
    public partial class Gs2InventorySetCapacityByUserIdFetcher : Gs2InventoryOwnInventoryContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Inventory:SetCapacityByUserId") {
                    Request = SetCapacityByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Inventory == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Inventory:SetCapacityByUserId");
                if (action != null) {
                    Request = SetCapacityByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Inventory == null || (
                            Inventory.NamespaceName == Request.NamespaceName &&
                            Inventory.InventoryName == Request.InventoryName)
                    ) {
    ...
    public partial class Gs2InventorySetCapacityByUserIdFetcher
    {
    ...
    public partial class Gs2InventorySetCapacityByUserIdFetcher
    {
        public SetCapacityByUserIdRequest Request { get; protected set; }
