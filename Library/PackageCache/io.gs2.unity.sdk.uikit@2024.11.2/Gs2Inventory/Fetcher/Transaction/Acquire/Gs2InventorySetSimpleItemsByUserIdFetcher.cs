...
namespace Gs2.Unity.UiKit.Gs2Inventory.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/SimpleItem/Fetcher/Acquire/Gs2InventorySetSimpleItemsByUserIdFetcher")]
    public partial class Gs2InventorySetSimpleItemsByUserIdFetcher : Gs2InventoryOwnSimpleInventoryContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Inventory:SetSimpleItemsByUserId") {
                    Request = SetSimpleItemsByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Inventory:SetSimpleItemsByUserId");
                if (action != null) {
                    Request = SetSimpleItemsByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (SimpleInventory == null || (
                            SimpleInventory.NamespaceName == Request.NamespaceName &&
                            SimpleInventory.InventoryName == Request.InventoryName)
                    ) {
    ...
    public partial class Gs2InventorySetSimpleItemsByUserIdFetcher
    {
    ...
    public partial class Gs2InventorySetSimpleItemsByUserIdFetcher
    {
        public SetSimpleItemsByUserIdRequest Request { get; protected set; }
