...
namespace Gs2.Unity.UiKit.Gs2Inventory.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/Fetcher/Consume/Gs2InventoryVerifyBigItemByUserIdFetcher")]
    public partial class Gs2InventoryVerifyBigItemByUserIdFetcher : Gs2InventoryOwnBigItemContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Inventory:VerifyBigItemByUserId") {
                    Request = VerifyBigItemByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (BigItem == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Inventory:VerifyBigItemByUserId");
                if (action != null) {
                    Request = VerifyBigItemByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (BigItem == null || (
                            BigItem.NamespaceName == Request.NamespaceName &&
                            BigItem.InventoryName == Request.InventoryName &&
                            BigItem.ItemName == Request.ItemName)
    ...
    public partial class Gs2InventoryVerifyBigItemByUserIdFetcher
    {
    ...
    public partial class Gs2InventoryVerifyBigItemByUserIdFetcher
    {
        public VerifyBigItemByUserIdRequest Request { get; protected set; }
