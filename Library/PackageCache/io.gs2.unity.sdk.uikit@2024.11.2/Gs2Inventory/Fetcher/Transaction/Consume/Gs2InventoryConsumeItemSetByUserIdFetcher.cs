...
namespace Gs2.Unity.UiKit.Gs2Inventory.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/Fetcher/Consume/Gs2InventoryConsumeItemSetByUserIdFetcher")]
    public partial class Gs2InventoryConsumeItemSetByUserIdFetcher : Gs2InventoryOwnItemSetContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Inventory:ConsumeItemSetByUserId") {
                    Request = ConsumeItemSetByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (ItemSet == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Inventory:ConsumeItemSetByUserId");
                if (action != null) {
                    Request = ConsumeItemSetByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (ItemSet == null || (
                            ItemSet.NamespaceName == Request.NamespaceName &&
                            ItemSet.InventoryName == Request.InventoryName &&
                            ItemSet.ItemName == Request.ItemName &&
    ...
    public partial class Gs2InventoryConsumeItemSetByUserIdFetcher
    {
    ...
    public partial class Gs2InventoryConsumeItemSetByUserIdFetcher
    {
        public ConsumeItemSetByUserIdRequest Request { get; protected set; }
