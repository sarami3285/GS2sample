...
namespace Gs2.Unity.UiKit.Gs2Inventory.Fetcher
{
    ...
    public partial class Gs2InventoryConsumeSimpleItemsByUserIdFetcher : Gs2InventoryOwnSimpleInventoryContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Inventory:ConsumeSimpleItemsByUserId") {
                    Request = ConsumeSimpleItemsByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Inventory:ConsumeSimpleItemsByUserId");
                if (action != null) {
    ...
    public partial class Gs2InventoryConsumeSimpleItemsByUserIdFetcher
    {
    ...
    public partial class Gs2InventoryConsumeSimpleItemsByUserIdFetcher
    {
        public ConsumeSimpleItemsByUserIdRequest Request { get; protected set; }
