...
namespace Gs2.Unity.UiKit.Gs2Inventory.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/Inventory/Fetcher/Consume/Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdFetcher")]
    public partial class Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdFetcher : Gs2InventoryOwnInventoryContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Inventory:VerifyInventoryCurrentMaxCapacityByUserId") {
                    Request = VerifyInventoryCurrentMaxCapacityByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Inventory == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Inventory:VerifyInventoryCurrentMaxCapacityByUserId");
                if (action != null) {
                    Request = VerifyInventoryCurrentMaxCapacityByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Inventory == null || (
                            Inventory.NamespaceName == Request.NamespaceName &&
                            Inventory.InventoryName == Request.InventoryName)
                    ) {
    ...
    public partial class Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdFetcher
    {
    ...
    public partial class Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdFetcher
    {
        public VerifyInventoryCurrentMaxCapacityByUserIdRequest Request { get; protected set; }
