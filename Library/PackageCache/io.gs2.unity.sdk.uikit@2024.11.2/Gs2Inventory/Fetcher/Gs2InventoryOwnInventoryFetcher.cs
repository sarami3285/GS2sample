...
namespace Gs2.Unity.UiKit.Gs2Inventory.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/Inventory/Fetcher/Gs2InventoryOwnInventoryFetcher")]
    public partial class Gs2InventoryOwnInventoryFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Fetch()
        {
            ...
            yield return new WaitUntil(() => Context != null && this.Context.Inventory != null);
        ...
        public void SetTemporaryInventory(
            Gs2.Unity.Gs2Inventory.Model.EzInventory inventory
        ) {
            Inventory = inventory;
            this.OnFetched.Invoke();
        }

        public void RollbackTemporaryInventory(
        ) {
            OnUpdateContext();
        }
    }
    ...
    public partial class Gs2InventoryOwnInventoryFetcher
    {
    ...
    public partial class Gs2InventoryOwnInventoryFetcher
    {
        public Gs2.Unity.Gs2Inventory.Model.EzInventory Inventory { get; protected set; }
