    ...
    public partial class Gs2AdRewardConsumePointByUserIdFetcher : Gs2AdRewardNamespaceContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2AdReward:ConsumePointByUserId") {
                    Request = ConsumePointByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Namespace == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2AdReward:ConsumePointByUserId");
                if (action != null) {
