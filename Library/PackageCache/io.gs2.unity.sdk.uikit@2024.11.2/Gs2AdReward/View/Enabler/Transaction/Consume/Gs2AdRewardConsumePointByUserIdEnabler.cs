...
namespace Gs2.Unity.UiKit.Gs2AdReward
{
	...
	[AddComponentMenu("GS2 UIKit/AdReward/Point/View/Enabler/Transaction/Gs2AdRewardConsumePointByUserIdEnabler")]
    public partial class Gs2AdRewardConsumePointByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2AdReward:ConsumePointByUserId") == 0) {
    ...
    public partial class Gs2AdRewardConsumePointByUserIdEnabler
    {
