...
namespace Gs2.Unity.UiKit.Gs2AdReward
{
	...
	[AddComponentMenu("GS2 UIKit/AdReward/Point/View/Enabler/Gs2AdRewardOwnPointEnabler")]
    public partial class Gs2AdRewardOwnPointEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Point == null)
            {
    ...
    public partial class Gs2AdRewardOwnPointEnabler
    {
