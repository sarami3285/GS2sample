...
namespace Gs2.Unity.UiKit.Gs2Limit
{
    ...
    public partial class Gs2LimitCounterCountUpAction
    {
        ...
        {
            this._context = GetComponent<Gs2LimitOwnCounterContext>() ?? GetComponentInParent<Gs2LimitOwnCounterContext>(true);
            if (this._context == null) {
                return true;
            }
            return false;
    ...
    public partial class Gs2LimitCounterCountUpAction
    {
        ...
        public void SetCountUpValue(int value) {
            ...
            this.onChangeCountUpValue.Invoke(this.CountUpValue);
        ...
        public void SetMaxValue(int value) {
            this.MaxValue = value;
            this.onChangeMaxValue.Invoke(this.MaxValue);
            this.OnChange.Invoke();
        }
