...
namespace Gs2.Unity.UiKit.Gs2Limit.Context
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/Namespace/Context/Gs2LimitNamespaceContext")]
    public partial class Gs2LimitNamespaceContext : MonoBehaviour
    {
        public void Start() {
            if (Namespace == null) {
                Debug.LogWarning($"{gameObject.GetFullPath()}: Namespace is not set in Gs2LimitNamespaceContext.");
            }
        }
