...
namespace Gs2.Unity.UiKit.Gs2Limit
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/Counter/View/Enabler/Transaction/Gs2LimitVerifyCounterByUserIdEnabler")]
    public partial class Gs2LimitVerifyCounterByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Limit:VerifyCounterByUserId") == 0) {
    ...
    public partial class Gs2LimitVerifyCounterByUserIdEnabler
    {
