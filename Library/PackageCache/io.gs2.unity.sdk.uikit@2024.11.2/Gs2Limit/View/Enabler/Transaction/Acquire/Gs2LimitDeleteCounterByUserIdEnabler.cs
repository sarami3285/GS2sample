...
namespace Gs2.Unity.UiKit.Gs2Limit
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/Counter/View/Enabler/Transaction/Gs2LimitDeleteCounterByUserIdEnabler")]
    public partial class Gs2LimitDeleteCounterByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Limit:DeleteCounterByUserId") == 0) {
    ...
    public partial class Gs2LimitDeleteCounterByUserIdEnabler
    {
