...
namespace Gs2.Unity.UiKit.Gs2Limit
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/Counter/View/Enabler/Properties/Count/Gs2LimitOwnCounterCountEnabler")]
    public partial class Gs2LimitOwnCounterCountEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableCounts.Contains(this._fetcher.Counter.Count));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableCounts.Contains(this._fetcher.Counter.Count));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableCount > this._fetcher.Counter.Count);
                    break;
    ...
    public partial class Gs2LimitOwnCounterCountEnabler
    {
