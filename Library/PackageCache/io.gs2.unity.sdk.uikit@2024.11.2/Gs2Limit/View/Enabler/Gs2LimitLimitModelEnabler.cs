...
namespace Gs2.Unity.UiKit.Gs2Limit
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/LimitModel/View/Enabler/Gs2LimitLimitModelEnabler")]
    public partial class Gs2LimitLimitModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.LimitModel == null)
            {
    ...
    public partial class Gs2LimitLimitModelEnabler
    {
