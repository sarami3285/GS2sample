...
namespace Gs2.Unity.UiKit.Gs2Limit
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/LimitModel/View/Enabler/Properties/ResetDayOfMonth/Gs2LimitLimitModelResetDayOfMonthEnabler")]
    public partial class Gs2LimitLimitModelResetDayOfMonthEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableResetDayOfMonths.Contains(this._fetcher.LimitModel.ResetDayOfMonth));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableResetDayOfMonths.Contains(this._fetcher.LimitModel.ResetDayOfMonth));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableResetDayOfMonth > this._fetcher.LimitModel.ResetDayOfMonth);
                    break;
