...
namespace Gs2.Unity.UiKit.Gs2Limit
{
    ...
    public partial class Gs2LimitLimitModelResetHourEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableResetHours.Contains(this._fetcher.LimitModel.ResetHour));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableResetHours.Contains(this._fetcher.LimitModel.ResetHour));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableResetHour > this._fetcher.LimitModel.ResetHour);
                    break;
