...
namespace Gs2.Unity.UiKit.Gs2Limit.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/LimitModel/View/SpriteSwitcher/Properties/ResetType/Gs2LimitLimitModelResetTypeSpriteTableSwitcher")]
    public partial class Gs2LimitLimitModelResetTypeSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.LimitModel.ResetType) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.LimitModel.ResetType).sprite);
            }
            else {
    ...
    public partial class Gs2LimitLimitModelResetTypeSpriteTableSwitcher
    {
