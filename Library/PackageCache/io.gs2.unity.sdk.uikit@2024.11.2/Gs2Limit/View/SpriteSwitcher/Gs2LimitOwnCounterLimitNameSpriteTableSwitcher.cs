...
namespace Gs2.Unity.UiKit.Gs2Limit.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/Counter/View/SpriteSwitcher/Properties/LimitName/Gs2LimitOwnCounterLimitNameSpriteTableSwitcher")]
    public partial class Gs2LimitOwnCounterLimitNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Counter.LimitName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Counter.LimitName).sprite);
            }
            else {
    ...
    public partial class Gs2LimitOwnCounterLimitNameSpriteTableSwitcher
    {
