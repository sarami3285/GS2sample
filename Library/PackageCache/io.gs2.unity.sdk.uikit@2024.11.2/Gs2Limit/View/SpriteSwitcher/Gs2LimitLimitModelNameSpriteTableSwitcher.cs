...
namespace Gs2.Unity.UiKit.Gs2Limit.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/LimitModel/View/SpriteSwitcher/Properties/Name/Gs2LimitLimitModelNameSpriteTableSwitcher")]
    public partial class Gs2LimitLimitModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.LimitModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.LimitModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2LimitLimitModelNameSpriteTableSwitcher
    {
