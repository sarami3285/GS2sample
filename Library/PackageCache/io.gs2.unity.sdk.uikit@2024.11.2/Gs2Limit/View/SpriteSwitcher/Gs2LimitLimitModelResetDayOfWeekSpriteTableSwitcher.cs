...
namespace Gs2.Unity.UiKit.Gs2Limit.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/LimitModel/View/SpriteSwitcher/Properties/ResetDayOfWeek/Gs2LimitLimitModelResetDayOfWeekSpriteTableSwitcher")]
    public partial class Gs2LimitLimitModelResetDayOfWeekSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.LimitModel.ResetDayOfWeek) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.LimitModel.ResetDayOfWeek).sprite);
            }
            else {
    ...
    public partial class Gs2LimitLimitModelResetDayOfWeekSpriteTableSwitcher
    {
