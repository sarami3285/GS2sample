...
namespace Gs2.Unity.UiKit.Gs2Limit.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/LimitModel/View/SpriteSwitcher/Properties/Metadata/Gs2LimitLimitModelMetadataSpriteTableSwitcher")]
    public partial class Gs2LimitLimitModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.LimitModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.LimitModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2LimitLimitModelMetadataSpriteTableSwitcher
    {
