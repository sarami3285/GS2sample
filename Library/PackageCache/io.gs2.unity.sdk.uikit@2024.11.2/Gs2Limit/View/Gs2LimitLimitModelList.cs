...
namespace Gs2.Unity.UiKit.Gs2Limit
{
    ...
    public partial class Gs2LimitLimitModelList
    {
        ...
        public void Awake()
        {
            ...
            this._fetcher = GetComponent<Gs2LimitLimitModelListFetcher>() ?? GetComponentInParent<Gs2LimitLimitModelListFetcher>();
            if (this._fetcher == null) {
                Debug.LogError($"{gameObject.GetFullPath()}: Couldn't find the Gs2LimitLimitModelListFetcher.");
                enabled = false;
            }

            this._children = new List<Gs2LimitLimitModelContext>();
        ...
        public virtual bool HasError()
        {
            ...
            this._fetcher = GetComponent<Gs2LimitLimitModelListFetcher>() ?? GetComponentInParent<Gs2LimitLimitModelListFetcher>(true);
            if (this._fetcher == null) {
                return true;
            }
            return false;
