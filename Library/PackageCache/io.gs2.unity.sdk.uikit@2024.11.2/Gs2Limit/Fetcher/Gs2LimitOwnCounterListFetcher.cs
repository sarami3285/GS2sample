...
namespace Gs2.Unity.UiKit.Gs2Limit.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/Counter/Fetcher/Gs2LimitOwnCounterListFetcher")]
    public partial class Gs2LimitOwnCounterListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var items = new List<Gs2.Unity.Gs2Limit.Model.EzCounter>();
            while (it.HasNext())
            {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeCounters(
                items =>
                {
                    Counters = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2LimitOwnCounterListFetcher
    {
        public Gs2LimitNamespaceContext Context;

        public UnityEvent OnFetched = new UnityEvent();

        public void Awake()
        {
            Context = GetComponent<Gs2LimitNamespaceContext>() ?? GetComponentInParent<Gs2LimitNamespaceContext>();
            if (Context == null) {
    ...
    public partial class Gs2LimitOwnCounterListFetcher
    {
        public List<Gs2.Unity.Gs2Limit.Model.EzCounter> Counters { get; private set; }
