    ...
    public partial class Gs2LimitDeleteCounterByUserIdFetcher : Gs2LimitOwnCounterContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Limit:DeleteCounterByUserId") {
                    Request = DeleteCounterByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Counter == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Limit:DeleteCounterByUserId");
                if (action != null) {
