    ...
    public partial class Gs2LimitCountUpByUserIdFetcher : Gs2LimitOwnCounterContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Limit:CountUpByUserId") {
                    Request = CountUpByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Counter == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Limit:CountUpByUserId");
                if (action != null) {
