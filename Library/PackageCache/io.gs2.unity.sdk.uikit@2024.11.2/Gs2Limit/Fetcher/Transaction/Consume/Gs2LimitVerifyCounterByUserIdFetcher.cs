...
namespace Gs2.Unity.UiKit.Gs2Limit.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/Counter/Fetcher/Consume/Gs2LimitVerifyCounterByUserIdFetcher")]
    public partial class Gs2LimitVerifyCounterByUserIdFetcher : Gs2LimitOwnCounterContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Limit:VerifyCounterByUserId") {
                    Request = VerifyCounterByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Counter == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Limit:VerifyCounterByUserId");
                if (action != null) {
                    Request = VerifyCounterByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Counter == null || (
                            Counter.NamespaceName == Request.NamespaceName &&
                            Counter.LimitName == Request.LimitName &&
                            Counter.CounterName == Request.CounterName)
    ...
    public partial class Gs2LimitVerifyCounterByUserIdFetcher
    {
    ...
    public partial class Gs2LimitVerifyCounterByUserIdFetcher
    {
        public VerifyCounterByUserIdRequest Request { get; protected set; }
