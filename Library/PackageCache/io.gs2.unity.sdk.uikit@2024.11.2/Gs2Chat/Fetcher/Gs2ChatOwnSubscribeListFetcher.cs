...
namespace Gs2.Unity.UiKit.Gs2Chat.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Chat/Subscribe/Fetcher/Gs2ChatOwnSubscribeListFetcher")]
    public partial class Gs2ChatOwnSubscribeListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var items = new List<Gs2.Unity.Gs2Chat.Model.EzSubscribe>();
            while (it.HasNext())
            {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeSubscribes(
                items =>
                {
                    Subscribes = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2ChatOwnSubscribeListFetcher
    {
        public Gs2ChatNamespaceContext Context;

        public UnityEvent OnFetched = new UnityEvent();

        public void Awake()
        {
            Context = GetComponent<Gs2ChatNamespaceContext>() ?? GetComponentInParent<Gs2ChatNamespaceContext>();
            if (Context == null) {
    ...
    public partial class Gs2ChatOwnSubscribeListFetcher
    {
        public List<Gs2.Unity.Gs2Chat.Model.EzSubscribe> Subscribes { get; private set; }
