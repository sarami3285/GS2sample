...
namespace Gs2.Unity.UiKit.Gs2Chat.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Chat/Message/View/SpriteSwitcher/Properties/Name/Gs2ChatMessageNameSpriteTableSwitcher")]
    public partial class Gs2ChatMessageNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Message.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Message.Name).sprite);
            }
            else {
    ...
    public partial class Gs2ChatMessageNameSpriteTableSwitcher
    {
