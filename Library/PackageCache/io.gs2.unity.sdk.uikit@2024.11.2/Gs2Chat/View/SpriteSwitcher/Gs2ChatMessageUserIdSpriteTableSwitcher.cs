...
namespace Gs2.Unity.UiKit.Gs2Chat.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Chat/Message/View/SpriteSwitcher/Properties/UserId/Gs2ChatMessageUserIdSpriteTableSwitcher")]
    public partial class Gs2ChatMessageUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Message.UserId) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Message.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2ChatMessageUserIdSpriteTableSwitcher
    {
