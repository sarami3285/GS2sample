...
namespace Gs2.Unity.UiKit.Gs2Chat.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Chat/Message/View/SpriteSwitcher/Properties/RoomName/Gs2ChatMessageRoomNameSpriteTableSwitcher")]
    public partial class Gs2ChatMessageRoomNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Message.RoomName) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Message.RoomName).sprite);
            }
            else {
    ...
    public partial class Gs2ChatMessageRoomNameSpriteTableSwitcher
    {
