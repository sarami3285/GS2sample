...
namespace Gs2.Unity.UiKit.Gs2Chat.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Chat/Subscribe/View/SpriteSwitcher/Properties/UserId/Gs2ChatOwnSubscribeUserIdSpriteTableSwitcher")]
    public partial class Gs2ChatOwnSubscribeUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Subscribe.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Subscribe.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2ChatOwnSubscribeUserIdSpriteTableSwitcher
    {
