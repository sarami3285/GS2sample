...
namespace Gs2.Unity.UiKit.Gs2Chat.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Chat/Subscribe/View/SpriteSwitcher/Properties/RoomName/Gs2ChatOwnSubscribeRoomNameSpriteTableSwitcher")]
    public partial class Gs2ChatOwnSubscribeRoomNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Subscribe.RoomName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Subscribe.RoomName).sprite);
            }
            else {
    ...
    public partial class Gs2ChatOwnSubscribeRoomNameSpriteTableSwitcher
    {
