...
namespace Gs2.Unity.UiKit.Gs2Chat.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Chat/Room/View/SpriteSwitcher/Properties/Metadata/Gs2ChatRoomMetadataSpriteTableSwitcher")]
    public partial class Gs2ChatRoomMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Room.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Room.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2ChatRoomMetadataSpriteTableSwitcher
    {
