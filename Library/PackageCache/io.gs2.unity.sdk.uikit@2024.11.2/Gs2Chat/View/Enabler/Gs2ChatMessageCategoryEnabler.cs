...
namespace Gs2.Unity.UiKit.Gs2Chat
{
	...
	[AddComponentMenu("GS2 UIKit/Chat/Message/View/Enabler/Properties/Category/Gs2ChatMessageCategoryEnabler")]
    public partial class Gs2ChatMessageCategoryEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableCategories.Contains(this._fetcher.Message.Category));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableCategories.Contains(this._fetcher.Message.Category));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableCategory > this._fetcher.Message.Category);
                    break;
