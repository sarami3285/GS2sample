...
namespace Gs2.Unity.UiKit.Gs2Inbox.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/SpriteSwitcher/Properties/Metadata/Gs2InboxOwnMessageMetadataSpriteTableSwitcher")]
    public partial class Gs2InboxOwnMessageMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Message.Metadata) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Message.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2InboxOwnMessageMetadataSpriteTableSwitcher
    {
