...
namespace Gs2.Unity.UiKit.Gs2Inbox.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/SpriteSwitcher/Properties/Name/Gs2InboxOwnMessageNameSpriteTableSwitcher")]
    public partial class Gs2InboxOwnMessageNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Message.Name) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Message.Name).sprite);
            }
            else {
    ...
    public partial class Gs2InboxOwnMessageNameSpriteTableSwitcher
    {
