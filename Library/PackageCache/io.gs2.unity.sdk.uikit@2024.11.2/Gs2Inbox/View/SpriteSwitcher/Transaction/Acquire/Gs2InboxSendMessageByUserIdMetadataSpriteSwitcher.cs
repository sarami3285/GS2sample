...
namespace Gs2.Unity.UiKit.Gs2Inbox.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/SpriteSwitcher/Transaction/Properties/Metadata/Gs2InboxSendMessageByUserIdMetadataSpriteSwitcher")]
    public partial class Gs2InboxSendMessageByUserIdMetadataSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyMetadatas.Contains(this._fetcher.Request?.Metadata ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.Request?.Metadata ?? "").StartsWith(this.applyMetadata)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.Request?.Metadata ?? "").EndsWith(this.applyMetadata)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2InboxSendMessageByUserIdMetadataSpriteSwitcher
    {
