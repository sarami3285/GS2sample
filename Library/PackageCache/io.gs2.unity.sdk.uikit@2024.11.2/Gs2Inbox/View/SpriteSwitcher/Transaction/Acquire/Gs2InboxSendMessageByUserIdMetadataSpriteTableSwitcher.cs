...
namespace Gs2.Unity.UiKit.Gs2Inbox.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/SpriteSwitcher/Transaction/Properties/Metadata/Gs2InboxSendMessageByUserIdMetadataSpriteTableSwitcher")]
    public partial class Gs2InboxSendMessageByUserIdMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2InboxSendMessageByUserIdMetadataSpriteTableSwitcher
    {
