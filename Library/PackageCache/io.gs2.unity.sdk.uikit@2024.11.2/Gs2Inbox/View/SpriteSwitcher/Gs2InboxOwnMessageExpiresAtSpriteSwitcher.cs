...
namespace Gs2.Unity.UiKit.Gs2Inbox
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/SpriteSwitcher/Properties/ExpiresAt/Gs2InboxOwnMessageExpiresAtSpriteSwitcher")]
    public partial class Gs2InboxOwnMessageExpiresAtSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyExpiresAts.Contains(this._fetcher.Message.ExpiresAt)) {
                ...
                case Expression.Less:
                    if (this.applyExpiresAt > this._fetcher.Message.ExpiresAt) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
    ...
    public partial class Gs2InboxOwnMessageExpiresAtSpriteSwitcher
    {
