...
namespace Gs2.Unity.UiKit.Gs2Inbox.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/Enabler/Properties/Name/Gs2InboxOwnMessageNameEnabler")]
    public partial class Gs2InboxOwnMessageNameEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableNames.Contains(this._fetcher.Message?.Name ?? ""));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableNames.Contains(this._fetcher.Message?.Name ?? ""));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive((this._fetcher.Message?.Name ?? "").StartsWith(this.enableName));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive((this._fetcher.Message?.Name ?? "").EndsWith(this.enableName));
                    break;
                default:
    ...
    public partial class Gs2InboxOwnMessageNameEnabler
    {
