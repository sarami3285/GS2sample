...
namespace Gs2.Unity.UiKit.Gs2Inbox
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/Enabler/Properties/ReceivedAt/Gs2InboxOwnMessageReceivedAtEnabler")]
    public partial class Gs2InboxOwnMessageReceivedAtEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableReceivedAts.Contains(this._fetcher.Message.ReceivedAt));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableReceivedAts.Contains(this._fetcher.Message.ReceivedAt));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableReceivedAt > this._fetcher.Message.ReceivedAt);
                    break;
    ...
    public partial class Gs2InboxOwnMessageReceivedAtEnabler
    {
