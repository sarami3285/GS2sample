...
namespace Gs2.Unity.UiKit.Gs2Inbox
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/Enabler/Properties/ExpiresAt/Gs2InboxOwnMessageExpiresAtEnabler")]
    public partial class Gs2InboxOwnMessageExpiresAtEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableExpiresAts.Contains(this._fetcher.Message.ExpiresAt));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableExpiresAts.Contains(this._fetcher.Message.ExpiresAt));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableExpiresAt > this._fetcher.Message.ExpiresAt);
                    break;
    ...
    public partial class Gs2InboxOwnMessageExpiresAtEnabler
    {
