...
namespace Gs2.Unity.UiKit.Gs2Inbox
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/Enabler/Properties/ReadAt/Gs2InboxOwnMessageReadAtEnabler")]
    public partial class Gs2InboxOwnMessageReadAtEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableReadAts.Contains(this._fetcher.Message.ReadAt));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableReadAts.Contains(this._fetcher.Message.ReadAt));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableReadAt > this._fetcher.Message.ReadAt);
                    break;
    ...
    public partial class Gs2InboxOwnMessageReadAtEnabler
    {
