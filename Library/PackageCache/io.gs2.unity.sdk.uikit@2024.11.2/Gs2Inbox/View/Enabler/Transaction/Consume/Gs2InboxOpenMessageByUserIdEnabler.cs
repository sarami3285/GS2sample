...
namespace Gs2.Unity.UiKit.Gs2Inbox
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/Enabler/Transaction/Gs2InboxOpenMessageByUserIdEnabler")]
    public partial class Gs2InboxOpenMessageByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Inbox:OpenMessageByUserId") == 0) {
    ...
    public partial class Gs2InboxOpenMessageByUserIdEnabler
    {
