...
namespace Gs2.Unity.UiKit.Gs2Inbox
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/Enabler/Transaction/Gs2InboxSendMessageByUserIdEnabler")]
    public partial class Gs2InboxSendMessageByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Inbox:SendMessageByUserId") == 0) {
    ...
    public partial class Gs2InboxSendMessageByUserIdEnabler
    {
