...
namespace Gs2.Unity.UiKit.Gs2Inbox.Label
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/Label/Transaction/Gs2InboxOpenMessageByUserIdLabel")]
    public partial class Gs2InboxOpenMessageByUserIdLabel : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._userDataFetcher == null) {
                var context = gameObject.AddComponent<Gs2InboxOwnMessageContext>();
                context.SetOwnMessage(
                    OwnMessage.New(
                        Namespace.New(
                ...
                this._userDataFetcher = gameObject.AddComponent<Gs2InboxOwnMessageFetcher>();
