...
namespace Gs2.Unity.UiKit.Gs2Inbox.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/Fetcher/Acquire/Gs2InboxSendMessageByUserIdFetcher")]
    public partial class Gs2InboxSendMessageByUserIdFetcher : Gs2InboxNamespaceContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Inbox:SendMessageByUserId") {
                    Request = SendMessageByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Namespace == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Inbox:SendMessageByUserId");
                if (action != null) {
                    Request = SendMessageByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Namespace == null || (
                            Namespace.NamespaceName == Request.NamespaceName)
                    ) {
                        Namespace = Namespace.New(
    ...
    public partial class Gs2InboxSendMessageByUserIdFetcher
    {
    ...
    public partial class Gs2InboxSendMessageByUserIdFetcher
    {
        public SendMessageByUserIdRequest Request { get; protected set; }
