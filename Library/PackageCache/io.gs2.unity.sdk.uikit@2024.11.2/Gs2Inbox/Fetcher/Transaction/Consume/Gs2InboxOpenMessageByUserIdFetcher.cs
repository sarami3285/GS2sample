...
namespace Gs2.Unity.UiKit.Gs2Inbox.Fetcher
{
    ...
    public partial class Gs2InboxOpenMessageByUserIdFetcher : Gs2InboxOwnMessageContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Inbox:OpenMessageByUserId") {
                    Request = OpenMessageByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Message == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Inbox:OpenMessageByUserId");
                if (action != null) {
