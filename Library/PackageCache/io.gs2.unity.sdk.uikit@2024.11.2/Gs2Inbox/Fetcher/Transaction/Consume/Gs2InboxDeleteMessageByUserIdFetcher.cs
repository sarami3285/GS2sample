...
namespace Gs2.Unity.UiKit.Gs2Inbox.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/Fetcher/Consume/Gs2InboxDeleteMessageByUserIdFetcher")]
    public partial class Gs2InboxDeleteMessageByUserIdFetcher : Gs2InboxOwnMessageContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Inbox:DeleteMessageByUserId") {
                    Request = DeleteMessageByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Message == null || (
                            Message.NamespaceName == Request.NamespaceName &&
                            Message.MessageName == Request.MessageName)
                    ) {
                        Message = OwnMessage.New(
                            Namespace.New(
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Inbox:DeleteMessageByUserId");
                if (action != null) {
                    Request = DeleteMessageByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Message == null || (
                            Message.NamespaceName == Request.NamespaceName &&
                            Message.MessageName == Request.MessageName)
                    ) {
    ...
    public partial class Gs2InboxDeleteMessageByUserIdFetcher
    {
    ...
    public partial class Gs2InboxDeleteMessageByUserIdFetcher
    {
        public DeleteMessageByUserIdRequest Request { get; protected set; }
