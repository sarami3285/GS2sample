...
namespace Gs2.Unity.UiKit.Gs2Schedule
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/Enabler/Properties/RepeatEndHour/Gs2ScheduleOwnEventRepeatEndHourEnabler")]
    public partial class Gs2ScheduleOwnEventRepeatEndHourEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableRepeatEndHours.Contains(this._fetcher.Event.RepeatEndHour));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableRepeatEndHours.Contains(this._fetcher.Event.RepeatEndHour));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableRepeatEndHour > this._fetcher.Event.RepeatEndHour);
                    break;
    ...
    public partial class Gs2ScheduleOwnEventRepeatEndHourEnabler
    {
