...
namespace Gs2.Unity.UiKit.Gs2Schedule
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/Enabler/Transaction/Gs2ScheduleVerifyEventByUserIdEnabler")]
    public partial class Gs2ScheduleVerifyEventByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Schedule:VerifyEventByUserId") == 0) {
    ...
    public partial class Gs2ScheduleVerifyEventByUserIdEnabler
    {
