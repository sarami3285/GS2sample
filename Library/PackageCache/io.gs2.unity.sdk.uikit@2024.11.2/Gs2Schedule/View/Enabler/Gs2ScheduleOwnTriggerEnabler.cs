...
namespace Gs2.Unity.UiKit.Gs2Schedule
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Trigger/View/Enabler/Gs2ScheduleOwnTriggerEnabler")]
    public partial class Gs2ScheduleOwnTriggerEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Trigger == null)
            {
    ...
    public partial class Gs2ScheduleOwnTriggerEnabler
    {
