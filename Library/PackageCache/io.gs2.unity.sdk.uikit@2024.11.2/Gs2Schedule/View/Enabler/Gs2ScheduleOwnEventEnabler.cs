...
namespace Gs2.Unity.UiKit.Gs2Schedule
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/Enabler/Gs2ScheduleOwnEventEnabler")]
    public partial class Gs2ScheduleOwnEventEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Event == null)
            {
    ...
    public partial class Gs2ScheduleOwnEventEnabler
    {
