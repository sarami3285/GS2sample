...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Trigger/View/SpriteSwitcher/Properties/Name/Gs2ScheduleOwnTriggerNameSpriteTableSwitcher")]
    public partial class Gs2ScheduleOwnTriggerNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Trigger.Name) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Trigger.Name).sprite);
            }
            else {
    ...
    public partial class Gs2ScheduleOwnTriggerNameSpriteTableSwitcher
    {
