...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/ScheduleType/Gs2ScheduleOwnEventScheduleTypeSpriteSwitcher")]
    public partial class Gs2ScheduleOwnEventScheduleTypeSpriteSwitcher : MonoBehaviour
    {
    ...
    public partial class Gs2ScheduleOwnEventScheduleTypeSpriteSwitcher
    {
    ...
    public partial class Gs2ScheduleOwnEventScheduleTypeSpriteSwitcher
    {
        ...
        public List<string> applyScheduleTypes;

        public string applyScheduleType;
