...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/RepeatEndDayOfWeek/Gs2ScheduleOwnEventRepeatEndDayOfWeekSpriteTableSwitcher")]
    public partial class Gs2ScheduleOwnEventRepeatEndDayOfWeekSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Event.RepeatEndDayOfWeek) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Event.RepeatEndDayOfWeek).sprite);
            }
            else {
    ...
    public partial class Gs2ScheduleOwnEventRepeatEndDayOfWeekSpriteTableSwitcher
    {
