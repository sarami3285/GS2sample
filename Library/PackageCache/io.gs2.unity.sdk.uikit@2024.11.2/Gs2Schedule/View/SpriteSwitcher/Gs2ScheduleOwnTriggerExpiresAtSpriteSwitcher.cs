...
namespace Gs2.Unity.UiKit.Gs2Schedule
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Trigger/View/SpriteSwitcher/Properties/ExpiresAt/Gs2ScheduleOwnTriggerExpiresAtSpriteSwitcher")]
    public partial class Gs2ScheduleOwnTriggerExpiresAtSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyExpiresAts.Contains(this._fetcher.Trigger.ExpiresAt)) {
                ...
                case Expression.Less:
                    if (this.applyExpiresAt > this._fetcher.Trigger.ExpiresAt) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
    ...
    public partial class Gs2ScheduleOwnTriggerExpiresAtSpriteSwitcher
    {
