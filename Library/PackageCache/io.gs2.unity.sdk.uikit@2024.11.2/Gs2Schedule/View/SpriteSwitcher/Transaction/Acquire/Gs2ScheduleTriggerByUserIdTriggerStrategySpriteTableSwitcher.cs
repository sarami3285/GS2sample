...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Trigger/View/SpriteSwitcher/Transaction/Properties/TriggerStrategy/Gs2ScheduleTriggerByUserIdTriggerStrategySpriteTableSwitcher")]
    public partial class Gs2ScheduleTriggerByUserIdTriggerStrategySpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.TriggerStrategy) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.TriggerStrategy).sprite);
            }
            else {
    ...
    public partial class Gs2ScheduleTriggerByUserIdTriggerStrategySpriteTableSwitcher
    {
