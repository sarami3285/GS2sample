...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Trigger/View/SpriteSwitcher/Transaction/Properties/TriggerName/Gs2ScheduleDeleteTriggerByUserIdTriggerNameSpriteTableSwitcher")]
    public partial class Gs2ScheduleDeleteTriggerByUserIdTriggerNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.TriggerName) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.TriggerName).sprite);
            }
            else {
    ...
    public partial class Gs2ScheduleDeleteTriggerByUserIdTriggerNameSpriteTableSwitcher
    {
