...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/RepeatType/Gs2ScheduleOwnEventRepeatTypeSpriteTableSwitcher")]
    public partial class Gs2ScheduleOwnEventRepeatTypeSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Event.RepeatType) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Event.RepeatType).sprite);
            }
            else {
    ...
    public partial class Gs2ScheduleOwnEventRepeatTypeSpriteTableSwitcher
    {
