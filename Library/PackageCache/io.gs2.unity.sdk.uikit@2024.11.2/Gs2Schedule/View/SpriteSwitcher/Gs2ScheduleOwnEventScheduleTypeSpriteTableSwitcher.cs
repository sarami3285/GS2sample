...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/ScheduleType/Gs2ScheduleOwnEventScheduleTypeSpriteTableSwitcher")]
    public partial class Gs2ScheduleOwnEventScheduleTypeSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Event.ScheduleType) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Event.ScheduleType).sprite);
            }
            else {
    ...
    public partial class Gs2ScheduleOwnEventScheduleTypeSpriteTableSwitcher
    {
