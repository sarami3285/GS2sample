...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/Metadata/Gs2ScheduleOwnEventMetadataSpriteTableSwitcher")]
    public partial class Gs2ScheduleOwnEventMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Event.Metadata) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Event.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2ScheduleOwnEventMetadataSpriteTableSwitcher
    {
