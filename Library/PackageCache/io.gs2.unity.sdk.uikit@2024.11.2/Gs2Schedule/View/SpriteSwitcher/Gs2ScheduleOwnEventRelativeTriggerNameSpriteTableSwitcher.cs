...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/RelativeTriggerName/Gs2ScheduleOwnEventRelativeTriggerNameSpriteTableSwitcher")]
    public partial class Gs2ScheduleOwnEventRelativeTriggerNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Event.RelativeTriggerName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Event.RelativeTriggerName).sprite);
            }
            else {
    ...
    public partial class Gs2ScheduleOwnEventRelativeTriggerNameSpriteTableSwitcher
    {
