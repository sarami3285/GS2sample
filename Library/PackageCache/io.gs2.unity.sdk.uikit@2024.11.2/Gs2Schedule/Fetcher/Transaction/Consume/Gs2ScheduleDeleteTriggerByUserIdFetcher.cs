    ...
    public partial class Gs2ScheduleDeleteTriggerByUserIdFetcher : Gs2ScheduleOwnTriggerContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Schedule:DeleteTriggerByUserId") {
                    Request = DeleteTriggerByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Trigger == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Schedule:DeleteTriggerByUserId");
                if (action != null) {
