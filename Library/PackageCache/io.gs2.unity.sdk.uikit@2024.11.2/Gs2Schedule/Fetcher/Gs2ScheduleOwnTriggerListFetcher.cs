...
namespace Gs2.Unity.UiKit.Gs2Schedule.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Trigger/Fetcher/Gs2ScheduleOwnTriggerListFetcher")]
    public partial class Gs2ScheduleOwnTriggerListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var items = new List<Gs2.Unity.Gs2Schedule.Model.EzTrigger>();
            while (it.HasNext())
            {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeTriggers(
                items =>
                {
                    Triggers = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2ScheduleOwnTriggerListFetcher
    {
    ...
    public partial class Gs2ScheduleOwnTriggerListFetcher
    {
        public List<Gs2.Unity.Gs2Schedule.Model.EzTrigger> Triggers { get; private set; }
