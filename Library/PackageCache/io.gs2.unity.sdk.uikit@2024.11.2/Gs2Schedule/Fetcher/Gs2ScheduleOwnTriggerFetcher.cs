...
namespace Gs2.Unity.UiKit.Gs2Schedule.Fetcher
{
    ...
    {
        private EzTriggerGameSessionDomain _domain;
        ...
        private IEnumerator Fetch()
        {
            ...
            yield return new WaitUntil(() => Context != null && this.Context.Trigger != null);
        ...
        public void SetTemporaryTrigger(
            Gs2.Unity.Gs2Schedule.Model.EzTrigger trigger
        ) {
            Trigger = trigger;
            this.OnFetched.Invoke();
        }

        public void RollbackTemporaryTrigger(
        ) {
            OnUpdateContext();
        }
    }
