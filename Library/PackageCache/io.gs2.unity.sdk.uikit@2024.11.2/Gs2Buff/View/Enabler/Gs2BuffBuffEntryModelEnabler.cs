...
namespace Gs2.Unity.UiKit.Gs2Buff
{
	...
	[AddComponentMenu("GS2 UIKit/Buff/BuffEntryModel/View/Enabler/Gs2BuffBuffEntryModelEnabler")]
    public partial class Gs2BuffBuffEntryModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.BuffEntryModel == null)
            {
    ...
    public partial class Gs2BuffBuffEntryModelEnabler
    {
