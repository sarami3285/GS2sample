...
namespace Gs2.Unity.UiKit.Gs2Buff.Localization
{
    /// <summary>
    /// Main
    /// </summary>

    [AddComponentMenu("GS2 UIKit/Buff/BuffEntryModel/View/Localization/Gs2BuffBuffEntryModelLocalizationVariables")]
    public partial class Gs2BuffBuffEntryModelLocalizationVariables : MonoBehaviour
    {
        private void OnFetched()
        {
            this.target.StringReference["name"] = new StringVariable {
                Value = _fetcher?.BuffEntryModel?.Name ?? "",
            };
            this.target.StringReference["metadata"] = new StringVariable {
                Value = _fetcher?.BuffEntryModel?.Metadata ?? "",
            };
            this.target.StringReference["targetType"] = new StringVariable {
                Value = _fetcher?.BuffEntryModel?.TargetType ?? "",
            };
    ...
    public partial class Gs2BuffBuffEntryModelLocalizationVariables
    {
