...
namespace Gs2.Unity.UiKit.Gs2Friend.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/Profile/Fetcher/Acquire/Gs2FriendUpdateProfileByUserIdFetcher")]
    public partial class Gs2FriendUpdateProfileByUserIdFetcher : Gs2FriendNamespaceContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Friend:UpdateProfileByUserId") {
                    Request = UpdateProfileByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Namespace == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Friend:UpdateProfileByUserId");
                if (action != null) {
                    Request = UpdateProfileByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Namespace == null || (
                            Namespace.NamespaceName == Request.NamespaceName)
                    ) {
                        Namespace = Namespace.New(
    ...
    public partial class Gs2FriendUpdateProfileByUserIdFetcher
    {
    ...
    public partial class Gs2FriendUpdateProfileByUserIdFetcher
    {
        public UpdateProfileByUserIdRequest Request { get; protected set; }
