...
namespace Gs2.Unity.UiKit.Gs2Friend.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/SendFriendRequest/Fetcher/Gs2FriendOwnSendFriendRequestListFetcher")]
    public partial class Gs2FriendOwnSendFriendRequestListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeSendRequests(
                items =>
                {
                    SendFriendRequests = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
