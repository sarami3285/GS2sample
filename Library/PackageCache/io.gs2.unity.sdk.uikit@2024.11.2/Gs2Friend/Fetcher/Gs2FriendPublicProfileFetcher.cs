...
namespace Gs2.Unity.UiKit.Gs2Friend.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/PublicProfile/Fetcher/Gs2FriendPublicProfileFetcher")]
    public partial class Gs2FriendPublicProfileFetcher : MonoBehaviour
    {
        private EzPublicProfileDomain _domain;
        ...
        private IEnumerator Fetch()
        {
            ...
            yield return new WaitUntil(() => Context != null && this.Context.PublicProfile != null);
    ...
    public partial class Gs2FriendPublicProfileFetcher
    {
        public EzPublicProfile PublicProfile { get; protected set; }
