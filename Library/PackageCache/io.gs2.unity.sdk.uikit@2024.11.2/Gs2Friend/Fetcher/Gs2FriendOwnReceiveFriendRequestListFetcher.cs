...
namespace Gs2.Unity.UiKit.Gs2Friend.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/ReceiveFriendRequest/Fetcher/Gs2FriendOwnReceiveFriendRequestListFetcher")]
    public partial class Gs2FriendOwnReceiveFriendRequestListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeReceiveRequests(
                items =>
                {
                    ReceiveFriendRequests = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2FriendOwnReceiveFriendRequestListFetcher
    {
        public List<Gs2.Unity.Gs2Friend.Model.EzFriendRequest> ReceiveFriendRequests { get; private set; }
