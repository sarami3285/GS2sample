...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/Profile/View/SpriteSwitcher/Properties/PublicProfile/Gs2FriendOwnProfilePublicProfileSpriteTableSwitcher")]
    public partial class Gs2FriendOwnProfilePublicProfileSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Profile.PublicProfile) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Profile.PublicProfile).sprite);
            }
            else {
    ...
    public partial class Gs2FriendOwnProfilePublicProfileSpriteTableSwitcher
    {
