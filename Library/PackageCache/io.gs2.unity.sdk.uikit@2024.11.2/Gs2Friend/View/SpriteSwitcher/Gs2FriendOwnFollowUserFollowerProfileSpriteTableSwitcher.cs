...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/FollowUser/View/SpriteSwitcher/Properties/FollowerProfile/Gs2FriendOwnFollowUserFollowerProfileSpriteTableSwitcher")]
    public partial class Gs2FriendOwnFollowUserFollowerProfileSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.FollowUser.FollowerProfile) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.FollowUser.FollowerProfile).sprite);
            }
            else {
    ...
    public partial class Gs2FriendOwnFollowUserFollowerProfileSpriteTableSwitcher
    {
