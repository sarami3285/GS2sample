...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/FollowUser/View/SpriteSwitcher/Properties/PublicProfile/Gs2FriendOwnFollowUserPublicProfileSpriteTableSwitcher")]
    public partial class Gs2FriendOwnFollowUserPublicProfileSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.FollowUser.PublicProfile) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.FollowUser.PublicProfile).sprite);
            }
            else {
    ...
    public partial class Gs2FriendOwnFollowUserPublicProfileSpriteTableSwitcher
    {
