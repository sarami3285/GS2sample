...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/FriendUser/View/SpriteSwitcher/Properties/UserId/Gs2FriendOwnFriendUserUserIdSpriteTableSwitcher")]
    public partial class Gs2FriendOwnFriendUserUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.FriendUser.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.FriendUser.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2FriendOwnFriendUserUserIdSpriteTableSwitcher
    {
