...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/Profile/View/SpriteSwitcher/Properties/FollowerProfile/Gs2FriendOwnProfileFollowerProfileSpriteTableSwitcher")]
    public partial class Gs2FriendOwnProfileFollowerProfileSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Profile.FollowerProfile) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Profile.FollowerProfile).sprite);
            }
            else {
    ...
    public partial class Gs2FriendOwnProfileFollowerProfileSpriteTableSwitcher
    {
