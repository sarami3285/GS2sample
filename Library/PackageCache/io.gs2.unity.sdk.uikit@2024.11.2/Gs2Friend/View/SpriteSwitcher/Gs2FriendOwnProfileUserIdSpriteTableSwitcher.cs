...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/Profile/View/SpriteSwitcher/Properties/UserId/Gs2FriendOwnProfileUserIdSpriteTableSwitcher")]
    public partial class Gs2FriendOwnProfileUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Profile.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Profile.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2FriendOwnProfileUserIdSpriteTableSwitcher
    {
