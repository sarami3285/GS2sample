...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/FriendUser/View/SpriteSwitcher/Properties/PublicProfile/Gs2FriendOwnFriendUserPublicProfileSpriteTableSwitcher")]
    public partial class Gs2FriendOwnFriendUserPublicProfileSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.FriendUser.PublicProfile) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.FriendUser.PublicProfile).sprite);
            }
            else {
    ...
    public partial class Gs2FriendOwnFriendUserPublicProfileSpriteTableSwitcher
    {
