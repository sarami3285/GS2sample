...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/Profile/View/SpriteSwitcher/Transaction/Properties/FollowerProfile/Gs2FriendUpdateProfileByUserIdFollowerProfileSpriteTableSwitcher")]
    public partial class Gs2FriendUpdateProfileByUserIdFollowerProfileSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.FollowerProfile) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.FollowerProfile).sprite);
            }
            else {
    ...
    public partial class Gs2FriendUpdateProfileByUserIdFollowerProfileSpriteTableSwitcher
    {
