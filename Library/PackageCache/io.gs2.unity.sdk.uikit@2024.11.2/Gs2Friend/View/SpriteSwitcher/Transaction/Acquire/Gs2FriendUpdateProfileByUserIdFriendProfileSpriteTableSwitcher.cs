...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/Profile/View/SpriteSwitcher/Transaction/Properties/FriendProfile/Gs2FriendUpdateProfileByUserIdFriendProfileSpriteTableSwitcher")]
    public partial class Gs2FriendUpdateProfileByUserIdFriendProfileSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.FriendProfile) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.FriendProfile).sprite);
            }
            else {
    ...
    public partial class Gs2FriendUpdateProfileByUserIdFriendProfileSpriteTableSwitcher
    {
