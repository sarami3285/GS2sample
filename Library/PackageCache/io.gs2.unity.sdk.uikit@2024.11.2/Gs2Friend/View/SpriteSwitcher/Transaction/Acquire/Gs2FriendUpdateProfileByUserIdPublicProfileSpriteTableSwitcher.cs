...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/Profile/View/SpriteSwitcher/Transaction/Properties/PublicProfile/Gs2FriendUpdateProfileByUserIdPublicProfileSpriteTableSwitcher")]
    public partial class Gs2FriendUpdateProfileByUserIdPublicProfileSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.PublicProfile) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.PublicProfile).sprite);
            }
            else {
    ...
    public partial class Gs2FriendUpdateProfileByUserIdPublicProfileSpriteTableSwitcher
    {
