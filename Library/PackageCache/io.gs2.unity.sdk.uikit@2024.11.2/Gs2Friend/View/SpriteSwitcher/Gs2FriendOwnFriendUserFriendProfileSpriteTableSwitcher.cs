...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/FriendUser/View/SpriteSwitcher/Properties/FriendProfile/Gs2FriendOwnFriendUserFriendProfileSpriteTableSwitcher")]
    public partial class Gs2FriendOwnFriendUserFriendProfileSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.FriendUser.FriendProfile) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.FriendUser.FriendProfile).sprite);
            }
            else {
    ...
    public partial class Gs2FriendOwnFriendUserFriendProfileSpriteTableSwitcher
    {
