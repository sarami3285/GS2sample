...
namespace Gs2.Unity.UiKit.Gs2Friend
{
    ...
    public partial class Gs2FriendOwnSendFriendRequestEnabler : MonoBehaviour
    {
        ...
        {
            if (this._fetcher.SendFriendRequest == null)
            {
    ...
    public partial class Gs2FriendOwnSendFriendRequestEnabler
    {
        ...
        public void Awake()
        {
            this._fetcher = GetComponent<Gs2FriendOwnSendFriendRequestFetcher>() ?? GetComponentInParent<Gs2FriendOwnSendFriendRequestFetcher>();
        ...
        {
            this._fetcher = GetComponent<Gs2FriendOwnSendFriendRequestFetcher>() ?? GetComponentInParent<Gs2FriendOwnSendFriendRequestFetcher>(true);
            if (this._fetcher == null) {
                return true;
            }
            if (this.target == null) {
