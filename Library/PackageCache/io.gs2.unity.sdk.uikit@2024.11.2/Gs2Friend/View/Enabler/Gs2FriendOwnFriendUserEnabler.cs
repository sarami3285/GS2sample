...
namespace Gs2.Unity.UiKit.Gs2Friend
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/FriendUser/View/Enabler/Gs2FriendOwnFriendUserEnabler")]
    public partial class Gs2FriendOwnFriendUserEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.FriendUser == null)
            {
    ...
    public partial class Gs2FriendOwnFriendUserEnabler
    {
