...
namespace Gs2.Unity.UiKit.Gs2Friend
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/Profile/View/Enabler/Transaction/Gs2FriendUpdateProfileByUserIdEnabler")]
    public partial class Gs2FriendUpdateProfileByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Friend:UpdateProfileByUserId") == 0) {
    ...
    public partial class Gs2FriendUpdateProfileByUserIdEnabler
    {
