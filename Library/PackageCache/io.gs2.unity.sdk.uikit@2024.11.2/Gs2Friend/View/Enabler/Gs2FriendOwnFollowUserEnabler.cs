...
namespace Gs2.Unity.UiKit.Gs2Friend
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/FollowUser/View/Enabler/Gs2FriendOwnFollowUserEnabler")]
    public partial class Gs2FriendOwnFollowUserEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.FollowUser == null)
            {
    ...
    public partial class Gs2FriendOwnFollowUserEnabler
    {
