...
namespace Gs2.Unity.UiKit.Gs2Friend
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/Profile/View/Enabler/Gs2FriendOwnProfileEnabler")]
    public partial class Gs2FriendOwnProfileEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Profile == null)
            {
    ...
    public partial class Gs2FriendOwnProfileEnabler
    {
