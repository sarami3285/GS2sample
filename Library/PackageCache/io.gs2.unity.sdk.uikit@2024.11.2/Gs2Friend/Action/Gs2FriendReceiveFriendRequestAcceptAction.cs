...
namespace Gs2.Unity.UiKit.Gs2Friend
{
    ...
    public partial class Gs2FriendReceiveFriendRequestAcceptAction
    {
        ...
        public event UnityAction<EzFriendRequest> OnAcceptComplete
        {
    ...
    public partial class Gs2FriendReceiveFriendRequestAcceptAction
    {
        [MenuItem("GameObject/Game Server Services/Friend/ReceiveFriendRequest/Action/Accept", priority = 0)]
        private static void CreateButton()
        {
            var prefab = AssetDatabase.LoadAssetAtPath<Gs2FriendReceiveFriendRequestAcceptAction>(
                "Packages/io.gs2.unity.sdk.uikit/Gs2Friend/Prefabs/Action/Gs2FriendReceiveFriendRequestAcceptAction.prefab"
            );
