...
namespace Gs2.Unity.UiKit.Gs2Stamina.Context
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/Namespace/Context/Gs2StaminaNamespaceContext")]
    public partial class Gs2StaminaNamespaceContext : MonoBehaviour
    {
        public void Start() {
            if (Namespace == null) {
                Debug.LogWarning($"{gameObject.GetFullPath()}: Namespace is not set in Gs2StaminaNamespaceContext.");
            }
        }
    ...
    public partial class Gs2StaminaNamespaceContext
    {
