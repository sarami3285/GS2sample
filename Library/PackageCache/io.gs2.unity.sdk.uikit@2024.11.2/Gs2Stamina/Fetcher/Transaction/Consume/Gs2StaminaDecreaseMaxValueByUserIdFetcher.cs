    ...
    public partial class Gs2StaminaDecreaseMaxValueByUserIdFetcher : Gs2StaminaOwnStaminaContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Stamina:DecreaseMaxValueByUserId") {
                    Request = DecreaseMaxValueByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Stamina == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Stamina:DecreaseMaxValueByUserId");
                if (action != null) {
