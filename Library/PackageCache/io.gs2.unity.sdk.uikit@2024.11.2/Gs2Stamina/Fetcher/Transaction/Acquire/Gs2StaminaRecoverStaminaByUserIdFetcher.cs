    ...
    public partial class Gs2StaminaRecoverStaminaByUserIdFetcher : Gs2StaminaOwnStaminaContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Stamina:RecoverStaminaByUserId") {
                    Request = RecoverStaminaByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Stamina == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Stamina:RecoverStaminaByUserId");
                if (action != null) {
