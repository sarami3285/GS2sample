...
namespace Gs2.Unity.UiKit.Gs2Stamina.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/Stamina/Fetcher/Acquire/Gs2StaminaRaiseMaxValueByUserIdFetcher")]
    public partial class Gs2StaminaRaiseMaxValueByUserIdFetcher : Gs2StaminaOwnStaminaContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Stamina:RaiseMaxValueByUserId") {
                    Request = RaiseMaxValueByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Stamina == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Stamina:RaiseMaxValueByUserId");
                if (action != null) {
                    Request = RaiseMaxValueByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Stamina == null || (
                            Stamina.NamespaceName == Request.NamespaceName &&
                            Stamina.StaminaName == Request.StaminaName)
                    ) {
    ...
    public partial class Gs2StaminaRaiseMaxValueByUserIdFetcher
    {
    ...
    public partial class Gs2StaminaRaiseMaxValueByUserIdFetcher
    {
        public RaiseMaxValueByUserIdRequest Request { get; protected set; }
