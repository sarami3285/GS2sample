    ...
    public partial class Gs2StaminaSetRecoverIntervalByUserIdFetcher : Gs2StaminaOwnStaminaContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Stamina:SetRecoverIntervalByUserId") {
                    Request = SetRecoverIntervalByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Stamina == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Stamina:SetRecoverIntervalByUserId");
                if (action != null) {
