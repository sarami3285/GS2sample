...
namespace Gs2.Unity.UiKit.Gs2Stamina
{
    public partial class Gs2StaminaStaminaSetMaxValueAction : MonoBehaviour
    {
        private IEnumerator Process()
        {
            ...
            if (future.Error != null)
            {
                if (future.Error is TransactionException e)
                {
                    IEnumerator Retry()
                    {
                        ...
                        this.onSetMaxValueComplete.Invoke(future3.Result);
                    }
            ...
            this.onSetMaxValueComplete.Invoke(future2.Result);
        }
    ...
    public partial class Gs2StaminaStaminaSetMaxValueAction
    {
    ...
    public partial class Gs2StaminaStaminaSetMaxValueAction
    {
        ...
        [Serializable]
        private class SetMaxValueCompleteEvent : UnityEvent<EzStamina>
        {

        }

        [SerializeField]
        private SetMaxValueCompleteEvent onSetMaxValueComplete = new SetMaxValueCompleteEvent();
        public event UnityAction<EzStamina> OnSetMaxValueComplete
        {
            add => this.onSetMaxValueComplete.AddListener(value);
            remove => this.onSetMaxValueComplete.RemoveListener(value);
        }
    ...
    public partial class Gs2StaminaStaminaSetMaxValueAction
    {
        [MenuItem("GameObject/Game Server Services/Stamina/Stamina/Action/SetMaxValue", priority = 0)]
        private static void CreateButton()
        {
            var prefab = AssetDatabase.LoadAssetAtPath<Gs2StaminaStaminaSetMaxValueAction>(
                "Packages/io.gs2.unity.sdk.uikit/Gs2Stamina/Prefabs/Action/Gs2StaminaStaminaSetMaxValueAction.prefab"
            );
