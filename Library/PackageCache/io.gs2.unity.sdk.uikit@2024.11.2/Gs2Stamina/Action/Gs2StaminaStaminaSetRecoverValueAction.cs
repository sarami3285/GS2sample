...
namespace Gs2.Unity.UiKit.Gs2Stamina
{
    public partial class Gs2StaminaStaminaSetRecoverValueAction : MonoBehaviour
    {
        private IEnumerator Process()
        {
            ...
            if (future.Error != null)
            {
                if (future.Error is TransactionException e)
                {
                    IEnumerator Retry()
                    {
                        ...
                        this.onSetRecoverValueComplete.Invoke(future3.Result);
                    }
            ...
            this.onSetRecoverValueComplete.Invoke(future2.Result);
        }
    ...
    public partial class Gs2StaminaStaminaSetRecoverValueAction
    {
        ...
        [Serializable]
        private class SetRecoverValueCompleteEvent : UnityEvent<EzStamina>
        {

        }

        [SerializeField]
        private SetRecoverValueCompleteEvent onSetRecoverValueComplete = new SetRecoverValueCompleteEvent();
        public event UnityAction<EzStamina> OnSetRecoverValueComplete
        {
            add => this.onSetRecoverValueComplete.AddListener(value);
            remove => this.onSetRecoverValueComplete.RemoveListener(value);
        }
    ...
    public partial class Gs2StaminaStaminaSetRecoverValueAction
    {
        [MenuItem("GameObject/Game Server Services/Stamina/Stamina/Action/SetRecoverValue", priority = 0)]
        private static void CreateButton()
        {
            var prefab = AssetDatabase.LoadAssetAtPath<Gs2StaminaStaminaSetRecoverValueAction>(
                "Packages/io.gs2.unity.sdk.uikit/Gs2Stamina/Prefabs/Action/Gs2StaminaStaminaSetRecoverValueAction.prefab"
            );
