...
namespace Gs2.Unity.UiKit.Gs2Stamina
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/StaminaModel/View/Enabler/Gs2StaminaStaminaModelEnabler")]
    public partial class Gs2StaminaStaminaModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.StaminaModel == null)
            {
    ...
    public partial class Gs2StaminaStaminaModelEnabler
    {
