...
namespace Gs2.Unity.UiKit.Gs2Stamina
{
    ...
    public partial class Gs2StaminaStaminaModelMaxCapacityEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableMaxCapacities.Contains(this._fetcher.StaminaModel.MaxCapacity));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableMaxCapacities.Contains(this._fetcher.StaminaModel.MaxCapacity));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableMaxCapacity > this._fetcher.StaminaModel.MaxCapacity);
                    break;
