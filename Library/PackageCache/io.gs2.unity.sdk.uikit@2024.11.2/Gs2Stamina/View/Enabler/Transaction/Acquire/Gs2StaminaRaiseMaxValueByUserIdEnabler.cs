...
namespace Gs2.Unity.UiKit.Gs2Stamina
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/Stamina/View/Enabler/Transaction/Gs2StaminaRaiseMaxValueByUserIdEnabler")]
    public partial class Gs2StaminaRaiseMaxValueByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Stamina:RaiseMaxValueByUserId") == 0) {
