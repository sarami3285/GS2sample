...
namespace Gs2.Unity.UiKit.Gs2Stamina
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/Stamina/View/Enabler/Transaction/Gs2StaminaSetRecoverValueByUserIdEnabler")]
    public partial class Gs2StaminaSetRecoverValueByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Stamina:SetRecoverValueByUserId") == 0) {
    ...
    public partial class Gs2StaminaSetRecoverValueByUserIdEnabler
    {
