...
namespace Gs2.Unity.UiKit.Gs2Stamina
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/Stamina/View/Enabler/Transaction/Gs2StaminaSetMaxValueByUserIdValueEnabler")]
    public partial class Gs2StaminaSetMaxValueByUserIdValueEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this._fetcher.Request.MaxValue != null && this.enableMaxValues.Contains(this._fetcher.Request.MaxValue.Value));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(this._fetcher.Request.MaxValue != null && !this.enableMaxValues.Contains(this._fetcher.Request.MaxValue.Value));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableMaxValue > this._fetcher.Request.MaxValue);
                    break;
    ...
    public partial class Gs2StaminaSetMaxValueByUserIdValueEnabler
    {
