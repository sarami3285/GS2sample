...
namespace Gs2.Unity.UiKit.Gs2Stamina
{
    ...
    public partial class Gs2StaminaStaminaModelInitialCapacityEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableInitialCapacities.Contains(this._fetcher.StaminaModel.InitialCapacity));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableInitialCapacities.Contains(this._fetcher.StaminaModel.InitialCapacity));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableInitialCapacity > this._fetcher.StaminaModel.InitialCapacity);
                    break;
