...
namespace Gs2.Unity.UiKit.Gs2Stamina
{
    ...
    public partial class Gs2StaminaStaminaModelList
    {
        ...
        public void Awake()
        {
            ...
            this._fetcher = GetComponent<Gs2StaminaStaminaModelListFetcher>() ?? GetComponentInParent<Gs2StaminaStaminaModelListFetcher>();
            if (this._fetcher == null) {
                Debug.LogError($"{gameObject.GetFullPath()}: Couldn't find the Gs2StaminaStaminaModelListFetcher.");
                enabled = false;
            }

            this._children = new List<Gs2StaminaStaminaModelContext>();
        ...
        public virtual bool HasError()
        {
            ...
            this._fetcher = GetComponent<Gs2StaminaStaminaModelListFetcher>() ?? GetComponentInParent<Gs2StaminaStaminaModelListFetcher>(true);
            if (this._fetcher == null) {
                return true;
            }
            return false;
