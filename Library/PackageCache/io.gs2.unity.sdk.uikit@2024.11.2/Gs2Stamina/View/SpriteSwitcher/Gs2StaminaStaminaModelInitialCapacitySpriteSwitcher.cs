...
namespace Gs2.Unity.UiKit.Gs2Stamina
{
    ...
    public partial class Gs2StaminaStaminaModelInitialCapacitySpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyInitialCapacities.Contains(this._fetcher.StaminaModel.InitialCapacity)) {
                ...
                case Expression.Less:
                    if (this.applyInitialCapacity > this._fetcher.StaminaModel.InitialCapacity) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
