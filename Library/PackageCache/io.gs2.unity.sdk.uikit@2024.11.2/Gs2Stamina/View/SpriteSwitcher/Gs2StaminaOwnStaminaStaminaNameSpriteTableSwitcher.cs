...
namespace Gs2.Unity.UiKit.Gs2Stamina.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/Stamina/View/SpriteSwitcher/Properties/StaminaName/Gs2StaminaOwnStaminaStaminaNameSpriteTableSwitcher")]
    public partial class Gs2StaminaOwnStaminaStaminaNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Stamina.StaminaName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Stamina.StaminaName).sprite);
            }
            else {
    ...
    public partial class Gs2StaminaOwnStaminaStaminaNameSpriteTableSwitcher
    {
