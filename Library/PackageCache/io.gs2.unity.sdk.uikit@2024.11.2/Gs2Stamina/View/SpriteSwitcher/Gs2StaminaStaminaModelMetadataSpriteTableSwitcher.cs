...
namespace Gs2.Unity.UiKit.Gs2Stamina.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/StaminaModel/View/SpriteSwitcher/Properties/Metadata/Gs2StaminaStaminaModelMetadataSpriteTableSwitcher")]
    public partial class Gs2StaminaStaminaModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.StaminaModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.StaminaModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2StaminaStaminaModelMetadataSpriteTableSwitcher
    {
