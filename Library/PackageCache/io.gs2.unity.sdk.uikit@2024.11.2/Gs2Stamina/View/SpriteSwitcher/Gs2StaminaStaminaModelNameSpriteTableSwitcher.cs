...
namespace Gs2.Unity.UiKit.Gs2Stamina.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/StaminaModel/View/SpriteSwitcher/Properties/Name/Gs2StaminaStaminaModelNameSpriteTableSwitcher")]
    public partial class Gs2StaminaStaminaModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.StaminaModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.StaminaModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2StaminaStaminaModelNameSpriteTableSwitcher
    {
