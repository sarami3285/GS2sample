...
namespace Gs2.Unity.UiKit.Gs2Stamina.Label
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/Stamina/View/Label/Transaction/Gs2StaminaRaiseMaxValueByUserIdLabel")]
    public partial class Gs2StaminaRaiseMaxValueByUserIdLabel : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            this.onUpdate?.Invoke(
                this.format.Replace(
                    ...
                    "{raiseValue}",
                    $"{this._fetcher.Request.RaiseValue}"
                ).Replace(
                    "{timeOffsetToken}",
                    ...
                    $"{this._userDataFetcher.Stamina.MaxValue + this._fetcher.Request.RaiseValue}"
                ).Replace(
