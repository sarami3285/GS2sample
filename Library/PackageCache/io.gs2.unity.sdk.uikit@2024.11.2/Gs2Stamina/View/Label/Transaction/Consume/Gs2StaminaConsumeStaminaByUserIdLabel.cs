...
namespace Gs2.Unity.UiKit.Gs2Stamina.Label
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/Stamina/View/Label/Transaction/Gs2StaminaConsumeStaminaByUserIdLabel")]
        ...
        private void OnFetched()
        {
            ...
            this.onUpdate?.Invoke(
                this.format.Replace(
                    ...
                    "{consumeValue}",
                    $"{this._fetcher.Request.ConsumeValue}"
                ).Replace(
                    "{timeOffsetToken}",
                    ...
                    $"{this._userDataFetcher.Stamina.Value + this._fetcher.Request.ConsumeValue}"
                ).Replace(
