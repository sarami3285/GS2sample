...
namespace Gs2.Unity.UiKit.Gs2Grade.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/Status/Fetcher/Gs2GradeOwnStatusFetcher")]
    public partial class Gs2GradeOwnStatusFetcher : MonoBehaviour
    {
        ...
        public void SetTemporaryStatus(
            Gs2.Unity.Gs2Grade.Model.EzStatus status
        ) {
            Status = status;
            this.OnFetched.Invoke();
        }
    ...
    public partial class Gs2GradeOwnStatusFetcher
    {
        public Gs2GradeOwnStatusContext Context { get; private set; }

        public void Awake()
        {
            Context = GetComponent<Gs2GradeOwnStatusContext>() ?? GetComponentInParent<Gs2GradeOwnStatusContext>();
            if (Context == null) {
        ...
        {
            Context = GetComponent<Gs2GradeOwnStatusContext>() ?? GetComponentInParent<Gs2GradeOwnStatusContext>(true);
            if (Context == null) {
                return true;
            }
            return false;
    ...
    public partial class Gs2GradeOwnStatusFetcher
    {
        public Gs2.Unity.Gs2Grade.Model.EzStatus Status { get; protected set; }
