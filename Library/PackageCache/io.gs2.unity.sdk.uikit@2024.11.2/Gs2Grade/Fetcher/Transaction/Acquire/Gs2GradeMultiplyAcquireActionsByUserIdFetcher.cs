...
namespace Gs2.Unity.UiKit.Gs2Grade.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/Status/Fetcher/Acquire/Gs2GradeMultiplyAcquireActionsByUserIdFetcher")]
    public partial class Gs2GradeMultiplyAcquireActionsByUserIdFetcher : Gs2GradeOwnStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Grade:MultiplyAcquireActionsByUserId") {
                    ...
                    if (Status == null || (
                            ...
                            Status.GradeName == Request.GradeName &&
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Grade:MultiplyAcquireActionsByUserId");
                if (action != null) {
    ...
    public partial class Gs2GradeMultiplyAcquireActionsByUserIdFetcher
    {
