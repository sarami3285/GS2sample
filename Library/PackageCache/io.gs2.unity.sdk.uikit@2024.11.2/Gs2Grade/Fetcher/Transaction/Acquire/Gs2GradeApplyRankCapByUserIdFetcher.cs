...
namespace Gs2.Unity.UiKit.Gs2Grade.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/Status/Fetcher/Acquire/Gs2GradeApplyRankCapByUserIdFetcher")]
    public partial class Gs2GradeApplyRankCapByUserIdFetcher : Gs2GradeOwnStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Grade:ApplyRankCapByUserId") {
                    Request = ApplyRankCapByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Status == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Grade:ApplyRankCapByUserId");
                if (action != null) {
                    Request = ApplyRankCapByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Status == null || (
                            Status.NamespaceName == Request.NamespaceName &&
                            Status.GradeName == Request.GradeName &&
                            Status.PropertyId == Request.PropertyId)
    ...
    public partial class Gs2GradeApplyRankCapByUserIdFetcher
    {
    ...
    public partial class Gs2GradeApplyRankCapByUserIdFetcher
    {
        public ApplyRankCapByUserIdRequest Request { get; protected set; }
