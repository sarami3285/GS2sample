...
namespace Gs2.Unity.UiKit.Gs2Grade.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/Status/Fetcher/Consume/Gs2GradeSubGradeByUserIdFetcher")]
    public partial class Gs2GradeSubGradeByUserIdFetcher : Gs2GradeOwnStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Grade:SubGradeByUserId") {
                    Request = SubGradeByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Status == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Grade:SubGradeByUserId");
                if (action != null) {
                    Request = SubGradeByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Status == null || (
                            Status.NamespaceName == Request.NamespaceName &&
                            Status.GradeName == Request.GradeName &&
                            Status.PropertyId == Request.PropertyId)
    ...
    public partial class Gs2GradeSubGradeByUserIdFetcher
    {
    ...
    public partial class Gs2GradeSubGradeByUserIdFetcher
    {
        public SubGradeByUserIdRequest Request { get; protected set; }
