...
namespace Gs2.Unity.UiKit.Gs2Grade.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/Status/Fetcher/Consume/Gs2GradeVerifyGradeUpMaterialByUserIdFetcher")]
    public partial class Gs2GradeVerifyGradeUpMaterialByUserIdFetcher : Gs2GradeOwnStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Grade:VerifyGradeUpMaterialByUserId") {
                    Request = VerifyGradeUpMaterialByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Status == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Grade:VerifyGradeUpMaterialByUserId");
                if (action != null) {
                    Request = VerifyGradeUpMaterialByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Status == null || (
                            Status.NamespaceName == Request.NamespaceName &&
                            Status.GradeName == Request.GradeName &&
                            Status.PropertyId == Request.PropertyId)
    ...
    public partial class Gs2GradeVerifyGradeUpMaterialByUserIdFetcher
    {
    ...
    public partial class Gs2GradeVerifyGradeUpMaterialByUserIdFetcher
    {
        public VerifyGradeUpMaterialByUserIdRequest Request { get; protected set; }
