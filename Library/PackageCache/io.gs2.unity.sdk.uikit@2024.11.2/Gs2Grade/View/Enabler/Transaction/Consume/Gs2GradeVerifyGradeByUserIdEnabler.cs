...
namespace Gs2.Unity.UiKit.Gs2Grade
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/Status/View/Enabler/Transaction/Gs2GradeVerifyGradeByUserIdEnabler")]
    public partial class Gs2GradeVerifyGradeByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Grade:VerifyGradeByUserId") == 0) {
    ...
    public partial class Gs2GradeVerifyGradeByUserIdEnabler
    {
