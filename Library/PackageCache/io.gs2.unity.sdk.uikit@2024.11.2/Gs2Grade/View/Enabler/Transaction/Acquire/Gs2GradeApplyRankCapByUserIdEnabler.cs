...
namespace Gs2.Unity.UiKit.Gs2Grade
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/Status/View/Enabler/Transaction/Gs2GradeApplyRankCapByUserIdEnabler")]
    public partial class Gs2GradeApplyRankCapByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Grade:ApplyRankCapByUserId") == 0) {
    ...
    public partial class Gs2GradeApplyRankCapByUserIdEnabler
    {
