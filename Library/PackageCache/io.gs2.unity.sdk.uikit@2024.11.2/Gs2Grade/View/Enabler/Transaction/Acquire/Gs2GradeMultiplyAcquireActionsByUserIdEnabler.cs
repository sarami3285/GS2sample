...
namespace Gs2.Unity.UiKit.Gs2Grade
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/Status/View/Enabler/Transaction/Gs2GradeMultiplyAcquireActionsByUserIdEnabler")]
    public partial class Gs2GradeMultiplyAcquireActionsByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Grade:MultiplyAcquireActionsByUserId") == 0) {
    ...
    public partial class Gs2GradeMultiplyAcquireActionsByUserIdEnabler
    {
