...
namespace Gs2.Unity.UiKit.Gs2Grade.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/GradeModel/View/Enabler/Properties/Name/Gs2GradeGradeModelNameEnabler")]
    public partial class Gs2GradeGradeModelNameEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableNames.Contains(this._fetcher.GradeModel?.Name ?? ""));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableNames.Contains(this._fetcher.GradeModel?.Name ?? ""));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive((this._fetcher.GradeModel?.Name ?? "").StartsWith(this.enableName));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive((this._fetcher.GradeModel?.Name ?? "").EndsWith(this.enableName));
                    break;
                default:
    ...
    public partial class Gs2GradeGradeModelNameEnabler
    {
