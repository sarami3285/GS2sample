...
namespace Gs2.Unity.UiKit.Gs2Grade
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/GradeModel/View/Enabler/Gs2GradeGradeModelEnabler")]
    public partial class Gs2GradeGradeModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.GradeModel == null)
            {
    ...
    public partial class Gs2GradeGradeModelEnabler
    {
