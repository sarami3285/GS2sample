...
namespace Gs2.Unity.UiKit.Gs2Grade.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/GradeModel/View/SpriteSwitcher/Properties/Metadata/Gs2GradeGradeModelMetadataSpriteSwitcher")]
    public partial class Gs2GradeGradeModelMetadataSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyMetadatas.Contains(this._fetcher.GradeModel?.Metadata ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.GradeModel?.Metadata ?? "").StartsWith(this.applyMetadata)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.GradeModel?.Metadata ?? "").EndsWith(this.applyMetadata)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2GradeGradeModelMetadataSpriteSwitcher
    {
