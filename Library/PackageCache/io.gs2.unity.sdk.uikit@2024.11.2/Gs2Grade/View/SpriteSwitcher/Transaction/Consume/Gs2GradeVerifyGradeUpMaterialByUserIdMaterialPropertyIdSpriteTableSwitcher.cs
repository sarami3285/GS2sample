...
namespace Gs2.Unity.UiKit.Gs2Grade.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/Status/View/SpriteSwitcher/Transaction/Properties/MaterialPropertyId/Gs2GradeVerifyGradeUpMaterialByUserIdMaterialPropertyIdSpriteTableSwitcher")]
    public partial class Gs2GradeVerifyGradeUpMaterialByUserIdMaterialPropertyIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.MaterialPropertyId) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.MaterialPropertyId).sprite);
            }
            else {
    ...
    public partial class Gs2GradeVerifyGradeUpMaterialByUserIdMaterialPropertyIdSpriteTableSwitcher
    {
