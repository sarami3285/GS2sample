...
namespace Gs2.Unity.UiKit.Gs2Grade.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/Status/View/SpriteSwitcher/Properties/GradeName/Gs2GradeOwnStatusGradeNameSpriteTableSwitcher")]
    public partial class Gs2GradeOwnStatusGradeNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Status.GradeName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Status.GradeName).sprite);
            }
            else {
    ...
    public partial class Gs2GradeOwnStatusGradeNameSpriteTableSwitcher
    {
