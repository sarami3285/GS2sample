...
namespace Gs2.Unity.UiKit.Gs2Grade.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/GradeModel/View/SpriteSwitcher/Properties/Name/Gs2GradeGradeModelNameSpriteTableSwitcher")]
    public partial class Gs2GradeGradeModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.GradeModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.GradeModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2GradeGradeModelNameSpriteTableSwitcher
    {
