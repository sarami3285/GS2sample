...
namespace Gs2.Unity.UiKit.Gs2Grade.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/GradeModel/View/SpriteSwitcher/Properties/Name/Gs2GradeGradeModelNameSpriteSwitcher")]
    public partial class Gs2GradeGradeModelNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.GradeModel?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.GradeModel?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.GradeModel?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2GradeGradeModelNameSpriteSwitcher
    {
