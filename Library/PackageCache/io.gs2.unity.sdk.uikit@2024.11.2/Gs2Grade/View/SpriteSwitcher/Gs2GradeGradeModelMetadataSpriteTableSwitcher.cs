...
namespace Gs2.Unity.UiKit.Gs2Grade.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/GradeModel/View/SpriteSwitcher/Properties/Metadata/Gs2GradeGradeModelMetadataSpriteTableSwitcher")]
    public partial class Gs2GradeGradeModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.GradeModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.GradeModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2GradeGradeModelMetadataSpriteTableSwitcher
    {
