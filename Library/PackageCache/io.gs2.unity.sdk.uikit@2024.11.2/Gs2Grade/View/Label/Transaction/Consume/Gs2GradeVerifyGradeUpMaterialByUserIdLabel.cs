...
namespace Gs2.Unity.UiKit.Gs2Grade.Label
{
	...
	[AddComponentMenu("GS2 UIKit/Grade/Status/View/Label/Transaction/Gs2GradeVerifyGradeUpMaterialByUserIdLabel")]
    public partial class Gs2GradeVerifyGradeUpMaterialByUserIdLabel : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            this.onUpdate?.Invoke(
                this.format.Replace(
                    ...
                    "{materialPropertyId}",
                    $"{this._fetcher.Request.MaterialPropertyId}"
                ).Replace(
                    "{timeOffsetToken}",
    ...
    public partial class Gs2GradeVerifyGradeUpMaterialByUserIdLabel
    {
