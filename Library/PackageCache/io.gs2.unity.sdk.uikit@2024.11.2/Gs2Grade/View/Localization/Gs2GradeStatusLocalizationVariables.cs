...
namespace Gs2.Unity.UiKit.Gs2Grade.Localization
{
    ...
    [AddComponentMenu("GS2 UIKit/Grade/Status/View/Localization/Gs2GradeStatusLocalizationVariables")]
    public partial class Gs2GradeStatusLocalizationVariables : MonoBehaviour
    {
        private void OnFetched()
        {
            this.target.StringReference["gradeName"] = new StringVariable {
                Value = _fetcher?.Status?.GradeName ?? "",
            };
            this.target.StringReference["propertyId"] = new StringVariable {
                Value = _fetcher?.Status?.PropertyId ?? "",
            };
            this.target.StringReference["gradeValue"] = new LongVariable {
                Value = _fetcher?.Status?.GradeValue ?? 0,
            };
    ...
    public partial class Gs2GradeStatusLocalizationVariables
    {
