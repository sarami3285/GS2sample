...
namespace Gs2.Unity.UiKit.Gs2Lottery.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Lottery/LotteryModel/Fetcher/Gs2LotteryLotteryModelListFetcher")]
    public partial class Gs2LotteryLotteryModelListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var it = _domain.LotteryModels();
            var items = new List<Gs2.Unity.Gs2Lottery.Model.EzLotteryModel>();
            while (it.HasNext())
            {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeLotteryModels(
                items =>
                {
                    LotteryModels = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2LotteryLotteryModelListFetcher
    {
    ...
    public partial class Gs2LotteryLotteryModelListFetcher
    {
        public List<Gs2.Unity.Gs2Lottery.Model.EzLotteryModel> LotteryModels { get; private set; }
