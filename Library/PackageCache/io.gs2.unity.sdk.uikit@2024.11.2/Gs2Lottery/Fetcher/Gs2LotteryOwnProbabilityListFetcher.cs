...
namespace Gs2.Unity.UiKit.Gs2Lottery.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Lottery/Probability/Fetcher/Gs2LotteryOwnProbabilityListFetcher")]
    public partial class Gs2LotteryOwnProbabilityListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var it = _domain.Probabilities(Context.LotteryModel.LotteryName);
        ...
        private IEnumerator Fetch()
        {
            ...
            yield return new WaitUntil(() => Context != null && Context.LotteryModel != null);
            ...
            this._callbackId = this._domain.SubscribeProbabilities(
                items =>
                {
                    Probabilities = items.ToList();
                    this.OnFetched.Invoke();
                },
                Context.LotteryModel.LotteryName
            );
    ...
    public partial class Gs2LotteryOwnProbabilityListFetcher
    {
