...
namespace Gs2.Unity.UiKit.Gs2Lottery.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Lottery/BoxItems/Fetcher/Acquire/Gs2LotteryResetBoxByUserIdFetcher")]
    public partial class Gs2LotteryResetBoxByUserIdFetcher : Gs2LotteryOwnBoxItemsContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Lottery:ResetBoxByUserId") {
                    Request = ResetBoxByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (BoxItems == null || (
                            BoxItems.NamespaceName == Request.NamespaceName &&
                            BoxItems.PrizeTableName == Request.PrizeTableName)
                    ) {
                        BoxItems = OwnBoxItems.New(
                            Namespace.New(
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Lottery:ResetBoxByUserId");
                if (action != null) {
                    Request = ResetBoxByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (BoxItems == null || (
                            BoxItems.NamespaceName == Request.NamespaceName &&
                            BoxItems.PrizeTableName == Request.PrizeTableName)
                    ) {
    ...
    public partial class Gs2LotteryResetBoxByUserIdFetcher
    {
    ...
    public partial class Gs2LotteryResetBoxByUserIdFetcher
    {
        public ResetBoxByUserIdRequest Request { get; protected set; }
