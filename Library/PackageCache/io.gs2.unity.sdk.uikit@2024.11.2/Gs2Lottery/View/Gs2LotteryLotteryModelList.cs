...
namespace Gs2.Unity.UiKit.Gs2Lottery
{
    ...
    public partial class Gs2LotteryLotteryModelList
    {
        ...
        public void Awake()
        {
            ...
            this._fetcher = GetComponent<Gs2LotteryLotteryModelListFetcher>() ?? GetComponentInParent<Gs2LotteryLotteryModelListFetcher>();
            if (this._fetcher == null) {
                Debug.LogError($"{gameObject.GetFullPath()}: Couldn't find the Gs2LotteryLotteryModelListFetcher.");
                enabled = false;
            }

            this._children = new List<Gs2LotteryLotteryModelContext>();
        ...
        public virtual bool HasError()
        {
            ...
            this._fetcher = GetComponent<Gs2LotteryLotteryModelListFetcher>() ?? GetComponentInParent<Gs2LotteryLotteryModelListFetcher>(true);
            if (this._fetcher == null) {
                return true;
            }
            return false;
