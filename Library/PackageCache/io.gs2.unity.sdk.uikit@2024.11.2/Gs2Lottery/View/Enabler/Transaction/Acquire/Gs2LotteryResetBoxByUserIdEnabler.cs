...
namespace Gs2.Unity.UiKit.Gs2Lottery
{
	...
	[AddComponentMenu("GS2 UIKit/Lottery/BoxItems/View/Enabler/Transaction/Gs2LotteryResetBoxByUserIdEnabler")]
    public partial class Gs2LotteryResetBoxByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Lottery:ResetBoxByUserId") == 0) {
    ...
    public partial class Gs2LotteryResetBoxByUserIdEnabler
    {
