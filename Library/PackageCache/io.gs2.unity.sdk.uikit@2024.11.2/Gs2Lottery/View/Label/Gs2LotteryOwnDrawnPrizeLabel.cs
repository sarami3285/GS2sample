...
namespace Gs2.Unity.UiKit.Gs2Lottery
{
    ...
    public partial class Gs2LotteryOwnDrawnPrizeLabel : MonoBehaviour
    {
        private void OnFetched()
        {
            this.onUpdate?.Invoke(
                this.format.Replace(
                    "{prizeId}", $"{this._fetcher?.DrawnPrize?.PrizeId}"
                )
            );
        }
    }
    ...
    public partial class Gs2LotteryOwnDrawnPrizeLabel
    {
