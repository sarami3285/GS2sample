...
namespace Gs2.Unity.UiKit.Gs2Lottery.SpriteSwitcher
{
    ...
    public partial class Gs2LotteryOwnBoxItemsPrizeTableNameSpriteTableSwitcher : MonoBehaviour
    {
        ...
        {
            if (this.sprites.Count(v => v.value == _fetcher.BoxItems.PrizeTableName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.BoxItems.PrizeTableName).sprite);
            }
            else {
