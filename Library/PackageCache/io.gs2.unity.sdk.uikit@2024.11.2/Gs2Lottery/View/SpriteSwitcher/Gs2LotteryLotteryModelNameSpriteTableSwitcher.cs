...
namespace Gs2.Unity.UiKit.Gs2Lottery.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Lottery/LotteryModel/View/SpriteSwitcher/Properties/Name/Gs2LotteryLotteryModelNameSpriteTableSwitcher")]
    public partial class Gs2LotteryLotteryModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.LotteryModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.LotteryModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2LotteryLotteryModelNameSpriteTableSwitcher
    {
