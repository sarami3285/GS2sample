...
namespace Gs2.Unity.UiKit.Gs2Lottery.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Lottery/BoxItems/View/SpriteSwitcher/Transaction/Properties/PrizeTableName/Gs2LotteryResetBoxByUserIdPrizeTableNameSpriteTableSwitcher")]
    public partial class Gs2LotteryResetBoxByUserIdPrizeTableNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.PrizeTableName) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.PrizeTableName).sprite);
            }
            else {
    ...
    public partial class Gs2LotteryResetBoxByUserIdPrizeTableNameSpriteTableSwitcher
    {
