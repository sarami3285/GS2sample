...
namespace Gs2.Unity.UiKit.Gs2Lottery.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Lottery/LotteryModel/View/SpriteSwitcher/Properties/Metadata/Gs2LotteryLotteryModelMetadataSpriteTableSwitcher")]
    public partial class Gs2LotteryLotteryModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.LotteryModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.LotteryModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2LotteryLotteryModelMetadataSpriteTableSwitcher
    {
