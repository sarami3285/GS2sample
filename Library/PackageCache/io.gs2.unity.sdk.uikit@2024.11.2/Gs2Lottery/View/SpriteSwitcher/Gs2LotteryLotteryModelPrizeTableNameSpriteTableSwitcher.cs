...
namespace Gs2.Unity.UiKit.Gs2Lottery.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Lottery/LotteryModel/View/SpriteSwitcher/Properties/PrizeTableName/Gs2LotteryLotteryModelPrizeTableNameSpriteTableSwitcher")]
    public partial class Gs2LotteryLotteryModelPrizeTableNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.LotteryModel.PrizeTableName) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.LotteryModel.PrizeTableName).sprite);
            }
            else {
    ...
    public partial class Gs2LotteryLotteryModelPrizeTableNameSpriteTableSwitcher
    {
