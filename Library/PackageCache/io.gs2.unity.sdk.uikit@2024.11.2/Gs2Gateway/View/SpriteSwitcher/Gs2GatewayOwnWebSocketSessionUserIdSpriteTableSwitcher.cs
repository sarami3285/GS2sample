...
namespace Gs2.Unity.UiKit.Gs2Gateway.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Gateway/WebSocketSession/View/SpriteSwitcher/Properties/UserId/Gs2GatewayOwnWebSocketSessionUserIdSpriteTableSwitcher")]
    public partial class Gs2GatewayOwnWebSocketSessionUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.WebSocketSession.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.WebSocketSession.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2GatewayOwnWebSocketSessionUserIdSpriteTableSwitcher
    {
