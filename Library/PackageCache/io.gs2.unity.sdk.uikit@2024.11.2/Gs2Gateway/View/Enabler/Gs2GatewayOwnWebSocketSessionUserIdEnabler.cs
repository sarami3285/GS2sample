...
namespace Gs2.Unity.UiKit.Gs2Gateway.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Gateway/WebSocketSession/View/Enabler/Properties/UserId/Gs2GatewayOwnWebSocketSessionUserIdEnabler")]
    public partial class Gs2GatewayOwnWebSocketSessionUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableUserIds.Contains(this._fetcher.WebSocketSession?.UserId ?? ""));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableUserIds.Contains(this._fetcher.WebSocketSession?.UserId ?? ""));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive((this._fetcher.WebSocketSession?.UserId ?? "").StartsWith(this.enableUserId));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive((this._fetcher.WebSocketSession?.UserId ?? "").EndsWith(this.enableUserId));
                    break;
                default:
    ...
    public partial class Gs2GatewayOwnWebSocketSessionUserIdEnabler
    {
