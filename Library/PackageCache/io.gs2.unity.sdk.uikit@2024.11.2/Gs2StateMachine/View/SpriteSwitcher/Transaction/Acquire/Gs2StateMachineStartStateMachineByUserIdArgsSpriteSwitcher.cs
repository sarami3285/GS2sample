...
namespace Gs2.Unity.UiKit.Gs2StateMachine.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/StateMachine/Status/View/SpriteSwitcher/Transaction/Properties/Args/Gs2StateMachineStartStateMachineByUserIdArgsSpriteSwitcher")]
    public partial class Gs2StateMachineStartStateMachineByUserIdArgsSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyArgses.Contains(this._fetcher.Request?.Args ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.Request?.Args ?? "").StartsWith(this.applyArgs)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.Request?.Args ?? "").EndsWith(this.applyArgs)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2StateMachineStartStateMachineByUserIdArgsSpriteSwitcher
    {
    ...
    public partial class Gs2StateMachineStartStateMachineByUserIdArgsSpriteSwitcher
    {
        ...
        public List<string> applyArgses;

        public string applyArgs;
