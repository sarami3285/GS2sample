...
namespace Gs2.Unity.UiKit.Gs2StateMachine.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/StateMachine/Status/View/SpriteSwitcher/Transaction/Properties/Args/Gs2StateMachineStartStateMachineByUserIdArgsSpriteTableSwitcher")]
    public partial class Gs2StateMachineStartStateMachineByUserIdArgsSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.Args) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.Args).sprite);
            }
            else {
    ...
    public partial class Gs2StateMachineStartStateMachineByUserIdArgsSpriteTableSwitcher
    {
