...
namespace Gs2.Unity.UiKit.Gs2StateMachine.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/StateMachine/Status/View/SpriteSwitcher/Properties/Name/Gs2StateMachineOwnStatusNameSpriteTableSwitcher")]
    public partial class Gs2StateMachineOwnStatusNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Status.Name) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Status.Name).sprite);
            }
            else {
    ...
    public partial class Gs2StateMachineOwnStatusNameSpriteTableSwitcher
    {
