...
namespace Gs2.Unity.UiKit.Gs2StateMachine.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/StateMachine/Status/View/SpriteSwitcher/Properties/Status/Gs2StateMachineOwnStatusStatusSpriteSwitcher")]
    public partial class Gs2StateMachineOwnStatusStatusSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyStatuses.Contains(this._fetcher.Status?.Status ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.Status?.Status ?? "").StartsWith(this.applyStatus)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.Status?.Status ?? "").EndsWith(this.applyStatus)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2StateMachineOwnStatusStatusSpriteSwitcher
    {
