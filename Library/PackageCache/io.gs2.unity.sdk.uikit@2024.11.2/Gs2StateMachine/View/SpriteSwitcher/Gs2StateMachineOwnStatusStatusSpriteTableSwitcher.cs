...
namespace Gs2.Unity.UiKit.Gs2StateMachine.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/StateMachine/Status/View/SpriteSwitcher/Properties/Status/Gs2StateMachineOwnStatusStatusSpriteTableSwitcher")]
    public partial class Gs2StateMachineOwnStatusStatusSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Status.Status) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Status.Status).sprite);
            }
            else {
    ...
    public partial class Gs2StateMachineOwnStatusStatusSpriteTableSwitcher
    {
