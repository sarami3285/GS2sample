...
namespace Gs2.Unity.UiKit.Gs2StateMachine.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/StateMachine/Status/View/SpriteSwitcher/Properties/EnableSpeculativeExecution/Gs2StateMachineOwnStatusEnableSpeculativeExecutionSpriteTableSwitcher")]
    public partial class Gs2StateMachineOwnStatusEnableSpeculativeExecutionSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Status.EnableSpeculativeExecution) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Status.EnableSpeculativeExecution).sprite);
            }
            else {
    ...
    public partial class Gs2StateMachineOwnStatusEnableSpeculativeExecutionSpriteTableSwitcher
    {
