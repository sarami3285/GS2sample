...
namespace Gs2.Unity.UiKit.Gs2StateMachine
{
	...
	[AddComponentMenu("GS2 UIKit/StateMachine/Status/View/Enabler/Transaction/Gs2StateMachineStartStateMachineByUserIdEnabler")]
    public partial class Gs2StateMachineStartStateMachineByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2StateMachine:StartStateMachineByUserId") == 0) {
    ...
    public partial class Gs2StateMachineStartStateMachineByUserIdEnabler
    {
