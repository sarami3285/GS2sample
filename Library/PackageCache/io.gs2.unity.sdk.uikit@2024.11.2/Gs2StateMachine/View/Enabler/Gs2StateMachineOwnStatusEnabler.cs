...
namespace Gs2.Unity.UiKit.Gs2StateMachine
{
	...
	[AddComponentMenu("GS2 UIKit/StateMachine/Status/View/Enabler/Gs2StateMachineOwnStatusEnabler")]
    public partial class Gs2StateMachineOwnStatusEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Status == null)
            {
    ...
    public partial class Gs2StateMachineOwnStatusEnabler
    {
