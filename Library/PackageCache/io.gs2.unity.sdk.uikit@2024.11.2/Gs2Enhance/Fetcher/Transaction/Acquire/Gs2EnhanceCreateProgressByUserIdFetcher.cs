    ...
    public partial class Gs2EnhanceCreateProgressByUserIdFetcher : Gs2EnhanceNamespaceContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Enhance:CreateProgressByUserId") {
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Enhance:CreateProgressByUserId");
                if (action != null) {
