    ...
    public partial class Gs2EnhanceDeleteProgressByUserIdFetcher : Gs2EnhanceNamespaceContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Enhance:DeleteProgressByUserId") {
                    Request = DeleteProgressByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Namespace == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Enhance:DeleteProgressByUserId");
                if (action != null) {
