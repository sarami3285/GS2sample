...
namespace Gs2.Unity.UiKit.Gs2Enhance.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enhance/RateModel/Fetcher/Gs2EnhanceRateModelListFetcher")]
    public partial class Gs2EnhanceRateModelListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var items = new List<Gs2.Unity.Gs2Enhance.Model.EzRateModel>();
            while (it.HasNext())
            {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._domain = clientHolder.Gs2.Enhance.Namespace(
                this.Context.Namespace.NamespaceName
            );
            this._callbackId = this._domain.SubscribeRateModels(
                items =>
                {
                    RateModels = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2EnhanceRateModelListFetcher
    {
        public Gs2EnhanceNamespaceContext Context { get; private set; }

        public UnityEvent OnFetched = new UnityEvent();

        public void Awake()
        {
            Context = GetComponent<Gs2EnhanceNamespaceContext>() ?? GetComponentInParent<Gs2EnhanceNamespaceContext>();
            if (Context == null) {
    ...
    public partial class Gs2EnhanceRateModelListFetcher
    {
        public List<Gs2.Unity.Gs2Enhance.Model.EzRateModel> RateModels { get; private set; }
