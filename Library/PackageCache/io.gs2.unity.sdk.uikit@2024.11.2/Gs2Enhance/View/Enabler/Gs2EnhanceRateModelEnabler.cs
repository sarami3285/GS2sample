...
namespace Gs2.Unity.UiKit.Gs2Enhance
{
	...
	[AddComponentMenu("GS2 UIKit/Enhance/RateModel/View/Enabler/Gs2EnhanceRateModelEnabler")]
    public partial class Gs2EnhanceRateModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.RateModel == null)
            {
    ...
    public partial class Gs2EnhanceRateModelEnabler
    {
