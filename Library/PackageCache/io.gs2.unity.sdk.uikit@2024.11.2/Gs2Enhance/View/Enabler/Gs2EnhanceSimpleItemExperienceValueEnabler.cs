...
namespace Gs2.Unity.UiKit.Gs2Enhance
{
	...
	[AddComponentMenu("GS2 UIKit/Enhance/RateModel/View/Enabler/Gs2EnhanceSimpleItemExperienceValueEnabler")]
    public partial class Gs2EnhanceSimpleItemExperienceValueEnabler : MonoBehaviour
    {
    ...
    public partial class Gs2EnhanceSimpleItemExperienceValueEnabler
    {
        ...
        public void Awake()
        {
            ...
            if (this._fetcher == null) {
                Debug.LogError($"{gameObject.GetFullPath()}: Couldn't find the Gs2EnhanceSimpleItemExperienceValueFetcher.");
                enabled = false;
            }
            if (this.target == null) {
