...
namespace Gs2.Unity.UiKit.Gs2Enhance
{
	...
	[AddComponentMenu("GS2 UIKit/Enhance/RateModel/View/Label/Gs2EnhanceItemSetExperienceValueLabel")]
    public partial class Gs2EnhanceItemSetExperienceValueLabel : MonoBehaviour
    {
    ...
    public partial class Gs2EnhanceItemSetExperienceValueLabel
    {
        private Gs2EnhanceItemSetQuantitySlider _slider;
        private Gs2EnhanceItemSetExperienceValueFetcher _fetcher;

        public void Awake()
        {
            this._slider = GetComponent<Gs2EnhanceItemSetQuantitySlider>() ?? GetComponentInParent<Gs2EnhanceItemSetQuantitySlider>();
        ...
        {
            this._slider = GetComponent<Gs2EnhanceItemSetQuantitySlider>() ?? GetComponentInParent<Gs2EnhanceItemSetQuantitySlider>(true);
