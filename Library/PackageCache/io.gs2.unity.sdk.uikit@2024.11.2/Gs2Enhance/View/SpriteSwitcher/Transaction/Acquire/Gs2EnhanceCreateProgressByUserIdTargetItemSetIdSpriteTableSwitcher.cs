...
namespace Gs2.Unity.UiKit.Gs2Enhance.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enhance/Progress/View/SpriteSwitcher/Transaction/Properties/TargetItemSetId/Gs2EnhanceCreateProgressByUserIdTargetItemSetIdSpriteTableSwitcher")]
    public partial class Gs2EnhanceCreateProgressByUserIdTargetItemSetIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.TargetItemSetId) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.TargetItemSetId).sprite);
            }
            else {
    ...
    public partial class Gs2EnhanceCreateProgressByUserIdTargetItemSetIdSpriteTableSwitcher
    {
