...
namespace Gs2.Unity.UiKit.Gs2Enhance.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enhance/Progress/View/SpriteSwitcher/Properties/RateName/Gs2EnhanceOwnProgressRateNameSpriteTableSwitcher")]
    public partial class Gs2EnhanceOwnProgressRateNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Progress.RateName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Progress.RateName).sprite);
            }
            else {
    ...
    public partial class Gs2EnhanceOwnProgressRateNameSpriteTableSwitcher
    {
