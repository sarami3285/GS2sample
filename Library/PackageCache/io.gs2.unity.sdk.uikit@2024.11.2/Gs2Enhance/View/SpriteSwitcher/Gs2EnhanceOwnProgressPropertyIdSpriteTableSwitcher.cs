...
namespace Gs2.Unity.UiKit.Gs2Enhance.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enhance/Progress/View/SpriteSwitcher/Properties/PropertyId/Gs2EnhanceOwnProgressPropertyIdSpriteTableSwitcher")]
    public partial class Gs2EnhanceOwnProgressPropertyIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Progress.PropertyId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Progress.PropertyId).sprite);
            }
            else {
    ...
    public partial class Gs2EnhanceOwnProgressPropertyIdSpriteTableSwitcher
    {
