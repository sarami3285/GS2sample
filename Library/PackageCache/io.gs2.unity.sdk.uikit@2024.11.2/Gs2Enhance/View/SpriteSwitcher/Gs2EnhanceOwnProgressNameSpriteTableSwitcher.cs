...
namespace Gs2.Unity.UiKit.Gs2Enhance.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enhance/Progress/View/SpriteSwitcher/Properties/Name/Gs2EnhanceOwnProgressNameSpriteTableSwitcher")]
    public partial class Gs2EnhanceOwnProgressNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Progress.Name) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Progress.Name).sprite);
            }
            else {
    ...
    public partial class Gs2EnhanceOwnProgressNameSpriteTableSwitcher
    {
