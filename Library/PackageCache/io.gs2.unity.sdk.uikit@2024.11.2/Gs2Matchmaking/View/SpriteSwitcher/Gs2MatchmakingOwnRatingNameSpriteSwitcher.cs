...
namespace Gs2.Unity.UiKit.Gs2Matchmaking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/Rating/View/SpriteSwitcher/Properties/Name/Gs2MatchmakingOwnRatingNameSpriteSwitcher")]
    public partial class Gs2MatchmakingOwnRatingNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.Rating?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.Rating?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.Rating?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2MatchmakingOwnRatingNameSpriteSwitcher
    {
