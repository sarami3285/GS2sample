...
namespace Gs2.Unity.UiKit.Gs2Matchmaking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/Rating/View/SpriteSwitcher/Properties/UserId/Gs2MatchmakingOwnRatingUserIdSpriteTableSwitcher")]
    public partial class Gs2MatchmakingOwnRatingUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Rating.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Rating.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2MatchmakingOwnRatingUserIdSpriteTableSwitcher
    {
