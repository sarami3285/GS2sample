...
namespace Gs2.Unity.UiKit.Gs2Matchmaking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/Rating/View/SpriteSwitcher/Properties/UserId/Gs2MatchmakingOwnRatingUserIdSpriteSwitcher")]
    public partial class Gs2MatchmakingOwnRatingUserIdSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyUserIds.Contains(this._fetcher.Rating?.UserId ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.Rating?.UserId ?? "").StartsWith(this.applyUserId)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.Rating?.UserId ?? "").EndsWith(this.applyUserId)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2MatchmakingOwnRatingUserIdSpriteSwitcher
    {
