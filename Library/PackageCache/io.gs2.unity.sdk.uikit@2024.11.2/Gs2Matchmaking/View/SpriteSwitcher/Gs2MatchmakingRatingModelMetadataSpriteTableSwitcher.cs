...
namespace Gs2.Unity.UiKit.Gs2Matchmaking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/RatingModel/View/SpriteSwitcher/Properties/Metadata/Gs2MatchmakingRatingModelMetadataSpriteTableSwitcher")]
    public partial class Gs2MatchmakingRatingModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.RatingModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.RatingModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2MatchmakingRatingModelMetadataSpriteTableSwitcher
    {
