...
namespace Gs2.Unity.UiKit.Gs2Matchmaking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/Gathering/View/SpriteSwitcher/Properties/Name/Gs2MatchmakingGatheringNameSpriteTableSwitcher")]
    public partial class Gs2MatchmakingGatheringNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Gathering.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Gathering.Name).sprite);
            }
            else {
    ...
    public partial class Gs2MatchmakingGatheringNameSpriteTableSwitcher
    {
