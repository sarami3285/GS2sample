...
namespace Gs2.Unity.UiKit.Gs2Matchmaking
{
    ...
    public partial class Gs2MatchmakingRatingModelList
    {
        ...
        public void Awake()
        {
            ...
            this._fetcher = GetComponent<Gs2MatchmakingRatingModelListFetcher>() ?? GetComponentInParent<Gs2MatchmakingRatingModelListFetcher>();
            if (this._fetcher == null) {
                Debug.LogError($"{gameObject.GetFullPath()}: Couldn't find the Gs2MatchmakingRatingModelListFetcher.");
                enabled = false;
            }

            this._children = new List<Gs2MatchmakingRatingModelContext>();
        ...
        public virtual bool HasError()
        {
            ...
            this._fetcher = GetComponent<Gs2MatchmakingRatingModelListFetcher>() ?? GetComponentInParent<Gs2MatchmakingRatingModelListFetcher>(true);
            if (this._fetcher == null) {
                return true;
            }
            return false;
