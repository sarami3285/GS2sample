...
namespace Gs2.Unity.UiKit.Gs2Matchmaking
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/SeasonModel/View/Label/Gs2MatchmakingSeasonModelLabel")]
    public partial class Gs2MatchmakingSeasonModelLabel : MonoBehaviour
    {
        private void OnFetched()
        {
            this.onUpdate?.Invoke(
                this.format.Replace(
                    ...
                    "{maximumParticipants}", $"{this._fetcher?.SeasonModel?.MaximumParticipants}"
                ).Replace(
                    "{experienceModelId}", $"{this._fetcher?.SeasonModel?.ExperienceModelId}"
                ).Replace(
                    "{challengePeriodEventId}", $"{this._fetcher?.SeasonModel?.ChallengePeriodEventId}"
                )
            );
        }
    }
    ...
    public partial class Gs2MatchmakingSeasonModelLabel
    {
