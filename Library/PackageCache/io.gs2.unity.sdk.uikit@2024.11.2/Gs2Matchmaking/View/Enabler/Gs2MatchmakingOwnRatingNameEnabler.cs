...
namespace Gs2.Unity.UiKit.Gs2Matchmaking.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/Rating/View/Enabler/Properties/Name/Gs2MatchmakingOwnRatingNameEnabler")]
    public partial class Gs2MatchmakingOwnRatingNameEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableNames.Contains(this._fetcher.Rating?.Name ?? ""));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableNames.Contains(this._fetcher.Rating?.Name ?? ""));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive((this._fetcher.Rating?.Name ?? "").StartsWith(this.enableName));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive((this._fetcher.Rating?.Name ?? "").EndsWith(this.enableName));
                    break;
                default:
    ...
    public partial class Gs2MatchmakingOwnRatingNameEnabler
    {
