...
namespace Gs2.Unity.UiKit.Gs2Matchmaking
{
    ...
    public partial class Gs2MatchmakingGatheringExpiresAtEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableExpiresAts.Contains(this._fetcher.Gathering.ExpiresAt));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableExpiresAts.Contains(this._fetcher.Gathering.ExpiresAt));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableExpiresAt > this._fetcher.Gathering.ExpiresAt);
                    break;
