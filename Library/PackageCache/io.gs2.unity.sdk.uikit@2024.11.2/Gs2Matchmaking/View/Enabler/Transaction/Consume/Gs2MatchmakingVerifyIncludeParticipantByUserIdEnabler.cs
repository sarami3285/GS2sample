...
namespace Gs2.Unity.UiKit.Gs2Matchmaking
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/SeasonGathering/View/Enabler/Transaction/Gs2MatchmakingVerifyIncludeParticipantByUserIdEnabler")]
    public partial class Gs2MatchmakingVerifyIncludeParticipantByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Matchmaking:VerifyIncludeParticipantByUserId") == 0) {
    ...
    public partial class Gs2MatchmakingVerifyIncludeParticipantByUserIdEnabler
    {
