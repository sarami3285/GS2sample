...
namespace Gs2.Unity.UiKit.Gs2Matchmaking.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/RatingModel/Fetcher/Gs2MatchmakingRatingModelListFetcher")]
    public partial class Gs2MatchmakingRatingModelListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var items = new List<Gs2.Unity.Gs2Matchmaking.Model.EzRatingModel>();
            while (it.HasNext())
            {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeRatingModels(
                items =>
                {
                    RatingModels = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2MatchmakingRatingModelListFetcher
    {
    ...
    public partial class Gs2MatchmakingRatingModelListFetcher
    {
        public List<Gs2.Unity.Gs2Matchmaking.Model.EzRatingModel> RatingModels { get; private set; }
