...
namespace Gs2.Unity.UiKit.Gs2Matchmaking
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/Gathering/Fetcher/Properties/CreatedAt/Gs2MatchmakingGatheringCreatedAtFetcher")]
    public partial class Gs2MatchmakingGatheringCreatedAtFetcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Gathering.CreatedAt != null) {
                onUpdate?.Invoke(
                    this._fetcher.Gathering.CreatedAt
                );
            }
        }
    }
    ...
    public partial class Gs2MatchmakingGatheringCreatedAtFetcher
    {
