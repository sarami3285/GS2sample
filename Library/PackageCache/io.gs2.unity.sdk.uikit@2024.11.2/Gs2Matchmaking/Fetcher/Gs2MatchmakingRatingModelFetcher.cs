...
namespace Gs2.Unity.UiKit.Gs2Matchmaking.Fetcher
{
    ...
    {
        private EzRatingModelDomain _domain;
        ...
        private IEnumerator Fetch()
        {
            ...
            yield return new WaitUntil(() => Context != null && this.Context.RatingModel != null);
        ...
        public void SetTemporaryRatingModel(
            Gs2.Unity.Gs2Matchmaking.Model.EzRatingModel ratingModel
        ) {
            RatingModel = ratingModel;
            this.OnFetched.Invoke();
        }

        public void RollbackTemporaryRatingModel(
        ) {
            OnUpdateContext();
        }
    }
