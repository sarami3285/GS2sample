...
namespace Gs2.Unity.UiKit.Gs2Matchmaking.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/SeasonModel/Fetcher/Gs2MatchmakingSeasonModelListFetcher")]
    public partial class Gs2MatchmakingSeasonModelListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var items = new List<Gs2.Unity.Gs2Matchmaking.Model.EzSeasonModel>();
            while (it.HasNext())
            {
    ...
    public partial class Gs2MatchmakingSeasonModelListFetcher
    {
        public Gs2MatchmakingNamespaceContext Context { get; private set; }
    ...
    public partial class Gs2MatchmakingSeasonModelListFetcher
    {
        public List<Gs2.Unity.Gs2Matchmaking.Model.EzSeasonModel> SeasonModels { get; private set; }
