...
namespace Gs2.Unity.UiKit.Gs2Matchmaking.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/Rating/Fetcher/Gs2MatchmakingOwnRatingListFetcher")]
    public partial class Gs2MatchmakingOwnRatingListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var items = new List<Gs2.Unity.Gs2Matchmaking.Model.EzRating>();
            while (it.HasNext())
            {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeRatings(
                items =>
                {
                    Ratings = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2MatchmakingOwnRatingListFetcher
    {
        public List<Gs2.Unity.Gs2Matchmaking.Model.EzRating> Ratings { get; private set; }
