...
namespace Gs2.Unity.UiKit.Gs2Matchmaking
{
    public partial class Gs2MatchmakingGatheringCancelMatchmakingAction : MonoBehaviour
    {
        private IEnumerator Process()
        {
            ...
            if (future.Error != null)
            {
                if (future.Error is TransactionException e)
                {
                    IEnumerator Retry()
                    {
                        ...
                        this.onCancelMatchmakingComplete.Invoke(future3.Result);
                    }
            ...
            this.onCancelMatchmakingComplete.Invoke(future2.Result);
        }
    ...
    public partial class Gs2MatchmakingGatheringCancelMatchmakingAction
    {
        ...
        [SerializeField]
        private CancelMatchmakingCompleteEvent onCancelMatchmakingComplete = new CancelMatchmakingCompleteEvent();
        public event UnityAction<EzGathering> OnCancelMatchmakingComplete
        {
    ...
    public partial class Gs2MatchmakingGatheringCancelMatchmakingAction
    {
        [MenuItem("GameObject/Game Server Services/Matchmaking/Gathering/Action/CancelMatchmaking", priority = 0)]
