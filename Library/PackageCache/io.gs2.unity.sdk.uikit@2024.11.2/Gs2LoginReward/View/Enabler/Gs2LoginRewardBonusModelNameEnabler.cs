...
namespace Gs2.Unity.UiKit.Gs2LoginReward.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/LoginReward/BonusModel/View/Enabler/Properties/Name/Gs2LoginRewardBonusModelNameEnabler")]
    public partial class Gs2LoginRewardBonusModelNameEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableNames.Contains(this._fetcher.BonusModel?.Name ?? ""));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableNames.Contains(this._fetcher.BonusModel?.Name ?? ""));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive((this._fetcher.BonusModel?.Name ?? "").StartsWith(this.enableName));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive((this._fetcher.BonusModel?.Name ?? "").EndsWith(this.enableName));
                    break;
                default:
    ...
    public partial class Gs2LoginRewardBonusModelNameEnabler
    {
