...
namespace Gs2.Unity.UiKit.Gs2LoginReward
{
	...
	[AddComponentMenu("GS2 UIKit/LoginReward/BonusModel/View/Enabler/Gs2LoginRewardBonusModelEnabler")]
    public partial class Gs2LoginRewardBonusModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.BonusModel == null)
            {
    ...
    public partial class Gs2LoginRewardBonusModelEnabler
    {
