...
namespace Gs2.Unity.UiKit.Gs2LoginReward
{
	...
	[AddComponentMenu("GS2 UIKit/LoginReward/ReceiveStatus/View/Enabler/Transaction/Gs2LoginRewardUnmarkReceivedByUserIdEnabler")]
    public partial class Gs2LoginRewardUnmarkReceivedByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2LoginReward:UnmarkReceivedByUserId") == 0) {
    ...
    public partial class Gs2LoginRewardUnmarkReceivedByUserIdEnabler
    {
