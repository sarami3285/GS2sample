...
namespace Gs2.Unity.UiKit.Gs2LoginReward.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/LoginReward/BonusModel/View/SpriteSwitcher/Properties/Name/Gs2LoginRewardBonusModelNameSpriteTableSwitcher")]
    public partial class Gs2LoginRewardBonusModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.BonusModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.BonusModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2LoginRewardBonusModelNameSpriteTableSwitcher
    {
