...
namespace Gs2.Unity.UiKit.Gs2LoginReward.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/LoginReward/BonusModel/View/SpriteSwitcher/Properties/Metadata/Gs2LoginRewardBonusModelMetadataSpriteTableSwitcher")]
    public partial class Gs2LoginRewardBonusModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.BonusModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.BonusModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2LoginRewardBonusModelMetadataSpriteTableSwitcher
    {
