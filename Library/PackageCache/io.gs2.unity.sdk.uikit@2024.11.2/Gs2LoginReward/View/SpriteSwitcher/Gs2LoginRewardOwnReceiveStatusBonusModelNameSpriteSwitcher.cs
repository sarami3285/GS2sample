...
namespace Gs2.Unity.UiKit.Gs2LoginReward.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/LoginReward/ReceiveStatus/View/SpriteSwitcher/Properties/BonusModelName/Gs2LoginRewardOwnReceiveStatusBonusModelNameSpriteSwitcher")]
    public partial class Gs2LoginRewardOwnReceiveStatusBonusModelNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyBonusModelNames.Contains(this._fetcher.ReceiveStatus?.BonusModelName ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.ReceiveStatus?.BonusModelName ?? "").StartsWith(this.applyBonusModelName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.ReceiveStatus?.BonusModelName ?? "").EndsWith(this.applyBonusModelName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2LoginRewardOwnReceiveStatusBonusModelNameSpriteSwitcher
    {
