...
namespace Gs2.Unity.UiKit.Gs2LoginReward.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/LoginReward/BonusModel/View/SpriteSwitcher/Properties/Mode/Gs2LoginRewardBonusModelModeSpriteTableSwitcher")]
    public partial class Gs2LoginRewardBonusModelModeSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.BonusModel.Mode) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.BonusModel.Mode).sprite);
            }
            else {
    ...
    public partial class Gs2LoginRewardBonusModelModeSpriteTableSwitcher
    {
