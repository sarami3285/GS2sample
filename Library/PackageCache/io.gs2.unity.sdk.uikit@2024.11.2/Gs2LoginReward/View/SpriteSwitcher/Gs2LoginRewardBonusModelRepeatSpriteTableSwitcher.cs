...
namespace Gs2.Unity.UiKit.Gs2LoginReward.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/LoginReward/BonusModel/View/SpriteSwitcher/Properties/Repeat/Gs2LoginRewardBonusModelRepeatSpriteTableSwitcher")]
    public partial class Gs2LoginRewardBonusModelRepeatSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.BonusModel.Repeat) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.BonusModel.Repeat).sprite);
            }
            else {
    ...
    public partial class Gs2LoginRewardBonusModelRepeatSpriteTableSwitcher
    {
