...
namespace Gs2.Unity.UiKit.Gs2LoginReward.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/LoginReward/ReceiveStatus/Fetcher/Gs2LoginRewardOwnReceiveStatusListFetcher")]
    public partial class Gs2LoginRewardOwnReceiveStatusListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var it = _domain.ReceiveStatuses();
            var items = new List<Gs2.Unity.Gs2LoginReward.Model.EzReceiveStatus>();
            while (it.HasNext())
            {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeReceiveStatuses(
                items =>
                {
                    ReceiveStatuses = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2LoginRewardOwnReceiveStatusListFetcher
    {
        public Gs2LoginRewardNamespaceContext Context;
    ...
    public partial class Gs2LoginRewardOwnReceiveStatusListFetcher
    {
        public List<Gs2.Unity.Gs2LoginReward.Model.EzReceiveStatus> ReceiveStatuses { get; private set; }
