...
namespace Gs2.Unity.UiKit.Gs2LoginReward.Fetcher
{
    ...
    public partial class Gs2LoginRewardBonusModelFetcher : MonoBehaviour, IConsumeActionsFetcher, IVerifyActionsFetcher
    {
        ...
        private IEnumerator Fetch()
        {
            ...
            yield return new WaitUntil(() => Context != null && this.Context.BonusModel != null);

            this._domain = clientHolder.Gs2.LoginReward.Namespace(
                this.Context.BonusModel.NamespaceName
            ).BonusModel(
                this.Context.BonusModel.BonusModelName
            );;
    ...
    public partial class Gs2LoginRewardBonusModelFetcher
    {
        ...
        public void Awake()
        {
            Context = GetComponent<Gs2LoginRewardBonusModelContext>() ?? GetComponentInParent<Gs2LoginRewardBonusModelContext>();
            if (Context == null) {
                Debug.LogError($"{gameObject.GetFullPath()}: Couldn't find the Gs2LoginRewardBonusModelContext.");
                enabled = false;
            }
        }
