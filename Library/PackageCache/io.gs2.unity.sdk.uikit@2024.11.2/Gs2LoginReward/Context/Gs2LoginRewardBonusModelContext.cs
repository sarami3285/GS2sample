...
namespace Gs2.Unity.UiKit.Gs2LoginReward.Context
{
	...
	[AddComponentMenu("GS2 UIKit/LoginReward/BonusModel/Context/Gs2LoginRewardBonusModelContext")]
    public partial class Gs2LoginRewardBonusModelContext : MonoBehaviour
    {
        public void Start() {
            if (BonusModel == null) {
