...
namespace Gs2.Unity.UiKit.Gs2LoginReward.Context
{
	...
	[AddComponentMenu("GS2 UIKit/LoginReward/Namespace/Context/Gs2LoginRewardNamespaceContext")]
    public partial class Gs2LoginRewardNamespaceContext : MonoBehaviour
    {
        public void Start() {
            if (Namespace == null) {
    ...
    public partial class Gs2LoginRewardNamespaceContext
    {
