...
namespace Gs2.Unity.UiKit.Gs2Idle.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Idle/Status/Fetcher/Gs2IdleOwnStatusListFetcher")]
    public partial class Gs2IdleOwnStatusListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var items = new List<Gs2.Unity.Gs2Idle.Model.EzStatus>();
            while (it.HasNext())
            {
    ...
    public partial class Gs2IdleOwnStatusListFetcher
    {
        public Gs2IdleNamespaceContext Context;
    ...
    public partial class Gs2IdleOwnStatusListFetcher
    {
        public List<Gs2.Unity.Gs2Idle.Model.EzStatus> Statuses { get; private set; }
