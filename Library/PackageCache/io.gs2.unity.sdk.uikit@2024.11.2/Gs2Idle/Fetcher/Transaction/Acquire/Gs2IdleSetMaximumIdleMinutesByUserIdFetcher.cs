...
namespace Gs2.Unity.UiKit.Gs2Idle.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Idle/Status/Fetcher/Acquire/Gs2IdleSetMaximumIdleMinutesByUserIdFetcher")]
    public partial class Gs2IdleSetMaximumIdleMinutesByUserIdFetcher : Gs2IdleOwnStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Idle:SetMaximumIdleMinutesByUserId") {
                    Request = SetMaximumIdleMinutesByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Status == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Idle:SetMaximumIdleMinutesByUserId");
                if (action != null) {
                    Request = SetMaximumIdleMinutesByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Status == null || (
                            Status.NamespaceName == Request.NamespaceName &&
                            Status.CategoryName == Request.CategoryName)
                    ) {
    ...
    public partial class Gs2IdleSetMaximumIdleMinutesByUserIdFetcher
    {
    ...
    public partial class Gs2IdleSetMaximumIdleMinutesByUserIdFetcher
    {
        public SetMaximumIdleMinutesByUserIdRequest Request { get; protected set; }
