...
namespace Gs2.Unity.UiKit.Gs2Idle.Fetcher
{
    ...
    public partial class Gs2IdleIncreaseMaximumIdleMinutesByUserIdFetcher : Gs2IdleOwnStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Idle:IncreaseMaximumIdleMinutesByUserId") {
                    Request = IncreaseMaximumIdleMinutesByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Status == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Idle:IncreaseMaximumIdleMinutesByUserId");
                if (action != null) {
    ...
    public partial class Gs2IdleIncreaseMaximumIdleMinutesByUserIdFetcher
    {
        public IncreaseMaximumIdleMinutesByUserIdRequest Request { get; protected set; }
