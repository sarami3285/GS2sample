...
namespace Gs2.Unity.UiKit.Gs2Idle.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Idle/Status/Fetcher/Acquire/Gs2IdleReceiveByUserIdFetcher")]
    public partial class Gs2IdleReceiveByUserIdFetcher : Gs2IdleOwnStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Idle:ReceiveByUserId") {
                    Request = ReceiveByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Status == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Idle:ReceiveByUserId");
                if (action != null) {
    ...
    public partial class Gs2IdleReceiveByUserIdFetcher
    {
