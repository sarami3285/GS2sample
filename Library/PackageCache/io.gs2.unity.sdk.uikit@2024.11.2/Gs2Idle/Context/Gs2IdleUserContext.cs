...
namespace Gs2.Unity.UiKit.Gs2Idle.Context
{
	...
	[AddComponentMenu("GS2 UIKit/Idle/User/Context/Gs2IdleUserContext")]
    public partial class Gs2IdleUserContext : MonoBehaviour
    {
        public void Start() {
            if (User == null) {
    ...
    public partial class Gs2IdleUserContext
    {
