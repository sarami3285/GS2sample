...
namespace Gs2.Unity.UiKit.Gs2Idle
{
    ...
    public partial class Gs2IdleCategoryModelList
    {
        ...
        public void Awake()
        {
            ...
            this._fetcher = GetComponent<Gs2IdleCategoryModelListFetcher>() ?? GetComponentInParent<Gs2IdleCategoryModelListFetcher>();
            if (this._fetcher == null) {
                Debug.LogError($"{gameObject.GetFullPath()}: Couldn't find the Gs2IdleCategoryModelListFetcher.");
                enabled = false;
            }

            this._children = new List<Gs2IdleCategoryModelContext>();
        ...
        public virtual bool HasError()
        {
            ...
            this._fetcher = GetComponent<Gs2IdleCategoryModelListFetcher>() ?? GetComponentInParent<Gs2IdleCategoryModelListFetcher>(true);
            if (this._fetcher == null) {
                return true;
            }
            return false;
