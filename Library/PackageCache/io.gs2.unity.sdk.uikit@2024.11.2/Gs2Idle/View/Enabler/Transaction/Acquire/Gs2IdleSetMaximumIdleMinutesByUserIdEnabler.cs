...
namespace Gs2.Unity.UiKit.Gs2Idle
{
	...
	[AddComponentMenu("GS2 UIKit/Idle/Status/View/Enabler/Transaction/Gs2IdleSetMaximumIdleMinutesByUserIdEnabler")]
    public partial class Gs2IdleSetMaximumIdleMinutesByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Idle:SetMaximumIdleMinutesByUserId") == 0) {
    ...
    public partial class Gs2IdleSetMaximumIdleMinutesByUserIdEnabler
    {
