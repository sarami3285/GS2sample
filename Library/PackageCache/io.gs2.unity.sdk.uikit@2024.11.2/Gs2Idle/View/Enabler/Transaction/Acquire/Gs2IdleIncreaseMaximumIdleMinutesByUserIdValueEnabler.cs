...
namespace Gs2.Unity.UiKit.Gs2Idle
{
    ...
    public partial class Gs2IdleIncreaseMaximumIdleMinutesByUserIdValueEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this._fetcher.Request.IncreaseMinutes != null && this.enableIncreaseMinuteses.Contains(this._fetcher.Request.IncreaseMinutes.Value));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(this._fetcher.Request.IncreaseMinutes != null && !this.enableIncreaseMinuteses.Contains(this._fetcher.Request.IncreaseMinutes.Value));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableIncreaseMinutes > this._fetcher.Request.IncreaseMinutes);
                    break;
