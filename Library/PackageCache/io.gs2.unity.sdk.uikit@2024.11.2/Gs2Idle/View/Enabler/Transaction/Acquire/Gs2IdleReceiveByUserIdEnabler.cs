...
namespace Gs2.Unity.UiKit.Gs2Idle
{
	...
	[AddComponentMenu("GS2 UIKit/Idle/Status/View/Enabler/Transaction/Gs2IdleReceiveByUserIdEnabler")]
    public partial class Gs2IdleReceiveByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Idle:ReceiveByUserId") == 0) {
    ...
    public partial class Gs2IdleReceiveByUserIdEnabler
    {
