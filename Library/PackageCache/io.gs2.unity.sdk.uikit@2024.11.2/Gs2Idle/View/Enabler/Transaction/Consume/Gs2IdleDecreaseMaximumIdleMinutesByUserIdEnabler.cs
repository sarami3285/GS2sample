...
namespace Gs2.Unity.UiKit.Gs2Idle
{
	...
	[AddComponentMenu("GS2 UIKit/Idle/Status/View/Enabler/Transaction/Gs2IdleDecreaseMaximumIdleMinutesByUserIdEnabler")]
    public partial class Gs2IdleDecreaseMaximumIdleMinutesByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Idle:DecreaseMaximumIdleMinutesByUserId") == 0) {
    ...
    public partial class Gs2IdleDecreaseMaximumIdleMinutesByUserIdEnabler
    {
