...
namespace Gs2.Unity.UiKit.Gs2Idle
{
	...
	[AddComponentMenu("GS2 UIKit/Idle/CategoryModel/View/Enabler/Gs2IdleCategoryModelEnabler")]
    public partial class Gs2IdleCategoryModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.CategoryModel == null)
            {
    ...
    public partial class Gs2IdleCategoryModelEnabler
    {
