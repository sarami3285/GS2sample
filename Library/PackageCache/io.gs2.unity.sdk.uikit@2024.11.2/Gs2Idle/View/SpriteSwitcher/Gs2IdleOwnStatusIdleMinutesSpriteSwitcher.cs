...
namespace Gs2.Unity.UiKit.Gs2Idle
{
	...
	[AddComponentMenu("GS2 UIKit/Idle/Status/View/SpriteSwitcher/Properties/IdleMinutes/Gs2IdleOwnStatusIdleMinutesSpriteSwitcher")]
    public partial class Gs2IdleOwnStatusIdleMinutesSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyIdleMinuteses.Contains(this._fetcher.Status.IdleMinutes)) {
                ...
                case Expression.Less:
                    if (this.applyIdleMinutes > this._fetcher.Status.IdleMinutes) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
    ...
    public partial class Gs2IdleOwnStatusIdleMinutesSpriteSwitcher
    {
