...
namespace Gs2.Unity.UiKit.Gs2Idle
{
	...
	[AddComponentMenu("GS2 UIKit/Idle/Status/View/SpriteSwitcher/Properties/RandomSeed/Gs2IdleOwnStatusRandomSeedSpriteSwitcher")]
    public partial class Gs2IdleOwnStatusRandomSeedSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyRandomSeeds.Contains(this._fetcher.Status.RandomSeed)) {
                ...
                case Expression.Less:
                    if (this.applyRandomSeed > this._fetcher.Status.RandomSeed) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
    ...
    public partial class Gs2IdleOwnStatusRandomSeedSpriteSwitcher
    {
