...
namespace Gs2.Unity.UiKit.Gs2Idle
{
    ...
    public partial class Gs2IdleCategoryModelRewardIntervalMinutesSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyRewardIntervalMinuteses.Contains(this._fetcher.CategoryModel.RewardIntervalMinutes)) {
                ...
                case Expression.Less:
                    if (this.applyRewardIntervalMinutes > this._fetcher.CategoryModel.RewardIntervalMinutes) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
