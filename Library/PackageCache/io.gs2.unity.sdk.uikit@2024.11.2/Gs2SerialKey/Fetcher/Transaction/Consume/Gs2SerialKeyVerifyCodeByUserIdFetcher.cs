...
namespace Gs2.Unity.UiKit.Gs2SerialKey.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/SerialKey/Fetcher/Consume/Gs2SerialKeyVerifyCodeByUserIdFetcher")]
    public partial class Gs2SerialKeyVerifyCodeByUserIdFetcher : Gs2SerialKeyNamespaceContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2SerialKey:VerifyCodeByUserId") {
                    Request = VerifyCodeByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Namespace == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2SerialKey:VerifyCodeByUserId");
                if (action != null) {
                    Request = VerifyCodeByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Namespace == null || (
                            Namespace.NamespaceName == Request.NamespaceName)
                    ) {
                        Namespace = Namespace.New(
    ...
    public partial class Gs2SerialKeyVerifyCodeByUserIdFetcher
    {
    ...
    public partial class Gs2SerialKeyVerifyCodeByUserIdFetcher
    {
        public VerifyCodeByUserIdRequest Request { get; protected set; }
