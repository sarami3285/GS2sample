...
namespace Gs2.Unity.UiKit.Gs2SerialKey.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/SerialKey/Fetcher/Acquire/Gs2SerialKeyIssueOnceFetcher")]
    public partial class Gs2SerialKeyIssueOnceFetcher : Gs2SerialKeyNamespaceContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2SerialKey:IssueOnce") {
                    Request = IssueOnceRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Namespace == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2SerialKey:IssueOnce");
                if (action != null) {
                    Request = IssueOnceRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Namespace == null || (
                            Namespace.NamespaceName == Request.NamespaceName)
                    ) {
                        Namespace = Namespace.New(
    ...
    public partial class Gs2SerialKeyIssueOnceFetcher
    {
    ...
    public partial class Gs2SerialKeyIssueOnceFetcher
    {
        public IssueOnceRequest Request { get; protected set; }
