...
namespace Gs2.Unity.UiKit.Gs2SerialKey.Context
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/SerialKey/Context/Gs2SerialKeyOwnSerialKeyContext")]
    public partial class Gs2SerialKeyOwnSerialKeyContext : MonoBehaviour
    {
        public void Start() {
            if (SerialKey == null) {
    ...
    public partial class Gs2SerialKeyOwnSerialKeyContext
    {
