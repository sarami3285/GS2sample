...
namespace Gs2.Unity.UiKit.Gs2SerialKey.Localization
{
    ...
    [AddComponentMenu("GS2 UIKit/SerialKey/CampaignModel/View/Localization/Gs2SerialKeyCampaignModelLocalizationVariables")]
    public partial class Gs2SerialKeyCampaignModelLocalizationVariables : MonoBehaviour
    {
        private void OnFetched()
        {
            this.target.StringReference["name"] = new StringVariable {
                Value = _fetcher?.CampaignModel?.Name ?? "",
            };
            this.target.StringReference["metadata"] = new StringVariable {
                Value = _fetcher?.CampaignModel?.Metadata ?? "",
            };
            this.target.StringReference["enableCampaignCode"] = new BoolVariable {
                Value = _fetcher?.CampaignModel?.EnableCampaignCode ?? false,
            };
    ...
    public partial class Gs2SerialKeyCampaignModelLocalizationVariables
    {
