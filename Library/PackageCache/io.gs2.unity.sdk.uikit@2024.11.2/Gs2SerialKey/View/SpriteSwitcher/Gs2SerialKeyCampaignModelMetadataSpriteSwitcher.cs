...
namespace Gs2.Unity.UiKit.Gs2SerialKey.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/CampaignModel/View/SpriteSwitcher/Properties/Metadata/Gs2SerialKeyCampaignModelMetadataSpriteSwitcher")]
    public partial class Gs2SerialKeyCampaignModelMetadataSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyMetadatas.Contains(this._fetcher.CampaignModel?.Metadata ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.CampaignModel?.Metadata ?? "").StartsWith(this.applyMetadata)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.CampaignModel?.Metadata ?? "").EndsWith(this.applyMetadata)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2SerialKeyCampaignModelMetadataSpriteSwitcher
    {
