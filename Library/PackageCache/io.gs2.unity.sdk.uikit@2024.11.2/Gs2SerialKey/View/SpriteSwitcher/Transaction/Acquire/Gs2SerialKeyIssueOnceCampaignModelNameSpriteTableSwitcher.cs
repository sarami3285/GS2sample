...
namespace Gs2.Unity.UiKit.Gs2SerialKey.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/SerialKey/View/SpriteSwitcher/Transaction/Properties/CampaignModelName/Gs2SerialKeyIssueOnceCampaignModelNameSpriteTableSwitcher")]
    public partial class Gs2SerialKeyIssueOnceCampaignModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.CampaignModelName) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.CampaignModelName).sprite);
            }
            else {
    ...
    public partial class Gs2SerialKeyIssueOnceCampaignModelNameSpriteTableSwitcher
    {
