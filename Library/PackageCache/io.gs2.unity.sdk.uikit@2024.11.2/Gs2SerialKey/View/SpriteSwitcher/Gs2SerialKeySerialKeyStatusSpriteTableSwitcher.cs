...
namespace Gs2.Unity.UiKit.Gs2SerialKey.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/SerialKey/View/SpriteSwitcher/Properties/Status/Gs2SerialKeySerialKeyStatusSpriteTableSwitcher")]
    public partial class Gs2SerialKeySerialKeyStatusSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.SerialKey.Status) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.SerialKey.Status).sprite);
            }
            else {
    ...
    public partial class Gs2SerialKeySerialKeyStatusSpriteTableSwitcher
    {
