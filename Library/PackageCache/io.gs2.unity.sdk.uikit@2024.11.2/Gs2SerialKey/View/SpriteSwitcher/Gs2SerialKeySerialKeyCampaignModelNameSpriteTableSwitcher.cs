...
namespace Gs2.Unity.UiKit.Gs2SerialKey.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/SerialKey/View/SpriteSwitcher/Properties/CampaignModelName/Gs2SerialKeySerialKeyCampaignModelNameSpriteTableSwitcher")]
    public partial class Gs2SerialKeySerialKeyCampaignModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.SerialKey.CampaignModelName) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.SerialKey.CampaignModelName).sprite);
            }
            else {
    ...
    public partial class Gs2SerialKeySerialKeyCampaignModelNameSpriteTableSwitcher
    {
