...
namespace Gs2.Unity.UiKit.Gs2SerialKey.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/CampaignModel/View/SpriteSwitcher/Properties/Name/Gs2SerialKeyCampaignModelNameSpriteSwitcher")]
    public partial class Gs2SerialKeyCampaignModelNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.CampaignModel?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.CampaignModel?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.CampaignModel?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2SerialKeyCampaignModelNameSpriteSwitcher
    {
