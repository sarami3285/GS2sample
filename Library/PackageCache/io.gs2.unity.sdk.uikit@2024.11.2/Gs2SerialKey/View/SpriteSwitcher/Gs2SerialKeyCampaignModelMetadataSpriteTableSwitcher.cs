...
namespace Gs2.Unity.UiKit.Gs2SerialKey.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/CampaignModel/View/SpriteSwitcher/Properties/Metadata/Gs2SerialKeyCampaignModelMetadataSpriteTableSwitcher")]
    public partial class Gs2SerialKeyCampaignModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.CampaignModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.CampaignModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2SerialKeyCampaignModelMetadataSpriteTableSwitcher
    {
