...
namespace Gs2.Unity.UiKit.Gs2SerialKey.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/CampaignModel/View/SpriteSwitcher/Properties/Name/Gs2SerialKeyCampaignModelNameSpriteTableSwitcher")]
    public partial class Gs2SerialKeyCampaignModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.CampaignModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.CampaignModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2SerialKeyCampaignModelNameSpriteTableSwitcher
    {
