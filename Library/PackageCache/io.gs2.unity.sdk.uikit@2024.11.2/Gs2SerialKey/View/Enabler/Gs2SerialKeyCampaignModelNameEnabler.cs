...
namespace Gs2.Unity.UiKit.Gs2SerialKey.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/CampaignModel/View/Enabler/Properties/Name/Gs2SerialKeyCampaignModelNameEnabler")]
    public partial class Gs2SerialKeyCampaignModelNameEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableNames.Contains(this._fetcher.CampaignModel?.Name ?? ""));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableNames.Contains(this._fetcher.CampaignModel?.Name ?? ""));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive((this._fetcher.CampaignModel?.Name ?? "").StartsWith(this.enableName));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive((this._fetcher.CampaignModel?.Name ?? "").EndsWith(this.enableName));
                    break;
                default:
    ...
    public partial class Gs2SerialKeyCampaignModelNameEnabler
    {
