...
namespace Gs2.Unity.UiKit.Gs2SerialKey
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/CampaignModel/View/Enabler/Gs2SerialKeyCampaignModelEnabler")]
    public partial class Gs2SerialKeyCampaignModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.CampaignModel == null)
            {
    ...
    public partial class Gs2SerialKeyCampaignModelEnabler
    {
