...
namespace Gs2.Unity.UiKit.Gs2SerialKey
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/SerialKey/View/Enabler/Gs2SerialKeySerialKeyEnabler")]
    public partial class Gs2SerialKeySerialKeyEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.SerialKey == null)
            {
    ...
    public partial class Gs2SerialKeySerialKeyEnabler
    {
