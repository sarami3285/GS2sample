...
namespace Gs2.Unity.UiKit.Gs2SerialKey
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/SerialKey/View/Enabler/Transaction/Gs2SerialKeyUseByUserIdEnabler")]
    public partial class Gs2SerialKeyUseByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2SerialKey:UseByUserId") == 0) {
    ...
    public partial class Gs2SerialKeyUseByUserIdEnabler
    {
