...
namespace Gs2.Unity.UiKit.Gs2SerialKey
{
	...
	[AddComponentMenu("GS2 UIKit/SerialKey/SerialKey/View/Enabler/Transaction/Gs2SerialKeyIssueOnceEnabler")]
    public partial class Gs2SerialKeyIssueOnceEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2SerialKey:IssueOnce") == 0) {
    ...
    public partial class Gs2SerialKeyIssueOnceEnabler
    {
