...
namespace Gs2.Unity.UiKit.Gs2Ranking
{
    ...
    public partial class Gs2RankingSubscribeUserUnsubscribeAction
    {
        ...
        public event UnityAction<EzSubscribeUser> OnUnsubscribeComplete
        {
    ...
    public partial class Gs2RankingSubscribeUserUnsubscribeAction
    {
        [MenuItem("GameObject/Game Server Services/Ranking/SubscribeUser/Action/Unsubscribe", priority = 0)]
        private static void CreateButton()
        {
            var prefab = AssetDatabase.LoadAssetAtPath<Gs2RankingSubscribeUserUnsubscribeAction>(
                "Packages/io.gs2.unity.sdk.uikit/Gs2Ranking/Prefabs/Action/Gs2RankingSubscribeUserUnsubscribeAction.prefab"
            );
