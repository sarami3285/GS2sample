...
namespace Gs2.Unity.UiKit.Gs2Ranking.Fetcher
{
    ...
    {
        private EzScoreGameSessionDomain _domain;
        ...
        private IEnumerator Fetch()
        {
            ...
            yield return new WaitUntil(() => Context != null && this.Context.Score != null);
        ...
        public void SetTemporaryScore(
            Gs2.Unity.Gs2Ranking.Model.EzScore score
        ) {
            Score = score;
            this.OnFetched.Invoke();
        }

        public void RollbackTemporaryScore(
        ) {
            OnUpdateContext();
        }
    }
