...
namespace Gs2.Unity.UiKit.Gs2Ranking
{
    ...
    public partial class Gs2RankingCategoryModelList
    {
        ...
        public void Awake()
        {
            ...
            this._fetcher = GetComponent<Gs2RankingCategoryModelListFetcher>() ?? GetComponentInParent<Gs2RankingCategoryModelListFetcher>();
            if (this._fetcher == null) {
                Debug.LogError($"{gameObject.GetFullPath()}: Couldn't find the Gs2RankingCategoryModelListFetcher.");
                enabled = false;
            }

            this._children = new List<Gs2RankingCategoryModelContext>();
        ...
        public virtual bool HasError()
        {
            ...
            this._fetcher = GetComponent<Gs2RankingCategoryModelListFetcher>() ?? GetComponentInParent<Gs2RankingCategoryModelListFetcher>(true);
            if (this._fetcher == null) {
                return true;
            }
            return false;
