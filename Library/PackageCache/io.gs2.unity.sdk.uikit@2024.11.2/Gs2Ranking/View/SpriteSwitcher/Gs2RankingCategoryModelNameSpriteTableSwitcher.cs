...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/CategoryModel/View/SpriteSwitcher/Properties/Name/Gs2RankingCategoryModelNameSpriteTableSwitcher")]
    public partial class Gs2RankingCategoryModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.CategoryModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.CategoryModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2RankingCategoryModelNameSpriteTableSwitcher
    {
