...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/Score/View/SpriteSwitcher/Properties/Metadata/Gs2RankingOwnScoreMetadataSpriteTableSwitcher")]
    public partial class Gs2RankingOwnScoreMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Score.Metadata) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Score.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2RankingOwnScoreMetadataSpriteTableSwitcher
    {
