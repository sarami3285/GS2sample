...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/Score/View/SpriteSwitcher/Properties/ScorerUserId/Gs2RankingOwnScoreScorerUserIdSpriteTableSwitcher")]
    public partial class Gs2RankingOwnScoreScorerUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Score.ScorerUserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Score.ScorerUserId).sprite);
            }
            else {
    ...
    public partial class Gs2RankingOwnScoreScorerUserIdSpriteTableSwitcher
    {
