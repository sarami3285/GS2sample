...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/Score/View/SpriteSwitcher/Properties/UserId/Gs2RankingOwnScoreUserIdSpriteTableSwitcher")]
    public partial class Gs2RankingOwnScoreUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Score.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Score.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2RankingOwnScoreUserIdSpriteTableSwitcher
    {
