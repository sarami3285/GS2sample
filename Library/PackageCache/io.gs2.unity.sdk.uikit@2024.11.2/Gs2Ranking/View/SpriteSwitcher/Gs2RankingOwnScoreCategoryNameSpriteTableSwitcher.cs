...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/Score/View/SpriteSwitcher/Properties/CategoryName/Gs2RankingOwnScoreCategoryNameSpriteTableSwitcher")]
    public partial class Gs2RankingOwnScoreCategoryNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Score.CategoryName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Score.CategoryName).sprite);
            }
            else {
    ...
    public partial class Gs2RankingOwnScoreCategoryNameSpriteTableSwitcher
    {
