...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/Score/View/SpriteSwitcher/Properties/UniqueId/Gs2RankingOwnScoreUniqueIdSpriteTableSwitcher")]
    public partial class Gs2RankingOwnScoreUniqueIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Score.UniqueId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Score.UniqueId).sprite);
            }
            else {
    ...
    public partial class Gs2RankingOwnScoreUniqueIdSpriteTableSwitcher
    {
