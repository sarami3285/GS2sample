...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/CategoryModel/View/SpriteSwitcher/Properties/Metadata/Gs2RankingCategoryModelMetadataSpriteTableSwitcher")]
    public partial class Gs2RankingCategoryModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.CategoryModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.CategoryModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2RankingCategoryModelMetadataSpriteTableSwitcher
    {
