...
{
    [CustomEditor(typeof(Gs2AdRewardOwnPointFetcher))]
    public class Gs2AdRewardOwnPointFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AdRewardOwnPointFetcher;
