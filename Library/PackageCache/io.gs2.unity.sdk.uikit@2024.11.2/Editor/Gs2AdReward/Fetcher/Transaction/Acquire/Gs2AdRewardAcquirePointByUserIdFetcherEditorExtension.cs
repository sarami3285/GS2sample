...
namespace Gs2.Unity.UiKit.Gs2AdReward.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2AdRewardAcquirePointByUserIdFetcher))]
    public class Gs2AdRewardAcquirePointByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AdRewardAcquirePointByUserIdFetcher;
