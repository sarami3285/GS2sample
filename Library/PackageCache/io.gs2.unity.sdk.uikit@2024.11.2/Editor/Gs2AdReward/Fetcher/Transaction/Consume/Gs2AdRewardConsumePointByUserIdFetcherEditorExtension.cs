...
{
    [CustomEditor(typeof(Gs2AdRewardConsumePointByUserIdFetcher))]
    public class Gs2AdRewardConsumePointByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AdRewardConsumePointByUserIdFetcher;
