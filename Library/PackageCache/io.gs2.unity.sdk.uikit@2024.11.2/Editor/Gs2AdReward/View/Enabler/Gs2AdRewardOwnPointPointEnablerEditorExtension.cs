...
{
    [CustomEditor(typeof(Gs2AdRewardOwnPointPointEnabler))]
    public class Gs2AdRewardOwnPointPointEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AdRewardOwnPointPointEnabler;
            ...
            if (original.expression == Gs2AdRewardOwnPointPointEnabler.Expression.In || original.expression == Gs2AdRewardOwnPointPointEnabler.Expression.NotIn) {
