...
{
    [CustomEditor(typeof(Gs2AdRewardAcquirePointByUserIdEnabler))]
    public class Gs2AdRewardAcquirePointByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AdRewardAcquirePointByUserIdEnabler;
