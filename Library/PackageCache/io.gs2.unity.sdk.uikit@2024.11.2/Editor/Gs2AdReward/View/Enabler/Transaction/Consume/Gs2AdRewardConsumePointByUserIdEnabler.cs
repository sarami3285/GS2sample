...
{
    [CustomEditor(typeof(Gs2AdRewardConsumePointByUserIdEnabler))]
    public class Gs2AdRewardConsumePointByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AdRewardConsumePointByUserIdEnabler;
