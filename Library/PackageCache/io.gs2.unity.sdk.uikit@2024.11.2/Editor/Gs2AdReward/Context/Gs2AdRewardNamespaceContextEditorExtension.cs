...
{
    [CustomEditor(typeof(Gs2AdRewardNamespaceContext))]
    public class Gs2AdRewardNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AdRewardNamespaceContext;
