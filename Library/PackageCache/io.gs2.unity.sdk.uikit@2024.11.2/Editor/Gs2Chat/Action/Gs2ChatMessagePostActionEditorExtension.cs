...
{
    [CustomEditor(typeof(Gs2ChatMessagePostAction))]
    public class Gs2ChatMessagePostActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatMessagePostAction;
            ...
            if (context == null) {
                ...
                if (context.transform.parent.GetComponent<Gs2ChatMessageList>() != null) {
