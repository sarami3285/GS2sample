...
{
    [CustomEditor(typeof(Gs2ChatSubscribeUnsubscribeAction))]
    public class Gs2ChatSubscribeUnsubscribeActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatSubscribeUnsubscribeAction;
            ...
            if (context == null) {
                ...
                if (context.transform.GetComponentInParent<Gs2ChatOwnSubscribeList>(true) != null) {
