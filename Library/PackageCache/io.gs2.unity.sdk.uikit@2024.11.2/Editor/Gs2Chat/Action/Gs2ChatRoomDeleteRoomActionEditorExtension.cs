...
{
    [CustomEditor(typeof(Gs2ChatRoomDeleteRoomAction))]
    public class Gs2ChatRoomDeleteRoomActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatRoomDeleteRoomAction;
