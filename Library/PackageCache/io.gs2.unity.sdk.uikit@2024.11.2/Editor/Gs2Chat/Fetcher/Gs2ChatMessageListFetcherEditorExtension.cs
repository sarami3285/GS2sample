...
{
    [CustomEditor(typeof(Gs2ChatMessageListFetcher))]
    public class Gs2ChatMessageListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatMessageListFetcher;
