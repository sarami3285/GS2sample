...
{
    [CustomEditor(typeof(Gs2ChatNamespaceContext))]
    public class Gs2ChatNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatNamespaceContext;
