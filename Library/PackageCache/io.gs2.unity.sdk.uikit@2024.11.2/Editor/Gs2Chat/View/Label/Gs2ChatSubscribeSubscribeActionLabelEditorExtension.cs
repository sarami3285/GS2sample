...
{
    [CustomEditor(typeof(Gs2ChatSubscribeSubscribeActionLabel))]
    public class Gs2ChatSubscribeSubscribeActionLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatSubscribeSubscribeActionLabel;
