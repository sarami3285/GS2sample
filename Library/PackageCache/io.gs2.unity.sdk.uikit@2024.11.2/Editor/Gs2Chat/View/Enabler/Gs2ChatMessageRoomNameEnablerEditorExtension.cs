...
{
    [CustomEditor(typeof(Gs2ChatMessageRoomNameEnabler))]
    public class Gs2ChatMessageRoomNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatMessageRoomNameEnabler;
            ...
            if (original.expression == Gs2ChatMessageRoomNameEnabler.Expression.In || original.expression == Gs2ChatMessageRoomNameEnabler.Expression.NotIn) {
