...
{
    [CustomEditor(typeof(Gs2ChatMessageCategoryEnabler))]
    public class Gs2ChatMessageCategoryEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatMessageCategoryEnabler;
            ...
            if (original.expression == Gs2ChatMessageCategoryEnabler.Expression.In || original.expression == Gs2ChatMessageCategoryEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableCategories"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableCategory"), true);
            }
