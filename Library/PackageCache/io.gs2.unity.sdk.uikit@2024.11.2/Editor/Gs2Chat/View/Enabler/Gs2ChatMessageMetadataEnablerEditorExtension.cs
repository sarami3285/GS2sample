...
{
    [CustomEditor(typeof(Gs2ChatMessageMetadataEnabler))]
    public class Gs2ChatMessageMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatMessageMetadataEnabler;
            ...
            if (original.expression == Gs2ChatMessageMetadataEnabler.Expression.In || original.expression == Gs2ChatMessageMetadataEnabler.Expression.NotIn) {
