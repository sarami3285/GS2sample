...
{
    [CustomEditor(typeof(Gs2ChatOwnSubscribeUserIdEnabler))]
    public class Gs2ChatOwnSubscribeUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatOwnSubscribeUserIdEnabler;
            ...
            if (original.expression == Gs2ChatOwnSubscribeUserIdEnabler.Expression.In || original.expression == Gs2ChatOwnSubscribeUserIdEnabler.Expression.NotIn) {
