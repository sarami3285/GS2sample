...
namespace Gs2.Unity.UiKit.Gs2Chat.Enabler.Editor
{
    ...
    public class Gs2ChatMessageUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatMessageUserIdEnabler;
            ...
            if (original.expression == Gs2ChatMessageUserIdEnabler.Expression.In || original.expression == Gs2ChatMessageUserIdEnabler.Expression.NotIn) {
