...
{
    [CustomEditor(typeof(Gs2ChatOwnSubscribeRoomNameEnabler))]
    public class Gs2ChatOwnSubscribeRoomNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatOwnSubscribeRoomNameEnabler;
            ...
            if (original.expression == Gs2ChatOwnSubscribeRoomNameEnabler.Expression.In || original.expression == Gs2ChatOwnSubscribeRoomNameEnabler.Expression.NotIn) {
