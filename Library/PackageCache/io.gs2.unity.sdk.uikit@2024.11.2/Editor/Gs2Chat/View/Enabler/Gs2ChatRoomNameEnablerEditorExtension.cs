...
{
    [CustomEditor(typeof(Gs2ChatRoomNameEnabler))]
    public class Gs2ChatRoomNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatRoomNameEnabler;
            ...
            if (original.expression == Gs2ChatRoomNameEnabler.Expression.In || original.expression == Gs2ChatRoomNameEnabler.Expression.NotIn) {
