...
{
    [CustomEditor(typeof(Gs2ChatMessageNameSpriteSwitcher))]
    public class Gs2ChatMessageNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatMessageNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ChatMessageNameSpriteSwitcher.Expression.In || original.expression == Gs2ChatMessageNameSpriteSwitcher.Expression.NotIn) {
