...
{
    [CustomEditor(typeof(Gs2ChatMessageUserIdSpriteSwitcher))]
    public class Gs2ChatMessageUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatMessageUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2ChatMessageUserIdSpriteSwitcher.Expression.In || original.expression == Gs2ChatMessageUserIdSpriteSwitcher.Expression.NotIn) {
