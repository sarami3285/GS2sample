...
{
    [CustomEditor(typeof(Gs2ChatMessageCategorySpriteSwitcher))]
    public class Gs2ChatMessageCategorySpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatMessageCategorySpriteSwitcher;
            ...
            if (original.expression == Gs2ChatMessageCategorySpriteSwitcher.Expression.In || original.expression == Gs2ChatMessageCategorySpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCategories"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCategory"), true);
            }
