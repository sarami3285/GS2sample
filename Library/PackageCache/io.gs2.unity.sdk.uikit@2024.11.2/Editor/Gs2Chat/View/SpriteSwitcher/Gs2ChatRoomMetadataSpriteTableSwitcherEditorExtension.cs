...
{
    [CustomEditor(typeof(Gs2ChatRoomMetadataSpriteTableSwitcher))]
    public class Gs2ChatRoomMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatRoomMetadataSpriteTableSwitcher;
