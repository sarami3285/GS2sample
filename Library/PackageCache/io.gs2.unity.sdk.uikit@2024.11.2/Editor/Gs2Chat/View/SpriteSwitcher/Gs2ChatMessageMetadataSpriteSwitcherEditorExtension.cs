...
{
    [CustomEditor(typeof(Gs2ChatMessageMetadataSpriteSwitcher))]
    public class Gs2ChatMessageMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatMessageMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2ChatMessageMetadataSpriteSwitcher.Expression.In || original.expression == Gs2ChatMessageMetadataSpriteSwitcher.Expression.NotIn) {
