...
{
    [CustomEditor(typeof(Gs2ChatRoomNameSpriteSwitcher))]
    public class Gs2ChatRoomNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatRoomNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ChatRoomNameSpriteSwitcher.Expression.In || original.expression == Gs2ChatRoomNameSpriteSwitcher.Expression.NotIn) {
