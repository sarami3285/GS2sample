...
{
    [CustomEditor(typeof(Gs2ChatOwnSubscribeRoomNameSpriteSwitcher))]
    public class Gs2ChatOwnSubscribeRoomNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatOwnSubscribeRoomNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ChatOwnSubscribeRoomNameSpriteSwitcher.Expression.In || original.expression == Gs2ChatOwnSubscribeRoomNameSpriteSwitcher.Expression.NotIn) {
