...
{
    [CustomEditor(typeof(Gs2StaminaStaminaSetRecoverIntervalAction))]
    public class Gs2StaminaStaminaSetRecoverIntervalActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaSetRecoverIntervalAction;
            ...
            if (context == null) {
                ...
                if (context.transform.GetComponentInParent<Gs2StaminaOwnStaminaList>(true) != null) {
                    EditorGUI.BeginDisabledGroup(true);
                    EditorGUILayout.ObjectField("Context", context.gameObject, typeof(Gs2StaminaOwnStaminaContext), false);
                    EditorGUI.EndDisabledGroup();
                    EditorGUILayout.HelpBox("Stamina is auto assign from Gs2StaminaStaminaList.", MessageType.Info);
                }
                else {
                    EditorGUI.BeginDisabledGroup(true);
                    EditorGUILayout.ObjectField("Context", context.gameObject, typeof(Gs2StaminaOwnStaminaContext), false);
