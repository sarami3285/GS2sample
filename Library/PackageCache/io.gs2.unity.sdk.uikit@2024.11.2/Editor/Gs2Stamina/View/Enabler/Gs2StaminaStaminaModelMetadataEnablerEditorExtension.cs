...
namespace Gs2.Unity.UiKit.Gs2Stamina.Enabler.Editor
{
    ...
    public class Gs2StaminaStaminaModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaModelMetadataEnabler;
            ...
            if (original.expression == Gs2StaminaStaminaModelMetadataEnabler.Expression.In || original.expression == Gs2StaminaStaminaModelMetadataEnabler.Expression.NotIn) {
