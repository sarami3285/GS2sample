...
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaOverflowValueEnabler))]
    public class Gs2StaminaOwnStaminaOverflowValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaOverflowValueEnabler;
            ...
            if (original.expression == Gs2StaminaOwnStaminaOverflowValueEnabler.Expression.In || original.expression == Gs2StaminaOwnStaminaOverflowValueEnabler.Expression.NotIn) {
