...
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaEnabler))]
    public class Gs2StaminaOwnStaminaEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("StaminaFetcher not assigned.", MessageType.Error);
