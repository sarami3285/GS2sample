...
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaRecoverValueEnabler))]
    public class Gs2StaminaOwnStaminaRecoverValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaRecoverValueEnabler;
            ...
            if (original.expression == Gs2StaminaOwnStaminaRecoverValueEnabler.Expression.In || original.expression == Gs2StaminaOwnStaminaRecoverValueEnabler.Expression.NotIn) {
