...
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaMaxValueEnabler))]
    public class Gs2StaminaOwnStaminaMaxValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaMaxValueEnabler;
            ...
            if (original.expression == Gs2StaminaOwnStaminaMaxValueEnabler.Expression.In || original.expression == Gs2StaminaOwnStaminaMaxValueEnabler.Expression.NotIn) {
