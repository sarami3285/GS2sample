...
{
    [CustomEditor(typeof(Gs2StaminaSetRecoverValueByUserIdValueEnabler))]
    public class Gs2StaminaSetRecoverValueByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaSetRecoverValueByUserIdValueEnabler;
            ...
            if (original.expression == Gs2StaminaSetRecoverValueByUserIdValueEnabler.Expression.In || original.expression == Gs2StaminaSetRecoverValueByUserIdValueEnabler.Expression.NotIn) {
