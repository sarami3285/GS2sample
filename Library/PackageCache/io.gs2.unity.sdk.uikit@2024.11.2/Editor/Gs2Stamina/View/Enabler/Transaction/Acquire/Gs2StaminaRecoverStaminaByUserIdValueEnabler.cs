...
{
    [CustomEditor(typeof(Gs2StaminaRecoverStaminaByUserIdValueEnabler))]
    public class Gs2StaminaRecoverStaminaByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaRecoverStaminaByUserIdValueEnabler;
            ...
            if (original.expression == Gs2StaminaRecoverStaminaByUserIdValueEnabler.Expression.In || original.expression == Gs2StaminaRecoverStaminaByUserIdValueEnabler.Expression.NotIn) {
