...
{
    [CustomEditor(typeof(Gs2StaminaDecreaseMaxValueByUserIdEnabler))]
    public class Gs2StaminaDecreaseMaxValueByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaDecreaseMaxValueByUserIdEnabler;
