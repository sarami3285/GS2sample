...
{
    [CustomEditor(typeof(Gs2StaminaSetRecoverIntervalByUserIdEnabler))]
    public class Gs2StaminaSetRecoverIntervalByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaSetRecoverIntervalByUserIdEnabler;
