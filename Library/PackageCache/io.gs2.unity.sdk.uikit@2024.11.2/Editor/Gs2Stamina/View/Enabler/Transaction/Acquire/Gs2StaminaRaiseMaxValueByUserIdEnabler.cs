...
{
    [CustomEditor(typeof(Gs2StaminaRaiseMaxValueByUserIdEnabler))]
    public class Gs2StaminaRaiseMaxValueByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaRaiseMaxValueByUserIdEnabler;
