...
{
    [CustomEditor(typeof(Gs2StaminaSetMaxValueByUserIdValueEnabler))]
    public class Gs2StaminaSetMaxValueByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaSetMaxValueByUserIdValueEnabler;
            ...
            if (original.expression == Gs2StaminaSetMaxValueByUserIdValueEnabler.Expression.In || original.expression == Gs2StaminaSetMaxValueByUserIdValueEnabler.Expression.NotIn) {
