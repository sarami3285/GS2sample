...
{
    [CustomEditor(typeof(Gs2StaminaSetMaxValueByUserIdEnabler))]
    public class Gs2StaminaSetMaxValueByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaSetMaxValueByUserIdEnabler;
