...
{
    [CustomEditor(typeof(Gs2StaminaSetRecoverValueByUserIdEnabler))]
    public class Gs2StaminaSetRecoverValueByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaSetRecoverValueByUserIdEnabler;
