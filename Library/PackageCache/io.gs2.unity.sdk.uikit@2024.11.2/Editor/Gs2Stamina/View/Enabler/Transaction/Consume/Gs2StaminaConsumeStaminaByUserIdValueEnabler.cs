...
{
    [CustomEditor(typeof(Gs2StaminaConsumeStaminaByUserIdValueEnabler))]
    public class Gs2StaminaConsumeStaminaByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaConsumeStaminaByUserIdValueEnabler;
            ...
            if (original.expression == Gs2StaminaConsumeStaminaByUserIdValueEnabler.Expression.In || original.expression == Gs2StaminaConsumeStaminaByUserIdValueEnabler.Expression.NotIn) {
