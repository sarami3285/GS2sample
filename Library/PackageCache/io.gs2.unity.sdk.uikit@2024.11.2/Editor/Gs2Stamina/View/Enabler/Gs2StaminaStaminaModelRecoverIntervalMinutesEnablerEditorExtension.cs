...
{
    [CustomEditor(typeof(Gs2StaminaStaminaModelRecoverIntervalMinutesEnabler))]
    public class Gs2StaminaStaminaModelRecoverIntervalMinutesEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaModelRecoverIntervalMinutesEnabler;
            ...
            if (original.expression == Gs2StaminaStaminaModelRecoverIntervalMinutesEnabler.Expression.In || original.expression == Gs2StaminaStaminaModelRecoverIntervalMinutesEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRecoverIntervalMinuteses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRecoverIntervalMinutes"), true);
            }
