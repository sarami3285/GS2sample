...
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaNextRecoverAtEnabler))]
    public class Gs2StaminaOwnStaminaNextRecoverAtEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaNextRecoverAtEnabler;
            ...
            if (original.expression == Gs2StaminaOwnStaminaNextRecoverAtEnabler.Expression.In || original.expression == Gs2StaminaOwnStaminaNextRecoverAtEnabler.Expression.NotIn) {
