...
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaValueEnabler))]
    public class Gs2StaminaOwnStaminaValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaValueEnabler;
            ...
            if (original.expression == Gs2StaminaOwnStaminaValueEnabler.Expression.In || original.expression == Gs2StaminaOwnStaminaValueEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableValues"), true);
            } else if (original.expression == Gs2StaminaOwnStaminaValueEnabler.Expression.ReachMax || original.expression == Gs2StaminaOwnStaminaValueEnabler.Expression.NotReachMax) {
            } else {
