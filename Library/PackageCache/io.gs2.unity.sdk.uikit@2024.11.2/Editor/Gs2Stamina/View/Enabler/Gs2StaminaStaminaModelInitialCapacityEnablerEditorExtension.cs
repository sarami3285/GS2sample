...
{
    [CustomEditor(typeof(Gs2StaminaStaminaModelInitialCapacityEnabler))]
    public class Gs2StaminaStaminaModelInitialCapacityEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaModelInitialCapacityEnabler;
            ...
            if (original.expression == Gs2StaminaStaminaModelInitialCapacityEnabler.Expression.In || original.expression == Gs2StaminaStaminaModelInitialCapacityEnabler.Expression.NotIn) {
