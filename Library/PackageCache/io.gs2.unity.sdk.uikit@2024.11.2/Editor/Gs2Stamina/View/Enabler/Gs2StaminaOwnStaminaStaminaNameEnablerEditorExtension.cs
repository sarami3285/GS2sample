...
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaStaminaNameEnabler))]
    public class Gs2StaminaOwnStaminaStaminaNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaStaminaNameEnabler;
            ...
            if (original.expression == Gs2StaminaOwnStaminaStaminaNameEnabler.Expression.In || original.expression == Gs2StaminaOwnStaminaStaminaNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableStaminaNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableStaminaName"), true);
            }
