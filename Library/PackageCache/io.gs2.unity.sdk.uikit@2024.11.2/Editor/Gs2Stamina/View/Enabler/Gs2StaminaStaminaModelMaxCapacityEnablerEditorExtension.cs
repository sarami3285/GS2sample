...
{
    [CustomEditor(typeof(Gs2StaminaStaminaModelMaxCapacityEnabler))]
    public class Gs2StaminaStaminaModelMaxCapacityEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaModelMaxCapacityEnabler;
            ...
            if (original.expression == Gs2StaminaStaminaModelMaxCapacityEnabler.Expression.In || original.expression == Gs2StaminaStaminaModelMaxCapacityEnabler.Expression.NotIn) {
