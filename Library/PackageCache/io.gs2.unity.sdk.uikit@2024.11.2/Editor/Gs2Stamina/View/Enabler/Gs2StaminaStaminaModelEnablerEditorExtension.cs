...
{
    [CustomEditor(typeof(Gs2StaminaStaminaModelEnabler))]
    public class Gs2StaminaStaminaModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaModelEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("StaminaModelFetcher not assigned.", MessageType.Error);
