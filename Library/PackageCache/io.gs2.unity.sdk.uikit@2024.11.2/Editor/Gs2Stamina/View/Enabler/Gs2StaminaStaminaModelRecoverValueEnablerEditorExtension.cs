...
{
    [CustomEditor(typeof(Gs2StaminaStaminaModelRecoverValueEnabler))]
    public class Gs2StaminaStaminaModelRecoverValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaModelRecoverValueEnabler;
            ...
            if (original.expression == Gs2StaminaStaminaModelRecoverValueEnabler.Expression.In || original.expression == Gs2StaminaStaminaModelRecoverValueEnabler.Expression.NotIn) {
