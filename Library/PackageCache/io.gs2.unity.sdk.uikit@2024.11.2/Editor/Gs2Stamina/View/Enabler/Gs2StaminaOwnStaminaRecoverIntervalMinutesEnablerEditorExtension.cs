...
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaRecoverIntervalMinutesEnabler))]
    public class Gs2StaminaOwnStaminaRecoverIntervalMinutesEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaRecoverIntervalMinutesEnabler;
            ...
            if (original.expression == Gs2StaminaOwnStaminaRecoverIntervalMinutesEnabler.Expression.In || original.expression == Gs2StaminaOwnStaminaRecoverIntervalMinutesEnabler.Expression.NotIn) {
