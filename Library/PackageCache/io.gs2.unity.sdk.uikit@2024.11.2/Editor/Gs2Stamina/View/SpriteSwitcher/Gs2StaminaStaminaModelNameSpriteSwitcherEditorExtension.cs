...
{
    [CustomEditor(typeof(Gs2StaminaStaminaModelNameSpriteSwitcher))]
    public class Gs2StaminaStaminaModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaStaminaModelNameSpriteSwitcher.Expression.In || original.expression == Gs2StaminaStaminaModelNameSpriteSwitcher.Expression.NotIn) {
