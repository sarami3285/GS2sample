...
{
    [CustomEditor(typeof(Gs2StaminaStaminaModelRecoverValueSpriteSwitcher))]
    public class Gs2StaminaStaminaModelRecoverValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaModelRecoverValueSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaStaminaModelRecoverValueSpriteSwitcher.Expression.In || original.expression == Gs2StaminaStaminaModelRecoverValueSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRecoverValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRecoverValue"), true);
            }
