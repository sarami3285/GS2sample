...
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaNextRecoverAtSpriteSwitcher))]
    public class Gs2StaminaOwnStaminaNextRecoverAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaNextRecoverAtSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaOwnStaminaNextRecoverAtSpriteSwitcher.Expression.In || original.expression == Gs2StaminaOwnStaminaNextRecoverAtSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyNextRecoverAts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyNextRecoverAt"), true);
            }
