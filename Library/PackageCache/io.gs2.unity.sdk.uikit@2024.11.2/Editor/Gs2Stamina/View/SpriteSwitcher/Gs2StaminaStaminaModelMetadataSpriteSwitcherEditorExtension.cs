...
{
    [CustomEditor(typeof(Gs2StaminaStaminaModelMetadataSpriteSwitcher))]
    public class Gs2StaminaStaminaModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaStaminaModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2StaminaStaminaModelMetadataSpriteSwitcher.Expression.NotIn) {
