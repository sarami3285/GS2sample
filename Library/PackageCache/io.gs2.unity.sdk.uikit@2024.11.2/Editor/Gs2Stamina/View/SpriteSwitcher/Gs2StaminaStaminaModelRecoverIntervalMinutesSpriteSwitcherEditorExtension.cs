...
{
    [CustomEditor(typeof(Gs2StaminaStaminaModelRecoverIntervalMinutesSpriteSwitcher))]
    public class Gs2StaminaStaminaModelRecoverIntervalMinutesSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaModelRecoverIntervalMinutesSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaStaminaModelRecoverIntervalMinutesSpriteSwitcher.Expression.In || original.expression == Gs2StaminaStaminaModelRecoverIntervalMinutesSpriteSwitcher.Expression.NotIn) {
