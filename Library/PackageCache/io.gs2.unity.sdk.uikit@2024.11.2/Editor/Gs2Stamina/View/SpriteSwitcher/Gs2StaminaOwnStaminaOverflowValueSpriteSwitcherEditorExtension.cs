...
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaOverflowValueSpriteSwitcher))]
    public class Gs2StaminaOwnStaminaOverflowValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaOverflowValueSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaOwnStaminaOverflowValueSpriteSwitcher.Expression.In || original.expression == Gs2StaminaOwnStaminaOverflowValueSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyOverflowValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyOverflowValue"), true);
            }
