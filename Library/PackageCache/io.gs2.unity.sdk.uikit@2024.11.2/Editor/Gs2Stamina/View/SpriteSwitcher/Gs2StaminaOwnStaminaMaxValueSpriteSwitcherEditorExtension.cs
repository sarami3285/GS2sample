...
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaMaxValueSpriteSwitcher))]
    public class Gs2StaminaOwnStaminaMaxValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaMaxValueSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaOwnStaminaMaxValueSpriteSwitcher.Expression.In || original.expression == Gs2StaminaOwnStaminaMaxValueSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMaxValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMaxValue"), true);
            }
