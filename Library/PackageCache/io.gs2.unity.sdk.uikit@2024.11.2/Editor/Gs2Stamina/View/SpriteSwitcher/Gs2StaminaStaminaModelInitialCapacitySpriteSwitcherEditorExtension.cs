...
{
    [CustomEditor(typeof(Gs2StaminaStaminaModelInitialCapacitySpriteSwitcher))]
    public class Gs2StaminaStaminaModelInitialCapacitySpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaModelInitialCapacitySpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaStaminaModelInitialCapacitySpriteSwitcher.Expression.In || original.expression == Gs2StaminaStaminaModelInitialCapacitySpriteSwitcher.Expression.NotIn) {
