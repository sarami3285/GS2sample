...
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaRecoverValueSpriteSwitcher))]
    public class Gs2StaminaOwnStaminaRecoverValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaRecoverValueSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaOwnStaminaRecoverValueSpriteSwitcher.Expression.In || original.expression == Gs2StaminaOwnStaminaRecoverValueSpriteSwitcher.Expression.NotIn) {
