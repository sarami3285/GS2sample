...
namespace Gs2.Unity.UiKit.Gs2Stamina.SpriteSwitcher.Editor
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaStaminaNameSpriteSwitcher))]
    public class Gs2StaminaOwnStaminaStaminaNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaStaminaNameSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaOwnStaminaStaminaNameSpriteSwitcher.Expression.In || original.expression == Gs2StaminaOwnStaminaStaminaNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyStaminaNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyStaminaName"), true);
            }
