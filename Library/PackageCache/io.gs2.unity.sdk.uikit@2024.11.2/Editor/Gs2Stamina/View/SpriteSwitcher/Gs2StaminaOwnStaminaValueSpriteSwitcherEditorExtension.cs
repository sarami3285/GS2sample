...
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaValueSpriteSwitcher))]
    public class Gs2StaminaOwnStaminaValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaValueSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaOwnStaminaValueSpriteSwitcher.Expression.In || original.expression == Gs2StaminaOwnStaminaValueSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyValue"), true);
            }
