...
{
    [CustomEditor(typeof(Gs2StaminaSetRecoverIntervalByUserIdLabel))]
    public class Gs2StaminaSetRecoverIntervalByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaSetRecoverIntervalByUserIdLabel;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2StaminaSetRecoverIntervalByUserIdFetcher>() ?? original.GetComponentInParent<Gs2StaminaSetRecoverIntervalByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2StaminaSetRecoverIntervalByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2StaminaSetRecoverIntervalByUserIdFetcher>();
                }
            }
