...
{
    [CustomEditor(typeof(Gs2StaminaRecoverStaminaByUserIdLabel))]
    public class Gs2StaminaRecoverStaminaByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaRecoverStaminaByUserIdLabel;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2StaminaRecoverStaminaByUserIdFetcher>() ?? original.GetComponentInParent<Gs2StaminaRecoverStaminaByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2StaminaRecoverStaminaByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2StaminaRecoverStaminaByUserIdFetcher>();
                }
            }
