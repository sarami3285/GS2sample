...
namespace Gs2.Unity.UiKit.Gs2Stamina.Label.Editor
{
    ...
    public class Gs2StaminaRaiseMaxValueByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            ...
            var fetcher = original.GetComponent<Gs2StaminaRaiseMaxValueByUserIdFetcher>() ?? original.GetComponentInParent<Gs2StaminaRaiseMaxValueByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2StaminaRaiseMaxValueByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2StaminaRaiseMaxValueByUserIdFetcher>();
                }
            }
