...
{
    [CustomEditor(typeof(Gs2StaminaNamespaceContext))]
    public class Gs2StaminaNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaNamespaceContext;
