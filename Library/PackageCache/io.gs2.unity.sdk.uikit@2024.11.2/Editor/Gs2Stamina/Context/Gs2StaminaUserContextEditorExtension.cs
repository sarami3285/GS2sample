...
{
    [CustomEditor(typeof(Gs2StaminaUserContext))]
    public class Gs2StaminaUserContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaUserContext;
