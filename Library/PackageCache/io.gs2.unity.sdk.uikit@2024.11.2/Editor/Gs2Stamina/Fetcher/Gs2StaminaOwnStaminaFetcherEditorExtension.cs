...
{
    [CustomEditor(typeof(Gs2StaminaOwnStaminaFetcher))]
    public class Gs2StaminaOwnStaminaFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaOwnStaminaFetcher;
