...
{
    [CustomEditor(typeof(Gs2StaminaRaiseMaxValueByUserIdFetcher))]
    public class Gs2StaminaRaiseMaxValueByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaRaiseMaxValueByUserIdFetcher;
