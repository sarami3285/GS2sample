...
{
    [CustomEditor(typeof(Gs2StaminaSetMaxValueByUserIdFetcher))]
    public class Gs2StaminaSetMaxValueByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaSetMaxValueByUserIdFetcher;
