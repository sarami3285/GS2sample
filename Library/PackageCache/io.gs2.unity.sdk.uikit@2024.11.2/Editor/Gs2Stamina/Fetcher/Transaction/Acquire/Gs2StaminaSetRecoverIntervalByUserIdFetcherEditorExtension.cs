...
namespace Gs2.Unity.UiKit.Gs2Stamina.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2StaminaSetRecoverIntervalByUserIdFetcher))]
    public class Gs2StaminaSetRecoverIntervalByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaSetRecoverIntervalByUserIdFetcher;
