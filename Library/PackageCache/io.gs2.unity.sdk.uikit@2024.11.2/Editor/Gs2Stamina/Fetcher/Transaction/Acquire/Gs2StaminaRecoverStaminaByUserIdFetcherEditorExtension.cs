...
{
    [CustomEditor(typeof(Gs2StaminaRecoverStaminaByUserIdFetcher))]
    public class Gs2StaminaRecoverStaminaByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaRecoverStaminaByUserIdFetcher;
