...
{
    [CustomEditor(typeof(Gs2StaminaSetRecoverValueByUserIdFetcher))]
    public class Gs2StaminaSetRecoverValueByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaSetRecoverValueByUserIdFetcher;
