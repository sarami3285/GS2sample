...
{
    [CustomEditor(typeof(Gs2StaminaConsumeStaminaByUserIdFetcher))]
    public class Gs2StaminaConsumeStaminaByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaConsumeStaminaByUserIdFetcher;
