...
{
    [CustomEditor(typeof(Gs2StaminaDecreaseMaxValueByUserIdFetcher))]
    public class Gs2StaminaDecreaseMaxValueByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaDecreaseMaxValueByUserIdFetcher;
