...
{
    [CustomEditor(typeof(Gs2SkillTreeOwnStatusFetcher))]
    public class Gs2SkillTreeOwnStatusFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeOwnStatusFetcher;
