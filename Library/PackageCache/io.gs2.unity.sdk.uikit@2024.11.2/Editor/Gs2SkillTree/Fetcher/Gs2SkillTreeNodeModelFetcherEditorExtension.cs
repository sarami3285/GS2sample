...
{
    [CustomEditor(typeof(Gs2SkillTreeNodeModelFetcher))]
    public class Gs2SkillTreeNodeModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeNodeModelFetcher;
