...
namespace Gs2.Unity.UiKit.Gs2SkillTree.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2SkillTreeMarkRestrainByUserIdFetcher))]
    public class Gs2SkillTreeMarkRestrainByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeMarkRestrainByUserIdFetcher;
