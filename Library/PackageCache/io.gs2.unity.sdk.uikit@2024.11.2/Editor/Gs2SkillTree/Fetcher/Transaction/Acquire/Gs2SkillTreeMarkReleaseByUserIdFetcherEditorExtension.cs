...
{
    [CustomEditor(typeof(Gs2SkillTreeMarkReleaseByUserIdFetcher))]
    public class Gs2SkillTreeMarkReleaseByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeMarkReleaseByUserIdFetcher;
