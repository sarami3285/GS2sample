...
{
    [CustomEditor(typeof(Gs2SkillTreeNamespaceContext))]
    public class Gs2SkillTreeNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeNamespaceContext;
