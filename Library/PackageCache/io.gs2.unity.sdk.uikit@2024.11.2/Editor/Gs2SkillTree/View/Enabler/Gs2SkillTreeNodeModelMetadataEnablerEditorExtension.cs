...
namespace Gs2.Unity.UiKit.Gs2SkillTree.Enabler.Editor
{
    [CustomEditor(typeof(Gs2SkillTreeNodeModelMetadataEnabler))]
    public class Gs2SkillTreeNodeModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeNodeModelMetadataEnabler;
            ...
            if (original.expression == Gs2SkillTreeNodeModelMetadataEnabler.Expression.In || original.expression == Gs2SkillTreeNodeModelMetadataEnabler.Expression.NotIn) {
