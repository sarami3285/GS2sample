...
{
    [CustomEditor(typeof(Gs2SkillTreeMarkRestrainByUserIdEnabler))]
    public class Gs2SkillTreeMarkRestrainByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeMarkRestrainByUserIdEnabler;
