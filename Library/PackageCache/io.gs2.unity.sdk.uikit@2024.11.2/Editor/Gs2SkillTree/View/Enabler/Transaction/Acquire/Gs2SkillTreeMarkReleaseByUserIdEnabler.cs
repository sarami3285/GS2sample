...
{
    [CustomEditor(typeof(Gs2SkillTreeMarkReleaseByUserIdEnabler))]
    public class Gs2SkillTreeMarkReleaseByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeMarkReleaseByUserIdEnabler;
