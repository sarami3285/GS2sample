...
{
    [CustomEditor(typeof(Gs2SkillTreeNodeModelRestrainReturnRateEnabler))]
    public class Gs2SkillTreeNodeModelRestrainReturnRateEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeNodeModelRestrainReturnRateEnabler;
            ...
            if (original.expression == Gs2SkillTreeNodeModelRestrainReturnRateEnabler.Expression.In || original.expression == Gs2SkillTreeNodeModelRestrainReturnRateEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRestrainReturnRates"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRestrainReturnRate"), true);
            }
