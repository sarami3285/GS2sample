...
{
    [CustomEditor(typeof(Gs2SkillTreeNodeModelNameEnabler))]
    public class Gs2SkillTreeNodeModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeNodeModelNameEnabler;
            ...
            if (original.expression == Gs2SkillTreeNodeModelNameEnabler.Expression.In || original.expression == Gs2SkillTreeNodeModelNameEnabler.Expression.NotIn) {
