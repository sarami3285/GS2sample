...
{
    [CustomEditor(typeof(Gs2SkillTreeOwnStatusUserIdEnabler))]
    public class Gs2SkillTreeOwnStatusUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeOwnStatusUserIdEnabler;
            ...
            if (original.expression == Gs2SkillTreeOwnStatusUserIdEnabler.Expression.In || original.expression == Gs2SkillTreeOwnStatusUserIdEnabler.Expression.NotIn) {
