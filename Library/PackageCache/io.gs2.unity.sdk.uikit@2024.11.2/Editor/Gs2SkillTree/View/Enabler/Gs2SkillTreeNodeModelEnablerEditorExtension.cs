...
{
    [CustomEditor(typeof(Gs2SkillTreeNodeModelEnabler))]
    public class Gs2SkillTreeNodeModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeNodeModelEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("NodeModelFetcher not assigned.", MessageType.Error);
