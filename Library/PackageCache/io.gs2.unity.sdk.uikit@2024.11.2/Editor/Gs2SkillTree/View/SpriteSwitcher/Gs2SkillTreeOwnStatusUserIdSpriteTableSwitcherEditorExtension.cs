...
{
    [CustomEditor(typeof(Gs2SkillTreeOwnStatusUserIdSpriteTableSwitcher))]
    public class Gs2SkillTreeOwnStatusUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeOwnStatusUserIdSpriteTableSwitcher;
