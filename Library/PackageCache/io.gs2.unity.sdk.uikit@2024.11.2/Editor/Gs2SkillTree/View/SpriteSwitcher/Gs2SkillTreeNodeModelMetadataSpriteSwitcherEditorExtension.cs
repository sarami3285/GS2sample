...
{
    [CustomEditor(typeof(Gs2SkillTreeNodeModelMetadataSpriteSwitcher))]
    public class Gs2SkillTreeNodeModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeNodeModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2SkillTreeNodeModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2SkillTreeNodeModelMetadataSpriteSwitcher.Expression.NotIn) {
