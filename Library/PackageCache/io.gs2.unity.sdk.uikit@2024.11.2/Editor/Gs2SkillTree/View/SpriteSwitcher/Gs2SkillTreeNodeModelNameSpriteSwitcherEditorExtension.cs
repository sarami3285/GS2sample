...
{
    [CustomEditor(typeof(Gs2SkillTreeNodeModelNameSpriteSwitcher))]
    public class Gs2SkillTreeNodeModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeNodeModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2SkillTreeNodeModelNameSpriteSwitcher.Expression.In || original.expression == Gs2SkillTreeNodeModelNameSpriteSwitcher.Expression.NotIn) {
