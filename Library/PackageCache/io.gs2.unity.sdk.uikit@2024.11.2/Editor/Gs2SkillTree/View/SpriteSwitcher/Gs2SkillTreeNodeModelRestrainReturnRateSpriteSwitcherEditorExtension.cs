...
{
    [CustomEditor(typeof(Gs2SkillTreeNodeModelRestrainReturnRateSpriteSwitcher))]
    public class Gs2SkillTreeNodeModelRestrainReturnRateSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeNodeModelRestrainReturnRateSpriteSwitcher;
            ...
            if (original.expression == Gs2SkillTreeNodeModelRestrainReturnRateSpriteSwitcher.Expression.In || original.expression == Gs2SkillTreeNodeModelRestrainReturnRateSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRestrainReturnRates"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRestrainReturnRate"), true);
            }
