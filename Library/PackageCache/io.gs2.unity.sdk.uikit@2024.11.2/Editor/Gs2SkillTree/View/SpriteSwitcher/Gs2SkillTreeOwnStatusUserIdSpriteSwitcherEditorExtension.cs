...
{
    [CustomEditor(typeof(Gs2SkillTreeOwnStatusUserIdSpriteSwitcher))]
    public class Gs2SkillTreeOwnStatusUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeOwnStatusUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2SkillTreeOwnStatusUserIdSpriteSwitcher.Expression.In || original.expression == Gs2SkillTreeOwnStatusUserIdSpriteSwitcher.Expression.NotIn) {
