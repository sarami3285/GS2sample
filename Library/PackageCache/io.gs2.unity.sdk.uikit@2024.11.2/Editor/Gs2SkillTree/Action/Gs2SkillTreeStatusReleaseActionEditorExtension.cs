...
{
    [CustomEditor(typeof(Gs2SkillTreeStatusReleaseAction))]
    public class Gs2SkillTreeStatusReleaseActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeStatusReleaseAction;
