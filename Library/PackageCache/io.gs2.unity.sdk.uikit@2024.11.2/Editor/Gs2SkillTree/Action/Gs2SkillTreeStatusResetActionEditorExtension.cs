...
{
    [CustomEditor(typeof(Gs2SkillTreeStatusResetAction))]
    public class Gs2SkillTreeStatusResetActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SkillTreeStatusResetAction;
