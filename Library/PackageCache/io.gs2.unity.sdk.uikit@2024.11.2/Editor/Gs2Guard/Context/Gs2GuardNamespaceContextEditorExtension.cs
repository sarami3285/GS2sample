...
using Gs2.Unity.UiKit.Gs2Guard.Context;
using UnityEditor;
using UnityEngine;

namespace Gs2.Unity.UiKit.Gs2Guard.Editor
{
    [CustomEditor(typeof(Gs2GuardNamespaceContext))]
    public class Gs2GuardNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GuardNamespaceContext;
