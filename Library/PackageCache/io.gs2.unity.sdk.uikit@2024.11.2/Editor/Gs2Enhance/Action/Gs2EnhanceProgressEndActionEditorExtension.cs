...
{
    [CustomEditor(typeof(Gs2EnhanceProgressEndAction))]
    public class Gs2EnhanceProgressEndActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressEndAction;
