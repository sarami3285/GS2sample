...
{
    [CustomEditor(typeof(Gs2EnhanceProgressDeleteProgressAction))]
    public class Gs2EnhanceProgressDeleteProgressActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressDeleteProgressAction;
