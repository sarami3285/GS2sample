...
{
    [CustomEditor(typeof(Gs2EnhanceRateModelAcquireExperienceSuffixSpriteSwitcher))]
    public class Gs2EnhanceRateModelAcquireExperienceSuffixSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceRateModelAcquireExperienceSuffixSpriteSwitcher;
            ...
            if (original.expression == Gs2EnhanceRateModelAcquireExperienceSuffixSpriteSwitcher.Expression.In || original.expression == Gs2EnhanceRateModelAcquireExperienceSuffixSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyAcquireExperienceSuffixes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyAcquireExperienceSuffix"), true);
            }
