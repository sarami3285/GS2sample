...
{
    [CustomEditor(typeof(Gs2EnhanceRateModelMetadataSpriteTableSwitcher))]
    public class Gs2EnhanceRateModelMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceRateModelMetadataSpriteTableSwitcher;
