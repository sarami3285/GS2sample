...
{
    [CustomEditor(typeof(Gs2EnhanceRateModelMetadataSpriteSwitcher))]
    public class Gs2EnhanceRateModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceRateModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2EnhanceRateModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2EnhanceRateModelMetadataSpriteSwitcher.Expression.NotIn) {
