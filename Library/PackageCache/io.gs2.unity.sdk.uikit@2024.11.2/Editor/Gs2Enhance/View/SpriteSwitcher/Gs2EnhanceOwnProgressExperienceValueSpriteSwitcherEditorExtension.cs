...
{
    [CustomEditor(typeof(Gs2EnhanceOwnProgressExperienceValueSpriteSwitcher))]
    public class Gs2EnhanceOwnProgressExperienceValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceOwnProgressExperienceValueSpriteSwitcher;
            ...
            if (original.expression == Gs2EnhanceOwnProgressExperienceValueSpriteSwitcher.Expression.In || original.expression == Gs2EnhanceOwnProgressExperienceValueSpriteSwitcher.Expression.NotIn) {
