...
{
    [CustomEditor(typeof(Gs2EnhanceOwnProgressPropertyIdSpriteSwitcher))]
    public class Gs2EnhanceOwnProgressPropertyIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceOwnProgressPropertyIdSpriteSwitcher;
            ...
            if (original.expression == Gs2EnhanceOwnProgressPropertyIdSpriteSwitcher.Expression.In || original.expression == Gs2EnhanceOwnProgressPropertyIdSpriteSwitcher.Expression.NotIn) {
