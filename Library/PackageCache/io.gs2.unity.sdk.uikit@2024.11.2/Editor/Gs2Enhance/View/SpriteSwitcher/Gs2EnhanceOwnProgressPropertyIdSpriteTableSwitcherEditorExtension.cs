...
{
    [CustomEditor(typeof(Gs2EnhanceOwnProgressPropertyIdSpriteTableSwitcher))]
    public class Gs2EnhanceOwnProgressPropertyIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceOwnProgressPropertyIdSpriteTableSwitcher;
