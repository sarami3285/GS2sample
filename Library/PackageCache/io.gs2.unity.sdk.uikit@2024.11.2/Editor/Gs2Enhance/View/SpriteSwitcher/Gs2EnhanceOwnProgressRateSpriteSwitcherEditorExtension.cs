...
{
    [CustomEditor(typeof(Gs2EnhanceOwnProgressRateSpriteSwitcher))]
    public class Gs2EnhanceOwnProgressRateSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceOwnProgressRateSpriteSwitcher;
            ...
            if (original.expression == Gs2EnhanceOwnProgressRateSpriteSwitcher.Expression.In || original.expression == Gs2EnhanceOwnProgressRateSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRates"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRate"), true);
            }
