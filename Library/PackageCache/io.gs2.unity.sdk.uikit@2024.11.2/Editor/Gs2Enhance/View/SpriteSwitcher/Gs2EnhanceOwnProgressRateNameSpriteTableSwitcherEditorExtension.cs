...
{
    [CustomEditor(typeof(Gs2EnhanceOwnProgressRateNameSpriteTableSwitcher))]
    public class Gs2EnhanceOwnProgressRateNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceOwnProgressRateNameSpriteTableSwitcher;
