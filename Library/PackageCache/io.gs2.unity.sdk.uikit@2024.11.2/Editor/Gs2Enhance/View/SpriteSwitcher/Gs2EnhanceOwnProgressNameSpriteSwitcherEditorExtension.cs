...
{
    [CustomEditor(typeof(Gs2EnhanceOwnProgressNameSpriteSwitcher))]
    public class Gs2EnhanceOwnProgressNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceOwnProgressNameSpriteSwitcher;
            ...
            if (original.expression == Gs2EnhanceOwnProgressNameSpriteSwitcher.Expression.In || original.expression == Gs2EnhanceOwnProgressNameSpriteSwitcher.Expression.NotIn) {
