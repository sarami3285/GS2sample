...
{
    [CustomEditor(typeof(Gs2EnhanceOwnProgressNameSpriteTableSwitcher))]
    public class Gs2EnhanceOwnProgressNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceOwnProgressNameSpriteTableSwitcher;
