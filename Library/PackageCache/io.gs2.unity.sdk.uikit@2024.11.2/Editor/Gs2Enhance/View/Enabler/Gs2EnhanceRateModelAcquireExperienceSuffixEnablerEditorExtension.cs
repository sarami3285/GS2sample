...
{
    [CustomEditor(typeof(Gs2EnhanceRateModelAcquireExperienceSuffixEnabler))]
    public class Gs2EnhanceRateModelAcquireExperienceSuffixEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceRateModelAcquireExperienceSuffixEnabler;
            ...
            if (original.expression == Gs2EnhanceRateModelAcquireExperienceSuffixEnabler.Expression.In || original.expression == Gs2EnhanceRateModelAcquireExperienceSuffixEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableAcquireExperienceSuffixes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableAcquireExperienceSuffix"), true);
            }
