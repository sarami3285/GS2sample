...
{
    [CustomEditor(typeof(Gs2EnhanceOwnProgressNameEnabler))]
    public class Gs2EnhanceOwnProgressNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceOwnProgressNameEnabler;
            ...
            if (original.expression == Gs2EnhanceOwnProgressNameEnabler.Expression.In || original.expression == Gs2EnhanceOwnProgressNameEnabler.Expression.NotIn) {
