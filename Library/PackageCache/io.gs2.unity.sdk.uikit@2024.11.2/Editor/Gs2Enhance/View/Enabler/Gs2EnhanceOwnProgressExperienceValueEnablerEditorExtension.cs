...
{
    [CustomEditor(typeof(Gs2EnhanceOwnProgressExperienceValueEnabler))]
    public class Gs2EnhanceOwnProgressExperienceValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceOwnProgressExperienceValueEnabler;
            ...
            if (original.expression == Gs2EnhanceOwnProgressExperienceValueEnabler.Expression.In || original.expression == Gs2EnhanceOwnProgressExperienceValueEnabler.Expression.NotIn) {
