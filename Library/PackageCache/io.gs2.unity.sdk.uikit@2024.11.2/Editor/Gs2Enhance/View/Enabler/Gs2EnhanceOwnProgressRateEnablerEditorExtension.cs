...
{
    [CustomEditor(typeof(Gs2EnhanceOwnProgressRateEnabler))]
    public class Gs2EnhanceOwnProgressRateEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceOwnProgressRateEnabler;
            ...
            if (original.expression == Gs2EnhanceOwnProgressRateEnabler.Expression.In || original.expression == Gs2EnhanceOwnProgressRateEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRates"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRate"), true);
            }
