...
{
    [CustomEditor(typeof(Gs2EnhanceOwnProgressRateNameEnabler))]
    public class Gs2EnhanceOwnProgressRateNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceOwnProgressRateNameEnabler;
            ...
            if (original.expression == Gs2EnhanceOwnProgressRateNameEnabler.Expression.In || original.expression == Gs2EnhanceOwnProgressRateNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRateNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRateName"), true);
            }
