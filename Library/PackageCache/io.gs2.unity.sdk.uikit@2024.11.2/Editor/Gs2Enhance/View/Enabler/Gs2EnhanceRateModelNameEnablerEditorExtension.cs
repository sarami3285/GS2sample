...
{
    [CustomEditor(typeof(Gs2EnhanceRateModelNameEnabler))]
    public class Gs2EnhanceRateModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceRateModelNameEnabler;
            ...
            if (original.expression == Gs2EnhanceRateModelNameEnabler.Expression.In || original.expression == Gs2EnhanceRateModelNameEnabler.Expression.NotIn) {
