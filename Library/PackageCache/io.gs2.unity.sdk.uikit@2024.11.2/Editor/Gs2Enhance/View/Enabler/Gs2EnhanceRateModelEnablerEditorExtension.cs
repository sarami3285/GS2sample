...
{
    [CustomEditor(typeof(Gs2EnhanceRateModelEnabler))]
    public class Gs2EnhanceRateModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceRateModelEnabler;
