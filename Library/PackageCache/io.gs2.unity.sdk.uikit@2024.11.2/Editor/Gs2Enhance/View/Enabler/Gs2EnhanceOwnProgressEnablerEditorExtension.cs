...
{
    [CustomEditor(typeof(Gs2EnhanceOwnProgressEnabler))]
    public class Gs2EnhanceOwnProgressEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceOwnProgressEnabler;
