...
{
    [CustomEditor(typeof(Gs2EnhanceCreateProgressByUserIdEnabler))]
    public class Gs2EnhanceCreateProgressByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceCreateProgressByUserIdEnabler;
