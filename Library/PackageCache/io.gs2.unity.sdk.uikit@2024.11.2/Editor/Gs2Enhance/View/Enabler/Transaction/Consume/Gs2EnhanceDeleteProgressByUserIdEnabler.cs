...
{
    [CustomEditor(typeof(Gs2EnhanceDeleteProgressByUserIdEnabler))]
    public class Gs2EnhanceDeleteProgressByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceDeleteProgressByUserIdEnabler;
