...
{
    [CustomEditor(typeof(Gs2EnhanceRateModelFetcher))]
    public class Gs2EnhanceRateModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceRateModelFetcher;
