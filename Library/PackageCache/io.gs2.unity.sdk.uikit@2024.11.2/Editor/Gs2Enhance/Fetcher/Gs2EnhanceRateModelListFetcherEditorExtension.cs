...
{
    [CustomEditor(typeof(Gs2EnhanceRateModelListFetcher))]
    public class Gs2EnhanceRateModelListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceRateModelListFetcher;
