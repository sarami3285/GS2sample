...
namespace Gs2.Unity.UiKit.Gs2Enhance.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2EnhanceCreateProgressByUserIdFetcher))]
    public class Gs2EnhanceCreateProgressByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceCreateProgressByUserIdFetcher;
