...
{
    [CustomEditor(typeof(Gs2EnhanceDeleteProgressByUserIdFetcher))]
    public class Gs2EnhanceDeleteProgressByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceDeleteProgressByUserIdFetcher;
