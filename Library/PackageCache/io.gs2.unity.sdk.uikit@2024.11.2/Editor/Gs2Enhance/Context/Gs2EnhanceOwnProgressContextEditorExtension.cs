...
{
    [CustomEditor(typeof(Gs2EnhanceOwnProgressContext))]
    public class Gs2EnhanceOwnProgressContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceOwnProgressContext;
