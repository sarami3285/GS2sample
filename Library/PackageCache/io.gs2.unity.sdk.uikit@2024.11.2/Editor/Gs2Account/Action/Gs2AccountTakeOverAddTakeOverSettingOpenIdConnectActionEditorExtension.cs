...
{
    [CustomEditor(typeof(Gs2AccountTakeOverAddTakeOverSettingOpenIdConnectAction))]
    public class Gs2AccountTakeOverAddTakeOverSettingOpenIdConnectActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountTakeOverAddTakeOverSettingOpenIdConnectAction;
