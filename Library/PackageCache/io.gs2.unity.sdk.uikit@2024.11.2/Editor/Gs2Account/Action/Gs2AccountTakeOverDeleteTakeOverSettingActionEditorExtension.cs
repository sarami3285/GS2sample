...
{
    [CustomEditor(typeof(Gs2AccountTakeOverDeleteTakeOverSettingAction))]
    public class Gs2AccountTakeOverDeleteTakeOverSettingActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountTakeOverDeleteTakeOverSettingAction;
