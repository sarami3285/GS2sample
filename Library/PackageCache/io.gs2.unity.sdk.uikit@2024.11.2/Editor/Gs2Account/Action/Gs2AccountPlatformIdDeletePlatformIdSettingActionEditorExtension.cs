...
{
    [CustomEditor(typeof(Gs2AccountPlatformIdDeletePlatformIdSettingAction))]
    public class Gs2AccountPlatformIdDeletePlatformIdSettingActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountPlatformIdDeletePlatformIdSettingAction;
            ...
            if (context == null) {
                ...
                if (context.transform.GetComponentInParent<Gs2AccountOwnPlatformIdList>(true) != null) {
                    ...
                    context.PlatformId = EditorGUILayout.ObjectField("OwnPlatformId", context.PlatformId, typeof(OwnPlatformId), false) as OwnPlatformId;
