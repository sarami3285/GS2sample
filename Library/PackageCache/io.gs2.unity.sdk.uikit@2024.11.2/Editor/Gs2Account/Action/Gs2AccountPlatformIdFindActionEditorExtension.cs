...
{
    [CustomEditor(typeof(Gs2AccountPlatformIdFindAction))]
    public class Gs2AccountPlatformIdFindActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountPlatformIdFindAction;
