...
{
    [CustomEditor(typeof(Gs2AccountOwnPlatformIdListFetcher))]
    public class Gs2AccountOwnPlatformIdListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnPlatformIdListFetcher;
