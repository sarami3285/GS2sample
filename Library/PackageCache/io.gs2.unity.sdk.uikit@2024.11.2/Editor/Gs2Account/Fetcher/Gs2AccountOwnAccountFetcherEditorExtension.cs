...
{
    [CustomEditor(typeof(Gs2AccountOwnAccountFetcher))]
    public class Gs2AccountOwnAccountFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnAccountFetcher;
