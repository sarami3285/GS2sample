...
{
    [CustomEditor(typeof(Gs2AccountOwnDataOwnerContext))]
    public class Gs2AccountOwnDataOwnerContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnDataOwnerContext;
