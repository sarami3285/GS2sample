...
{
    [CustomEditor(typeof(Gs2AccountNamespaceContext))]
    public class Gs2AccountNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountNamespaceContext;
