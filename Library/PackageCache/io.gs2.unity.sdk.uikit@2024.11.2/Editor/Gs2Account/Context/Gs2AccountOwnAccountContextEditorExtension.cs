...
{
    [CustomEditor(typeof(Gs2AccountOwnAccountContext))]
    public class Gs2AccountOwnAccountContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnAccountContext;
