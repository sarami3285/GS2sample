    ...
    public class Gs2AccountTakeOverDoTakeOverActionLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            ...
            if (original.action == null) {
                EditorGUILayout.HelpBox("Gs2AccountTakeOverDoTakeOverAction not found.", MessageType.Error);
                if (GUILayout.Button("Add Context")) {
                    original.gameObject.AddComponent<Gs2AccountTakeOverDoTakeOverAction>();
                }
                return;
            }
