...
{
    [CustomEditor(typeof(Gs2AccountOwnPlatformIdLabel))]
    public class Gs2AccountOwnPlatformIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnPlatformIdLabel;
            ...
            if (fetcher == null) {
                ...
                if (fetcher.gameObject.GetComponentInParent<Gs2AccountOwnPlatformIdList>(true) != null) {
                    ...
                    if (fetcher.Context != null) {
                        EditorGUILayout.ObjectField("PlatformId", fetcher.Context.PlatformId, typeof(OwnPlatformId), false);
                        EditorGUI.indentLevel++;
                        EditorGUILayout.TextField("NamespaceName", fetcher.Context.PlatformId?.NamespaceName?.ToString());
                        EditorGUILayout.TextField("Type", fetcher.Context.PlatformId?.Type.ToString());
                        EditorGUILayout.TextField("UserIdentifier", fetcher.Context.PlatformId?.UserIdentifier?.ToString());
                        EditorGUI.indentLevel--;
                    }
                    EditorGUI.indentLevel--;
                    EditorGUI.EndDisabledGroup();
