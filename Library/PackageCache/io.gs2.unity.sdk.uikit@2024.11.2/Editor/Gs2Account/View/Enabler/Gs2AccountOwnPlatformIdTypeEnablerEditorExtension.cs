...
{
    [CustomEditor(typeof(Gs2AccountOwnPlatformIdTypeEnabler))]
    public class Gs2AccountOwnPlatformIdTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnPlatformIdTypeEnabler;
            ...
            if (original.expression == Gs2AccountOwnPlatformIdTypeEnabler.Expression.In || original.expression == Gs2AccountOwnPlatformIdTypeEnabler.Expression.NotIn) {
