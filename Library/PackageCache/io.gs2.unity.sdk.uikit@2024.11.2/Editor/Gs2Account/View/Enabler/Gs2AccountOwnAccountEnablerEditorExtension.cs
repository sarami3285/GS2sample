...
{
    [CustomEditor(typeof(Gs2AccountOwnAccountEnabler))]
    public class Gs2AccountOwnAccountEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnAccountEnabler;
