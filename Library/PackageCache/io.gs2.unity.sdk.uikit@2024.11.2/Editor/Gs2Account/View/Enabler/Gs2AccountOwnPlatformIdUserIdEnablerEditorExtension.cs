...
{
    [CustomEditor(typeof(Gs2AccountOwnPlatformIdUserIdEnabler))]
    public class Gs2AccountOwnPlatformIdUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnPlatformIdUserIdEnabler;
            ...
            if (original.expression == Gs2AccountOwnPlatformIdUserIdEnabler.Expression.In || original.expression == Gs2AccountOwnPlatformIdUserIdEnabler.Expression.NotIn) {
