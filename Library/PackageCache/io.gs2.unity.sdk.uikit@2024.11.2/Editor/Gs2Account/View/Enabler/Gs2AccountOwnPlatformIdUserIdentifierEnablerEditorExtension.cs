...
{
    [CustomEditor(typeof(Gs2AccountOwnPlatformIdUserIdentifierEnabler))]
    public class Gs2AccountOwnPlatformIdUserIdentifierEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnPlatformIdUserIdentifierEnabler;
            ...
            if (original.expression == Gs2AccountOwnPlatformIdUserIdentifierEnabler.Expression.In || original.expression == Gs2AccountOwnPlatformIdUserIdentifierEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableUserIdentifiers"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableUserIdentifier"), true);
            }
