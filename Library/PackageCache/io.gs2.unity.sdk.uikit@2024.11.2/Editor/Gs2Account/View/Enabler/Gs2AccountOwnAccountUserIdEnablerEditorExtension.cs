...
{
    [CustomEditor(typeof(Gs2AccountOwnAccountUserIdEnabler))]
    public class Gs2AccountOwnAccountUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnAccountUserIdEnabler;
            ...
            if (original.expression == Gs2AccountOwnAccountUserIdEnabler.Expression.In || original.expression == Gs2AccountOwnAccountUserIdEnabler.Expression.NotIn) {
