...
{
    [CustomEditor(typeof(Gs2AccountOwnTakeOverUserIdEnabler))]
    public class Gs2AccountOwnTakeOverUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnTakeOverUserIdEnabler;
            ...
            if (original.expression == Gs2AccountOwnTakeOverUserIdEnabler.Expression.In || original.expression == Gs2AccountOwnTakeOverUserIdEnabler.Expression.NotIn) {
