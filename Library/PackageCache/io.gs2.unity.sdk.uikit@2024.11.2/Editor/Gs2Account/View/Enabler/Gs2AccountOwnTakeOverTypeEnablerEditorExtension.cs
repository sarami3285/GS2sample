...
{
    [CustomEditor(typeof(Gs2AccountOwnTakeOverTypeEnabler))]
    public class Gs2AccountOwnTakeOverTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnTakeOverTypeEnabler;
            ...
            if (original.expression == Gs2AccountOwnTakeOverTypeEnabler.Expression.In || original.expression == Gs2AccountOwnTakeOverTypeEnabler.Expression.NotIn) {
