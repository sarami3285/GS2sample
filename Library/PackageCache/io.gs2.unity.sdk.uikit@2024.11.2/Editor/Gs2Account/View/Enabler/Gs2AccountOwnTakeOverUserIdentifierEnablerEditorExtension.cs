...
{
    [CustomEditor(typeof(Gs2AccountOwnTakeOverUserIdentifierEnabler))]
    public class Gs2AccountOwnTakeOverUserIdentifierEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnTakeOverUserIdentifierEnabler;
            ...
            if (original.expression == Gs2AccountOwnTakeOverUserIdentifierEnabler.Expression.In || original.expression == Gs2AccountOwnTakeOverUserIdentifierEnabler.Expression.NotIn) {
