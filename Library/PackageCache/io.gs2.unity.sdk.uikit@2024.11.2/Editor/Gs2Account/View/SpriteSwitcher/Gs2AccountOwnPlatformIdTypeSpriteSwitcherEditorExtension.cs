...
{
    [CustomEditor(typeof(Gs2AccountOwnPlatformIdTypeSpriteSwitcher))]
    public class Gs2AccountOwnPlatformIdTypeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnPlatformIdTypeSpriteSwitcher;
            ...
            if (original.expression == Gs2AccountOwnPlatformIdTypeSpriteSwitcher.Expression.In || original.expression == Gs2AccountOwnPlatformIdTypeSpriteSwitcher.Expression.NotIn) {
