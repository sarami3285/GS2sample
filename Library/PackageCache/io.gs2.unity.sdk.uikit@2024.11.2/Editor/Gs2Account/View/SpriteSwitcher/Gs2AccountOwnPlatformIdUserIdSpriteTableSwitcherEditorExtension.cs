...
{
    [CustomEditor(typeof(Gs2AccountOwnPlatformIdUserIdSpriteTableSwitcher))]
    public class Gs2AccountOwnPlatformIdUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnPlatformIdUserIdSpriteTableSwitcher;
