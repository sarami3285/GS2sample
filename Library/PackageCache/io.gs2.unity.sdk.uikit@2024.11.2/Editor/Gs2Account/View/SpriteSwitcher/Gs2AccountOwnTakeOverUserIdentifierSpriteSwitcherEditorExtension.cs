...
{
    [CustomEditor(typeof(Gs2AccountOwnTakeOverUserIdentifierSpriteSwitcher))]
    public class Gs2AccountOwnTakeOverUserIdentifierSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnTakeOverUserIdentifierSpriteSwitcher;
            ...
            if (original.expression == Gs2AccountOwnTakeOverUserIdentifierSpriteSwitcher.Expression.In || original.expression == Gs2AccountOwnTakeOverUserIdentifierSpriteSwitcher.Expression.NotIn) {
