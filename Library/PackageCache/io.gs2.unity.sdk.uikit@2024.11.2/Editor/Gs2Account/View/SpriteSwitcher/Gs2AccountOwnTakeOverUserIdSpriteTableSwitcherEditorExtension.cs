...
{
    [CustomEditor(typeof(Gs2AccountOwnTakeOverUserIdSpriteTableSwitcher))]
    public class Gs2AccountOwnTakeOverUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnTakeOverUserIdSpriteTableSwitcher;
