...
{
    [CustomEditor(typeof(Gs2AccountOwnPlatformIdUserIdentifierSpriteSwitcher))]
    public class Gs2AccountOwnPlatformIdUserIdentifierSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnPlatformIdUserIdentifierSpriteSwitcher;
            ...
            if (original.expression == Gs2AccountOwnPlatformIdUserIdentifierSpriteSwitcher.Expression.In || original.expression == Gs2AccountOwnPlatformIdUserIdentifierSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyUserIdentifiers"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyUserIdentifier"), true);
            }
