...
{
    [CustomEditor(typeof(Gs2AccountOwnTakeOverTypeSpriteSwitcher))]
    public class Gs2AccountOwnTakeOverTypeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnTakeOverTypeSpriteSwitcher;
            ...
            if (original.expression == Gs2AccountOwnTakeOverTypeSpriteSwitcher.Expression.In || original.expression == Gs2AccountOwnTakeOverTypeSpriteSwitcher.Expression.NotIn) {
