...
{
    [CustomEditor(typeof(Gs2AccountOwnAccountPasswordSpriteSwitcher))]
    public class Gs2AccountOwnAccountPasswordSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnAccountPasswordSpriteSwitcher;
            ...
            if (original.expression == Gs2AccountOwnAccountPasswordSpriteSwitcher.Expression.In || original.expression == Gs2AccountOwnAccountPasswordSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyPasswords"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyPassword"), true);
            }
