...
{
    [CustomEditor(typeof(Gs2AccountOwnTakeOverUserIdSpriteSwitcher))]
    public class Gs2AccountOwnTakeOverUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnTakeOverUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2AccountOwnTakeOverUserIdSpriteSwitcher.Expression.In || original.expression == Gs2AccountOwnTakeOverUserIdSpriteSwitcher.Expression.NotIn) {
