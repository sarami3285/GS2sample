...
{
    [CustomEditor(typeof(Gs2AccountOwnAccountUserIdSpriteTableSwitcher))]
    public class Gs2AccountOwnAccountUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnAccountUserIdSpriteTableSwitcher;
