...
{
    [CustomEditor(typeof(Gs2AccountOwnAccountPasswordSpriteTableSwitcher))]
    public class Gs2AccountOwnAccountPasswordSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountOwnAccountPasswordSpriteTableSwitcher;
