...
{
    [CustomEditor(typeof(Gs2MissionCompleteBatchReceiveRewardsAction))]
    public class Gs2MissionCompleteBatchReceiveRewardsActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionCompleteBatchReceiveRewardsAction;
            ...
            if (context == null) {
                ...
                if (context.transform.GetComponentInParent<Gs2MissionOwnCompleteList>(true) != null) {
