...
{
    [CustomEditor(typeof(Gs2MissionMissionGroupModelResetDayOfMonthSpriteSwitcher))]
    public class Gs2MissionMissionGroupModelResetDayOfMonthSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionGroupModelResetDayOfMonthSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionMissionGroupModelResetDayOfMonthSpriteSwitcher.Expression.In || original.expression == Gs2MissionMissionGroupModelResetDayOfMonthSpriteSwitcher.Expression.NotIn) {
