...
{
    [CustomEditor(typeof(Gs2MissionMissionGroupModelResetTypeSpriteSwitcher))]
    public class Gs2MissionMissionGroupModelResetTypeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionGroupModelResetTypeSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionMissionGroupModelResetTypeSpriteSwitcher.Expression.In || original.expression == Gs2MissionMissionGroupModelResetTypeSpriteSwitcher.Expression.NotIn) {
