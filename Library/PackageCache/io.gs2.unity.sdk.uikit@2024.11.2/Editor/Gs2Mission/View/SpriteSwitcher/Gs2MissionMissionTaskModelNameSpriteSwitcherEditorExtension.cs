...
{
    [CustomEditor(typeof(Gs2MissionMissionTaskModelNameSpriteSwitcher))]
    public class Gs2MissionMissionTaskModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionTaskModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionMissionTaskModelNameSpriteSwitcher.Expression.In || original.expression == Gs2MissionMissionTaskModelNameSpriteSwitcher.Expression.NotIn) {
