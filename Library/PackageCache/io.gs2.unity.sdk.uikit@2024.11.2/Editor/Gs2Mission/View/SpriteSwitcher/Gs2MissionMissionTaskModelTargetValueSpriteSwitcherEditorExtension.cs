...
{
    [CustomEditor(typeof(Gs2MissionMissionTaskModelTargetValueSpriteSwitcher))]
    public class Gs2MissionMissionTaskModelTargetValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionTaskModelTargetValueSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionMissionTaskModelTargetValueSpriteSwitcher.Expression.In || original.expression == Gs2MissionMissionTaskModelTargetValueSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTargetValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTargetValue"), true);
            }
