...
{
    [CustomEditor(typeof(Gs2MissionOwnCounterNameSpriteSwitcher))]
    public class Gs2MissionOwnCounterNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionOwnCounterNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionOwnCounterNameSpriteSwitcher.Expression.In || original.expression == Gs2MissionOwnCounterNameSpriteSwitcher.Expression.NotIn) {
