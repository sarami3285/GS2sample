...
{
    [CustomEditor(typeof(Gs2MissionMissionGroupModelResetDayOfWeekSpriteSwitcher))]
    public class Gs2MissionMissionGroupModelResetDayOfWeekSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionGroupModelResetDayOfWeekSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionMissionGroupModelResetDayOfWeekSpriteSwitcher.Expression.In || original.expression == Gs2MissionMissionGroupModelResetDayOfWeekSpriteSwitcher.Expression.NotIn) {
