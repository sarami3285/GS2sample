...
{
    [CustomEditor(typeof(Gs2MissionMissionGroupModelNameSpriteSwitcher))]
    public class Gs2MissionMissionGroupModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionGroupModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionMissionGroupModelNameSpriteSwitcher.Expression.In || original.expression == Gs2MissionMissionGroupModelNameSpriteSwitcher.Expression.NotIn) {
