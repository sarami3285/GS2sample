...
{
    [CustomEditor(typeof(Gs2MissionMissionTaskModelPremiseMissionTaskNameSpriteSwitcher))]
    public class Gs2MissionMissionTaskModelPremiseMissionTaskNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionTaskModelPremiseMissionTaskNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionMissionTaskModelPremiseMissionTaskNameSpriteSwitcher.Expression.In || original.expression == Gs2MissionMissionTaskModelPremiseMissionTaskNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyPremiseMissionTaskNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyPremiseMissionTaskName"), true);
            }
