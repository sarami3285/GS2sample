...
{
    [CustomEditor(typeof(Gs2MissionOwnCompleteMissionGroupNameSpriteSwitcher))]
    public class Gs2MissionOwnCompleteMissionGroupNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionOwnCompleteMissionGroupNameSpriteSwitcher;
            ...
            if (context == null) {
                ...
                if (context.gameObject.GetComponentInParent<Gs2MissionOwnCompleteList>(true) != null) {
            ...
            if (original.expression == Gs2MissionOwnCompleteMissionGroupNameSpriteSwitcher.Expression.In || original.expression == Gs2MissionOwnCompleteMissionGroupNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMissionGroupNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMissionGroupName"), true);
            }
