...
{
    [CustomEditor(typeof(Gs2MissionMissionTaskModelVerifyCompleteTypeSpriteTableSwitcher))]
    public class Gs2MissionMissionTaskModelVerifyCompleteTypeSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionTaskModelVerifyCompleteTypeSpriteTableSwitcher;
