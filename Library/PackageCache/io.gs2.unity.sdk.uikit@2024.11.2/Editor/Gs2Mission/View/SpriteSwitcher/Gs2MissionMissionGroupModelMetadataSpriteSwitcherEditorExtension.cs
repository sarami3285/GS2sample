...
{
    [CustomEditor(typeof(Gs2MissionMissionGroupModelMetadataSpriteSwitcher))]
    public class Gs2MissionMissionGroupModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionGroupModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionMissionGroupModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2MissionMissionGroupModelMetadataSpriteSwitcher.Expression.NotIn) {
