...
{
    [CustomEditor(typeof(Gs2MissionCounterModelNameSpriteSwitcher))]
    public class Gs2MissionCounterModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionCounterModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionCounterModelNameSpriteSwitcher.Expression.In || original.expression == Gs2MissionCounterModelNameSpriteSwitcher.Expression.NotIn) {
