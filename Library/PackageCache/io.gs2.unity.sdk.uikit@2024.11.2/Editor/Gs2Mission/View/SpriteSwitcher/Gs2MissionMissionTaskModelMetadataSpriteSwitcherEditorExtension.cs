...
{
    [CustomEditor(typeof(Gs2MissionMissionTaskModelMetadataSpriteSwitcher))]
    public class Gs2MissionMissionTaskModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionTaskModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionMissionTaskModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2MissionMissionTaskModelMetadataSpriteSwitcher.Expression.NotIn) {
