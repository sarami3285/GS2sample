...
{
    [CustomEditor(typeof(Gs2MissionMissionTaskModelMetadataSpriteTableSwitcher))]
    public class Gs2MissionMissionTaskModelMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionTaskModelMetadataSpriteTableSwitcher;
