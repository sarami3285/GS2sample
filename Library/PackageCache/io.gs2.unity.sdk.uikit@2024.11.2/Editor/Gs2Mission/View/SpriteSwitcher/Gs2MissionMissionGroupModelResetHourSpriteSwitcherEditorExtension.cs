...
{
    [CustomEditor(typeof(Gs2MissionMissionGroupModelResetHourSpriteSwitcher))]
    public class Gs2MissionMissionGroupModelResetHourSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionGroupModelResetHourSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionMissionGroupModelResetHourSpriteSwitcher.Expression.In || original.expression == Gs2MissionMissionGroupModelResetHourSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyResetHours"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyResetHour"), true);
            }
