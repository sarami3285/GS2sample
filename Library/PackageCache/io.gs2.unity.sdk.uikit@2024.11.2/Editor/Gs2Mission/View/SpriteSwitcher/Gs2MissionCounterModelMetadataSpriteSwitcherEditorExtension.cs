...
{
    [CustomEditor(typeof(Gs2MissionCounterModelMetadataSpriteSwitcher))]
    public class Gs2MissionCounterModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionCounterModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionCounterModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2MissionCounterModelMetadataSpriteSwitcher.Expression.NotIn) {
