...
{
    [CustomEditor(typeof(Gs2MissionMissionTaskModelCounterNameSpriteSwitcher))]
    public class Gs2MissionMissionTaskModelCounterNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionTaskModelCounterNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionMissionTaskModelCounterNameSpriteSwitcher.Expression.In || original.expression == Gs2MissionMissionTaskModelCounterNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCounterNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCounterName"), true);
            }
