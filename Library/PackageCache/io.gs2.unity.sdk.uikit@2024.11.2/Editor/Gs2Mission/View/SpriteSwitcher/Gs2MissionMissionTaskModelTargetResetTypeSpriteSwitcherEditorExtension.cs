...
{
    [CustomEditor(typeof(Gs2MissionMissionTaskModelTargetResetTypeSpriteSwitcher))]
    public class Gs2MissionMissionTaskModelTargetResetTypeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionTaskModelTargetResetTypeSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionMissionTaskModelTargetResetTypeSpriteSwitcher.Expression.In || original.expression == Gs2MissionMissionTaskModelTargetResetTypeSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTargetResetTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTargetResetType"), true);
            }
