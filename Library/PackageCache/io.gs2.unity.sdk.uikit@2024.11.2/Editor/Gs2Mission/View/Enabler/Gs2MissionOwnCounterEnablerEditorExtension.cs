...
{
    [CustomEditor(typeof(Gs2MissionOwnCounterEnabler))]
    public class Gs2MissionOwnCounterEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionOwnCounterEnabler;
