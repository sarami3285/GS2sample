...
{
    [CustomEditor(typeof(Gs2MissionMissionGroupModelResetTypeEnabler))]
    public class Gs2MissionMissionGroupModelResetTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionGroupModelResetTypeEnabler;
            ...
            if (original.expression == Gs2MissionMissionGroupModelResetTypeEnabler.Expression.In || original.expression == Gs2MissionMissionGroupModelResetTypeEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableResetTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableResetType"), true);
            }
