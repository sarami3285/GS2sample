...
{
    [CustomEditor(typeof(Gs2MissionMissionGroupModelResetDayOfMonthEnabler))]
    public class Gs2MissionMissionGroupModelResetDayOfMonthEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionGroupModelResetDayOfMonthEnabler;
            ...
            if (original.expression == Gs2MissionMissionGroupModelResetDayOfMonthEnabler.Expression.In || original.expression == Gs2MissionMissionGroupModelResetDayOfMonthEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableResetDayOfMonths"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableResetDayOfMonth"), true);
            }
