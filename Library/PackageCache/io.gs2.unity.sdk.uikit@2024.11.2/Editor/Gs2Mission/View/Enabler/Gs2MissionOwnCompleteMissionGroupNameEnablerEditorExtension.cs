...
{
    [CustomEditor(typeof(Gs2MissionOwnCompleteMissionGroupNameEnabler))]
    public class Gs2MissionOwnCompleteMissionGroupNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionOwnCompleteMissionGroupNameEnabler;
            ...
            if (original.expression == Gs2MissionOwnCompleteMissionGroupNameEnabler.Expression.In || original.expression == Gs2MissionOwnCompleteMissionGroupNameEnabler.Expression.NotIn) {
