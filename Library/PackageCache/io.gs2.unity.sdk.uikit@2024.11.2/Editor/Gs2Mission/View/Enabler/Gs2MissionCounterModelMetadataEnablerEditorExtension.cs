...
{
    [CustomEditor(typeof(Gs2MissionCounterModelMetadataEnabler))]
    public class Gs2MissionCounterModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionCounterModelMetadataEnabler;
            ...
            if (original.expression == Gs2MissionCounterModelMetadataEnabler.Expression.In || original.expression == Gs2MissionCounterModelMetadataEnabler.Expression.NotIn) {
