...
{
    [CustomEditor(typeof(Gs2MissionMissionTaskModelVerifyCompleteTypeEnabler))]
    public class Gs2MissionMissionTaskModelVerifyCompleteTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionTaskModelVerifyCompleteTypeEnabler;
            ...
            if (original.expression == Gs2MissionMissionTaskModelVerifyCompleteTypeEnabler.Expression.In || original.expression == Gs2MissionMissionTaskModelVerifyCompleteTypeEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableVerifyCompleteTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableVerifyCompleteType"), true);
            }
