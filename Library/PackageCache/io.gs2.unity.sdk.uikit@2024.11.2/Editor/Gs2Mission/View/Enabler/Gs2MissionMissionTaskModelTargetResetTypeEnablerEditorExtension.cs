...
{
    [CustomEditor(typeof(Gs2MissionMissionTaskModelTargetResetTypeEnabler))]
    public class Gs2MissionMissionTaskModelTargetResetTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionTaskModelTargetResetTypeEnabler;
            ...
            if (original.expression == Gs2MissionMissionTaskModelTargetResetTypeEnabler.Expression.In || original.expression == Gs2MissionMissionTaskModelTargetResetTypeEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTargetResetTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTargetResetType"), true);
            }
