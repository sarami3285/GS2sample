...
{
    [CustomEditor(typeof(Gs2MissionMissionGroupModelMetadataEnabler))]
    public class Gs2MissionMissionGroupModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionGroupModelMetadataEnabler;
            ...
            if (original.expression == Gs2MissionMissionGroupModelMetadataEnabler.Expression.In || original.expression == Gs2MissionMissionGroupModelMetadataEnabler.Expression.NotIn) {
