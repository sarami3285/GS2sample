...
{
    [CustomEditor(typeof(Gs2MissionMissionTaskModelNameEnabler))]
    public class Gs2MissionMissionTaskModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionTaskModelNameEnabler;
            ...
            if (original.expression == Gs2MissionMissionTaskModelNameEnabler.Expression.In || original.expression == Gs2MissionMissionTaskModelNameEnabler.Expression.NotIn) {
