...
{
    [CustomEditor(typeof(Gs2MissionMissionTaskModelTargetValueEnabler))]
    public class Gs2MissionMissionTaskModelTargetValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionTaskModelTargetValueEnabler;
            ...
            if (original.expression == Gs2MissionMissionTaskModelTargetValueEnabler.Expression.In || original.expression == Gs2MissionMissionTaskModelTargetValueEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTargetValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTargetValue"), true);
            }
