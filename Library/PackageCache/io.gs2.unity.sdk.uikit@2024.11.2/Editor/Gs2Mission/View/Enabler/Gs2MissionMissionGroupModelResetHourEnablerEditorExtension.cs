...
{
    [CustomEditor(typeof(Gs2MissionMissionGroupModelResetHourEnabler))]
    public class Gs2MissionMissionGroupModelResetHourEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionGroupModelResetHourEnabler;
            ...
            if (original.expression == Gs2MissionMissionGroupModelResetHourEnabler.Expression.In || original.expression == Gs2MissionMissionGroupModelResetHourEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableResetHours"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableResetHour"), true);
            }
