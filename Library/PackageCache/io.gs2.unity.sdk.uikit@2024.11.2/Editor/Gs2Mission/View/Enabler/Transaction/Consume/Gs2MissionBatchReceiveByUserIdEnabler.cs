...
{
    [CustomEditor(typeof(Gs2MissionBatchReceiveByUserIdEnabler))]
    public class Gs2MissionBatchReceiveByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionBatchReceiveByUserIdEnabler;
