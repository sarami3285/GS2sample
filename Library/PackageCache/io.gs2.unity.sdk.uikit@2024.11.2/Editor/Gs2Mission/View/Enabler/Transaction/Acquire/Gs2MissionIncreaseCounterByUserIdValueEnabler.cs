...
{
    [CustomEditor(typeof(Gs2MissionIncreaseCounterByUserIdValueEnabler))]
    public class Gs2MissionIncreaseCounterByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionIncreaseCounterByUserIdValueEnabler;
            ...
            if (original.expression == Gs2MissionIncreaseCounterByUserIdValueEnabler.Expression.In || original.expression == Gs2MissionIncreaseCounterByUserIdValueEnabler.Expression.NotIn) {
