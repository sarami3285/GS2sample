...
{
    [CustomEditor(typeof(Gs2MissionSetCounterByUserIdEnabler))]
    public class Gs2MissionSetCounterByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionSetCounterByUserIdEnabler;
