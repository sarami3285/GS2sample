...
{
    [CustomEditor(typeof(Gs2MissionReceiveByUserIdEnabler))]
    public class Gs2MissionReceiveByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionReceiveByUserIdEnabler;
