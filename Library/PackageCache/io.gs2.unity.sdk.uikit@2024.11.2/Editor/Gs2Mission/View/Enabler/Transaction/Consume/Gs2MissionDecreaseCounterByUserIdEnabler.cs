...
{
    [CustomEditor(typeof(Gs2MissionDecreaseCounterByUserIdEnabler))]
    public class Gs2MissionDecreaseCounterByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionDecreaseCounterByUserIdEnabler;
