...
{
    [CustomEditor(typeof(Gs2MissionVerifyCounterValueByUserIdEnabler))]
    public class Gs2MissionVerifyCounterValueByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionVerifyCounterValueByUserIdEnabler;
