...
{
    [CustomEditor(typeof(Gs2MissionRevertReceiveByUserIdEnabler))]
    public class Gs2MissionRevertReceiveByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionRevertReceiveByUserIdEnabler;
