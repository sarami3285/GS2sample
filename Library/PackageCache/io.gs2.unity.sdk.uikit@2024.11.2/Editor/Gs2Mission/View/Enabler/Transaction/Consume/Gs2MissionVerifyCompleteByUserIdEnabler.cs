...
{
    [CustomEditor(typeof(Gs2MissionVerifyCompleteByUserIdEnabler))]
    public class Gs2MissionVerifyCompleteByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionVerifyCompleteByUserIdEnabler;
