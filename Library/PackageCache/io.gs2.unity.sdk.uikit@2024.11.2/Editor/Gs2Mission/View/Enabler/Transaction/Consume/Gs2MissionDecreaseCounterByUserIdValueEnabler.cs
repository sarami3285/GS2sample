...
{
    [CustomEditor(typeof(Gs2MissionDecreaseCounterByUserIdValueEnabler))]
    public class Gs2MissionDecreaseCounterByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionDecreaseCounterByUserIdValueEnabler;
            ...
            if (original.expression == Gs2MissionDecreaseCounterByUserIdValueEnabler.Expression.In || original.expression == Gs2MissionDecreaseCounterByUserIdValueEnabler.Expression.NotIn) {
