...
{
    [CustomEditor(typeof(Gs2MissionMissionGroupModelNameEnabler))]
    public class Gs2MissionMissionGroupModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionGroupModelNameEnabler;
            ...
            if (original.expression == Gs2MissionMissionGroupModelNameEnabler.Expression.In || original.expression == Gs2MissionMissionGroupModelNameEnabler.Expression.NotIn) {
