...
{
    [CustomEditor(typeof(Gs2MissionMissionTaskModelPremiseMissionTaskNameEnabler))]
    public class Gs2MissionMissionTaskModelPremiseMissionTaskNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionMissionTaskModelPremiseMissionTaskNameEnabler;
            ...
            if (original.expression == Gs2MissionMissionTaskModelPremiseMissionTaskNameEnabler.Expression.In || original.expression == Gs2MissionMissionTaskModelPremiseMissionTaskNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enablePremiseMissionTaskNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enablePremiseMissionTaskName"), true);
            }
