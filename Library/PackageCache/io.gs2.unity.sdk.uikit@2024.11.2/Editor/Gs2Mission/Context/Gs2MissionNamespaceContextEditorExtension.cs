...
{
    [CustomEditor(typeof(Gs2MissionNamespaceContext))]
    public class Gs2MissionNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionNamespaceContext;
