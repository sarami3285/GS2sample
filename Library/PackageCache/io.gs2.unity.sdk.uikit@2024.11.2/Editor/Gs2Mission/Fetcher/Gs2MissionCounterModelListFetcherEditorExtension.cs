...
{
    [CustomEditor(typeof(Gs2MissionCounterModelListFetcher))]
    public class Gs2MissionCounterModelListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionCounterModelListFetcher;
