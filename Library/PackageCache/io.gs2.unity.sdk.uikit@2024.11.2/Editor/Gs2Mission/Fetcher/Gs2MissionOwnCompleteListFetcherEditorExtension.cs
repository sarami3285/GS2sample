...
{
    [CustomEditor(typeof(Gs2MissionOwnCompleteListFetcher))]
    public class Gs2MissionOwnCompleteListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionOwnCompleteListFetcher;
