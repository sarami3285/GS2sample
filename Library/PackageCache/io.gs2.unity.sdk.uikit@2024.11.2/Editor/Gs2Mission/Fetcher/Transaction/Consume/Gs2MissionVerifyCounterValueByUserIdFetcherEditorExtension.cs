...
{
    [CustomEditor(typeof(Gs2MissionVerifyCounterValueByUserIdFetcher))]
    public class Gs2MissionVerifyCounterValueByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionVerifyCounterValueByUserIdFetcher;
