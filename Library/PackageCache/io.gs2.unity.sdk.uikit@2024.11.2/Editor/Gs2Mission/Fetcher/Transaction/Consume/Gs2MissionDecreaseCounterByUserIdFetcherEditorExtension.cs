...
{
    [CustomEditor(typeof(Gs2MissionDecreaseCounterByUserIdFetcher))]
    public class Gs2MissionDecreaseCounterByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionDecreaseCounterByUserIdFetcher;
