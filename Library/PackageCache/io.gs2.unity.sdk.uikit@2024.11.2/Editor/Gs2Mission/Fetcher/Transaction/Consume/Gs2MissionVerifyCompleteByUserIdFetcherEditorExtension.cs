...
{
    [CustomEditor(typeof(Gs2MissionVerifyCompleteByUserIdFetcher))]
    public class Gs2MissionVerifyCompleteByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionVerifyCompleteByUserIdFetcher;
