...
{
    [CustomEditor(typeof(Gs2MissionReceiveByUserIdFetcher))]
    public class Gs2MissionReceiveByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionReceiveByUserIdFetcher;
