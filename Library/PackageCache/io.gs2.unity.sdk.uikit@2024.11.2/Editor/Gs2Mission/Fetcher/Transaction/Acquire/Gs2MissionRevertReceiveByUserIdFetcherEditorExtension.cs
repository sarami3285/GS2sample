...
{
    [CustomEditor(typeof(Gs2MissionRevertReceiveByUserIdFetcher))]
    public class Gs2MissionRevertReceiveByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionRevertReceiveByUserIdFetcher;
