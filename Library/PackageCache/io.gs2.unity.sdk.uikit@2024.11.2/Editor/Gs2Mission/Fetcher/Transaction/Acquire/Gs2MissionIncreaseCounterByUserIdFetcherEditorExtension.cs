...
{
    [CustomEditor(typeof(Gs2MissionIncreaseCounterByUserIdFetcher))]
    public class Gs2MissionIncreaseCounterByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionIncreaseCounterByUserIdFetcher;
