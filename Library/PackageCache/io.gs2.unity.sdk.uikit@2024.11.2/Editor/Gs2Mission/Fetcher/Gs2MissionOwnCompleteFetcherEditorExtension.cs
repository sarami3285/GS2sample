...
{
    [CustomEditor(typeof(Gs2MissionOwnCompleteFetcher))]
    public class Gs2MissionOwnCompleteFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionOwnCompleteFetcher;
