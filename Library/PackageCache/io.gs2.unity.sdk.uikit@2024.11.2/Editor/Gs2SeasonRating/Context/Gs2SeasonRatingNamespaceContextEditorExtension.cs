...
{
    [CustomEditor(typeof(Gs2SeasonRatingNamespaceContext))]
    public class Gs2SeasonRatingNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SeasonRatingNamespaceContext;
