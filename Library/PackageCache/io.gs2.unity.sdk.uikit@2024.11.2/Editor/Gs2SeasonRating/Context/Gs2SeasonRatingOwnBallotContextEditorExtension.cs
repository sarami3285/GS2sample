...
{
    [CustomEditor(typeof(Gs2SeasonRatingOwnBallotContext))]
    public class Gs2SeasonRatingOwnBallotContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SeasonRatingOwnBallotContext;
