...
{
    [CustomEditor(typeof(Gs2SeasonRatingSeasonModelMetadataEnabler))]
    public class Gs2SeasonRatingSeasonModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SeasonRatingSeasonModelMetadataEnabler;
            ...
            if (original.expression == Gs2SeasonRatingSeasonModelMetadataEnabler.Expression.In || original.expression == Gs2SeasonRatingSeasonModelMetadataEnabler.Expression.NotIn) {
