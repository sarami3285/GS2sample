...
{
    [CustomEditor(typeof(Gs2SeasonRatingSeasonModelMetadataSpriteTableSwitcher))]
    public class Gs2SeasonRatingSeasonModelMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SeasonRatingSeasonModelMetadataSpriteTableSwitcher;
