...
{
    [CustomEditor(typeof(Gs2SeasonRatingSeasonModelMetadataSpriteSwitcher))]
    public class Gs2SeasonRatingSeasonModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SeasonRatingSeasonModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2SeasonRatingSeasonModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2SeasonRatingSeasonModelMetadataSpriteSwitcher.Expression.NotIn) {
