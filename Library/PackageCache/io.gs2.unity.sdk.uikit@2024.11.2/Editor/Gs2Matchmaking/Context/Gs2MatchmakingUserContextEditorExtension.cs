...
{
    [CustomEditor(typeof(Gs2MatchmakingUserContext))]
    public class Gs2MatchmakingUserContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingUserContext;
