...
{
    [CustomEditor(typeof(Gs2MatchmakingSeasonModelContext))]
    public class Gs2MatchmakingSeasonModelContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingSeasonModelContext;
