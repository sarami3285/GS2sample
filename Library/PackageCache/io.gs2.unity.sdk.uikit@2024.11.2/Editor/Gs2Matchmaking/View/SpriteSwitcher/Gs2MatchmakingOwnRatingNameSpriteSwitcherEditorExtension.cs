...
{
    [CustomEditor(typeof(Gs2MatchmakingOwnRatingNameSpriteSwitcher))]
    public class Gs2MatchmakingOwnRatingNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingOwnRatingNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MatchmakingOwnRatingNameSpriteSwitcher.Expression.In || original.expression == Gs2MatchmakingOwnRatingNameSpriteSwitcher.Expression.NotIn) {
