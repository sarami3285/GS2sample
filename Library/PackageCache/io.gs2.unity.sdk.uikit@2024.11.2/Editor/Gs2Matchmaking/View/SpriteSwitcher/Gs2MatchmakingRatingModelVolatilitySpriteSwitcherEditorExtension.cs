...
{
    [CustomEditor(typeof(Gs2MatchmakingRatingModelVolatilitySpriteSwitcher))]
    public class Gs2MatchmakingRatingModelVolatilitySpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingRatingModelVolatilitySpriteSwitcher;
            ...
            if (original.expression == Gs2MatchmakingRatingModelVolatilitySpriteSwitcher.Expression.In || original.expression == Gs2MatchmakingRatingModelVolatilitySpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyVolatilities"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyVolatility"), true);
            }
