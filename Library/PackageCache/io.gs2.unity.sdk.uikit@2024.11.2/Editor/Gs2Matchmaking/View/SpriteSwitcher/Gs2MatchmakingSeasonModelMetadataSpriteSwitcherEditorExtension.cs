...
{
    [CustomEditor(typeof(Gs2MatchmakingSeasonModelMetadataSpriteSwitcher))]
    public class Gs2MatchmakingSeasonModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingSeasonModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2MatchmakingSeasonModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2MatchmakingSeasonModelMetadataSpriteSwitcher.Expression.NotIn) {
