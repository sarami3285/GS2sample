...
{
    [CustomEditor(typeof(Gs2MatchmakingGatheringMetadataSpriteTableSwitcher))]
    public class Gs2MatchmakingGatheringMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingGatheringMetadataSpriteTableSwitcher;
