...
{
    [CustomEditor(typeof(Gs2MatchmakingSeasonModelMaximumParticipantsSpriteSwitcher))]
    public class Gs2MatchmakingSeasonModelMaximumParticipantsSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingSeasonModelMaximumParticipantsSpriteSwitcher;
            ...
            if (original.expression == Gs2MatchmakingSeasonModelMaximumParticipantsSpriteSwitcher.Expression.In || original.expression == Gs2MatchmakingSeasonModelMaximumParticipantsSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMaximumParticipantses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMaximumParticipants"), true);
            }
