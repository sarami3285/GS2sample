...
{
    [CustomEditor(typeof(Gs2MatchmakingRatingModelMetadataSpriteSwitcher))]
    public class Gs2MatchmakingRatingModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingRatingModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2MatchmakingRatingModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2MatchmakingRatingModelMetadataSpriteSwitcher.Expression.NotIn) {
