...
{
    [CustomEditor(typeof(Gs2MatchmakingOwnRatingUserIdSpriteSwitcher))]
    public class Gs2MatchmakingOwnRatingUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingOwnRatingUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2MatchmakingOwnRatingUserIdSpriteSwitcher.Expression.In || original.expression == Gs2MatchmakingOwnRatingUserIdSpriteSwitcher.Expression.NotIn) {
