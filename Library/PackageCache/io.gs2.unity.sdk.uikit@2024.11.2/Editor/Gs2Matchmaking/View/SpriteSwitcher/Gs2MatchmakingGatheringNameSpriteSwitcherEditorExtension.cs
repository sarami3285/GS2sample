...
{
    [CustomEditor(typeof(Gs2MatchmakingGatheringNameSpriteSwitcher))]
    public class Gs2MatchmakingGatheringNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingGatheringNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MatchmakingGatheringNameSpriteSwitcher.Expression.In || original.expression == Gs2MatchmakingGatheringNameSpriteSwitcher.Expression.NotIn) {
