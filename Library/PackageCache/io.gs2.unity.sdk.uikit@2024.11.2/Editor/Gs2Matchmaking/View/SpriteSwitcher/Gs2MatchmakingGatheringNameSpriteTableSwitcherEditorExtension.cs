...
{
    [CustomEditor(typeof(Gs2MatchmakingGatheringNameSpriteTableSwitcher))]
    public class Gs2MatchmakingGatheringNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingGatheringNameSpriteTableSwitcher;
