...
{
    [CustomEditor(typeof(Gs2MatchmakingSeasonModelNameSpriteSwitcher))]
    public class Gs2MatchmakingSeasonModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingSeasonModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MatchmakingSeasonModelNameSpriteSwitcher.Expression.In || original.expression == Gs2MatchmakingSeasonModelNameSpriteSwitcher.Expression.NotIn) {
