...
{
    [CustomEditor(typeof(Gs2MatchmakingGatheringMetadataSpriteSwitcher))]
    public class Gs2MatchmakingGatheringMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingGatheringMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2MatchmakingGatheringMetadataSpriteSwitcher.Expression.In || original.expression == Gs2MatchmakingGatheringMetadataSpriteSwitcher.Expression.NotIn) {
