...
{
    [CustomEditor(typeof(Gs2MatchmakingOwnRatingRateValueSpriteSwitcher))]
    public class Gs2MatchmakingOwnRatingRateValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingOwnRatingRateValueSpriteSwitcher;
            ...
            if (original.expression == Gs2MatchmakingOwnRatingRateValueSpriteSwitcher.Expression.In || original.expression == Gs2MatchmakingOwnRatingRateValueSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRateValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRateValue"), true);
            }
