...
{
    [CustomEditor(typeof(Gs2MatchmakingVerifyIncludeParticipantByUserIdEnabler))]
    public class Gs2MatchmakingVerifyIncludeParticipantByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingVerifyIncludeParticipantByUserIdEnabler;
