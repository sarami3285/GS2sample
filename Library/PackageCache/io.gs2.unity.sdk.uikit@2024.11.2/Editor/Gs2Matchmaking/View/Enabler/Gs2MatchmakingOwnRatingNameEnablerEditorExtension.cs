...
{
    [CustomEditor(typeof(Gs2MatchmakingOwnRatingNameEnabler))]
    public class Gs2MatchmakingOwnRatingNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingOwnRatingNameEnabler;
            ...
            if (original.expression == Gs2MatchmakingOwnRatingNameEnabler.Expression.In || original.expression == Gs2MatchmakingOwnRatingNameEnabler.Expression.NotIn) {
