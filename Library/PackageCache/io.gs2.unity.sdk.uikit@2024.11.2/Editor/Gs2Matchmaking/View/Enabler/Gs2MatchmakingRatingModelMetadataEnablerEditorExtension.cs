...
{
    [CustomEditor(typeof(Gs2MatchmakingRatingModelMetadataEnabler))]
    public class Gs2MatchmakingRatingModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingRatingModelMetadataEnabler;
            ...
            if (original.expression == Gs2MatchmakingRatingModelMetadataEnabler.Expression.In || original.expression == Gs2MatchmakingRatingModelMetadataEnabler.Expression.NotIn) {
