...
{
    [CustomEditor(typeof(Gs2MatchmakingOwnRatingRateValueEnabler))]
    public class Gs2MatchmakingOwnRatingRateValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingOwnRatingRateValueEnabler;
            ...
            if (original.expression == Gs2MatchmakingOwnRatingRateValueEnabler.Expression.In || original.expression == Gs2MatchmakingOwnRatingRateValueEnabler.Expression.NotIn) {
