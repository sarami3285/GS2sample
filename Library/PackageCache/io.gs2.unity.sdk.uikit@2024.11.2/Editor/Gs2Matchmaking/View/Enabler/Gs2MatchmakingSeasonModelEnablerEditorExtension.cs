...
{
    [CustomEditor(typeof(Gs2MatchmakingSeasonModelEnabler))]
    public class Gs2MatchmakingSeasonModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingSeasonModelEnabler;
