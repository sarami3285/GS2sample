...
{
    [CustomEditor(typeof(Gs2MatchmakingOwnRatingEnabler))]
    public class Gs2MatchmakingOwnRatingEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingOwnRatingEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("RatingFetcher not assigned.", MessageType.Error);
