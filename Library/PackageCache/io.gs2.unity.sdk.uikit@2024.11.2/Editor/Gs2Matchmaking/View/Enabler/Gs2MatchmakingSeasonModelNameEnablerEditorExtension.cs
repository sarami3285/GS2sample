...
{
    [CustomEditor(typeof(Gs2MatchmakingSeasonModelNameEnabler))]
    public class Gs2MatchmakingSeasonModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingSeasonModelNameEnabler;
            ...
            if (original.expression == Gs2MatchmakingSeasonModelNameEnabler.Expression.In || original.expression == Gs2MatchmakingSeasonModelNameEnabler.Expression.NotIn) {
