...
{
    [CustomEditor(typeof(Gs2MatchmakingRatingModelEnabler))]
    public class Gs2MatchmakingRatingModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingRatingModelEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("RatingModelFetcher not assigned.", MessageType.Error);
