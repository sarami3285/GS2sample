...
{
    [CustomEditor(typeof(Gs2MatchmakingGatheringNameEnabler))]
    public class Gs2MatchmakingGatheringNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingGatheringNameEnabler;
            ...
            if (original.expression == Gs2MatchmakingGatheringNameEnabler.Expression.In || original.expression == Gs2MatchmakingGatheringNameEnabler.Expression.NotIn) {
