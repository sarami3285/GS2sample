...
{
    [CustomEditor(typeof(Gs2MatchmakingSeasonModelMaximumParticipantsEnabler))]
    public class Gs2MatchmakingSeasonModelMaximumParticipantsEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingSeasonModelMaximumParticipantsEnabler;
            ...
            if (original.expression == Gs2MatchmakingSeasonModelMaximumParticipantsEnabler.Expression.In || original.expression == Gs2MatchmakingSeasonModelMaximumParticipantsEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableMaximumParticipantses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableMaximumParticipants"), true);
            }
