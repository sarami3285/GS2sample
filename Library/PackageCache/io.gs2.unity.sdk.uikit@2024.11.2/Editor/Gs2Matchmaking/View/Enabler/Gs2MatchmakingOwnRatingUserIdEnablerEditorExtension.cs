...
{
    [CustomEditor(typeof(Gs2MatchmakingOwnRatingUserIdEnabler))]
    public class Gs2MatchmakingOwnRatingUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingOwnRatingUserIdEnabler;
            ...
            if (original.expression == Gs2MatchmakingOwnRatingUserIdEnabler.Expression.In || original.expression == Gs2MatchmakingOwnRatingUserIdEnabler.Expression.NotIn) {
