...
{
    [CustomEditor(typeof(Gs2MatchmakingGatheringMetadataEnabler))]
    public class Gs2MatchmakingGatheringMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingGatheringMetadataEnabler;
            ...
            if (original.expression == Gs2MatchmakingGatheringMetadataEnabler.Expression.In || original.expression == Gs2MatchmakingGatheringMetadataEnabler.Expression.NotIn) {
