...
{
    [CustomEditor(typeof(Gs2MatchmakingRatingModelNameEnabler))]
    public class Gs2MatchmakingRatingModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingRatingModelNameEnabler;
            ...
            if (original.expression == Gs2MatchmakingRatingModelNameEnabler.Expression.In || original.expression == Gs2MatchmakingRatingModelNameEnabler.Expression.NotIn) {
