...
{
    [CustomEditor(typeof(Gs2MatchmakingGatheringEnabler))]
    public class Gs2MatchmakingGatheringEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingGatheringEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("GatheringFetcher not assigned.", MessageType.Error);
