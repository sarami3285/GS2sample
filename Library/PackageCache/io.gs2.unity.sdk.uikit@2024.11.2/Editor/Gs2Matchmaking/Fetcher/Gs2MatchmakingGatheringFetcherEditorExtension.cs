...
{
    [CustomEditor(typeof(Gs2MatchmakingGatheringFetcher))]
    public class Gs2MatchmakingGatheringFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingGatheringFetcher;
