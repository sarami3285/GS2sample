...
{
    [CustomEditor(typeof(Gs2MatchmakingSeasonModelFetcher))]
    public class Gs2MatchmakingSeasonModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingSeasonModelFetcher;
