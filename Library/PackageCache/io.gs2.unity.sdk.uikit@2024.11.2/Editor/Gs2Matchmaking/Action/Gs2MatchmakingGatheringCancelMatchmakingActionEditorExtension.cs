...
{
    [CustomEditor(typeof(Gs2MatchmakingGatheringCancelMatchmakingAction))]
    public class Gs2MatchmakingGatheringCancelMatchmakingActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingGatheringCancelMatchmakingAction;
