...
{
    [CustomEditor(typeof(Gs2MatchmakingGatheringPingAction))]
    public class Gs2MatchmakingGatheringPingActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingGatheringPingAction;
