...
{
    [CustomEditor(typeof(Gs2MatchmakingGatheringUpdateGatheringAction))]
    public class Gs2MatchmakingGatheringUpdateGatheringActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingGatheringUpdateGatheringAction;
