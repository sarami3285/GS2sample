...
{
    [CustomEditor(typeof(Gs2InventoryNamespaceContext))]
    public class Gs2InventoryNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryNamespaceContext;
