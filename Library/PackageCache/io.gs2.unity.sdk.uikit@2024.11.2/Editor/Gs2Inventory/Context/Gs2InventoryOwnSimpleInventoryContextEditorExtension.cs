...
{
    [CustomEditor(typeof(Gs2InventoryOwnSimpleInventoryContext))]
    public class Gs2InventoryOwnSimpleInventoryContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnSimpleInventoryContext;
            ...
            if (original.SimpleInventory == null) {
                ...
                if (original.SimpleInventory != null) {
                    ...
                    EditorGUILayout.TextField("NamespaceName", original.SimpleInventory?.NamespaceName?.ToString());
                    EditorGUILayout.TextField("InventoryName", original.SimpleInventory?.InventoryName?.ToString());
                    EditorGUI.indentLevel--;
                }
