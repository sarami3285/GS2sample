...
{
    [CustomEditor(typeof(Gs2InventorySetBigItemByUserIdLabel))]
    public class Gs2InventorySetBigItemByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySetBigItemByUserIdLabel;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2InventorySetBigItemByUserIdFetcher>() ?? original.GetComponentInParent<Gs2InventorySetBigItemByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2InventorySetBigItemByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2InventorySetBigItemByUserIdFetcher>();
                }
            }
