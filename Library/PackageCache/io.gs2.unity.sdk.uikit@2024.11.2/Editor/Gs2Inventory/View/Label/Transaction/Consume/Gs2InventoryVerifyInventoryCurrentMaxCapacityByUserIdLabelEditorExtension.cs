...
{
    [CustomEditor(typeof(Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdLabel))]
    public class Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdLabel;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdFetcher>() ?? original.GetComponentInParent<Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdFetcher>();
                }
            }
