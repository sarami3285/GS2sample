...
{
    [CustomEditor(typeof(Gs2InventoryAcquireBigItemByUserIdLabel))]
    public class Gs2InventoryAcquireBigItemByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryAcquireBigItemByUserIdLabel;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2InventoryAcquireBigItemByUserIdFetcher>() ?? original.GetComponentInParent<Gs2InventoryAcquireBigItemByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2InventoryAcquireBigItemByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2InventoryAcquireBigItemByUserIdFetcher>();
                }
            }
