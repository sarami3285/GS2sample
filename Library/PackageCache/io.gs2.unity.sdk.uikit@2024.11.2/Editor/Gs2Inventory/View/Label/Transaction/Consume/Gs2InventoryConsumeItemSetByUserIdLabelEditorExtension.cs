...
namespace Gs2.Unity.UiKit.Gs2Inventory.Label.Editor
{
    ...
    public class Gs2InventoryConsumeItemSetByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryConsumeItemSetByUserIdLabel;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2InventoryConsumeItemSetByUserIdFetcher>() ?? original.GetComponentInParent<Gs2InventoryConsumeItemSetByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2InventoryConsumeItemSetByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2InventoryConsumeItemSetByUserIdFetcher>();
                }
            }
