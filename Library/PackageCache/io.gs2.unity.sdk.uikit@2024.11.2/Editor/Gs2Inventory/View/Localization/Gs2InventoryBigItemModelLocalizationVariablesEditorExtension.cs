...
{
    [CustomEditor(typeof(Gs2InventoryBigItemModelLocalizationVariables))]
    public class Gs2InventoryBigItemModelLocalizationVariablesEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigItemModelLocalizationVariables;
