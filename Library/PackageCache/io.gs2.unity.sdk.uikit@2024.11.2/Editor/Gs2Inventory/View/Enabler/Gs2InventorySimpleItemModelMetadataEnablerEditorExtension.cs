...
{
    [CustomEditor(typeof(Gs2InventorySimpleItemModelMetadataEnabler))]
    public class Gs2InventorySimpleItemModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleItemModelMetadataEnabler;
            ...
            if (original.expression == Gs2InventorySimpleItemModelMetadataEnabler.Expression.In || original.expression == Gs2InventorySimpleItemModelMetadataEnabler.Expression.NotIn) {
