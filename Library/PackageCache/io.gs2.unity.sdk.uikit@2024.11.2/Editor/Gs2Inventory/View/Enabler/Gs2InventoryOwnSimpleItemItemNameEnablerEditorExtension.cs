...
{
    [CustomEditor(typeof(Gs2InventoryOwnSimpleItemItemNameEnabler))]
    public class Gs2InventoryOwnSimpleItemItemNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnSimpleItemItemNameEnabler;
            ...
            if (original.expression == Gs2InventoryOwnSimpleItemItemNameEnabler.Expression.In || original.expression == Gs2InventoryOwnSimpleItemItemNameEnabler.Expression.NotIn) {
