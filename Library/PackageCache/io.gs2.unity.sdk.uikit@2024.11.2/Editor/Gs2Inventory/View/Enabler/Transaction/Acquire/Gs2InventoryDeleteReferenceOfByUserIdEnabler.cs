...
{
    [CustomEditor(typeof(Gs2InventoryDeleteReferenceOfByUserIdEnabler))]
    public class Gs2InventoryDeleteReferenceOfByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryDeleteReferenceOfByUserIdEnabler;
