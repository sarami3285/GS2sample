...
{
    [CustomEditor(typeof(Gs2InventorySetCapacityByUserIdEnabler))]
    public class Gs2InventorySetCapacityByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySetCapacityByUserIdEnabler;
