...
{
    [CustomEditor(typeof(Gs2InventoryVerifyBigItemByUserIdValueEnabler))]
    public class Gs2InventoryVerifyBigItemByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryVerifyBigItemByUserIdValueEnabler;
            ...
            if (original.expression == Gs2InventoryVerifyBigItemByUserIdValueEnabler.Expression.In || original.expression == Gs2InventoryVerifyBigItemByUserIdValueEnabler.Expression.NotIn) {
