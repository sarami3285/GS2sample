...
{
    [CustomEditor(typeof(Gs2InventoryVerifyItemSetByUserIdValueEnabler))]
    public class Gs2InventoryVerifyItemSetByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryVerifyItemSetByUserIdValueEnabler;
            ...
            if (original.expression == Gs2InventoryVerifyItemSetByUserIdValueEnabler.Expression.In || original.expression == Gs2InventoryVerifyItemSetByUserIdValueEnabler.Expression.NotIn) {
