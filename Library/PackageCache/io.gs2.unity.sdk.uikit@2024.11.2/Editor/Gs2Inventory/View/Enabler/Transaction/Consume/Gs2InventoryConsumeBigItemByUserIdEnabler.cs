...
{
    [CustomEditor(typeof(Gs2InventoryConsumeBigItemByUserIdEnabler))]
    public class Gs2InventoryConsumeBigItemByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryConsumeBigItemByUserIdEnabler;
