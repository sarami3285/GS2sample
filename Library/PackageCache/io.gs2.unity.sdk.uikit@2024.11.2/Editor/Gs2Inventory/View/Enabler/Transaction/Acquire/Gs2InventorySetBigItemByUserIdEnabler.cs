...
{
    [CustomEditor(typeof(Gs2InventorySetBigItemByUserIdEnabler))]
    public class Gs2InventorySetBigItemByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySetBigItemByUserIdEnabler;
