...
{
    [CustomEditor(typeof(Gs2InventoryAcquireBigItemByUserIdValueEnabler))]
    public class Gs2InventoryAcquireBigItemByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryAcquireBigItemByUserIdValueEnabler;
            ...
            if (original.expression == Gs2InventoryAcquireBigItemByUserIdValueEnabler.Expression.In || original.expression == Gs2InventoryAcquireBigItemByUserIdValueEnabler.Expression.NotIn) {
