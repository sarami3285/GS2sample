...
{
    [CustomEditor(typeof(Gs2InventoryAcquireItemSetByUserIdValueEnabler))]
    public class Gs2InventoryAcquireItemSetByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryAcquireItemSetByUserIdValueEnabler;
            ...
            if (original.expression == Gs2InventoryAcquireItemSetByUserIdValueEnabler.Expression.In || original.expression == Gs2InventoryAcquireItemSetByUserIdValueEnabler.Expression.NotIn) {
