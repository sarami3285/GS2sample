...
{
    [CustomEditor(typeof(Gs2InventoryAddReferenceOfByUserIdEnabler))]
    public class Gs2InventoryAddReferenceOfByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryAddReferenceOfByUserIdEnabler;
