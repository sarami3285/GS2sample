...
{
    [CustomEditor(typeof(Gs2InventoryAcquireBigItemByUserIdEnabler))]
    public class Gs2InventoryAcquireBigItemByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryAcquireBigItemByUserIdEnabler;
