...
{
    [CustomEditor(typeof(Gs2InventoryAcquireSimpleItemsByUserIdEnabler))]
    public class Gs2InventoryAcquireSimpleItemsByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryAcquireSimpleItemsByUserIdEnabler;
