...
{
    [CustomEditor(typeof(Gs2InventoryConsumeItemSetByUserIdEnabler))]
    public class Gs2InventoryConsumeItemSetByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryConsumeItemSetByUserIdEnabler;
