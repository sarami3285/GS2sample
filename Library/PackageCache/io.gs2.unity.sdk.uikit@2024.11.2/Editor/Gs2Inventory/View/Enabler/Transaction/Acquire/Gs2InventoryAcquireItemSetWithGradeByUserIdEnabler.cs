...
{
    [CustomEditor(typeof(Gs2InventoryAcquireItemSetWithGradeByUserIdEnabler))]
    public class Gs2InventoryAcquireItemSetWithGradeByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryAcquireItemSetWithGradeByUserIdEnabler;
