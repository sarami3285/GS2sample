...
{
    [CustomEditor(typeof(Gs2InventoryVerifyItemSetByUserIdEnabler))]
    public class Gs2InventoryVerifyItemSetByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryVerifyItemSetByUserIdEnabler;
