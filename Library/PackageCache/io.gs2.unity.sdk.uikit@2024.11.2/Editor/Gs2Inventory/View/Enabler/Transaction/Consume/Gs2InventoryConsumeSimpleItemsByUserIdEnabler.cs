...
{
    [CustomEditor(typeof(Gs2InventoryConsumeSimpleItemsByUserIdEnabler))]
    public class Gs2InventoryConsumeSimpleItemsByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryConsumeSimpleItemsByUserIdEnabler;
