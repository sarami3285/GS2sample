...
{
    [CustomEditor(typeof(Gs2InventoryVerifySimpleItemByUserIdEnabler))]
    public class Gs2InventoryVerifySimpleItemByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryVerifySimpleItemByUserIdEnabler;
