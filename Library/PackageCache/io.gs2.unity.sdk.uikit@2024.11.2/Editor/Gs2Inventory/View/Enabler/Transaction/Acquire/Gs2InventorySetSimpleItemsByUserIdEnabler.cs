...
{
    [CustomEditor(typeof(Gs2InventorySetSimpleItemsByUserIdEnabler))]
    public class Gs2InventorySetSimpleItemsByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySetSimpleItemsByUserIdEnabler;
