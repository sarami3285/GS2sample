...
{
    [CustomEditor(typeof(Gs2InventoryVerifyBigItemByUserIdEnabler))]
    public class Gs2InventoryVerifyBigItemByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryVerifyBigItemByUserIdEnabler;
