...
{
    [CustomEditor(typeof(Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdEnabler))]
    public class Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryVerifyInventoryCurrentMaxCapacityByUserIdEnabler;
