...
{
    [CustomEditor(typeof(Gs2InventoryAddCapacityByUserIdValueEnabler))]
    public class Gs2InventoryAddCapacityByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryAddCapacityByUserIdValueEnabler;
            ...
            if (original.expression == Gs2InventoryAddCapacityByUserIdValueEnabler.Expression.In || original.expression == Gs2InventoryAddCapacityByUserIdValueEnabler.Expression.NotIn) {
