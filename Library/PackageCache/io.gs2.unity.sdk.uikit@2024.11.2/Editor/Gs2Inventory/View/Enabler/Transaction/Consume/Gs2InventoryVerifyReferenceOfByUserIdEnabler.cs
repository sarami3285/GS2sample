...
{
    [CustomEditor(typeof(Gs2InventoryVerifyReferenceOfByUserIdEnabler))]
    public class Gs2InventoryVerifyReferenceOfByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryVerifyReferenceOfByUserIdEnabler;
