...
{
    [CustomEditor(typeof(Gs2InventoryOwnItemSetNameEnabler))]
    public class Gs2InventoryOwnItemSetNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnItemSetNameEnabler;
            ...
            if (original.expression == Gs2InventoryOwnItemSetNameEnabler.Expression.In || original.expression == Gs2InventoryOwnItemSetNameEnabler.Expression.NotIn) {
