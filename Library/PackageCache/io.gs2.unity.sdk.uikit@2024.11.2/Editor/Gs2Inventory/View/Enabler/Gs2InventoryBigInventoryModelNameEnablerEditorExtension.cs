...
{
    [CustomEditor(typeof(Gs2InventoryBigInventoryModelNameEnabler))]
    public class Gs2InventoryBigInventoryModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigInventoryModelNameEnabler;
            ...
            if (original.expression == Gs2InventoryBigInventoryModelNameEnabler.Expression.In || original.expression == Gs2InventoryBigInventoryModelNameEnabler.Expression.NotIn) {
