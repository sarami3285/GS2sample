...
{
    [CustomEditor(typeof(Gs2InventoryOwnInventoryInventoryNameEnabler))]
    public class Gs2InventoryOwnInventoryInventoryNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnInventoryInventoryNameEnabler;
            ...
            if (original.expression == Gs2InventoryOwnInventoryInventoryNameEnabler.Expression.In || original.expression == Gs2InventoryOwnInventoryInventoryNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableInventoryNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableInventoryName"), true);
            }
