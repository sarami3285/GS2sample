...
{
    [CustomEditor(typeof(Gs2InventoryBigItemModelNameEnabler))]
    public class Gs2InventoryBigItemModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigItemModelNameEnabler;
            ...
            if (original.expression == Gs2InventoryBigItemModelNameEnabler.Expression.In || original.expression == Gs2InventoryBigItemModelNameEnabler.Expression.NotIn) {
