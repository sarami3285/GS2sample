...
{
    [CustomEditor(typeof(Gs2InventoryOwnBigItemCountEnabler))]
    public class Gs2InventoryOwnBigItemCountEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnBigItemCountEnabler;
            ...
            if (original.expression == Gs2InventoryOwnBigItemCountEnabler.Expression.In || original.expression == Gs2InventoryOwnBigItemCountEnabler.Expression.NotIn) {
