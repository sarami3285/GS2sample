...
{
    [CustomEditor(typeof(Gs2InventoryBigItemModelMetadataEnabler))]
    public class Gs2InventoryBigItemModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigItemModelMetadataEnabler;
            ...
            if (original.expression == Gs2InventoryBigItemModelMetadataEnabler.Expression.In || original.expression == Gs2InventoryBigItemModelMetadataEnabler.Expression.NotIn) {
