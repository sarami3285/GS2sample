...
{
    [CustomEditor(typeof(Gs2InventoryOwnItemSetSortValueEnabler))]
    public class Gs2InventoryOwnItemSetSortValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnItemSetSortValueEnabler;
            ...
            if (original.expression == Gs2InventoryOwnItemSetSortValueEnabler.Expression.In || original.expression == Gs2InventoryOwnItemSetSortValueEnabler.Expression.NotIn) {
