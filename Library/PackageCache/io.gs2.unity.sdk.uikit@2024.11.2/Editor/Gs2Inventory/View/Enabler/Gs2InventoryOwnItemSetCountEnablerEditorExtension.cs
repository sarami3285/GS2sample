...
{
    [CustomEditor(typeof(Gs2InventoryOwnItemSetCountEnabler))]
    public class Gs2InventoryOwnItemSetCountEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnItemSetCountEnabler;
            ...
            if (original.expression == Gs2InventoryOwnItemSetCountEnabler.Expression.In || original.expression == Gs2InventoryOwnItemSetCountEnabler.Expression.NotIn) {
