...
{
    [CustomEditor(typeof(Gs2InventorySimpleInventoryModelNameEnabler))]
    public class Gs2InventorySimpleInventoryModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleInventoryModelNameEnabler;
            ...
            if (original.expression == Gs2InventorySimpleInventoryModelNameEnabler.Expression.In || original.expression == Gs2InventorySimpleInventoryModelNameEnabler.Expression.NotIn) {
