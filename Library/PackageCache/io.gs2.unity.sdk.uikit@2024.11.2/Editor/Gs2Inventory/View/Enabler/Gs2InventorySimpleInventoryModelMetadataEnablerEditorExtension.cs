...
{
    [CustomEditor(typeof(Gs2InventorySimpleInventoryModelMetadataEnabler))]
    public class Gs2InventorySimpleInventoryModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleInventoryModelMetadataEnabler;
            ...
            if (original.expression == Gs2InventorySimpleInventoryModelMetadataEnabler.Expression.In || original.expression == Gs2InventorySimpleInventoryModelMetadataEnabler.Expression.NotIn) {
