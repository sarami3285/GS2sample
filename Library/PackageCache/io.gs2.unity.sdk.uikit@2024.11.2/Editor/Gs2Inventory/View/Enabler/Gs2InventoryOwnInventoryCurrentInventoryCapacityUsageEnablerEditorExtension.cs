...
{
    [CustomEditor(typeof(Gs2InventoryOwnInventoryCurrentInventoryCapacityUsageEnabler))]
    public class Gs2InventoryOwnInventoryCurrentInventoryCapacityUsageEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnInventoryCurrentInventoryCapacityUsageEnabler;
            ...
            if (original.expression == Gs2InventoryOwnInventoryCurrentInventoryCapacityUsageEnabler.Expression.In || original.expression == Gs2InventoryOwnInventoryCurrentInventoryCapacityUsageEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableCurrentInventoryCapacityUsages"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableCurrentInventoryCapacityUsage"), true);
            }
