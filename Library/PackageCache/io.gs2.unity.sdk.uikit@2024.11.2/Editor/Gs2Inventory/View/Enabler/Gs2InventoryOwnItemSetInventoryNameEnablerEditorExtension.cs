...
{
    [CustomEditor(typeof(Gs2InventoryOwnItemSetInventoryNameEnabler))]
    public class Gs2InventoryOwnItemSetInventoryNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnItemSetInventoryNameEnabler;
            ...
            if (original.expression == Gs2InventoryOwnItemSetInventoryNameEnabler.Expression.In || original.expression == Gs2InventoryOwnItemSetInventoryNameEnabler.Expression.NotIn) {
