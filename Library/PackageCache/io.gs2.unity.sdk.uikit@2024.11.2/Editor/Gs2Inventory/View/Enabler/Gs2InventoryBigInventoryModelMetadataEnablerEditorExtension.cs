...
{
    [CustomEditor(typeof(Gs2InventoryBigInventoryModelMetadataEnabler))]
    public class Gs2InventoryBigInventoryModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigInventoryModelMetadataEnabler;
            ...
            if (original.expression == Gs2InventoryBigInventoryModelMetadataEnabler.Expression.In || original.expression == Gs2InventoryBigInventoryModelMetadataEnabler.Expression.NotIn) {
