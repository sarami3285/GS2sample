...
{
    [CustomEditor(typeof(Gs2InventoryInventoryModelMaxCapacityEnabler))]
    public class Gs2InventoryInventoryModelMaxCapacityEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryInventoryModelMaxCapacityEnabler;
            ...
            if (original.expression == Gs2InventoryInventoryModelMaxCapacityEnabler.Expression.In || original.expression == Gs2InventoryInventoryModelMaxCapacityEnabler.Expression.NotIn) {
