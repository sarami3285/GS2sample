...
{
    [CustomEditor(typeof(Gs2InventoryItemModelSortValueEnabler))]
    public class Gs2InventoryItemModelSortValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemModelSortValueEnabler;
            ...
            if (original.expression == Gs2InventoryItemModelSortValueEnabler.Expression.In || original.expression == Gs2InventoryItemModelSortValueEnabler.Expression.NotIn) {
