...
{
    [CustomEditor(typeof(Gs2InventoryOwnItemSetItemNameEnabler))]
    public class Gs2InventoryOwnItemSetItemNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnItemSetItemNameEnabler;
            ...
            if (original.expression == Gs2InventoryOwnItemSetItemNameEnabler.Expression.In || original.expression == Gs2InventoryOwnItemSetItemNameEnabler.Expression.NotIn) {
