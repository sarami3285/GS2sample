...
{
    [CustomEditor(typeof(Gs2InventoryItemModelMetadataEnabler))]
    public class Gs2InventoryItemModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemModelMetadataEnabler;
            ...
            if (original.expression == Gs2InventoryItemModelMetadataEnabler.Expression.In || original.expression == Gs2InventoryItemModelMetadataEnabler.Expression.NotIn) {
