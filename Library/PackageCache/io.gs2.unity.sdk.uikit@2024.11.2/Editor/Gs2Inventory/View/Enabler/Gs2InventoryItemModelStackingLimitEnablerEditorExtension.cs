...
{
    [CustomEditor(typeof(Gs2InventoryItemModelStackingLimitEnabler))]
    public class Gs2InventoryItemModelStackingLimitEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemModelStackingLimitEnabler;
            ...
            if (original.expression == Gs2InventoryItemModelStackingLimitEnabler.Expression.In || original.expression == Gs2InventoryItemModelStackingLimitEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableStackingLimits"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableStackingLimit"), true);
            }
