...
{
    [CustomEditor(typeof(Gs2InventoryOwnInventoryCurrentInventoryMaxCapacityEnabler))]
    public class Gs2InventoryOwnInventoryCurrentInventoryMaxCapacityEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnInventoryCurrentInventoryMaxCapacityEnabler;
            ...
            if (original.expression == Gs2InventoryOwnInventoryCurrentInventoryMaxCapacityEnabler.Expression.In || original.expression == Gs2InventoryOwnInventoryCurrentInventoryMaxCapacityEnabler.Expression.NotIn) {
