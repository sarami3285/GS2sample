...
{
    [CustomEditor(typeof(Gs2InventoryInventoryModelNameEnabler))]
    public class Gs2InventoryInventoryModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryInventoryModelNameEnabler;
            ...
            if (original.expression == Gs2InventoryInventoryModelNameEnabler.Expression.In || original.expression == Gs2InventoryInventoryModelNameEnabler.Expression.NotIn) {
