...
{
    [CustomEditor(typeof(Gs2InventoryOwnSimpleItemCountSpriteSwitcher))]
    public class Gs2InventoryOwnSimpleItemCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnSimpleItemCountSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryOwnSimpleItemCountSpriteSwitcher.Expression.In || original.expression == Gs2InventoryOwnSimpleItemCountSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCounts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCount"), true);
            }
