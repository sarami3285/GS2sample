...
{
    [CustomEditor(typeof(Gs2InventoryOwnItemSetSortValueSpriteSwitcher))]
    public class Gs2InventoryOwnItemSetSortValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnItemSetSortValueSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryOwnItemSetSortValueSpriteSwitcher.Expression.In || original.expression == Gs2InventoryOwnItemSetSortValueSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applySortValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applySortValue"), true);
            }
