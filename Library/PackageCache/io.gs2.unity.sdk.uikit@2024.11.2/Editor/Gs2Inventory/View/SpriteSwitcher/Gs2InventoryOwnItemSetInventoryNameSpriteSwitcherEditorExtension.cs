...
{
    [CustomEditor(typeof(Gs2InventoryOwnItemSetInventoryNameSpriteSwitcher))]
    public class Gs2InventoryOwnItemSetInventoryNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnItemSetInventoryNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryOwnItemSetInventoryNameSpriteSwitcher.Expression.In || original.expression == Gs2InventoryOwnItemSetInventoryNameSpriteSwitcher.Expression.NotIn) {
