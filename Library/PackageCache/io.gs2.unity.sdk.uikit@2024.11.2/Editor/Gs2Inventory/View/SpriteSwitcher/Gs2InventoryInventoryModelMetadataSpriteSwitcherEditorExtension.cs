...
{
    [CustomEditor(typeof(Gs2InventoryInventoryModelMetadataSpriteSwitcher))]
    public class Gs2InventoryInventoryModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryInventoryModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryInventoryModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2InventoryInventoryModelMetadataSpriteSwitcher.Expression.NotIn) {
