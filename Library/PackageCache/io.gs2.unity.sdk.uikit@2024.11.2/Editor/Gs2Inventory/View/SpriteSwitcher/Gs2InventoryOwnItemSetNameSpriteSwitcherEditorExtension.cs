...
{
    [CustomEditor(typeof(Gs2InventoryOwnItemSetNameSpriteSwitcher))]
    public class Gs2InventoryOwnItemSetNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnItemSetNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryOwnItemSetNameSpriteSwitcher.Expression.In || original.expression == Gs2InventoryOwnItemSetNameSpriteSwitcher.Expression.NotIn) {
