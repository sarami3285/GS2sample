...
{
    [CustomEditor(typeof(Gs2InventoryOwnItemSetItemNameSpriteSwitcher))]
    public class Gs2InventoryOwnItemSetItemNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnItemSetItemNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryOwnItemSetItemNameSpriteSwitcher.Expression.In || original.expression == Gs2InventoryOwnItemSetItemNameSpriteSwitcher.Expression.NotIn) {
