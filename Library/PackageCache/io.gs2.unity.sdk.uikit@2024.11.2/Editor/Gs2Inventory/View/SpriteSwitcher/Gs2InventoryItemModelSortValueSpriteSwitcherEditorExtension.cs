...
{
    [CustomEditor(typeof(Gs2InventoryItemModelSortValueSpriteSwitcher))]
    public class Gs2InventoryItemModelSortValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemModelSortValueSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryItemModelSortValueSpriteSwitcher.Expression.In || original.expression == Gs2InventoryItemModelSortValueSpriteSwitcher.Expression.NotIn) {
