...
{
    [CustomEditor(typeof(Gs2InventoryOwnSimpleItemItemNameSpriteSwitcher))]
    public class Gs2InventoryOwnSimpleItemItemNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnSimpleItemItemNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryOwnSimpleItemItemNameSpriteSwitcher.Expression.In || original.expression == Gs2InventoryOwnSimpleItemItemNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyItemNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyItemName"), true);
            }
