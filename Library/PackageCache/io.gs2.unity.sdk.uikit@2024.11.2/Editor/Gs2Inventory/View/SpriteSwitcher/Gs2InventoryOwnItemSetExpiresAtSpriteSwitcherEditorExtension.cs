...
{
    [CustomEditor(typeof(Gs2InventoryOwnItemSetExpiresAtSpriteSwitcher))]
    public class Gs2InventoryOwnItemSetExpiresAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnItemSetExpiresAtSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryOwnItemSetExpiresAtSpriteSwitcher.Expression.In || original.expression == Gs2InventoryOwnItemSetExpiresAtSpriteSwitcher.Expression.NotIn) {
