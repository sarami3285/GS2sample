...
{
    [CustomEditor(typeof(Gs2InventoryBigItemModelNameSpriteSwitcher))]
    public class Gs2InventoryBigItemModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigItemModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryBigItemModelNameSpriteSwitcher.Expression.In || original.expression == Gs2InventoryBigItemModelNameSpriteSwitcher.Expression.NotIn) {
