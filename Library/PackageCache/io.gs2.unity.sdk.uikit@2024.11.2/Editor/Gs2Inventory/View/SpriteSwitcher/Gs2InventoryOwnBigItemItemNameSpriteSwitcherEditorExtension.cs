...
{
    [CustomEditor(typeof(Gs2InventoryOwnBigItemItemNameSpriteSwitcher))]
    public class Gs2InventoryOwnBigItemItemNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnBigItemItemNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryOwnBigItemItemNameSpriteSwitcher.Expression.In || original.expression == Gs2InventoryOwnBigItemItemNameSpriteSwitcher.Expression.NotIn) {
