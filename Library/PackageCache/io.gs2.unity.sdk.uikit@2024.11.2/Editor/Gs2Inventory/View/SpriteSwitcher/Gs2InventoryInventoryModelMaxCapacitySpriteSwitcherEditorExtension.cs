...
{
    [CustomEditor(typeof(Gs2InventoryInventoryModelMaxCapacitySpriteSwitcher))]
    public class Gs2InventoryInventoryModelMaxCapacitySpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryInventoryModelMaxCapacitySpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryInventoryModelMaxCapacitySpriteSwitcher.Expression.In || original.expression == Gs2InventoryInventoryModelMaxCapacitySpriteSwitcher.Expression.NotIn) {
