...
{
    [CustomEditor(typeof(Gs2InventorySimpleInventoryModelMetadataSpriteSwitcher))]
    public class Gs2InventorySimpleInventoryModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleInventoryModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2InventorySimpleInventoryModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2InventorySimpleInventoryModelMetadataSpriteSwitcher.Expression.NotIn) {
