...
{
    [CustomEditor(typeof(Gs2InventoryOwnInventoryInventoryNameSpriteSwitcher))]
    public class Gs2InventoryOwnInventoryInventoryNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnInventoryInventoryNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryOwnInventoryInventoryNameSpriteSwitcher.Expression.In || original.expression == Gs2InventoryOwnInventoryInventoryNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyInventoryNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyInventoryName"), true);
            }
