...
{
    [CustomEditor(typeof(Gs2InventoryInventoryModelNameSpriteSwitcher))]
    public class Gs2InventoryInventoryModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryInventoryModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryInventoryModelNameSpriteSwitcher.Expression.In || original.expression == Gs2InventoryInventoryModelNameSpriteSwitcher.Expression.NotIn) {
