...
{
    [CustomEditor(typeof(Gs2InventoryOwnInventoryCurrentInventoryCapacityUsageSpriteSwitcher))]
    public class Gs2InventoryOwnInventoryCurrentInventoryCapacityUsageSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnInventoryCurrentInventoryCapacityUsageSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryOwnInventoryCurrentInventoryCapacityUsageSpriteSwitcher.Expression.In || original.expression == Gs2InventoryOwnInventoryCurrentInventoryCapacityUsageSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCurrentInventoryCapacityUsages"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCurrentInventoryCapacityUsage"), true);
            }
