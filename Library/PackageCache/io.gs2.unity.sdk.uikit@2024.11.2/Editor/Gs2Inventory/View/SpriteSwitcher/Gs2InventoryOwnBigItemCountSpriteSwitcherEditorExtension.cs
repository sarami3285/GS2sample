...
{
    [CustomEditor(typeof(Gs2InventoryOwnBigItemCountSpriteSwitcher))]
    public class Gs2InventoryOwnBigItemCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnBigItemCountSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryOwnBigItemCountSpriteSwitcher.Expression.In || original.expression == Gs2InventoryOwnBigItemCountSpriteSwitcher.Expression.NotIn) {
