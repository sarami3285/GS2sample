...
{
    [CustomEditor(typeof(Gs2InventoryInventoryModelInitialCapacitySpriteSwitcher))]
    public class Gs2InventoryInventoryModelInitialCapacitySpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryInventoryModelInitialCapacitySpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryInventoryModelInitialCapacitySpriteSwitcher.Expression.In || original.expression == Gs2InventoryInventoryModelInitialCapacitySpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyInitialCapacities"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyInitialCapacity"), true);
            }
