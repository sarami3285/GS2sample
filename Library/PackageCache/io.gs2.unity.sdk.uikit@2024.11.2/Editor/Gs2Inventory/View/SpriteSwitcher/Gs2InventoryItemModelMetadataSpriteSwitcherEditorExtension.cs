...
{
    [CustomEditor(typeof(Gs2InventoryItemModelMetadataSpriteSwitcher))]
    public class Gs2InventoryItemModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryItemModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2InventoryItemModelMetadataSpriteSwitcher.Expression.NotIn) {
