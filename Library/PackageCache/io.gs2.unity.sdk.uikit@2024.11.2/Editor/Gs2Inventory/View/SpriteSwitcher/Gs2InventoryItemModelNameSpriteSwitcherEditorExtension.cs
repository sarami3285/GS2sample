...
{
    [CustomEditor(typeof(Gs2InventoryItemModelNameSpriteSwitcher))]
    public class Gs2InventoryItemModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryItemModelNameSpriteSwitcher.Expression.In || original.expression == Gs2InventoryItemModelNameSpriteSwitcher.Expression.NotIn) {
