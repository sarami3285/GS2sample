...
{
    [CustomEditor(typeof(Gs2InventoryBigItemModelMetadataSpriteSwitcher))]
    public class Gs2InventoryBigItemModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigItemModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryBigItemModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2InventoryBigItemModelMetadataSpriteSwitcher.Expression.NotIn) {
