...
{
    [CustomEditor(typeof(Gs2InventorySimpleInventoryModelMetadataSpriteTableSwitcher))]
    public class Gs2InventorySimpleInventoryModelMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleInventoryModelMetadataSpriteTableSwitcher;
            ...
            if (context == null) {
                ...
                if (context.gameObject.GetComponentInParent<Gs2InventorySimpleInventoryModelList>(true) != null) {
                    ...
                    if (context.SimpleInventoryModel != null) {
                        EditorGUI.indentLevel++;
