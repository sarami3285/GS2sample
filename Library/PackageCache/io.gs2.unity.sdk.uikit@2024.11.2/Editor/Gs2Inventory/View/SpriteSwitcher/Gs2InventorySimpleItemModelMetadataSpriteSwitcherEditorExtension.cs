...
{
    [CustomEditor(typeof(Gs2InventorySimpleItemModelMetadataSpriteSwitcher))]
    public class Gs2InventorySimpleItemModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleItemModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2InventorySimpleItemModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2InventorySimpleItemModelMetadataSpriteSwitcher.Expression.NotIn) {
