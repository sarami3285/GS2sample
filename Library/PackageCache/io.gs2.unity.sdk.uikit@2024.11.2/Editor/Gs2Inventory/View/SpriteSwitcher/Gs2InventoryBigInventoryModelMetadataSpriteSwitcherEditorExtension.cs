...
{
    [CustomEditor(typeof(Gs2InventoryBigInventoryModelMetadataSpriteSwitcher))]
    public class Gs2InventoryBigInventoryModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigInventoryModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryBigInventoryModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2InventoryBigInventoryModelMetadataSpriteSwitcher.Expression.NotIn) {
