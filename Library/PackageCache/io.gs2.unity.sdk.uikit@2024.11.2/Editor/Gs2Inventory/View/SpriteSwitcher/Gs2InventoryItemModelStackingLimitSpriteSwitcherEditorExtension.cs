...
{
    [CustomEditor(typeof(Gs2InventoryItemModelStackingLimitSpriteSwitcher))]
    public class Gs2InventoryItemModelStackingLimitSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemModelStackingLimitSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryItemModelStackingLimitSpriteSwitcher.Expression.In || original.expression == Gs2InventoryItemModelStackingLimitSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyStackingLimits"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyStackingLimit"), true);
            }
