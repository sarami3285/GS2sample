...
{
    [CustomEditor(typeof(Gs2InventoryInventoryModelNameSpriteTableSwitcher))]
    public class Gs2InventoryInventoryModelNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryInventoryModelNameSpriteTableSwitcher;
