...
{
    [CustomEditor(typeof(Gs2InventoryOwnItemSetCountSpriteSwitcher))]
    public class Gs2InventoryOwnItemSetCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnItemSetCountSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryOwnItemSetCountSpriteSwitcher.Expression.In || original.expression == Gs2InventoryOwnItemSetCountSpriteSwitcher.Expression.NotIn) {
