...
{
    [CustomEditor(typeof(Gs2InventorySimpleItemModelNameSpriteSwitcher))]
    public class Gs2InventorySimpleItemModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleItemModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventorySimpleItemModelNameSpriteSwitcher.Expression.In || original.expression == Gs2InventorySimpleItemModelNameSpriteSwitcher.Expression.NotIn) {
