...
{
    [CustomEditor(typeof(Gs2InventorySimpleInventoryModelListFetcher))]
    public class Gs2InventorySimpleInventoryModelListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleInventoryModelListFetcher;
