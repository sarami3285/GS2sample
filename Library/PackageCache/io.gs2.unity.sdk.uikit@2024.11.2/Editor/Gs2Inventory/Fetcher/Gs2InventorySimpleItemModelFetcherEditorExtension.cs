...
{
    [CustomEditor(typeof(Gs2InventorySimpleItemModelFetcher))]
    public class Gs2InventorySimpleItemModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleItemModelFetcher;
            ...
            if (context == null) {
                ...
                if (context.gameObject.GetComponentInParent<Gs2InventorySimpleItemModelList>(true) != null) {
                    ...
                    EditorGUILayout.ObjectField("SimpleItemModel", context.SimpleItemModel, typeof(SimpleItemModel), false);
