...
{
    [CustomEditor(typeof(Gs2InventorySimpleInventoryModelFetcher))]
    public class Gs2InventorySimpleInventoryModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleInventoryModelFetcher;
