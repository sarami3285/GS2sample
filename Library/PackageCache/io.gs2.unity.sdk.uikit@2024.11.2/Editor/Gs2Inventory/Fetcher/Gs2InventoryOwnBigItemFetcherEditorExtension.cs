...
{
    [CustomEditor(typeof(Gs2InventoryOwnBigItemFetcher))]
    public class Gs2InventoryOwnBigItemFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnBigItemFetcher;
            ...
            if (context == null) {
                ...
                if (context.gameObject.GetComponentInParent<Gs2InventoryOwnBigItemList>(true) != null) {
                    ...
                    EditorGUILayout.ObjectField("BigItem", context.BigItem, typeof(OwnBigItem), false);
