...
{
    [CustomEditor(typeof(Gs2InventoryAddCapacityByUserIdFetcher))]
    public class Gs2InventoryAddCapacityByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryAddCapacityByUserIdFetcher;
