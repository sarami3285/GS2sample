...
{
    [CustomEditor(typeof(Gs2InventorySetSimpleItemsByUserIdFetcher))]
    public class Gs2InventorySetSimpleItemsByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySetSimpleItemsByUserIdFetcher;
