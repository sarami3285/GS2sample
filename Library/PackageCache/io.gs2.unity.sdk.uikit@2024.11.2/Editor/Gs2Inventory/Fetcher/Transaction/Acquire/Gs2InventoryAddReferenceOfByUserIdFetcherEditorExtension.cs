...
{
    [CustomEditor(typeof(Gs2InventoryAddReferenceOfByUserIdFetcher))]
    public class Gs2InventoryAddReferenceOfByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryAddReferenceOfByUserIdFetcher;
