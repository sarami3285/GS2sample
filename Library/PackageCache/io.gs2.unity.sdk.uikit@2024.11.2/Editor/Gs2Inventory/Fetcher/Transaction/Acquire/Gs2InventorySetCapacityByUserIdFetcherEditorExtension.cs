...
{
    [CustomEditor(typeof(Gs2InventorySetCapacityByUserIdFetcher))]
    public class Gs2InventorySetCapacityByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySetCapacityByUserIdFetcher;
