...
{
    [CustomEditor(typeof(Gs2InventoryVerifyBigItemByUserIdFetcher))]
    public class Gs2InventoryVerifyBigItemByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryVerifyBigItemByUserIdFetcher;
