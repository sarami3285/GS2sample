...
{
    [CustomEditor(typeof(Gs2InventoryBigItemModelFetcher))]
    public class Gs2InventoryBigItemModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigItemModelFetcher;
            ...
            if (context == null) {
                ...
                if (context.gameObject.GetComponentInParent<Gs2InventoryBigItemModelList>(true) != null) {
                    ...
                    EditorGUILayout.ObjectField("BigItemModel", context.BigItemModel, typeof(BigItemModel), false);
