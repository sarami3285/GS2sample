...
{
    [CustomEditor(typeof(Gs2InventoryOwnSimpleItemFetcher))]
    public class Gs2InventoryOwnSimpleItemFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryOwnSimpleItemFetcher;
            ...
            if (context == null) {
                ...
                if (context.gameObject.GetComponentInParent<Gs2InventoryOwnSimpleItemList>(true) != null) {
                    ...
                    EditorGUILayout.ObjectField("SimpleItem", context.SimpleItem, typeof(OwnSimpleItem), false);
