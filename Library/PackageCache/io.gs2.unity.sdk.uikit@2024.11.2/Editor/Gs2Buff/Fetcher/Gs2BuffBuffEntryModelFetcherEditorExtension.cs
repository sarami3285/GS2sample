...
{
    [CustomEditor(typeof(Gs2BuffBuffEntryModelFetcher))]
    public class Gs2BuffBuffEntryModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2BuffBuffEntryModelFetcher;
            ...
            if (context == null) {
                ...
                if (context.gameObject.GetComponentInParent<Gs2BuffBuffEntryModelList>(true) != null) {
                    ...
                    EditorGUILayout.ObjectField("BuffEntryModel", context.BuffEntryModel, typeof(BuffEntryModel), false);
