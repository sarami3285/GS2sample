...
{
    [CustomEditor(typeof(Gs2BuffBuffEntryModelExpressionEnabler))]
    public class Gs2BuffBuffEntryModelExpressionEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2BuffBuffEntryModelExpressionEnabler;
            ...
            if (original.expression == Gs2BuffBuffEntryModelExpressionEnabler.Expression.In || original.expression == Gs2BuffBuffEntryModelExpressionEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableExpressions"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableExpression"), true);
            }
