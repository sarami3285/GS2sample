...
{
    [CustomEditor(typeof(Gs2BuffBuffEntryModelTargetTypeEnabler))]
    public class Gs2BuffBuffEntryModelTargetTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2BuffBuffEntryModelTargetTypeEnabler;
            ...
            if (original.expression == Gs2BuffBuffEntryModelTargetTypeEnabler.Expression.In || original.expression == Gs2BuffBuffEntryModelTargetTypeEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTargetTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTargetType"), true);
            }
