...
{
    [CustomEditor(typeof(Gs2BuffBuffEntryModelEnabler))]
    public class Gs2BuffBuffEntryModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2BuffBuffEntryModelEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("BuffEntryModelFetcher not assigned.", MessageType.Error);
