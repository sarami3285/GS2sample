...
{
    [CustomEditor(typeof(Gs2BuffBuffEntryModelMetadataEnabler))]
    public class Gs2BuffBuffEntryModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2BuffBuffEntryModelMetadataEnabler;
            ...
            if (original.expression == Gs2BuffBuffEntryModelMetadataEnabler.Expression.In || original.expression == Gs2BuffBuffEntryModelMetadataEnabler.Expression.NotIn) {
