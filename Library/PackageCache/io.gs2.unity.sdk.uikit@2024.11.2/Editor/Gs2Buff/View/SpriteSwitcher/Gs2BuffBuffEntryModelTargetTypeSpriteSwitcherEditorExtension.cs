...
{
    [CustomEditor(typeof(Gs2BuffBuffEntryModelTargetTypeSpriteSwitcher))]
    public class Gs2BuffBuffEntryModelTargetTypeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2BuffBuffEntryModelTargetTypeSpriteSwitcher;
            ...
            if (original.expression == Gs2BuffBuffEntryModelTargetTypeSpriteSwitcher.Expression.In || original.expression == Gs2BuffBuffEntryModelTargetTypeSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTargetTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTargetType"), true);
            }
