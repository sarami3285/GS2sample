...
{
    [CustomEditor(typeof(Gs2BuffBuffEntryModelNameSpriteTableSwitcher))]
    public class Gs2BuffBuffEntryModelNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2BuffBuffEntryModelNameSpriteTableSwitcher;
