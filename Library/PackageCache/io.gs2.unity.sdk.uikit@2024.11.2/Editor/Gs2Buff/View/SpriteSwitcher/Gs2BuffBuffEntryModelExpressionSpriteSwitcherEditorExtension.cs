...
{
    [CustomEditor(typeof(Gs2BuffBuffEntryModelExpressionSpriteSwitcher))]
    public class Gs2BuffBuffEntryModelExpressionSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2BuffBuffEntryModelExpressionSpriteSwitcher;
            ...
            if (original.expression == Gs2BuffBuffEntryModelExpressionSpriteSwitcher.Expression.In || original.expression == Gs2BuffBuffEntryModelExpressionSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyExpressions"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyExpression"), true);
            }
