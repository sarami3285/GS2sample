...
{
    [CustomEditor(typeof(Gs2BuffBuffEntryModelNameSpriteSwitcher))]
    public class Gs2BuffBuffEntryModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2BuffBuffEntryModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2BuffBuffEntryModelNameSpriteSwitcher.Expression.In || original.expression == Gs2BuffBuffEntryModelNameSpriteSwitcher.Expression.NotIn) {
