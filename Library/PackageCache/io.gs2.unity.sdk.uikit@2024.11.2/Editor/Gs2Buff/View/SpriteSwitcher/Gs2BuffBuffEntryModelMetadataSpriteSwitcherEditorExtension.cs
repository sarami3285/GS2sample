...
{
    [CustomEditor(typeof(Gs2BuffBuffEntryModelMetadataSpriteSwitcher))]
    public class Gs2BuffBuffEntryModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2BuffBuffEntryModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2BuffBuffEntryModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2BuffBuffEntryModelMetadataSpriteSwitcher.Expression.NotIn) {
