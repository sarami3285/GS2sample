...
{
    [CustomEditor(typeof(Gs2GradeVerifyGradeByUserIdFetcher))]
    public class Gs2GradeVerifyGradeByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeVerifyGradeByUserIdFetcher;
