...
{
    [CustomEditor(typeof(Gs2GradeSubGradeByUserIdFetcher))]
    public class Gs2GradeSubGradeByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeSubGradeByUserIdFetcher;
