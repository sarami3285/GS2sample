...
{
    [CustomEditor(typeof(Gs2GradeVerifyGradeUpMaterialByUserIdFetcher))]
    public class Gs2GradeVerifyGradeUpMaterialByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeVerifyGradeUpMaterialByUserIdFetcher;
