...
{
    [CustomEditor(typeof(Gs2GradeAddGradeByUserIdFetcher))]
    public class Gs2GradeAddGradeByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeAddGradeByUserIdFetcher;
