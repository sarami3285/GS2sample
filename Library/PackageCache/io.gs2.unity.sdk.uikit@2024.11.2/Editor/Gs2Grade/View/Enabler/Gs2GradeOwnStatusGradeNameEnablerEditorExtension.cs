...
{
    [CustomEditor(typeof(Gs2GradeOwnStatusGradeNameEnabler))]
    public class Gs2GradeOwnStatusGradeNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeOwnStatusGradeNameEnabler;
            ...
            if (original.expression == Gs2GradeOwnStatusGradeNameEnabler.Expression.In || original.expression == Gs2GradeOwnStatusGradeNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableGradeNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableGradeName"), true);
            }
