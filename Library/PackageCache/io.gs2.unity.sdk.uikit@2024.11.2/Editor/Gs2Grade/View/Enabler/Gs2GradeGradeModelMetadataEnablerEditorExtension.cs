...
{
    [CustomEditor(typeof(Gs2GradeGradeModelMetadataEnabler))]
    public class Gs2GradeGradeModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeGradeModelMetadataEnabler;
            ...
            if (original.expression == Gs2GradeGradeModelMetadataEnabler.Expression.In || original.expression == Gs2GradeGradeModelMetadataEnabler.Expression.NotIn) {
