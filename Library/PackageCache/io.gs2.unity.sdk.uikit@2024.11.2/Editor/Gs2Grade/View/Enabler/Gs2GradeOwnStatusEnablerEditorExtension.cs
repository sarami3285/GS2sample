...
{
    [CustomEditor(typeof(Gs2GradeOwnStatusEnabler))]
    public class Gs2GradeOwnStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeOwnStatusEnabler;
