...
{
    [CustomEditor(typeof(Gs2GradeOwnStatusGradeValueEnabler))]
    public class Gs2GradeOwnStatusGradeValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeOwnStatusGradeValueEnabler;
            ...
            if (original.expression == Gs2GradeOwnStatusGradeValueEnabler.Expression.In || original.expression == Gs2GradeOwnStatusGradeValueEnabler.Expression.NotIn) {
