...
{
    [CustomEditor(typeof(Gs2GradeSubGradeByUserIdEnabler))]
    public class Gs2GradeSubGradeByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeSubGradeByUserIdEnabler;
