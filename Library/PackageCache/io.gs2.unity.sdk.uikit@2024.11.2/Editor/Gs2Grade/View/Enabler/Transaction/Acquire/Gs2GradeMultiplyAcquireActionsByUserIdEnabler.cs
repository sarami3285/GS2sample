...
{
    [CustomEditor(typeof(Gs2GradeMultiplyAcquireActionsByUserIdEnabler))]
    public class Gs2GradeMultiplyAcquireActionsByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeMultiplyAcquireActionsByUserIdEnabler;
