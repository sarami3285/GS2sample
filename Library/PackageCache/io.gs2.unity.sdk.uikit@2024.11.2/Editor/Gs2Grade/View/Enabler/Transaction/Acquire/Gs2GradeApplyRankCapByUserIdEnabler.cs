...
{
    [CustomEditor(typeof(Gs2GradeApplyRankCapByUserIdEnabler))]
    public class Gs2GradeApplyRankCapByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeApplyRankCapByUserIdEnabler;
