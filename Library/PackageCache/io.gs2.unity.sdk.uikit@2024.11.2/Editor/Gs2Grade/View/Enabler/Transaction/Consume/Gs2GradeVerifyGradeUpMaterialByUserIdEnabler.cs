...
{
    [CustomEditor(typeof(Gs2GradeVerifyGradeUpMaterialByUserIdEnabler))]
    public class Gs2GradeVerifyGradeUpMaterialByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeVerifyGradeUpMaterialByUserIdEnabler;
