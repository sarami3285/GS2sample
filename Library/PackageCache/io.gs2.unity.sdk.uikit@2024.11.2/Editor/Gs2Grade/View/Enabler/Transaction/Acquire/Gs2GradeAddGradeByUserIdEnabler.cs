...
{
    [CustomEditor(typeof(Gs2GradeAddGradeByUserIdEnabler))]
    public class Gs2GradeAddGradeByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeAddGradeByUserIdEnabler;
