...
{
    [CustomEditor(typeof(Gs2GradeVerifyGradeByUserIdEnabler))]
    public class Gs2GradeVerifyGradeByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeVerifyGradeByUserIdEnabler;
