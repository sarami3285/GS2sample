...
{
    [CustomEditor(typeof(Gs2GradeSubGradeByUserIdValueEnabler))]
    public class Gs2GradeSubGradeByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeSubGradeByUserIdValueEnabler;
            ...
            if (original.expression == Gs2GradeSubGradeByUserIdValueEnabler.Expression.In || original.expression == Gs2GradeSubGradeByUserIdValueEnabler.Expression.NotIn) {
