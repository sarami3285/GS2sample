...
{
    [CustomEditor(typeof(Gs2GradeOwnStatusPropertyIdEnabler))]
    public class Gs2GradeOwnStatusPropertyIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeOwnStatusPropertyIdEnabler;
            ...
            if (original.expression == Gs2GradeOwnStatusPropertyIdEnabler.Expression.In || original.expression == Gs2GradeOwnStatusPropertyIdEnabler.Expression.NotIn) {
