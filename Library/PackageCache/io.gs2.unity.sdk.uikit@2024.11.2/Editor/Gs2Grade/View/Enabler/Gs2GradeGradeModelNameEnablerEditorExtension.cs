...
{
    [CustomEditor(typeof(Gs2GradeGradeModelNameEnabler))]
    public class Gs2GradeGradeModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeGradeModelNameEnabler;
            ...
            if (original.expression == Gs2GradeGradeModelNameEnabler.Expression.In || original.expression == Gs2GradeGradeModelNameEnabler.Expression.NotIn) {
