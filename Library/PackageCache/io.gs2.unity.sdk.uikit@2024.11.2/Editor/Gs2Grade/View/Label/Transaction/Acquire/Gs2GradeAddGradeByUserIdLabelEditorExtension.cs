...
{
    [CustomEditor(typeof(Gs2GradeAddGradeByUserIdLabel))]
    public class Gs2GradeAddGradeByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeAddGradeByUserIdLabel;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2GradeAddGradeByUserIdFetcher>() ?? original.GetComponentInParent<Gs2GradeAddGradeByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2GradeAddGradeByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2GradeAddGradeByUserIdFetcher>();
                }
            }
