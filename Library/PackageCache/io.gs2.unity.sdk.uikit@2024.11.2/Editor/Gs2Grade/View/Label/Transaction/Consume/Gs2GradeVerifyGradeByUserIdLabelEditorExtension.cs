...
{
    [CustomEditor(typeof(Gs2GradeVerifyGradeByUserIdLabel))]
    public class Gs2GradeVerifyGradeByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeVerifyGradeByUserIdLabel;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2GradeVerifyGradeByUserIdFetcher>() ?? original.GetComponentInParent<Gs2GradeVerifyGradeByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2GradeVerifyGradeByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2GradeVerifyGradeByUserIdFetcher>();
                }
            }
