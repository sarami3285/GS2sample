...
{
    [CustomEditor(typeof(Gs2GradeApplyRankCapByUserIdLabel))]
    public class Gs2GradeApplyRankCapByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeApplyRankCapByUserIdLabel;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2GradeApplyRankCapByUserIdFetcher>() ?? original.GetComponentInParent<Gs2GradeApplyRankCapByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2GradeApplyRankCapByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2GradeApplyRankCapByUserIdFetcher>();
                }
            }
