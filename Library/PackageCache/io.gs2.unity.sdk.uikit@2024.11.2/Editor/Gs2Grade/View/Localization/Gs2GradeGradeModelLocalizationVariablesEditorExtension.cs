...
{
    [CustomEditor(typeof(Gs2GradeGradeModelLocalizationVariables))]
    public class Gs2GradeGradeModelLocalizationVariablesEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeGradeModelLocalizationVariables;
            ...
            if (fetcher == null) {
                ...
                if (fetcher.gameObject.GetComponentInParent<Gs2GradeGradeModelList>(true) != null) {
                    ...
                    context.GradeModel = EditorGUILayout.ObjectField("GradeModel", context.GradeModel, typeof(GradeModel), false) as GradeModel;
