...
{
    [CustomEditor(typeof(Gs2GradeGradeModelMetadataSpriteSwitcher))]
    public class Gs2GradeGradeModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeGradeModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2GradeGradeModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2GradeGradeModelMetadataSpriteSwitcher.Expression.NotIn) {
