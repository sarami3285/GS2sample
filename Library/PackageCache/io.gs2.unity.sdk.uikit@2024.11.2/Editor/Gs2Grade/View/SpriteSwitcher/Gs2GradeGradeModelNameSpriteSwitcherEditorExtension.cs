...
{
    [CustomEditor(typeof(Gs2GradeGradeModelNameSpriteSwitcher))]
    public class Gs2GradeGradeModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeGradeModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2GradeGradeModelNameSpriteSwitcher.Expression.In || original.expression == Gs2GradeGradeModelNameSpriteSwitcher.Expression.NotIn) {
