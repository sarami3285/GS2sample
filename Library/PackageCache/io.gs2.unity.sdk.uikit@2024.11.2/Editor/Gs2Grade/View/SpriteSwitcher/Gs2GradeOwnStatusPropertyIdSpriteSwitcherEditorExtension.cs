...
{
    [CustomEditor(typeof(Gs2GradeOwnStatusPropertyIdSpriteSwitcher))]
    public class Gs2GradeOwnStatusPropertyIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeOwnStatusPropertyIdSpriteSwitcher;
            ...
            if (original.expression == Gs2GradeOwnStatusPropertyIdSpriteSwitcher.Expression.In || original.expression == Gs2GradeOwnStatusPropertyIdSpriteSwitcher.Expression.NotIn) {
