...
{
    [CustomEditor(typeof(Gs2GradeOwnStatusGradeNameSpriteTableSwitcher))]
    public class Gs2GradeOwnStatusGradeNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeOwnStatusGradeNameSpriteTableSwitcher;
