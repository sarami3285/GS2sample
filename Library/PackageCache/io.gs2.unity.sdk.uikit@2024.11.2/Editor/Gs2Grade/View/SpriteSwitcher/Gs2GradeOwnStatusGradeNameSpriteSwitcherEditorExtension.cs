...
namespace Gs2.Unity.UiKit.Gs2Grade.SpriteSwitcher.Editor
{
    [CustomEditor(typeof(Gs2GradeOwnStatusGradeNameSpriteSwitcher))]
    public class Gs2GradeOwnStatusGradeNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeOwnStatusGradeNameSpriteSwitcher;
            ...
            if (original.expression == Gs2GradeOwnStatusGradeNameSpriteSwitcher.Expression.In || original.expression == Gs2GradeOwnStatusGradeNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyGradeNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyGradeName"), true);
            }
