...
{
    [CustomEditor(typeof(Gs2GradeOwnStatusPropertyIdSpriteTableSwitcher))]
    public class Gs2GradeOwnStatusPropertyIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeOwnStatusPropertyIdSpriteTableSwitcher;
