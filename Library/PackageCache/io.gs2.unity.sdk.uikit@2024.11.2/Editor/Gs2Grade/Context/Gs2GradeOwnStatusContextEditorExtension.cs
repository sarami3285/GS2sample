...
{
    [CustomEditor(typeof(Gs2GradeOwnStatusContext))]
    public class Gs2GradeOwnStatusContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeOwnStatusContext;
            ...
            if (original.Status == null) {
                var list = original.GetComponentInParent<Gs2GradeOwnStatusList>(true);
                if (list != null) {
                    EditorGUILayout.HelpBox("Status is auto assign from Gs2GradeOwnStatusList.", MessageType.Info);
                    EditorGUI.BeginDisabledGroup(true);
                    EditorGUILayout.ObjectField("List", list, typeof(Gs2GradeOwnStatusList), false);
                ...
                if (original.Status != null) {
                    ...
                    EditorGUILayout.TextField("GradeName", original.Status?.GradeName?.ToString());
