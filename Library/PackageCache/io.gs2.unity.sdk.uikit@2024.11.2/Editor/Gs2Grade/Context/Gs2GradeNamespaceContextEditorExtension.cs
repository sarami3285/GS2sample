...
{
    [CustomEditor(typeof(Gs2GradeNamespaceContext))]
    public class Gs2GradeNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GradeNamespaceContext;
