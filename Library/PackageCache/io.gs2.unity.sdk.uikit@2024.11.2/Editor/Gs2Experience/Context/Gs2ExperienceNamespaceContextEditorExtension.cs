...
{
    [CustomEditor(typeof(Gs2ExperienceNamespaceContext))]
    public class Gs2ExperienceNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceNamespaceContext;
