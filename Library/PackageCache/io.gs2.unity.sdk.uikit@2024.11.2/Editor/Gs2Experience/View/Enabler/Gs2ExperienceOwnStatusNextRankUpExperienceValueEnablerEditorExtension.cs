...
{
    [CustomEditor(typeof(Gs2ExperienceOwnStatusNextRankUpExperienceValueEnabler))]
    public class Gs2ExperienceOwnStatusNextRankUpExperienceValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceOwnStatusNextRankUpExperienceValueEnabler;
            ...
            if (original.expression == Gs2ExperienceOwnStatusNextRankUpExperienceValueEnabler.Expression.In || original.expression == Gs2ExperienceOwnStatusNextRankUpExperienceValueEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableNextRankUpExperienceValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableNextRankUpExperienceValue"), true);
            }
