...
{
    [CustomEditor(typeof(Gs2ExperienceOwnStatusPropertyIdEnabler))]
    public class Gs2ExperienceOwnStatusPropertyIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceOwnStatusPropertyIdEnabler;
            ...
            if (original.expression == Gs2ExperienceOwnStatusPropertyIdEnabler.Expression.In || original.expression == Gs2ExperienceOwnStatusPropertyIdEnabler.Expression.NotIn) {
