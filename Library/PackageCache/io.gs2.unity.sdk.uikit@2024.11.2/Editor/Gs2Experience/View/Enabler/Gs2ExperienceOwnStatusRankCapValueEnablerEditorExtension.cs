...
{
    [CustomEditor(typeof(Gs2ExperienceOwnStatusRankCapValueEnabler))]
    public class Gs2ExperienceOwnStatusRankCapValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceOwnStatusRankCapValueEnabler;
            ...
            if (original.expression == Gs2ExperienceOwnStatusRankCapValueEnabler.Expression.In || original.expression == Gs2ExperienceOwnStatusRankCapValueEnabler.Expression.NotIn) {
