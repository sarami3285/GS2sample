...
{
    [CustomEditor(typeof(Gs2ExperienceExperienceModelMetadataEnabler))]
    public class Gs2ExperienceExperienceModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceExperienceModelMetadataEnabler;
            ...
            if (original.expression == Gs2ExperienceExperienceModelMetadataEnabler.Expression.In || original.expression == Gs2ExperienceExperienceModelMetadataEnabler.Expression.NotIn) {
