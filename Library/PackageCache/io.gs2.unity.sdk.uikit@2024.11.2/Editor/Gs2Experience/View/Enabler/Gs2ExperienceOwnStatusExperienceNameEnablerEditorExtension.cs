...
{
    [CustomEditor(typeof(Gs2ExperienceOwnStatusExperienceNameEnabler))]
    public class Gs2ExperienceOwnStatusExperienceNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceOwnStatusExperienceNameEnabler;
            ...
            if (original.expression == Gs2ExperienceOwnStatusExperienceNameEnabler.Expression.In || original.expression == Gs2ExperienceOwnStatusExperienceNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableExperienceNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableExperienceName"), true);
            }
