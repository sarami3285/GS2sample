...
{
    [CustomEditor(typeof(Gs2ExperienceOwnStatusExperienceValueEnabler))]
    public class Gs2ExperienceOwnStatusExperienceValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceOwnStatusExperienceValueEnabler;
            ...
            if (original.expression == Gs2ExperienceOwnStatusExperienceValueEnabler.Expression.In || original.expression == Gs2ExperienceOwnStatusExperienceValueEnabler.Expression.NotIn) {
