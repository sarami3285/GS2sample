...
{
    [CustomEditor(typeof(Gs2ExperienceExperienceModelDefaultExperienceEnabler))]
    public class Gs2ExperienceExperienceModelDefaultExperienceEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceExperienceModelDefaultExperienceEnabler;
            ...
            if (original.expression == Gs2ExperienceExperienceModelDefaultExperienceEnabler.Expression.In || original.expression == Gs2ExperienceExperienceModelDefaultExperienceEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableDefaultExperiences"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableDefaultExperience"), true);
            }
