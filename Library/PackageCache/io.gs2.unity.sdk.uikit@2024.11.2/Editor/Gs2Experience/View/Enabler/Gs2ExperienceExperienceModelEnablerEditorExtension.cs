...
{
    [CustomEditor(typeof(Gs2ExperienceExperienceModelEnabler))]
    public class Gs2ExperienceExperienceModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceExperienceModelEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("ExperienceModelFetcher not assigned.", MessageType.Error);
