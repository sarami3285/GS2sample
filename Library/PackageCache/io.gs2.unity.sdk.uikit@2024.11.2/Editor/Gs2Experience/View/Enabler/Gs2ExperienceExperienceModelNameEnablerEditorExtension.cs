...
namespace Gs2.Unity.UiKit.Gs2Experience.Enabler.Editor
{
    ...
    public class Gs2ExperienceExperienceModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceExperienceModelNameEnabler;
            ...
            if (original.expression == Gs2ExperienceExperienceModelNameEnabler.Expression.In || original.expression == Gs2ExperienceExperienceModelNameEnabler.Expression.NotIn) {
