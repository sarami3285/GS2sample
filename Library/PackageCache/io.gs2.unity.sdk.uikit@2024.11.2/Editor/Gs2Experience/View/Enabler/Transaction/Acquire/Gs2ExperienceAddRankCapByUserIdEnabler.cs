...
{
    [CustomEditor(typeof(Gs2ExperienceAddRankCapByUserIdEnabler))]
    public class Gs2ExperienceAddRankCapByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceAddRankCapByUserIdEnabler;
