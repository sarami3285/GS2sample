...
{
    [CustomEditor(typeof(Gs2ExperienceAddExperienceByUserIdEnabler))]
    public class Gs2ExperienceAddExperienceByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceAddExperienceByUserIdEnabler;
