...
{
    [CustomEditor(typeof(Gs2ExperienceSetExperienceByUserIdValueEnabler))]
    public class Gs2ExperienceSetExperienceByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceSetExperienceByUserIdValueEnabler;
            ...
            if (original.expression == Gs2ExperienceSetExperienceByUserIdValueEnabler.Expression.In || original.expression == Gs2ExperienceSetExperienceByUserIdValueEnabler.Expression.NotIn) {
