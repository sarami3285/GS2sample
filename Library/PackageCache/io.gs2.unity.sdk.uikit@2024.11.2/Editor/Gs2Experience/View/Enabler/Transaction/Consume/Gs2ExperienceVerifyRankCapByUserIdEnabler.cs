...
{
    [CustomEditor(typeof(Gs2ExperienceVerifyRankCapByUserIdEnabler))]
    public class Gs2ExperienceVerifyRankCapByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceVerifyRankCapByUserIdEnabler;
