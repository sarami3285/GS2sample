...
{
    [CustomEditor(typeof(Gs2ExperienceSubRankCapByUserIdEnabler))]
    public class Gs2ExperienceSubRankCapByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceSubRankCapByUserIdEnabler;
