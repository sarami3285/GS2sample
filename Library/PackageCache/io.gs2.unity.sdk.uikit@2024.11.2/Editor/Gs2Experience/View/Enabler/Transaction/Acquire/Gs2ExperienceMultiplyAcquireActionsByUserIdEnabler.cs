...
{
    [CustomEditor(typeof(Gs2ExperienceMultiplyAcquireActionsByUserIdEnabler))]
    public class Gs2ExperienceMultiplyAcquireActionsByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceMultiplyAcquireActionsByUserIdEnabler;
