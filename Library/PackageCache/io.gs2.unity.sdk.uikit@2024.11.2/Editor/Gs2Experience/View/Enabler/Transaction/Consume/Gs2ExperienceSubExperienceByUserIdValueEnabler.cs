...
{
    [CustomEditor(typeof(Gs2ExperienceSubExperienceByUserIdValueEnabler))]
    public class Gs2ExperienceSubExperienceByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceSubExperienceByUserIdValueEnabler;
            ...
            if (original.expression == Gs2ExperienceSubExperienceByUserIdValueEnabler.Expression.In || original.expression == Gs2ExperienceSubExperienceByUserIdValueEnabler.Expression.NotIn) {
