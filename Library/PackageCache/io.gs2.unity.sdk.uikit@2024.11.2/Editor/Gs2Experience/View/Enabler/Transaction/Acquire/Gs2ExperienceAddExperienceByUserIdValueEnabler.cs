...
{
    [CustomEditor(typeof(Gs2ExperienceAddExperienceByUserIdValueEnabler))]
    public class Gs2ExperienceAddExperienceByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceAddExperienceByUserIdValueEnabler;
            ...
            if (original.expression == Gs2ExperienceAddExperienceByUserIdValueEnabler.Expression.In || original.expression == Gs2ExperienceAddExperienceByUserIdValueEnabler.Expression.NotIn) {
