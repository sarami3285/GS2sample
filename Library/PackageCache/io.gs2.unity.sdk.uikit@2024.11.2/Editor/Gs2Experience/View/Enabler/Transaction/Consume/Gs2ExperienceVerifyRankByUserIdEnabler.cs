...
{
    [CustomEditor(typeof(Gs2ExperienceVerifyRankByUserIdEnabler))]
    public class Gs2ExperienceVerifyRankByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceVerifyRankByUserIdEnabler;
