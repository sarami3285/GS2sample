...
{
    [CustomEditor(typeof(Gs2ExperienceSetExperienceByUserIdEnabler))]
    public class Gs2ExperienceSetExperienceByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceSetExperienceByUserIdEnabler;
