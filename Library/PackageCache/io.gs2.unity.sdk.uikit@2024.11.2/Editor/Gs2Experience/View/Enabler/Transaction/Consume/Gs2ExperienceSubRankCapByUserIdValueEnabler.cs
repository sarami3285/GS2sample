...
{
    [CustomEditor(typeof(Gs2ExperienceSubRankCapByUserIdValueEnabler))]
    public class Gs2ExperienceSubRankCapByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceSubRankCapByUserIdValueEnabler;
            ...
            if (original.expression == Gs2ExperienceSubRankCapByUserIdValueEnabler.Expression.In || original.expression == Gs2ExperienceSubRankCapByUserIdValueEnabler.Expression.NotIn) {
