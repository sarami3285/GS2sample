...
{
    [CustomEditor(typeof(Gs2ExperienceSetRankCapByUserIdEnabler))]
    public class Gs2ExperienceSetRankCapByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceSetRankCapByUserIdEnabler;
