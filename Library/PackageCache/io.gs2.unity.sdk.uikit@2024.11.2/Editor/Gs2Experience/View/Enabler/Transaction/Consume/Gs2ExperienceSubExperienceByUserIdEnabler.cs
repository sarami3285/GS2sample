...
{
    [CustomEditor(typeof(Gs2ExperienceSubExperienceByUserIdEnabler))]
    public class Gs2ExperienceSubExperienceByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceSubExperienceByUserIdEnabler;
