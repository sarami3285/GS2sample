...
{
    [CustomEditor(typeof(Gs2ExperienceOwnStatusExperienceValueSpriteSwitcher))]
    public class Gs2ExperienceOwnStatusExperienceValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceOwnStatusExperienceValueSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceOwnStatusExperienceValueSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceOwnStatusExperienceValueSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyExperienceValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyExperienceValue"), true);
            }
