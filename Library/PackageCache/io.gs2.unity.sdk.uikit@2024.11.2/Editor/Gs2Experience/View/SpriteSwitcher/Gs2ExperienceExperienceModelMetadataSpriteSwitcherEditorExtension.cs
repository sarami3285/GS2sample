...
{
    [CustomEditor(typeof(Gs2ExperienceExperienceModelMetadataSpriteSwitcher))]
    public class Gs2ExperienceExperienceModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceExperienceModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceExperienceModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceExperienceModelMetadataSpriteSwitcher.Expression.NotIn) {
