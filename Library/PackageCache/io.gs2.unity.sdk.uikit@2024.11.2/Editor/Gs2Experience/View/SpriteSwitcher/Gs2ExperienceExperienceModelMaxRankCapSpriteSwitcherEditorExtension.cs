...
{
    [CustomEditor(typeof(Gs2ExperienceExperienceModelMaxRankCapSpriteSwitcher))]
    public class Gs2ExperienceExperienceModelMaxRankCapSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceExperienceModelMaxRankCapSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceExperienceModelMaxRankCapSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceExperienceModelMaxRankCapSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMaxRankCaps"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMaxRankCap"), true);
            }
