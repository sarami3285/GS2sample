...
{
    [CustomEditor(typeof(Gs2ExperienceExperienceModelDefaultExperienceSpriteSwitcher))]
    public class Gs2ExperienceExperienceModelDefaultExperienceSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceExperienceModelDefaultExperienceSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceExperienceModelDefaultExperienceSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceExperienceModelDefaultExperienceSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyDefaultExperiences"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyDefaultExperience"), true);
            }
