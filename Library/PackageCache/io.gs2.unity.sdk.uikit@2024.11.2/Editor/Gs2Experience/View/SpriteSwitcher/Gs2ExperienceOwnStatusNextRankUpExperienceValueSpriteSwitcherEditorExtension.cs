...
{
    [CustomEditor(typeof(Gs2ExperienceOwnStatusNextRankUpExperienceValueSpriteSwitcher))]
    public class Gs2ExperienceOwnStatusNextRankUpExperienceValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceOwnStatusNextRankUpExperienceValueSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceOwnStatusNextRankUpExperienceValueSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceOwnStatusNextRankUpExperienceValueSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyNextRankUpExperienceValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyNextRankUpExperienceValue"), true);
            }
