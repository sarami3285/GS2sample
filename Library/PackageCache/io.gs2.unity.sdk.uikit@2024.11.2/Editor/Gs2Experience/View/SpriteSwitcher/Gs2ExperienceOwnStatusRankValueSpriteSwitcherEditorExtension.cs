...
{
    [CustomEditor(typeof(Gs2ExperienceOwnStatusRankValueSpriteSwitcher))]
    public class Gs2ExperienceOwnStatusRankValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceOwnStatusRankValueSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceOwnStatusRankValueSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceOwnStatusRankValueSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRankValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRankValue"), true);
            }
