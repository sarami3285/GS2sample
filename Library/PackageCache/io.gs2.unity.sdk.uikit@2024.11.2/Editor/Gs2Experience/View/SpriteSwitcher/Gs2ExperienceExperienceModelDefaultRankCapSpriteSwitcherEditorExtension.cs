...
{
    [CustomEditor(typeof(Gs2ExperienceExperienceModelDefaultRankCapSpriteSwitcher))]
    public class Gs2ExperienceExperienceModelDefaultRankCapSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceExperienceModelDefaultRankCapSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceExperienceModelDefaultRankCapSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceExperienceModelDefaultRankCapSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyDefaultRankCaps"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyDefaultRankCap"), true);
            }
