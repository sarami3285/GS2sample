...
{
    [CustomEditor(typeof(Gs2ExperienceOwnStatusRankCapValueSpriteSwitcher))]
    public class Gs2ExperienceOwnStatusRankCapValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceOwnStatusRankCapValueSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceOwnStatusRankCapValueSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceOwnStatusRankCapValueSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRankCapValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRankCapValue"), true);
            }
