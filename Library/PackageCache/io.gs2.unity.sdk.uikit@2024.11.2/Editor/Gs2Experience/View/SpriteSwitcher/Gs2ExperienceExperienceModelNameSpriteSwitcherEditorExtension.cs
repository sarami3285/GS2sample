...
{
    [CustomEditor(typeof(Gs2ExperienceExperienceModelNameSpriteSwitcher))]
    public class Gs2ExperienceExperienceModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceExperienceModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceExperienceModelNameSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceExperienceModelNameSpriteSwitcher.Expression.NotIn) {
