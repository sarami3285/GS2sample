...
{
    [CustomEditor(typeof(Gs2ExperienceOwnStatusExperienceNameSpriteSwitcher))]
    public class Gs2ExperienceOwnStatusExperienceNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceOwnStatusExperienceNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceOwnStatusExperienceNameSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceOwnStatusExperienceNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyExperienceNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyExperienceName"), true);
            }
