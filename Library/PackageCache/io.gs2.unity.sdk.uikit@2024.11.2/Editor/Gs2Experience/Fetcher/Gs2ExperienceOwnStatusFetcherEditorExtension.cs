...
{
    [CustomEditor(typeof(Gs2ExperienceOwnStatusFetcher))]
    public class Gs2ExperienceOwnStatusFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceOwnStatusFetcher;
