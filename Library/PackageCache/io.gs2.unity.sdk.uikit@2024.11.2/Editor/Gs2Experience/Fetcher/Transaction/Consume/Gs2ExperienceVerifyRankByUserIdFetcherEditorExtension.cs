...
{
    [CustomEditor(typeof(Gs2ExperienceVerifyRankByUserIdFetcher))]
    public class Gs2ExperienceVerifyRankByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceVerifyRankByUserIdFetcher;
