...
{
    [CustomEditor(typeof(Gs2ExperienceVerifyRankCapByUserIdFetcher))]
    public class Gs2ExperienceVerifyRankCapByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceVerifyRankCapByUserIdFetcher;
