...
{
    [CustomEditor(typeof(Gs2ExperienceSubRankCapByUserIdFetcher))]
    public class Gs2ExperienceSubRankCapByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceSubRankCapByUserIdFetcher;
