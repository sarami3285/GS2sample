...
{
    [CustomEditor(typeof(Gs2ExperienceSubExperienceByUserIdFetcher))]
    public class Gs2ExperienceSubExperienceByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceSubExperienceByUserIdFetcher;
