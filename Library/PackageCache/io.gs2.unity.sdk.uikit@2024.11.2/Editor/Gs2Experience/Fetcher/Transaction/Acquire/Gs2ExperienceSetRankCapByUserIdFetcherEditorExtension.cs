...
{
    [CustomEditor(typeof(Gs2ExperienceSetRankCapByUserIdFetcher))]
    public class Gs2ExperienceSetRankCapByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceSetRankCapByUserIdFetcher;
