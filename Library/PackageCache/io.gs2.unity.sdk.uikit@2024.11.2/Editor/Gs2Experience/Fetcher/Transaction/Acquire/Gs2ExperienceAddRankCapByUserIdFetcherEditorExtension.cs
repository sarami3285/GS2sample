...
{
    [CustomEditor(typeof(Gs2ExperienceAddRankCapByUserIdFetcher))]
    public class Gs2ExperienceAddRankCapByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceAddRankCapByUserIdFetcher;
