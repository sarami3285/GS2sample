...
namespace Gs2.Unity.UiKit.Gs2Experience.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2ExperienceMultiplyAcquireActionsByUserIdFetcher))]
    public class Gs2ExperienceMultiplyAcquireActionsByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceMultiplyAcquireActionsByUserIdFetcher;
