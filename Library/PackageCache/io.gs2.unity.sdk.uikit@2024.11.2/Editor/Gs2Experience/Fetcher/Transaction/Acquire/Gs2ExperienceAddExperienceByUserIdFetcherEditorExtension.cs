...
{
    [CustomEditor(typeof(Gs2ExperienceAddExperienceByUserIdFetcher))]
    public class Gs2ExperienceAddExperienceByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceAddExperienceByUserIdFetcher;
