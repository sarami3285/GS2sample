...
{
    [CustomEditor(typeof(Gs2ExperienceSetExperienceByUserIdFetcher))]
    public class Gs2ExperienceSetExperienceByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceSetExperienceByUserIdFetcher;
