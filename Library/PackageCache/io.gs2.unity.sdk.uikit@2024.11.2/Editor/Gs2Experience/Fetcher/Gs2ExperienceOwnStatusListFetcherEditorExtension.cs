...
{
    [CustomEditor(typeof(Gs2ExperienceOwnStatusListFetcher))]
    public class Gs2ExperienceOwnStatusListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceOwnStatusListFetcher;
