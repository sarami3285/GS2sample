...
{
    [CustomEditor(typeof(Gs2VersionOwnAcceptVersionVersionNameEnabler))]
    public class Gs2VersionOwnAcceptVersionVersionNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionOwnAcceptVersionVersionNameEnabler;
            ...
            if (original.expression == Gs2VersionOwnAcceptVersionVersionNameEnabler.Expression.In || original.expression == Gs2VersionOwnAcceptVersionVersionNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableVersionNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableVersionName"), true);
            }
