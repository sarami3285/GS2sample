...
{
    [CustomEditor(typeof(Gs2VersionOwnAcceptVersionUserIdEnabler))]
    public class Gs2VersionOwnAcceptVersionUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionOwnAcceptVersionUserIdEnabler;
            ...
            if (original.expression == Gs2VersionOwnAcceptVersionUserIdEnabler.Expression.In || original.expression == Gs2VersionOwnAcceptVersionUserIdEnabler.Expression.NotIn) {
