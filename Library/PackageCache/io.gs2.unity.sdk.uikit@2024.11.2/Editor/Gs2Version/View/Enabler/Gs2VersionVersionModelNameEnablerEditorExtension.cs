...
{
    [CustomEditor(typeof(Gs2VersionVersionModelNameEnabler))]
    public class Gs2VersionVersionModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionVersionModelNameEnabler;
            ...
            if (original.expression == Gs2VersionVersionModelNameEnabler.Expression.In || original.expression == Gs2VersionVersionModelNameEnabler.Expression.NotIn) {
