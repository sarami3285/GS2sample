...
{
    [CustomEditor(typeof(Gs2VersionVersionModelNameSpriteSwitcher))]
    public class Gs2VersionVersionModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionVersionModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2VersionVersionModelNameSpriteSwitcher.Expression.In || original.expression == Gs2VersionVersionModelNameSpriteSwitcher.Expression.NotIn) {
