...
{
    [CustomEditor(typeof(Gs2VersionVersionModelMetadataSpriteSwitcher))]
    public class Gs2VersionVersionModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionVersionModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2VersionVersionModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2VersionVersionModelMetadataSpriteSwitcher.Expression.NotIn) {
