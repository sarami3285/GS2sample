...
{
    [CustomEditor(typeof(Gs2VersionOwnAcceptVersionUserIdSpriteSwitcher))]
    public class Gs2VersionOwnAcceptVersionUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionOwnAcceptVersionUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2VersionOwnAcceptVersionUserIdSpriteSwitcher.Expression.In || original.expression == Gs2VersionOwnAcceptVersionUserIdSpriteSwitcher.Expression.NotIn) {
