...
{
    [CustomEditor(typeof(Gs2VersionVersionModelScopeSpriteSwitcher))]
    public class Gs2VersionVersionModelScopeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionVersionModelScopeSpriteSwitcher;
            ...
            if (original.expression == Gs2VersionVersionModelScopeSpriteSwitcher.Expression.In || original.expression == Gs2VersionVersionModelScopeSpriteSwitcher.Expression.NotIn) {
