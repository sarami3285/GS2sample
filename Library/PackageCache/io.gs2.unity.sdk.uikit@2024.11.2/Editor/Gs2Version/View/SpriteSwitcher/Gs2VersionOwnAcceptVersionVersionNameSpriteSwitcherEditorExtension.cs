...
{
    [CustomEditor(typeof(Gs2VersionOwnAcceptVersionVersionNameSpriteSwitcher))]
    public class Gs2VersionOwnAcceptVersionVersionNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionOwnAcceptVersionVersionNameSpriteSwitcher;
            ...
            if (original.expression == Gs2VersionOwnAcceptVersionVersionNameSpriteSwitcher.Expression.In || original.expression == Gs2VersionOwnAcceptVersionVersionNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyVersionNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyVersionName"), true);
            }
