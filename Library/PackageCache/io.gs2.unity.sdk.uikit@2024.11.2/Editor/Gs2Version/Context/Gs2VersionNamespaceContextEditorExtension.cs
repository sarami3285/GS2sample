...
{
    [CustomEditor(typeof(Gs2VersionNamespaceContext))]
    public class Gs2VersionNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionNamespaceContext;
