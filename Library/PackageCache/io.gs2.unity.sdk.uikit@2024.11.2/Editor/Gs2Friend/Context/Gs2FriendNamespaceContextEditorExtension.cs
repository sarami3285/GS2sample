...
{
    [CustomEditor(typeof(Gs2FriendNamespaceContext))]
    public class Gs2FriendNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendNamespaceContext;
