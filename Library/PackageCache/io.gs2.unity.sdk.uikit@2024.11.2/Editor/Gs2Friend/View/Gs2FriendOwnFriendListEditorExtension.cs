...
{
    [CustomEditor(typeof(Gs2FriendOwnFriendList))]
    public class Gs2FriendOwnFriendListEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFriendList;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2FriendOwnFriendListFetcher>() ?? original.GetComponentInParent<Gs2FriendOwnFriendListFetcher>(true);
            if (fetcher == null) {
                ...
                EditorGUILayout.ObjectField("Fetcher", fetcher.gameObject, typeof(Gs2FriendOwnFriendListFetcher), false);
