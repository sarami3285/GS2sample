...
{
    [CustomEditor(typeof(Gs2FriendUpdateProfileByUserIdEnabler))]
    public class Gs2FriendUpdateProfileByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendUpdateProfileByUserIdEnabler;
