...
{
    [CustomEditor(typeof(Gs2FriendOwnProfileUserIdEnabler))]
    public class Gs2FriendOwnProfileUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnProfileUserIdEnabler;
            ...
            if (original.expression == Gs2FriendOwnProfileUserIdEnabler.Expression.In || original.expression == Gs2FriendOwnProfileUserIdEnabler.Expression.NotIn) {
