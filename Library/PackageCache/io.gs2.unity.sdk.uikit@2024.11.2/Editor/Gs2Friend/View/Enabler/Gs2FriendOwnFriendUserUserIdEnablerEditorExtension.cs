...
{
    [CustomEditor(typeof(Gs2FriendOwnFriendUserUserIdEnabler))]
    public class Gs2FriendOwnFriendUserUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFriendUserUserIdEnabler;
            ...
            if (original.expression == Gs2FriendOwnFriendUserUserIdEnabler.Expression.In || original.expression == Gs2FriendOwnFriendUserUserIdEnabler.Expression.NotIn) {
