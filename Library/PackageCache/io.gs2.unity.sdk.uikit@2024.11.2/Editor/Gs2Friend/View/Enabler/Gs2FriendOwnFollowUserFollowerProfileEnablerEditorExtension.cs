...
{
    [CustomEditor(typeof(Gs2FriendOwnFollowUserFollowerProfileEnabler))]
    public class Gs2FriendOwnFollowUserFollowerProfileEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFollowUserFollowerProfileEnabler;
            ...
            if (original.expression == Gs2FriendOwnFollowUserFollowerProfileEnabler.Expression.In || original.expression == Gs2FriendOwnFollowUserFollowerProfileEnabler.Expression.NotIn) {
