...
{
    [CustomEditor(typeof(Gs2FriendOwnFollowUserPublicProfileEnabler))]
    public class Gs2FriendOwnFollowUserPublicProfileEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFollowUserPublicProfileEnabler;
            ...
            if (original.expression == Gs2FriendOwnFollowUserPublicProfileEnabler.Expression.In || original.expression == Gs2FriendOwnFollowUserPublicProfileEnabler.Expression.NotIn) {
