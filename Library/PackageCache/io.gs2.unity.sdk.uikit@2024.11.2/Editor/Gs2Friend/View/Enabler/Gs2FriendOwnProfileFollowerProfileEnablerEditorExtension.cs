...
{
    [CustomEditor(typeof(Gs2FriendOwnProfileFollowerProfileEnabler))]
    public class Gs2FriendOwnProfileFollowerProfileEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnProfileFollowerProfileEnabler;
            ...
            if (original.expression == Gs2FriendOwnProfileFollowerProfileEnabler.Expression.In || original.expression == Gs2FriendOwnProfileFollowerProfileEnabler.Expression.NotIn) {
