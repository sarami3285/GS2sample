...
{
    [CustomEditor(typeof(Gs2FriendOwnFriendUserFriendProfileEnabler))]
    public class Gs2FriendOwnFriendUserFriendProfileEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFriendUserFriendProfileEnabler;
            ...
            if (original.expression == Gs2FriendOwnFriendUserFriendProfileEnabler.Expression.In || original.expression == Gs2FriendOwnFriendUserFriendProfileEnabler.Expression.NotIn) {
