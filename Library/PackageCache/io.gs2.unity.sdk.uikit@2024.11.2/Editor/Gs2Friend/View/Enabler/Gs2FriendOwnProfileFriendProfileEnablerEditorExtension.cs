...
{
    [CustomEditor(typeof(Gs2FriendOwnProfileFriendProfileEnabler))]
    public class Gs2FriendOwnProfileFriendProfileEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnProfileFriendProfileEnabler;
            ...
            if (original.expression == Gs2FriendOwnProfileFriendProfileEnabler.Expression.In || original.expression == Gs2FriendOwnProfileFriendProfileEnabler.Expression.NotIn) {
