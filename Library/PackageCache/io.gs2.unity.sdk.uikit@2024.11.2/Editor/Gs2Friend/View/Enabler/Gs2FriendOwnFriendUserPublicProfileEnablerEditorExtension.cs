...
{
    [CustomEditor(typeof(Gs2FriendOwnFriendUserPublicProfileEnabler))]
    public class Gs2FriendOwnFriendUserPublicProfileEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFriendUserPublicProfileEnabler;
            ...
            if (original.expression == Gs2FriendOwnFriendUserPublicProfileEnabler.Expression.In || original.expression == Gs2FriendOwnFriendUserPublicProfileEnabler.Expression.NotIn) {
