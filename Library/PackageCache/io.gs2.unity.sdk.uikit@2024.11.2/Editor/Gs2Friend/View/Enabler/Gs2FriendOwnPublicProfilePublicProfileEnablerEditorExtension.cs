...
{
    [CustomEditor(typeof(Gs2FriendOwnPublicProfilePublicProfileEnabler))]
    public class Gs2FriendOwnPublicProfilePublicProfileEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnPublicProfilePublicProfileEnabler;
            ...
            if (original.expression == Gs2FriendOwnPublicProfilePublicProfileEnabler.Expression.In || original.expression == Gs2FriendOwnPublicProfilePublicProfileEnabler.Expression.NotIn) {
