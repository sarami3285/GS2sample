...
{
    [CustomEditor(typeof(Gs2FriendOwnFollowUserUserIdEnabler))]
    public class Gs2FriendOwnFollowUserUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFollowUserUserIdEnabler;
            ...
            if (original.expression == Gs2FriendOwnFollowUserUserIdEnabler.Expression.In || original.expression == Gs2FriendOwnFollowUserUserIdEnabler.Expression.NotIn) {
