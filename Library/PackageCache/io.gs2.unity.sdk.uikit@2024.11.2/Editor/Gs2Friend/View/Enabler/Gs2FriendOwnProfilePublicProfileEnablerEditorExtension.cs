...
{
    [CustomEditor(typeof(Gs2FriendOwnProfilePublicProfileEnabler))]
    public class Gs2FriendOwnProfilePublicProfileEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnProfilePublicProfileEnabler;
            ...
            if (original.expression == Gs2FriendOwnProfilePublicProfileEnabler.Expression.In || original.expression == Gs2FriendOwnProfilePublicProfileEnabler.Expression.NotIn) {
