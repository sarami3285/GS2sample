...
{
    [CustomEditor(typeof(Gs2FriendOwnFollowUserFollowerProfileSpriteSwitcher))]
    public class Gs2FriendOwnFollowUserFollowerProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFollowUserFollowerProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendOwnFollowUserFollowerProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendOwnFollowUserFollowerProfileSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyFollowerProfiles"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyFollowerProfile"), true);
            }
