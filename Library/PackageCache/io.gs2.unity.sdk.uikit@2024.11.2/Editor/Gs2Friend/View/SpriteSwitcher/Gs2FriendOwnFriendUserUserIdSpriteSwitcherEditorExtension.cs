...
{
    [CustomEditor(typeof(Gs2FriendOwnFriendUserUserIdSpriteSwitcher))]
    public class Gs2FriendOwnFriendUserUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFriendUserUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendOwnFriendUserUserIdSpriteSwitcher.Expression.In || original.expression == Gs2FriendOwnFriendUserUserIdSpriteSwitcher.Expression.NotIn) {
