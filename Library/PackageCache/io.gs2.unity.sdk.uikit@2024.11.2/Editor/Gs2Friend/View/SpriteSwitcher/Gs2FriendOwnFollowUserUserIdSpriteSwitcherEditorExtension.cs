...
{
    [CustomEditor(typeof(Gs2FriendOwnFollowUserUserIdSpriteSwitcher))]
    public class Gs2FriendOwnFollowUserUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFollowUserUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendOwnFollowUserUserIdSpriteSwitcher.Expression.In || original.expression == Gs2FriendOwnFollowUserUserIdSpriteSwitcher.Expression.NotIn) {
