...
{
    [CustomEditor(typeof(Gs2FriendOwnFriendUserUserIdSpriteTableSwitcher))]
    public class Gs2FriendOwnFriendUserUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFriendUserUserIdSpriteTableSwitcher;
