...
{
    [CustomEditor(typeof(Gs2FriendOwnProfileUserIdSpriteTableSwitcher))]
    public class Gs2FriendOwnProfileUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnProfileUserIdSpriteTableSwitcher;
