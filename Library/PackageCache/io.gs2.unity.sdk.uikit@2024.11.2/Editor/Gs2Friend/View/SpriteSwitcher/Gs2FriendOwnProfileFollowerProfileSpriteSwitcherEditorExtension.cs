...
{
    [CustomEditor(typeof(Gs2FriendOwnProfileFollowerProfileSpriteSwitcher))]
    public class Gs2FriendOwnProfileFollowerProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnProfileFollowerProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendOwnProfileFollowerProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendOwnProfileFollowerProfileSpriteSwitcher.Expression.NotIn) {
