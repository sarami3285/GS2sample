...
{
    [CustomEditor(typeof(Gs2FriendOwnProfileFriendProfileSpriteTableSwitcher))]
    public class Gs2FriendOwnProfileFriendProfileSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnProfileFriendProfileSpriteTableSwitcher;
