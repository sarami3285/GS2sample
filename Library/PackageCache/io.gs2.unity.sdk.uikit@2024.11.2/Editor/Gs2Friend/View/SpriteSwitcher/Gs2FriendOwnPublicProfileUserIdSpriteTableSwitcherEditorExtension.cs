...
{
    [CustomEditor(typeof(Gs2FriendOwnPublicProfileUserIdSpriteTableSwitcher))]
    public class Gs2FriendOwnPublicProfileUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnPublicProfileUserIdSpriteTableSwitcher;
