...
{
    [CustomEditor(typeof(Gs2FriendOwnProfileFollowerProfileSpriteTableSwitcher))]
    public class Gs2FriendOwnProfileFollowerProfileSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnProfileFollowerProfileSpriteTableSwitcher;
