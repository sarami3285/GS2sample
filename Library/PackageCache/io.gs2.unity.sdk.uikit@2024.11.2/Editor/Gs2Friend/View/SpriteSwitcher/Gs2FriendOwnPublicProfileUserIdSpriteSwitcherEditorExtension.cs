...
{
    [CustomEditor(typeof(Gs2FriendOwnPublicProfileUserIdSpriteSwitcher))]
    public class Gs2FriendOwnPublicProfileUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnPublicProfileUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendOwnPublicProfileUserIdSpriteSwitcher.Expression.In || original.expression == Gs2FriendOwnPublicProfileUserIdSpriteSwitcher.Expression.NotIn) {
