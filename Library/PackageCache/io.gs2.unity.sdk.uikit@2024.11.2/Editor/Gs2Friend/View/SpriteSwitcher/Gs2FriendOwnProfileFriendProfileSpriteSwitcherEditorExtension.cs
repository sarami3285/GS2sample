...
{
    [CustomEditor(typeof(Gs2FriendOwnProfileFriendProfileSpriteSwitcher))]
    public class Gs2FriendOwnProfileFriendProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnProfileFriendProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendOwnProfileFriendProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendOwnProfileFriendProfileSpriteSwitcher.Expression.NotIn) {
