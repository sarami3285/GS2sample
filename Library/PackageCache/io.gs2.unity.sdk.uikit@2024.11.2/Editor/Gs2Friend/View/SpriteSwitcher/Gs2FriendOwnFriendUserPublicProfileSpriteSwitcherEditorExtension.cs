...
{
    [CustomEditor(typeof(Gs2FriendOwnFriendUserPublicProfileSpriteSwitcher))]
    public class Gs2FriendOwnFriendUserPublicProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFriendUserPublicProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendOwnFriendUserPublicProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendOwnFriendUserPublicProfileSpriteSwitcher.Expression.NotIn) {
