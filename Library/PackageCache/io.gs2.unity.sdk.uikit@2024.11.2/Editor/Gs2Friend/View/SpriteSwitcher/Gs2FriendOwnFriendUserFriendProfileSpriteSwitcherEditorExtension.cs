...
{
    [CustomEditor(typeof(Gs2FriendOwnFriendUserFriendProfileSpriteSwitcher))]
    public class Gs2FriendOwnFriendUserFriendProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFriendUserFriendProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendOwnFriendUserFriendProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendOwnFriendUserFriendProfileSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyFriendProfiles"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyFriendProfile"), true);
            }
