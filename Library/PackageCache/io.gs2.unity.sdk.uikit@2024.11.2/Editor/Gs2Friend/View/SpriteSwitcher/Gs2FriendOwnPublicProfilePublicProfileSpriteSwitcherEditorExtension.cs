...
{
    [CustomEditor(typeof(Gs2FriendOwnPublicProfilePublicProfileSpriteSwitcher))]
    public class Gs2FriendOwnPublicProfilePublicProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnPublicProfilePublicProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendOwnPublicProfilePublicProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendOwnPublicProfilePublicProfileSpriteSwitcher.Expression.NotIn) {
