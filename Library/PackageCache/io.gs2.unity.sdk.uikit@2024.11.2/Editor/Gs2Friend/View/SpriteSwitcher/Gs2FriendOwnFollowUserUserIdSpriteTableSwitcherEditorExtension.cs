...
{
    [CustomEditor(typeof(Gs2FriendOwnFollowUserUserIdSpriteTableSwitcher))]
    public class Gs2FriendOwnFollowUserUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFollowUserUserIdSpriteTableSwitcher;
