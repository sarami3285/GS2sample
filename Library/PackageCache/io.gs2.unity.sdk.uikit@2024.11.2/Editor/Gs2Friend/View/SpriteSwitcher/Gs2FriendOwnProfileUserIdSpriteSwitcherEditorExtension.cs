...
{
    [CustomEditor(typeof(Gs2FriendOwnProfileUserIdSpriteSwitcher))]
    public class Gs2FriendOwnProfileUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnProfileUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendOwnProfileUserIdSpriteSwitcher.Expression.In || original.expression == Gs2FriendOwnProfileUserIdSpriteSwitcher.Expression.NotIn) {
