...
{
    [CustomEditor(typeof(Gs2FriendOwnFollowUserPublicProfileSpriteSwitcher))]
    public class Gs2FriendOwnFollowUserPublicProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFollowUserPublicProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendOwnFollowUserPublicProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendOwnFollowUserPublicProfileSpriteSwitcher.Expression.NotIn) {
