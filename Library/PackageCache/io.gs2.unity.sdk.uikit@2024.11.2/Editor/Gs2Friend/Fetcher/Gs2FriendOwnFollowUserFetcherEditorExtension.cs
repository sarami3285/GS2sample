...
{
    [CustomEditor(typeof(Gs2FriendOwnFollowUserFetcher))]
    public class Gs2FriendOwnFollowUserFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnFollowUserFetcher;
