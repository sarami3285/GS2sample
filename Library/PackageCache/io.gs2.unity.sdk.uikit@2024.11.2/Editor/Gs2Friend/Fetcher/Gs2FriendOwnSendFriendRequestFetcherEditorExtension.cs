...
{
    [CustomEditor(typeof(Gs2FriendOwnSendFriendRequestFetcher))]
    public class Gs2FriendOwnSendFriendRequestFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnSendFriendRequestFetcher;
            ...
            if (context == null) {
                ...
                context.FriendUser = EditorGUILayout.ObjectField("SendFriendRequest", context.FriendUser, typeof(OwnFriendUser), false) as OwnFriendUser;
                EditorGUI.indentLevel++;
                EditorGUILayout.TextField("NamespaceName", context.FriendUser?.NamespaceName.ToString());
                EditorGUILayout.TextField("TargetUserId", context.FriendUser?.TargetUserId.ToString());
                EditorGUI.indentLevel--;
                EditorGUI.indentLevel--;
