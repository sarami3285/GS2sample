...
{
    [CustomEditor(typeof(Gs2FriendOwnReceiveFriendRequestFetcher))]
    public class Gs2FriendOwnReceiveFriendRequestFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnReceiveFriendRequestFetcher;
            ...
            if (context == null) {
                ...
                context.FriendUser = EditorGUILayout.ObjectField("ReceiveFriendRequest", context.FriendUser, typeof(OwnFriendUser), false) as OwnFriendUser;
                EditorGUI.indentLevel++;
