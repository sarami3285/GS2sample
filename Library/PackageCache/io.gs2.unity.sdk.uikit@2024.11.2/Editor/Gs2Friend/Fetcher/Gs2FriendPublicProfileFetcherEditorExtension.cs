...
{
    [CustomEditor(typeof(Gs2FriendPublicProfileFetcher))]
    public class Gs2FriendPublicProfileFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendPublicProfileFetcher;
