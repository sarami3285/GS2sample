...
{
    [CustomEditor(typeof(Gs2InboxNamespaceContext))]
    public class Gs2InboxNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxNamespaceContext;
