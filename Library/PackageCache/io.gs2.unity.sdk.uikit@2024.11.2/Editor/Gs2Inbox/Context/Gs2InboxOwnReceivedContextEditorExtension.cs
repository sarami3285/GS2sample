...
{
    [CustomEditor(typeof(Gs2InboxOwnReceivedContext))]
    public class Gs2InboxOwnReceivedContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOwnReceivedContext;
