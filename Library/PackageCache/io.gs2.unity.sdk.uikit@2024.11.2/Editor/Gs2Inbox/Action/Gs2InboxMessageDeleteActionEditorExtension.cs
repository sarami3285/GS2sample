...
{
    [CustomEditor(typeof(Gs2InboxMessageDeleteAction))]
    public class Gs2InboxMessageDeleteActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageDeleteAction;
