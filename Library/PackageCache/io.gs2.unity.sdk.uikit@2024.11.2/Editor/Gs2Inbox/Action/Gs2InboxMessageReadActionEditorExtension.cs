...
{
    [CustomEditor(typeof(Gs2InboxMessageReadAction))]
    public class Gs2InboxMessageReadActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageReadAction;
