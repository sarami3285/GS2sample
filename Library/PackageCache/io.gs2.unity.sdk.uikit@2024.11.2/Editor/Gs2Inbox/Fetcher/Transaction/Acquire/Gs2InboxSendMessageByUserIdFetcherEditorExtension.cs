...
{
    [CustomEditor(typeof(Gs2InboxSendMessageByUserIdFetcher))]
    public class Gs2InboxSendMessageByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxSendMessageByUserIdFetcher;
