...
{
    [CustomEditor(typeof(Gs2InboxOpenMessageByUserIdFetcher))]
    public class Gs2InboxOpenMessageByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOpenMessageByUserIdFetcher;
