...
namespace Gs2.Unity.UiKit.Gs2Inbox.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2InboxDeleteMessageByUserIdFetcher))]
    public class Gs2InboxDeleteMessageByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxDeleteMessageByUserIdFetcher;
