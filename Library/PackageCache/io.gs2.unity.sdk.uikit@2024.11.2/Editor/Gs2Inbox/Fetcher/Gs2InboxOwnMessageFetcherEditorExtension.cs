...
{
    [CustomEditor(typeof(Gs2InboxOwnMessageFetcher))]
    public class Gs2InboxOwnMessageFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOwnMessageFetcher;
