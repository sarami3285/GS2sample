...
{
    [CustomEditor(typeof(Gs2InboxOwnMessageReadAtSpriteSwitcher))]
    public class Gs2InboxOwnMessageReadAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOwnMessageReadAtSpriteSwitcher;
            ...
            if (original.expression == Gs2InboxOwnMessageReadAtSpriteSwitcher.Expression.In || original.expression == Gs2InboxOwnMessageReadAtSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyReadAts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyReadAt"), true);
            }
