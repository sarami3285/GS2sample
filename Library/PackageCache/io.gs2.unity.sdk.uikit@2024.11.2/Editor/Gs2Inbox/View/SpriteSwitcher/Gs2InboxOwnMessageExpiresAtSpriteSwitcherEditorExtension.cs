...
{
    [CustomEditor(typeof(Gs2InboxOwnMessageExpiresAtSpriteSwitcher))]
    public class Gs2InboxOwnMessageExpiresAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOwnMessageExpiresAtSpriteSwitcher;
            ...
            if (original.expression == Gs2InboxOwnMessageExpiresAtSpriteSwitcher.Expression.In || original.expression == Gs2InboxOwnMessageExpiresAtSpriteSwitcher.Expression.NotIn) {
