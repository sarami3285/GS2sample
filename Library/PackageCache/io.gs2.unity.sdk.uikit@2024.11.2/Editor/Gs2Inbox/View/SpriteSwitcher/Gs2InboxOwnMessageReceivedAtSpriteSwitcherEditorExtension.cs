...
{
    [CustomEditor(typeof(Gs2InboxOwnMessageReceivedAtSpriteSwitcher))]
    public class Gs2InboxOwnMessageReceivedAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOwnMessageReceivedAtSpriteSwitcher;
            ...
            if (original.expression == Gs2InboxOwnMessageReceivedAtSpriteSwitcher.Expression.In || original.expression == Gs2InboxOwnMessageReceivedAtSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyReceivedAts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyReceivedAt"), true);
            }
