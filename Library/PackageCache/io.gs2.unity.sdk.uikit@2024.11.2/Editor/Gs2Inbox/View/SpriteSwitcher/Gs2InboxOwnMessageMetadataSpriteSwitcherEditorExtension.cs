...
namespace Gs2.Unity.UiKit.Gs2Inbox.SpriteSwitcher.Editor
{
    [CustomEditor(typeof(Gs2InboxOwnMessageMetadataSpriteSwitcher))]
    public class Gs2InboxOwnMessageMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOwnMessageMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2InboxOwnMessageMetadataSpriteSwitcher.Expression.In || original.expression == Gs2InboxOwnMessageMetadataSpriteSwitcher.Expression.NotIn) {
