...
{
    [CustomEditor(typeof(Gs2InboxOwnMessageNameSpriteSwitcher))]
    public class Gs2InboxOwnMessageNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOwnMessageNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InboxOwnMessageNameSpriteSwitcher.Expression.In || original.expression == Gs2InboxOwnMessageNameSpriteSwitcher.Expression.NotIn) {
