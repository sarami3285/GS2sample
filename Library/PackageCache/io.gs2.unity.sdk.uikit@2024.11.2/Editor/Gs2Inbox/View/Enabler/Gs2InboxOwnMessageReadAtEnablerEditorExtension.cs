...
{
    [CustomEditor(typeof(Gs2InboxOwnMessageReadAtEnabler))]
    public class Gs2InboxOwnMessageReadAtEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOwnMessageReadAtEnabler;
            ...
            if (original.expression == Gs2InboxOwnMessageReadAtEnabler.Expression.In || original.expression == Gs2InboxOwnMessageReadAtEnabler.Expression.NotIn) {
