...
{
    [CustomEditor(typeof(Gs2InboxOwnMessageNameEnabler))]
    public class Gs2InboxOwnMessageNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOwnMessageNameEnabler;
            ...
            if (original.expression == Gs2InboxOwnMessageNameEnabler.Expression.In || original.expression == Gs2InboxOwnMessageNameEnabler.Expression.NotIn) {
