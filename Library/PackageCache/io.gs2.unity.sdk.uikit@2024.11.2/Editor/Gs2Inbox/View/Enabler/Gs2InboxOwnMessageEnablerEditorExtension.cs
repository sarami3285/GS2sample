...
{
    [CustomEditor(typeof(Gs2InboxOwnMessageEnabler))]
    public class Gs2InboxOwnMessageEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOwnMessageEnabler;
