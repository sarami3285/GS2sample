...
{
    [CustomEditor(typeof(Gs2InboxOpenMessageByUserIdEnabler))]
    public class Gs2InboxOpenMessageByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOpenMessageByUserIdEnabler;
