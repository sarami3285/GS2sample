...
{
    [CustomEditor(typeof(Gs2InboxDeleteMessageByUserIdEnabler))]
    public class Gs2InboxDeleteMessageByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxDeleteMessageByUserIdEnabler;
