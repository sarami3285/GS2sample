...
{
    [CustomEditor(typeof(Gs2InboxSendMessageByUserIdEnabler))]
    public class Gs2InboxSendMessageByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxSendMessageByUserIdEnabler;
