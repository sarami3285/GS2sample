...
{
    [CustomEditor(typeof(Gs2InboxOwnMessageIsReadEnabler))]
    public class Gs2InboxOwnMessageIsReadEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOwnMessageIsReadEnabler;
