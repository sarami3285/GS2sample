...
{
    [CustomEditor(typeof(Gs2InboxOwnMessageReceivedAtEnabler))]
    public class Gs2InboxOwnMessageReceivedAtEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOwnMessageReceivedAtEnabler;
            ...
            if (original.expression == Gs2InboxOwnMessageReceivedAtEnabler.Expression.In || original.expression == Gs2InboxOwnMessageReceivedAtEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableReceivedAts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableReceivedAt"), true);
            }
