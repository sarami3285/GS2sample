...
{
    [CustomEditor(typeof(Gs2InboxOwnMessageExpiresAtEnabler))]
    public class Gs2InboxOwnMessageExpiresAtEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxOwnMessageExpiresAtEnabler;
            ...
            if (original.expression == Gs2InboxOwnMessageExpiresAtEnabler.Expression.In || original.expression == Gs2InboxOwnMessageExpiresAtEnabler.Expression.NotIn) {
