...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatBeginDayOfWeekEnabler))]
    public class Gs2ScheduleOwnEventRepeatBeginDayOfWeekEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatBeginDayOfWeekEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnEventRepeatBeginDayOfWeekEnabler.Expression.In || original.expression == Gs2ScheduleOwnEventRepeatBeginDayOfWeekEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRepeatBeginDayOfWeeks"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRepeatBeginDayOfWeek"), true);
            }
