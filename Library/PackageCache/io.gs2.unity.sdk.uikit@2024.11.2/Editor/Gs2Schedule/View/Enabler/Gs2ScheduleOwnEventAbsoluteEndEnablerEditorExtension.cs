...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventAbsoluteEndEnabler))]
    public class Gs2ScheduleOwnEventAbsoluteEndEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventAbsoluteEndEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnEventAbsoluteEndEnabler.Expression.In || original.expression == Gs2ScheduleOwnEventAbsoluteEndEnabler.Expression.NotIn) {
