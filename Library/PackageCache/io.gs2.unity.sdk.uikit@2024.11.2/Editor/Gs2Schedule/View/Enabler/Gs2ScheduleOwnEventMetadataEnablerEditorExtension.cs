...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventMetadataEnabler))]
    public class Gs2ScheduleOwnEventMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventMetadataEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnEventMetadataEnabler.Expression.In || original.expression == Gs2ScheduleOwnEventMetadataEnabler.Expression.NotIn) {
