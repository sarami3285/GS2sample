...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatEndHourEnabler))]
    public class Gs2ScheduleOwnEventRepeatEndHourEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatEndHourEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnEventRepeatEndHourEnabler.Expression.In || original.expression == Gs2ScheduleOwnEventRepeatEndHourEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRepeatEndHours"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRepeatEndHour"), true);
            }
