...
{
    [CustomEditor(typeof(Gs2ScheduleDeleteTriggerByUserIdEnabler))]
    public class Gs2ScheduleDeleteTriggerByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleDeleteTriggerByUserIdEnabler;
