...
{
    [CustomEditor(typeof(Gs2ScheduleVerifyEventByUserIdEnabler))]
    public class Gs2ScheduleVerifyEventByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleVerifyEventByUserIdEnabler;
