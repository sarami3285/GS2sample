...
{
    [CustomEditor(typeof(Gs2ScheduleTriggerByUserIdEnabler))]
    public class Gs2ScheduleTriggerByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleTriggerByUserIdEnabler;
