...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRelativeTriggerNameEnabler))]
    public class Gs2ScheduleOwnEventRelativeTriggerNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRelativeTriggerNameEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnEventRelativeTriggerNameEnabler.Expression.In || original.expression == Gs2ScheduleOwnEventRelativeTriggerNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRelativeTriggerNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRelativeTriggerName"), true);
            }
