...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatEndDayOfMonthEnabler))]
    public class Gs2ScheduleOwnEventRepeatEndDayOfMonthEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatEndDayOfMonthEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnEventRepeatEndDayOfMonthEnabler.Expression.In || original.expression == Gs2ScheduleOwnEventRepeatEndDayOfMonthEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRepeatEndDayOfMonths"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRepeatEndDayOfMonth"), true);
            }
