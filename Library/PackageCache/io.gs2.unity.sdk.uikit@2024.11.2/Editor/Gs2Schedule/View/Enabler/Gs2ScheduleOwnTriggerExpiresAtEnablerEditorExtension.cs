...
{
    [CustomEditor(typeof(Gs2ScheduleOwnTriggerExpiresAtEnabler))]
    public class Gs2ScheduleOwnTriggerExpiresAtEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnTriggerExpiresAtEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnTriggerExpiresAtEnabler.Expression.In || original.expression == Gs2ScheduleOwnTriggerExpiresAtEnabler.Expression.NotIn) {
