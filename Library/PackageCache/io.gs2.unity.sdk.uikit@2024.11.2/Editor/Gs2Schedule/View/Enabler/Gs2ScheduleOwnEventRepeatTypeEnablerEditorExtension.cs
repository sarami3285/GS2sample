...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatTypeEnabler))]
    public class Gs2ScheduleOwnEventRepeatTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatTypeEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnEventRepeatTypeEnabler.Expression.In || original.expression == Gs2ScheduleOwnEventRepeatTypeEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRepeatTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRepeatType"), true);
            }
