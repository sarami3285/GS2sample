...
{
    [CustomEditor(typeof(Gs2ScheduleOwnTriggerNameEnabler))]
    public class Gs2ScheduleOwnTriggerNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnTriggerNameEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnTriggerNameEnabler.Expression.In || original.expression == Gs2ScheduleOwnTriggerNameEnabler.Expression.NotIn) {
