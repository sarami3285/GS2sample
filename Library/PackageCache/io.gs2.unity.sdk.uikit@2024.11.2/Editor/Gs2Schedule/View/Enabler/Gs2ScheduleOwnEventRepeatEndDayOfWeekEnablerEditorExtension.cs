...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatEndDayOfWeekEnabler))]
    public class Gs2ScheduleOwnEventRepeatEndDayOfWeekEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatEndDayOfWeekEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnEventRepeatEndDayOfWeekEnabler.Expression.In || original.expression == Gs2ScheduleOwnEventRepeatEndDayOfWeekEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRepeatEndDayOfWeeks"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRepeatEndDayOfWeek"), true);
            }
