...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventNameEnabler))]
    public class Gs2ScheduleOwnEventNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventNameEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnEventNameEnabler.Expression.In || original.expression == Gs2ScheduleOwnEventNameEnabler.Expression.NotIn) {
