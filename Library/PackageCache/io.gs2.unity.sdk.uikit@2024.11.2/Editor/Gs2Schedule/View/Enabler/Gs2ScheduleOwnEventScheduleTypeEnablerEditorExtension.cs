...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventScheduleTypeEnabler))]
    public class Gs2ScheduleOwnEventScheduleTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventScheduleTypeEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnEventScheduleTypeEnabler.Expression.In || original.expression == Gs2ScheduleOwnEventScheduleTypeEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableScheduleTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableScheduleType"), true);
            }
