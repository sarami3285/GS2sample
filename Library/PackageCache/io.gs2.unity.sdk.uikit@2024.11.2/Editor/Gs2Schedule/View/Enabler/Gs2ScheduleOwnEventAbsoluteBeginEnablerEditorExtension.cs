...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventAbsoluteBeginEnabler))]
    public class Gs2ScheduleOwnEventAbsoluteBeginEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventAbsoluteBeginEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnEventAbsoluteBeginEnabler.Expression.In || original.expression == Gs2ScheduleOwnEventAbsoluteBeginEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableAbsoluteBegins"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableAbsoluteBegin"), true);
            }
