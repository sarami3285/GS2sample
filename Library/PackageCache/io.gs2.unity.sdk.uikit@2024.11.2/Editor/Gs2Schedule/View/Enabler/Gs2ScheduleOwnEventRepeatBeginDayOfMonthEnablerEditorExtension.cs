...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatBeginDayOfMonthEnabler))]
    public class Gs2ScheduleOwnEventRepeatBeginDayOfMonthEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatBeginDayOfMonthEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnEventRepeatBeginDayOfMonthEnabler.Expression.In || original.expression == Gs2ScheduleOwnEventRepeatBeginDayOfMonthEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRepeatBeginDayOfMonths"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRepeatBeginDayOfMonth"), true);
            }
