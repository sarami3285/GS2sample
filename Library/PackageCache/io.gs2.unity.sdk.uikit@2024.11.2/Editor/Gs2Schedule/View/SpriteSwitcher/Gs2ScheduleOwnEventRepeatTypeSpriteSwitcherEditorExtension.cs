...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatTypeSpriteSwitcher))]
    public class Gs2ScheduleOwnEventRepeatTypeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatTypeSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnEventRepeatTypeSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnEventRepeatTypeSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRepeatTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRepeatType"), true);
            }
