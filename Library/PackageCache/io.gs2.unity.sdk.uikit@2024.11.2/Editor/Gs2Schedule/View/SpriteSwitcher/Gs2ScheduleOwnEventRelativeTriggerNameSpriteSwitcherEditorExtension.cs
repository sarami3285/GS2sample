...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRelativeTriggerNameSpriteSwitcher))]
    public class Gs2ScheduleOwnEventRelativeTriggerNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRelativeTriggerNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnEventRelativeTriggerNameSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnEventRelativeTriggerNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRelativeTriggerNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRelativeTriggerName"), true);
            }
