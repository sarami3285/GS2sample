...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatEndHourSpriteSwitcher))]
    public class Gs2ScheduleOwnEventRepeatEndHourSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatEndHourSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnEventRepeatEndHourSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnEventRepeatEndHourSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRepeatEndHours"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRepeatEndHour"), true);
            }
