...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventAbsoluteBeginSpriteSwitcher))]
    public class Gs2ScheduleOwnEventAbsoluteBeginSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventAbsoluteBeginSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnEventAbsoluteBeginSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnEventAbsoluteBeginSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyAbsoluteBegins"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyAbsoluteBegin"), true);
            }
