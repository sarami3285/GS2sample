...
{
    [CustomEditor(typeof(Gs2ScheduleOwnTriggerNameSpriteTableSwitcher))]
    public class Gs2ScheduleOwnTriggerNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnTriggerNameSpriteTableSwitcher;
