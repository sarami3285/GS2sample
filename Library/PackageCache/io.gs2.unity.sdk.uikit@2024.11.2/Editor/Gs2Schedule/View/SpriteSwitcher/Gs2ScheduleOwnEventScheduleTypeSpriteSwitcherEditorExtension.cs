...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventScheduleTypeSpriteSwitcher))]
    public class Gs2ScheduleOwnEventScheduleTypeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventScheduleTypeSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnEventScheduleTypeSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnEventScheduleTypeSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyScheduleTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyScheduleType"), true);
            }
