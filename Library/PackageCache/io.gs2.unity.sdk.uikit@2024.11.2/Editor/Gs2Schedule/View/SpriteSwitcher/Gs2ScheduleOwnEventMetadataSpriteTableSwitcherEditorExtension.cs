...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventMetadataSpriteTableSwitcher))]
    public class Gs2ScheduleOwnEventMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventMetadataSpriteTableSwitcher;
