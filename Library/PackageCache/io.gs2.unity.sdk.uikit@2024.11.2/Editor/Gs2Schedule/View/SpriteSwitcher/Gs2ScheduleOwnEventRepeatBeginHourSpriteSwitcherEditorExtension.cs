...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatBeginHourSpriteSwitcher))]
    public class Gs2ScheduleOwnEventRepeatBeginHourSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatBeginHourSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnEventRepeatBeginHourSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnEventRepeatBeginHourSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRepeatBeginHours"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRepeatBeginHour"), true);
            }
