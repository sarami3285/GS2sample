...
{
    [CustomEditor(typeof(Gs2ScheduleOwnTriggerNameSpriteSwitcher))]
    public class Gs2ScheduleOwnTriggerNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnTriggerNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnTriggerNameSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnTriggerNameSpriteSwitcher.Expression.NotIn) {
