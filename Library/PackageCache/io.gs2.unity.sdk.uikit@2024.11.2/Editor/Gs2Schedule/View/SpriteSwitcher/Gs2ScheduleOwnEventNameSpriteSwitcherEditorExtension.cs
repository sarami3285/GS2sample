...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventNameSpriteSwitcher))]
    public class Gs2ScheduleOwnEventNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnEventNameSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnEventNameSpriteSwitcher.Expression.NotIn) {
