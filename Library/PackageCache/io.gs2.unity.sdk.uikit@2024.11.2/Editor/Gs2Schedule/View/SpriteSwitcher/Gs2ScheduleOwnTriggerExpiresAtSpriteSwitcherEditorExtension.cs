...
{
    [CustomEditor(typeof(Gs2ScheduleOwnTriggerExpiresAtSpriteSwitcher))]
    public class Gs2ScheduleOwnTriggerExpiresAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnTriggerExpiresAtSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnTriggerExpiresAtSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnTriggerExpiresAtSpriteSwitcher.Expression.NotIn) {
