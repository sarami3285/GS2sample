...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher.Editor
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatBeginDayOfWeekSpriteSwitcher))]
    public class Gs2ScheduleOwnEventRepeatBeginDayOfWeekSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatBeginDayOfWeekSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnEventRepeatBeginDayOfWeekSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnEventRepeatBeginDayOfWeekSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRepeatBeginDayOfWeeks"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRepeatBeginDayOfWeek"), true);
            }
