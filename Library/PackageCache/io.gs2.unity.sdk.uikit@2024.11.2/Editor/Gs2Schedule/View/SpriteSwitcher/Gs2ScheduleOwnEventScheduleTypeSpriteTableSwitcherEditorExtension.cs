...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventScheduleTypeSpriteTableSwitcher))]
    public class Gs2ScheduleOwnEventScheduleTypeSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventScheduleTypeSpriteTableSwitcher;
