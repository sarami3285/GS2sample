...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatEndDayOfWeekSpriteTableSwitcher))]
    public class Gs2ScheduleOwnEventRepeatEndDayOfWeekSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatEndDayOfWeekSpriteTableSwitcher;
