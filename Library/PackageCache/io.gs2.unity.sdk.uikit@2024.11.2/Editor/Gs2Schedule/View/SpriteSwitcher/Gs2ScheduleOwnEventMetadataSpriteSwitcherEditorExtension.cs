...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventMetadataSpriteSwitcher))]
    public class Gs2ScheduleOwnEventMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnEventMetadataSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnEventMetadataSpriteSwitcher.Expression.NotIn) {
