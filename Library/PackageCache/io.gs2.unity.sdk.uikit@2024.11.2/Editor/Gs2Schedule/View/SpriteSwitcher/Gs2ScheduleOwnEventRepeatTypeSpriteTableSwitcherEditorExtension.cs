...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatTypeSpriteTableSwitcher))]
    public class Gs2ScheduleOwnEventRepeatTypeSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatTypeSpriteTableSwitcher;
