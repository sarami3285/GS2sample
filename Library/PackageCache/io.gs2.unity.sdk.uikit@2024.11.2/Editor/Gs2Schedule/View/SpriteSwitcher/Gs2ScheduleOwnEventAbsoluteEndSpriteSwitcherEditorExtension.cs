...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventAbsoluteEndSpriteSwitcher))]
    public class Gs2ScheduleOwnEventAbsoluteEndSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventAbsoluteEndSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnEventAbsoluteEndSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnEventAbsoluteEndSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyAbsoluteEnds"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyAbsoluteEnd"), true);
            }
