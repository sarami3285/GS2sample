...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatBeginDayOfMonthSpriteSwitcher))]
    public class Gs2ScheduleOwnEventRepeatBeginDayOfMonthSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatBeginDayOfMonthSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnEventRepeatBeginDayOfMonthSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnEventRepeatBeginDayOfMonthSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRepeatBeginDayOfMonths"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRepeatBeginDayOfMonth"), true);
            }
