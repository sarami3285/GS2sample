...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatEndDayOfWeekSpriteSwitcher))]
    public class Gs2ScheduleOwnEventRepeatEndDayOfWeekSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatEndDayOfWeekSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnEventRepeatEndDayOfWeekSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnEventRepeatEndDayOfWeekSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRepeatEndDayOfWeeks"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRepeatEndDayOfWeek"), true);
            }
