...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventRepeatEndDayOfMonthSpriteSwitcher))]
    public class Gs2ScheduleOwnEventRepeatEndDayOfMonthSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventRepeatEndDayOfMonthSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnEventRepeatEndDayOfMonthSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnEventRepeatEndDayOfMonthSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRepeatEndDayOfMonths"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRepeatEndDayOfMonth"), true);
            }
