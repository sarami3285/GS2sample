...
{
    [CustomEditor(typeof(Gs2ScheduleTriggerByUserIdFetcher))]
    public class Gs2ScheduleTriggerByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleTriggerByUserIdFetcher;
