...
namespace Gs2.Unity.UiKit.Gs2Schedule.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2ScheduleDeleteTriggerByUserIdFetcher))]
    public class Gs2ScheduleDeleteTriggerByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleDeleteTriggerByUserIdFetcher;
