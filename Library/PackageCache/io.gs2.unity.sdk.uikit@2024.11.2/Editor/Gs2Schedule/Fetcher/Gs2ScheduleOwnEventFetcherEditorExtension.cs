...
{
    [CustomEditor(typeof(Gs2ScheduleOwnEventFetcher))]
    public class Gs2ScheduleOwnEventFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnEventFetcher;
            ...
            if (context == null) {
                ...
                if (context.gameObject.GetComponentInParent<Gs2ScheduleOwnEventList>(true) != null) {
                    ...
                    EditorGUILayout.ObjectField("Event", context.Event, typeof(OwnEvent), false);
