...
{
    [CustomEditor(typeof(Gs2DictionaryEntryModelMetadataEnabler))]
    public class Gs2DictionaryEntryModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryEntryModelMetadataEnabler;
            ...
            if (original.expression == Gs2DictionaryEntryModelMetadataEnabler.Expression.In || original.expression == Gs2DictionaryEntryModelMetadataEnabler.Expression.NotIn) {
