...
{
    [CustomEditor(typeof(Gs2DictionaryVerifyEntryByUserIdEnabler))]
    public class Gs2DictionaryVerifyEntryByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryVerifyEntryByUserIdEnabler;
