...
{
    [CustomEditor(typeof(Gs2DictionaryAddEntriesByUserIdEnabler))]
    public class Gs2DictionaryAddEntriesByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryAddEntriesByUserIdEnabler;
