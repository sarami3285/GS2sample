...
{
    [CustomEditor(typeof(Gs2DictionaryOwnEntryNameEnabler))]
    public class Gs2DictionaryOwnEntryNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryOwnEntryNameEnabler;
            ...
            if (original.expression == Gs2DictionaryOwnEntryNameEnabler.Expression.In || original.expression == Gs2DictionaryOwnEntryNameEnabler.Expression.NotIn) {
