...
{
    [CustomEditor(typeof(Gs2DictionaryOwnEntryAcquiredAtEnabler))]
    public class Gs2DictionaryOwnEntryAcquiredAtEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryOwnEntryAcquiredAtEnabler;
            ...
            if (original.expression == Gs2DictionaryOwnEntryAcquiredAtEnabler.Expression.In || original.expression == Gs2DictionaryOwnEntryAcquiredAtEnabler.Expression.NotIn) {
