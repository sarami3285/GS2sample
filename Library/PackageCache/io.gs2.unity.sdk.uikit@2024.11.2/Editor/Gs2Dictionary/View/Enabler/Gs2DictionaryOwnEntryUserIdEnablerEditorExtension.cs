...
{
    [CustomEditor(typeof(Gs2DictionaryOwnEntryUserIdEnabler))]
    public class Gs2DictionaryOwnEntryUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryOwnEntryUserIdEnabler;
            ...
            if (original.expression == Gs2DictionaryOwnEntryUserIdEnabler.Expression.In || original.expression == Gs2DictionaryOwnEntryUserIdEnabler.Expression.NotIn) {
