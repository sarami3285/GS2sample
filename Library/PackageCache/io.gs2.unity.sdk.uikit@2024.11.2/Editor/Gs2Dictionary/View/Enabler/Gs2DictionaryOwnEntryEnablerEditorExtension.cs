...
{
    [CustomEditor(typeof(Gs2DictionaryOwnEntryEnabler))]
    public class Gs2DictionaryOwnEntryEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryOwnEntryEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("EntryFetcher not assigned.", MessageType.Error);
