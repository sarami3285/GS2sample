...
{
    [CustomEditor(typeof(Gs2DictionaryOwnEntryNameSpriteSwitcher))]
    public class Gs2DictionaryOwnEntryNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryOwnEntryNameSpriteSwitcher;
            ...
            if (original.expression == Gs2DictionaryOwnEntryNameSpriteSwitcher.Expression.In || original.expression == Gs2DictionaryOwnEntryNameSpriteSwitcher.Expression.NotIn) {
