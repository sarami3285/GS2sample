...
{
    [CustomEditor(typeof(Gs2DictionaryOwnEntryUserIdSpriteTableSwitcher))]
    public class Gs2DictionaryOwnEntryUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryOwnEntryUserIdSpriteTableSwitcher;
