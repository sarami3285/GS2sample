...
{
    [CustomEditor(typeof(Gs2DictionaryEntryModelNameSpriteTableSwitcher))]
    public class Gs2DictionaryEntryModelNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryEntryModelNameSpriteTableSwitcher;
