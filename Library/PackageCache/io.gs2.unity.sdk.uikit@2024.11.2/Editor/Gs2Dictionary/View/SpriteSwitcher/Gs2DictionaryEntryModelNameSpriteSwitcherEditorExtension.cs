...
{
    [CustomEditor(typeof(Gs2DictionaryEntryModelNameSpriteSwitcher))]
    public class Gs2DictionaryEntryModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryEntryModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2DictionaryEntryModelNameSpriteSwitcher.Expression.In || original.expression == Gs2DictionaryEntryModelNameSpriteSwitcher.Expression.NotIn) {
