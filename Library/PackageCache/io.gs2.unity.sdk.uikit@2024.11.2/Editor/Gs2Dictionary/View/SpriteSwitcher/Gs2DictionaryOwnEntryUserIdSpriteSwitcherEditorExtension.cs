...
{
    [CustomEditor(typeof(Gs2DictionaryOwnEntryUserIdSpriteSwitcher))]
    public class Gs2DictionaryOwnEntryUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryOwnEntryUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2DictionaryOwnEntryUserIdSpriteSwitcher.Expression.In || original.expression == Gs2DictionaryOwnEntryUserIdSpriteSwitcher.Expression.NotIn) {
