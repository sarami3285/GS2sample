...
{
    [CustomEditor(typeof(Gs2DictionaryAddEntriesByUserIdFetcher))]
    public class Gs2DictionaryAddEntriesByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryAddEntriesByUserIdFetcher;
