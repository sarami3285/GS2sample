...
{
    [CustomEditor(typeof(Gs2DictionaryVerifyEntryByUserIdFetcher))]
    public class Gs2DictionaryVerifyEntryByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryVerifyEntryByUserIdFetcher;
