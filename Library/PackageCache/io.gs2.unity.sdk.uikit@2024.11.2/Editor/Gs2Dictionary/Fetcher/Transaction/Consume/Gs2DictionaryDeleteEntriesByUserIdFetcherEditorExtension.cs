...
namespace Gs2.Unity.UiKit.Gs2Dictionary.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2DictionaryDeleteEntriesByUserIdFetcher))]
    public class Gs2DictionaryDeleteEntriesByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryDeleteEntriesByUserIdFetcher;
