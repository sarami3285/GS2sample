...
{
    [CustomEditor(typeof(Gs2DictionaryNamespaceContext))]
    public class Gs2DictionaryNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryNamespaceContext;
