...
{
    [CustomEditor(typeof(Gs2ShowcaseOwnDisplayItemTypeSpriteTableSwitcher))]
    public class Gs2ShowcaseOwnDisplayItemTypeSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseOwnDisplayItemTypeSpriteTableSwitcher;
