...
{
    [CustomEditor(typeof(Gs2ShowcaseOwnShowcaseNameSpriteTableSwitcher))]
    public class Gs2ShowcaseOwnShowcaseNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseOwnShowcaseNameSpriteTableSwitcher;
