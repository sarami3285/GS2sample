...
{
    [CustomEditor(typeof(Gs2ShowcaseOwnShowcaseMetadataSpriteTableSwitcher))]
    public class Gs2ShowcaseOwnShowcaseMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseOwnShowcaseMetadataSpriteTableSwitcher;
