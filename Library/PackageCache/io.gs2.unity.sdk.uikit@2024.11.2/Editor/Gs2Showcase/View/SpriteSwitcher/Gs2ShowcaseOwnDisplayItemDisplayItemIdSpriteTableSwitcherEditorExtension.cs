...
{
    [CustomEditor(typeof(Gs2ShowcaseOwnDisplayItemDisplayItemIdSpriteTableSwitcher))]
    public class Gs2ShowcaseOwnDisplayItemDisplayItemIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseOwnDisplayItemDisplayItemIdSpriteTableSwitcher;
