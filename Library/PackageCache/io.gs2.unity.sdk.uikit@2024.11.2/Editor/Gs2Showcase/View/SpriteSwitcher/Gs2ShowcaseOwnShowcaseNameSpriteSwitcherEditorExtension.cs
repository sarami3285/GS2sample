...
{
    [CustomEditor(typeof(Gs2ShowcaseOwnShowcaseNameSpriteSwitcher))]
    public class Gs2ShowcaseOwnShowcaseNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseOwnShowcaseNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ShowcaseOwnShowcaseNameSpriteSwitcher.Expression.In || original.expression == Gs2ShowcaseOwnShowcaseNameSpriteSwitcher.Expression.NotIn) {
