...
{
    [CustomEditor(typeof(Gs2ShowcaseOwnDisplayItemDisplayItemIdSpriteSwitcher))]
    public class Gs2ShowcaseOwnDisplayItemDisplayItemIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseOwnDisplayItemDisplayItemIdSpriteSwitcher;
            ...
            if (original.expression == Gs2ShowcaseOwnDisplayItemDisplayItemIdSpriteSwitcher.Expression.In || original.expression == Gs2ShowcaseOwnDisplayItemDisplayItemIdSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyDisplayItemIds"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyDisplayItemId"), true);
            }
