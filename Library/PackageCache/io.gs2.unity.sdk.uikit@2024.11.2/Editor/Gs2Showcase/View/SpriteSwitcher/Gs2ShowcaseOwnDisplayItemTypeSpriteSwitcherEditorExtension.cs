...
{
    [CustomEditor(typeof(Gs2ShowcaseOwnDisplayItemTypeSpriteSwitcher))]
    public class Gs2ShowcaseOwnDisplayItemTypeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseOwnDisplayItemTypeSpriteSwitcher;
            ...
            if (original.expression == Gs2ShowcaseOwnDisplayItemTypeSpriteSwitcher.Expression.In || original.expression == Gs2ShowcaseOwnDisplayItemTypeSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyType"), true);
            }
