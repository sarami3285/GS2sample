...
{
    [CustomEditor(typeof(Gs2ShowcaseOwnSalesItemMetadataEnabler))]
    public class Gs2ShowcaseOwnSalesItemMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseOwnSalesItemMetadataEnabler;
            ...
            if (original.expression == Gs2ShowcaseOwnSalesItemMetadataEnabler.Expression.In || original.expression == Gs2ShowcaseOwnSalesItemMetadataEnabler.Expression.NotIn) {
