...
{
    [CustomEditor(typeof(Gs2ShowcaseOwnDisplayItemEnabler))]
    public class Gs2ShowcaseOwnDisplayItemEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseOwnDisplayItemEnabler;
