...
{
    [CustomEditor(typeof(Gs2ShowcaseOwnShowcaseMetadataEnabler))]
    public class Gs2ShowcaseOwnShowcaseMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseOwnShowcaseMetadataEnabler;
            ...
            if (original.expression == Gs2ShowcaseOwnShowcaseMetadataEnabler.Expression.In || original.expression == Gs2ShowcaseOwnShowcaseMetadataEnabler.Expression.NotIn) {
