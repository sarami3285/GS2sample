...
{
    [CustomEditor(typeof(Gs2ShowcaseOwnDisplayItemTypeEnabler))]
    public class Gs2ShowcaseOwnDisplayItemTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseOwnDisplayItemTypeEnabler;
            ...
            if (original.expression == Gs2ShowcaseOwnDisplayItemTypeEnabler.Expression.In || original.expression == Gs2ShowcaseOwnDisplayItemTypeEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableType"), true);
            }
