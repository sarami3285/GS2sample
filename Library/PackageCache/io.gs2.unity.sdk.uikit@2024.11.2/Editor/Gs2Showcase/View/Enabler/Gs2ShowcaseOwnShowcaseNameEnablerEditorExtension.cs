...
{
    [CustomEditor(typeof(Gs2ShowcaseOwnShowcaseNameEnabler))]
    public class Gs2ShowcaseOwnShowcaseNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseOwnShowcaseNameEnabler;
            ...
            if (original.expression == Gs2ShowcaseOwnShowcaseNameEnabler.Expression.In || original.expression == Gs2ShowcaseOwnShowcaseNameEnabler.Expression.NotIn) {
