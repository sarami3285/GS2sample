...
{
    [CustomEditor(typeof(Gs2ShowcaseDisplayItemBuyAction))]
    public class Gs2ShowcaseDisplayItemBuyActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseDisplayItemBuyAction;
