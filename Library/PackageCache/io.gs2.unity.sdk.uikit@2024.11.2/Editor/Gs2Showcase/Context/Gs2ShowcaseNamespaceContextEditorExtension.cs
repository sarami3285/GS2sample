...
{
    [CustomEditor(typeof(Gs2ShowcaseNamespaceContext))]
    public class Gs2ShowcaseNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseNamespaceContext;
