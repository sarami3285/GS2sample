...
{
    [CustomEditor(typeof(Gs2LimitLimitModelFetcher))]
    public class Gs2LimitLimitModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelFetcher;
