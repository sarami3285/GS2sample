...
{
    [CustomEditor(typeof(Gs2LimitOwnCounterListFetcher))]
    public class Gs2LimitOwnCounterListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitOwnCounterListFetcher;
