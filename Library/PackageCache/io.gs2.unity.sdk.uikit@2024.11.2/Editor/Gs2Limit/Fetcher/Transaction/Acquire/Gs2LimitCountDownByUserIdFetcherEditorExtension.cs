...
{
    [CustomEditor(typeof(Gs2LimitCountDownByUserIdFetcher))]
    public class Gs2LimitCountDownByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitCountDownByUserIdFetcher;
