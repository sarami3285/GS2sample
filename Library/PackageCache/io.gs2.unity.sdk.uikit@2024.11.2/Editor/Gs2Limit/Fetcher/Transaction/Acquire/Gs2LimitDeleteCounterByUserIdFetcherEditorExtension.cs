...
{
    [CustomEditor(typeof(Gs2LimitDeleteCounterByUserIdFetcher))]
    public class Gs2LimitDeleteCounterByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitDeleteCounterByUserIdFetcher;
