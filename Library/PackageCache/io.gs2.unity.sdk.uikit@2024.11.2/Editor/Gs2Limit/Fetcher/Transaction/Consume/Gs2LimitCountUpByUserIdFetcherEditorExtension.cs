...
{
    [CustomEditor(typeof(Gs2LimitCountUpByUserIdFetcher))]
    public class Gs2LimitCountUpByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitCountUpByUserIdFetcher;
