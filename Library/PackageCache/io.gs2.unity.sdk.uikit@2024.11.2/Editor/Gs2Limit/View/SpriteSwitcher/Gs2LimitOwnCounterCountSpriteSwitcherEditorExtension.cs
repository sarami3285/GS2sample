...
{
    [CustomEditor(typeof(Gs2LimitOwnCounterCountSpriteSwitcher))]
    public class Gs2LimitOwnCounterCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitOwnCounterCountSpriteSwitcher;
            ...
            if (original.expression == Gs2LimitOwnCounterCountSpriteSwitcher.Expression.In || original.expression == Gs2LimitOwnCounterCountSpriteSwitcher.Expression.NotIn) {
