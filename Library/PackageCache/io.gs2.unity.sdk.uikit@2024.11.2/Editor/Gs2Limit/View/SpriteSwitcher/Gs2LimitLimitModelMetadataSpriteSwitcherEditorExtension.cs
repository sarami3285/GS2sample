...
{
    [CustomEditor(typeof(Gs2LimitLimitModelMetadataSpriteSwitcher))]
    public class Gs2LimitLimitModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2LimitLimitModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2LimitLimitModelMetadataSpriteSwitcher.Expression.NotIn) {
