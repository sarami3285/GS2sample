...
{
    [CustomEditor(typeof(Gs2LimitLimitModelResetHourSpriteSwitcher))]
    public class Gs2LimitLimitModelResetHourSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelResetHourSpriteSwitcher;
            ...
            if (original.expression == Gs2LimitLimitModelResetHourSpriteSwitcher.Expression.In || original.expression == Gs2LimitLimitModelResetHourSpriteSwitcher.Expression.NotIn) {
