...
{
    [CustomEditor(typeof(Gs2LimitLimitModelMetadataSpriteTableSwitcher))]
    public class Gs2LimitLimitModelMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelMetadataSpriteTableSwitcher;
