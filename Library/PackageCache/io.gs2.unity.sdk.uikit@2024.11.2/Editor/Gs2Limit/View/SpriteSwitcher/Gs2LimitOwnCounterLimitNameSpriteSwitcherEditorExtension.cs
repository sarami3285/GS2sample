...
{
    [CustomEditor(typeof(Gs2LimitOwnCounterLimitNameSpriteSwitcher))]
    public class Gs2LimitOwnCounterLimitNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitOwnCounterLimitNameSpriteSwitcher;
            ...
            if (original.expression == Gs2LimitOwnCounterLimitNameSpriteSwitcher.Expression.In || original.expression == Gs2LimitOwnCounterLimitNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyLimitNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyLimitName"), true);
            }
