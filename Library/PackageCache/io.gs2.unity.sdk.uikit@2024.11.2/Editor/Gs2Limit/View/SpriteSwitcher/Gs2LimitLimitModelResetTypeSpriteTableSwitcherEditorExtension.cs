...
{
    [CustomEditor(typeof(Gs2LimitLimitModelResetTypeSpriteTableSwitcher))]
    public class Gs2LimitLimitModelResetTypeSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelResetTypeSpriteTableSwitcher;
