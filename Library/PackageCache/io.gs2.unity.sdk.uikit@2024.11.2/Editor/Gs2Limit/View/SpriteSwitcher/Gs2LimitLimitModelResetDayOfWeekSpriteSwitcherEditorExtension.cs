...
namespace Gs2.Unity.UiKit.Gs2Limit.SpriteSwitcher.Editor
{
    [CustomEditor(typeof(Gs2LimitLimitModelResetDayOfWeekSpriteSwitcher))]
    public class Gs2LimitLimitModelResetDayOfWeekSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelResetDayOfWeekSpriteSwitcher;
            ...
            if (original.expression == Gs2LimitLimitModelResetDayOfWeekSpriteSwitcher.Expression.In || original.expression == Gs2LimitLimitModelResetDayOfWeekSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyResetDayOfWeeks"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyResetDayOfWeek"), true);
            }
