...
{
    [CustomEditor(typeof(Gs2LimitLimitModelResetDayOfWeekSpriteTableSwitcher))]
    public class Gs2LimitLimitModelResetDayOfWeekSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelResetDayOfWeekSpriteTableSwitcher;
