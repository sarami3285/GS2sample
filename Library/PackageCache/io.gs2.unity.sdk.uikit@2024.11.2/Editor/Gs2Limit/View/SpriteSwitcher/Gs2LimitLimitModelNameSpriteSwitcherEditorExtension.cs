...
{
    [CustomEditor(typeof(Gs2LimitLimitModelNameSpriteSwitcher))]
    public class Gs2LimitLimitModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2LimitLimitModelNameSpriteSwitcher.Expression.In || original.expression == Gs2LimitLimitModelNameSpriteSwitcher.Expression.NotIn) {
