...
{
    [CustomEditor(typeof(Gs2LimitLimitModelResetTypeSpriteSwitcher))]
    public class Gs2LimitLimitModelResetTypeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelResetTypeSpriteSwitcher;
            ...
            if (original.expression == Gs2LimitLimitModelResetTypeSpriteSwitcher.Expression.In || original.expression == Gs2LimitLimitModelResetTypeSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyResetTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyResetType"), true);
            }
