...
{
    [CustomEditor(typeof(Gs2LimitOwnCounterNameSpriteSwitcher))]
    public class Gs2LimitOwnCounterNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitOwnCounterNameSpriteSwitcher;
            ...
            if (original.expression == Gs2LimitOwnCounterNameSpriteSwitcher.Expression.In || original.expression == Gs2LimitOwnCounterNameSpriteSwitcher.Expression.NotIn) {
