...
{
    [CustomEditor(typeof(Gs2LimitLimitModelResetDayOfWeekEnabler))]
    public class Gs2LimitLimitModelResetDayOfWeekEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelResetDayOfWeekEnabler;
            ...
            if (original.expression == Gs2LimitLimitModelResetDayOfWeekEnabler.Expression.In || original.expression == Gs2LimitLimitModelResetDayOfWeekEnabler.Expression.NotIn) {
