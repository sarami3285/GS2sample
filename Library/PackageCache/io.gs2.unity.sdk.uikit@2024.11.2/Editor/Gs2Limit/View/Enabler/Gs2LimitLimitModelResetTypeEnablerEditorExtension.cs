...
{
    [CustomEditor(typeof(Gs2LimitLimitModelResetTypeEnabler))]
    public class Gs2LimitLimitModelResetTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelResetTypeEnabler;
            ...
            if (original.expression == Gs2LimitLimitModelResetTypeEnabler.Expression.In || original.expression == Gs2LimitLimitModelResetTypeEnabler.Expression.NotIn) {
