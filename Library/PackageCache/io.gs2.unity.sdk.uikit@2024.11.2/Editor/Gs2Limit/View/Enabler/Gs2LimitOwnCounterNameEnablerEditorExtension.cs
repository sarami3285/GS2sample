...
{
    [CustomEditor(typeof(Gs2LimitOwnCounterNameEnabler))]
    public class Gs2LimitOwnCounterNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitOwnCounterNameEnabler;
            ...
            if (original.expression == Gs2LimitOwnCounterNameEnabler.Expression.In || original.expression == Gs2LimitOwnCounterNameEnabler.Expression.NotIn) {
