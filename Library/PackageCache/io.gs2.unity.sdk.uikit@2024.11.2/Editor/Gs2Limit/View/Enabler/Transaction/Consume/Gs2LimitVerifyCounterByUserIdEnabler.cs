...
{
    [CustomEditor(typeof(Gs2LimitVerifyCounterByUserIdEnabler))]
    public class Gs2LimitVerifyCounterByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitVerifyCounterByUserIdEnabler;
