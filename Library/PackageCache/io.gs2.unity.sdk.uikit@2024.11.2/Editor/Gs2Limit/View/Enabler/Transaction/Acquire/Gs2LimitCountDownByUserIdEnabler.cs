...
{
    [CustomEditor(typeof(Gs2LimitCountDownByUserIdEnabler))]
    public class Gs2LimitCountDownByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitCountDownByUserIdEnabler;
