...
{
    [CustomEditor(typeof(Gs2LimitDeleteCounterByUserIdEnabler))]
    public class Gs2LimitDeleteCounterByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitDeleteCounterByUserIdEnabler;
