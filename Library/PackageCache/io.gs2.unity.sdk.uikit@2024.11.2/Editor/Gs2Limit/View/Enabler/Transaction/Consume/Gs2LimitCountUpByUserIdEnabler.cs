...
{
    [CustomEditor(typeof(Gs2LimitCountUpByUserIdEnabler))]
    public class Gs2LimitCountUpByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitCountUpByUserIdEnabler;
