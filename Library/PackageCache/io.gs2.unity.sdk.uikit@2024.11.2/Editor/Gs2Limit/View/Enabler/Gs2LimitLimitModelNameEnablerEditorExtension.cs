...
{
    [CustomEditor(typeof(Gs2LimitLimitModelNameEnabler))]
    public class Gs2LimitLimitModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelNameEnabler;
            ...
            if (original.expression == Gs2LimitLimitModelNameEnabler.Expression.In || original.expression == Gs2LimitLimitModelNameEnabler.Expression.NotIn) {
