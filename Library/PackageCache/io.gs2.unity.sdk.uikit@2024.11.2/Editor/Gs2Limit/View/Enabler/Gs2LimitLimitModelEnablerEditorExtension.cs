...
{
    [CustomEditor(typeof(Gs2LimitLimitModelEnabler))]
    public class Gs2LimitLimitModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("LimitModelFetcher not assigned.", MessageType.Error);
