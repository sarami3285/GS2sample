...
{
    [CustomEditor(typeof(Gs2LimitOwnCounterLimitNameEnabler))]
    public class Gs2LimitOwnCounterLimitNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitOwnCounterLimitNameEnabler;
            ...
            if (original.expression == Gs2LimitOwnCounterLimitNameEnabler.Expression.In || original.expression == Gs2LimitOwnCounterLimitNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableLimitNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableLimitName"), true);
            }
