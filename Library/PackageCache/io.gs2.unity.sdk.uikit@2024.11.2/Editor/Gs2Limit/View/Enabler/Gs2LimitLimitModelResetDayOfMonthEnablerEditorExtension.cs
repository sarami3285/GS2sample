...
{
    [CustomEditor(typeof(Gs2LimitLimitModelResetDayOfMonthEnabler))]
    public class Gs2LimitLimitModelResetDayOfMonthEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelResetDayOfMonthEnabler;
            ...
            if (original.expression == Gs2LimitLimitModelResetDayOfMonthEnabler.Expression.In || original.expression == Gs2LimitLimitModelResetDayOfMonthEnabler.Expression.NotIn) {
