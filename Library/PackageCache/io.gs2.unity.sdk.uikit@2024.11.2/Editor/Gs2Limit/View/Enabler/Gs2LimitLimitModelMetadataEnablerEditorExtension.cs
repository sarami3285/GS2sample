...
namespace Gs2.Unity.UiKit.Gs2Limit.Enabler.Editor
{
    ...
    public class Gs2LimitLimitModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelMetadataEnabler;
            ...
            if (original.expression == Gs2LimitLimitModelMetadataEnabler.Expression.In || original.expression == Gs2LimitLimitModelMetadataEnabler.Expression.NotIn) {
