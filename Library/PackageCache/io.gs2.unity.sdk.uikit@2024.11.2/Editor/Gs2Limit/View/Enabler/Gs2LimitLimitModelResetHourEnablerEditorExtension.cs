...
{
    [CustomEditor(typeof(Gs2LimitLimitModelResetHourEnabler))]
    public class Gs2LimitLimitModelResetHourEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelResetHourEnabler;
            ...
            if (original.expression == Gs2LimitLimitModelResetHourEnabler.Expression.In || original.expression == Gs2LimitLimitModelResetHourEnabler.Expression.NotIn) {
