...
{
    [CustomEditor(typeof(Gs2LimitNamespaceContext))]
    public class Gs2LimitNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitNamespaceContext;
