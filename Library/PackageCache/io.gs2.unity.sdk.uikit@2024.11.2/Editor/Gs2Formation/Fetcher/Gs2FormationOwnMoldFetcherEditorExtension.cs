...
{
    [CustomEditor(typeof(Gs2FormationOwnMoldFetcher))]
    public class Gs2FormationOwnMoldFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnMoldFetcher;
