...
{
    [CustomEditor(typeof(Gs2FormationOwnSlotListFetcher))]
    public class Gs2FormationOwnSlotListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnSlotListFetcher;
