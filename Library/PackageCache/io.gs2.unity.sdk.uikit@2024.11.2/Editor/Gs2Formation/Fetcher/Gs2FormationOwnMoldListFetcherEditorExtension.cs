...
{
    [CustomEditor(typeof(Gs2FormationOwnMoldListFetcher))]
    public class Gs2FormationOwnMoldListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnMoldListFetcher;
