...
{
    [CustomEditor(typeof(Gs2FormationSetFormByUserIdFetcher))]
    public class Gs2FormationSetFormByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationSetFormByUserIdFetcher;
