...
{
    [CustomEditor(typeof(Gs2FormationAcquireActionsToPropertyFormPropertiesFetcher))]
    public class Gs2FormationAcquireActionsToPropertyFormPropertiesFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationAcquireActionsToPropertyFormPropertiesFetcher;
