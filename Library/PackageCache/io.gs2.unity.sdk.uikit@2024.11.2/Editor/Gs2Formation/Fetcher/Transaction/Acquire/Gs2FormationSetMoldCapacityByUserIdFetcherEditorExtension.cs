...
{
    [CustomEditor(typeof(Gs2FormationSetMoldCapacityByUserIdFetcher))]
    public class Gs2FormationSetMoldCapacityByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationSetMoldCapacityByUserIdFetcher;
