...
{
    [CustomEditor(typeof(Gs2FormationAcquireActionsToFormPropertiesFetcher))]
    public class Gs2FormationAcquireActionsToFormPropertiesFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationAcquireActionsToFormPropertiesFetcher;
