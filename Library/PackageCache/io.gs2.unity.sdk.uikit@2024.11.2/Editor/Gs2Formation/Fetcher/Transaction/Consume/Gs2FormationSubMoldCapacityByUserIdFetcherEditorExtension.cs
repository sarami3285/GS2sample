...
{
    [CustomEditor(typeof(Gs2FormationSubMoldCapacityByUserIdFetcher))]
    public class Gs2FormationSubMoldCapacityByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationSubMoldCapacityByUserIdFetcher;
