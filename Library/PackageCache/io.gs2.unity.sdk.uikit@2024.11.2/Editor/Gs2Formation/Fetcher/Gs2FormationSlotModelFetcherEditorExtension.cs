...
{
    [CustomEditor(typeof(Gs2FormationSlotModelFetcher))]
    public class Gs2FormationSlotModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationSlotModelFetcher;
            ...
            if (context == null) {
                ...
                if (context.gameObject.GetComponentInParent<Gs2FormationSlotModelList>(true) != null) {
                    ...
                    if (context.SlotModel != null) {
                        ...
                        EditorGUILayout.TextField("MoldModelName", context.SlotModel?.MoldModelName?.ToString());
