...
{
    [CustomEditor(typeof(Gs2FormationFormDeleteFormAction))]
    public class Gs2FormationFormDeleteFormActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationFormDeleteFormAction;
            ...
            if (context == null) {
                ...
                if (context.transform.GetComponentInParent<Gs2FormationOwnFormList>(true) != null) {
                    ...
                    context.Form = EditorGUILayout.ObjectField("OwnForm", context.Form, typeof(OwnForm), false) as OwnForm;
