...
{
    [CustomEditor(typeof(Gs2FormationFormModelNameSpriteTableSwitcher))]
    public class Gs2FormationFormModelNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationFormModelNameSpriteTableSwitcher;
