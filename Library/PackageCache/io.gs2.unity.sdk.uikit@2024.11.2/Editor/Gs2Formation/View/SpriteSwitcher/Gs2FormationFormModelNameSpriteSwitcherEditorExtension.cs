...
{
    [CustomEditor(typeof(Gs2FormationFormModelNameSpriteSwitcher))]
    public class Gs2FormationFormModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationFormModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationFormModelNameSpriteSwitcher.Expression.In || original.expression == Gs2FormationFormModelNameSpriteSwitcher.Expression.NotIn) {
