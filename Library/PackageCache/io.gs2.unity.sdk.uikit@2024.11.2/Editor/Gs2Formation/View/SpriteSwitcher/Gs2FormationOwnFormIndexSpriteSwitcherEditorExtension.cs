...
{
    [CustomEditor(typeof(Gs2FormationOwnFormIndexSpriteSwitcher))]
    public class Gs2FormationOwnFormIndexSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnFormIndexSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationOwnFormIndexSpriteSwitcher.Expression.In || original.expression == Gs2FormationOwnFormIndexSpriteSwitcher.Expression.NotIn) {
