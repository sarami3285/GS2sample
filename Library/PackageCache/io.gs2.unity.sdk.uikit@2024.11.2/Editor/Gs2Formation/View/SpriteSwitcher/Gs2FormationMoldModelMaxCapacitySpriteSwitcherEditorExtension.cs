...
{
    [CustomEditor(typeof(Gs2FormationMoldModelMaxCapacitySpriteSwitcher))]
    public class Gs2FormationMoldModelMaxCapacitySpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldModelMaxCapacitySpriteSwitcher;
            ...
            if (original.expression == Gs2FormationMoldModelMaxCapacitySpriteSwitcher.Expression.In || original.expression == Gs2FormationMoldModelMaxCapacitySpriteSwitcher.Expression.NotIn) {
