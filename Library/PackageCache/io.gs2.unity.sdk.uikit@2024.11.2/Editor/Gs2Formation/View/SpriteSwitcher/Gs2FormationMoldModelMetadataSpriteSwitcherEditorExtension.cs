...
{
    [CustomEditor(typeof(Gs2FormationMoldModelMetadataSpriteSwitcher))]
    public class Gs2FormationMoldModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationMoldModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2FormationMoldModelMetadataSpriteSwitcher.Expression.NotIn) {
