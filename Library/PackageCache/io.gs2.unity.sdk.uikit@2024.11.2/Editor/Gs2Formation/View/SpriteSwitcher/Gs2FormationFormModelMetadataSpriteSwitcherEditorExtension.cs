...
{
    [CustomEditor(typeof(Gs2FormationFormModelMetadataSpriteSwitcher))]
    public class Gs2FormationFormModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationFormModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationFormModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2FormationFormModelMetadataSpriteSwitcher.Expression.NotIn) {
