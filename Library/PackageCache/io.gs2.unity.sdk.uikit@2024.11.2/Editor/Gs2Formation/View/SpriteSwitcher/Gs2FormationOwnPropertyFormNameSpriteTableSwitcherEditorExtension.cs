...
{
    [CustomEditor(typeof(Gs2FormationOwnPropertyFormNameSpriteTableSwitcher))]
    public class Gs2FormationOwnPropertyFormNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnPropertyFormNameSpriteTableSwitcher;
