...
{
    [CustomEditor(typeof(Gs2FormationOwnMoldNameSpriteSwitcher))]
    public class Gs2FormationOwnMoldNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnMoldNameSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationOwnMoldNameSpriteSwitcher.Expression.In || original.expression == Gs2FormationOwnMoldNameSpriteSwitcher.Expression.NotIn) {
