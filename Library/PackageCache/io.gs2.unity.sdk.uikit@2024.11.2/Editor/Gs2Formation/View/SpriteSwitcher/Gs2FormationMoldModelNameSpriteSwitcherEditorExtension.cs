...
{
    [CustomEditor(typeof(Gs2FormationMoldModelNameSpriteSwitcher))]
    public class Gs2FormationMoldModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationMoldModelNameSpriteSwitcher.Expression.In || original.expression == Gs2FormationMoldModelNameSpriteSwitcher.Expression.NotIn) {
