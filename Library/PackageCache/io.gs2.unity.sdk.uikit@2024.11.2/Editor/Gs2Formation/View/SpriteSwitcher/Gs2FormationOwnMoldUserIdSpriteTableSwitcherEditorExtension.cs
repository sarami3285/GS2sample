...
{
    [CustomEditor(typeof(Gs2FormationOwnMoldUserIdSpriteTableSwitcher))]
    public class Gs2FormationOwnMoldUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnMoldUserIdSpriteTableSwitcher;
