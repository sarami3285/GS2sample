...
{
    [CustomEditor(typeof(Gs2FormationOwnMoldUserIdSpriteSwitcher))]
    public class Gs2FormationOwnMoldUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnMoldUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationOwnMoldUserIdSpriteSwitcher.Expression.In || original.expression == Gs2FormationOwnMoldUserIdSpriteSwitcher.Expression.NotIn) {
