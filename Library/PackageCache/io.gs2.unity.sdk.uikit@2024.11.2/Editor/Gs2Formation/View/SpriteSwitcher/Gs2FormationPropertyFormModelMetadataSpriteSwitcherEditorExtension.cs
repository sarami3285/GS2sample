...
{
    [CustomEditor(typeof(Gs2FormationPropertyFormModelMetadataSpriteSwitcher))]
    public class Gs2FormationPropertyFormModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationPropertyFormModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationPropertyFormModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2FormationPropertyFormModelMetadataSpriteSwitcher.Expression.NotIn) {
