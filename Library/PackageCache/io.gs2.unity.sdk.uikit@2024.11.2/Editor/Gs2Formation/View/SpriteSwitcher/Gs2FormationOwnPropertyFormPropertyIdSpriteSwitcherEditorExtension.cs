...
{
    [CustomEditor(typeof(Gs2FormationOwnPropertyFormPropertyIdSpriteSwitcher))]
    public class Gs2FormationOwnPropertyFormPropertyIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnPropertyFormPropertyIdSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationOwnPropertyFormPropertyIdSpriteSwitcher.Expression.In || original.expression == Gs2FormationOwnPropertyFormPropertyIdSpriteSwitcher.Expression.NotIn) {
