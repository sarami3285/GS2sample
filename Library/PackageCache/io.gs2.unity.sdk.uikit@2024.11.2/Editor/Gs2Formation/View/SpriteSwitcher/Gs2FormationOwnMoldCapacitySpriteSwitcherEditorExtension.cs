...
{
    [CustomEditor(typeof(Gs2FormationOwnMoldCapacitySpriteSwitcher))]
    public class Gs2FormationOwnMoldCapacitySpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnMoldCapacitySpriteSwitcher;
            ...
            if (original.expression == Gs2FormationOwnMoldCapacitySpriteSwitcher.Expression.In || original.expression == Gs2FormationOwnMoldCapacitySpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCapacities"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCapacity"), true);
            }
