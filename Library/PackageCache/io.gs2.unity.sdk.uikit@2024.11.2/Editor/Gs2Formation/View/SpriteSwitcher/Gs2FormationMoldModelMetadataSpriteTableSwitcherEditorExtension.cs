...
{
    [CustomEditor(typeof(Gs2FormationMoldModelMetadataSpriteTableSwitcher))]
    public class Gs2FormationMoldModelMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldModelMetadataSpriteTableSwitcher;
