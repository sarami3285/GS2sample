...
{
    [CustomEditor(typeof(Gs2FormationOwnFormNameSpriteSwitcher))]
    public class Gs2FormationOwnFormNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnFormNameSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationOwnFormNameSpriteSwitcher.Expression.In || original.expression == Gs2FormationOwnFormNameSpriteSwitcher.Expression.NotIn) {
