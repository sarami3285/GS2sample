...
{
    [CustomEditor(typeof(Gs2FormationPropertyFormModelNameSpriteSwitcher))]
    public class Gs2FormationPropertyFormModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationPropertyFormModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationPropertyFormModelNameSpriteSwitcher.Expression.In || original.expression == Gs2FormationPropertyFormModelNameSpriteSwitcher.Expression.NotIn) {
