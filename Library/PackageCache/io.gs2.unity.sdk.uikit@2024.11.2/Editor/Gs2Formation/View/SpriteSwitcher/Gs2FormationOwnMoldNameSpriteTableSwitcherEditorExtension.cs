...
{
    [CustomEditor(typeof(Gs2FormationOwnMoldNameSpriteTableSwitcher))]
    public class Gs2FormationOwnMoldNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnMoldNameSpriteTableSwitcher;
