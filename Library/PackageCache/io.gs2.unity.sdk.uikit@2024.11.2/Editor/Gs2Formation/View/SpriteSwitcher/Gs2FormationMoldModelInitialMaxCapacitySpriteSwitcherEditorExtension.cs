...
{
    [CustomEditor(typeof(Gs2FormationMoldModelInitialMaxCapacitySpriteSwitcher))]
    public class Gs2FormationMoldModelInitialMaxCapacitySpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldModelInitialMaxCapacitySpriteSwitcher;
            ...
            if (original.expression == Gs2FormationMoldModelInitialMaxCapacitySpriteSwitcher.Expression.In || original.expression == Gs2FormationMoldModelInitialMaxCapacitySpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyInitialMaxCapacities"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyInitialMaxCapacity"), true);
            }
