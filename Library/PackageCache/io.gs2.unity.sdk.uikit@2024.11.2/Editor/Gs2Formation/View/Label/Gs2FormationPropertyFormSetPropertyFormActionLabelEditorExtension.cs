    ...
    public class Gs2FormationPropertyFormSetPropertyFormActionLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            ...
            if (original.action == null) {
                EditorGUILayout.HelpBox("Gs2FormationPropertyFormSetPropertyFormAction not found.", MessageType.Error);
                if (GUILayout.Button("Add Context")) {
                    original.gameObject.AddComponent<Gs2FormationPropertyFormSetPropertyFormAction>();
                }
                return;
            }
