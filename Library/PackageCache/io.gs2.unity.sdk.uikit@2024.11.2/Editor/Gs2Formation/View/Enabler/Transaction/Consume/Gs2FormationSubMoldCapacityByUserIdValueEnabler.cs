...
{
    [CustomEditor(typeof(Gs2FormationSubMoldCapacityByUserIdValueEnabler))]
    public class Gs2FormationSubMoldCapacityByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationSubMoldCapacityByUserIdValueEnabler;
            ...
            if (original.expression == Gs2FormationSubMoldCapacityByUserIdValueEnabler.Expression.In || original.expression == Gs2FormationSubMoldCapacityByUserIdValueEnabler.Expression.NotIn) {
