...
{
    [CustomEditor(typeof(Gs2FormationAddMoldCapacityByUserIdEnabler))]
    public class Gs2FormationAddMoldCapacityByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationAddMoldCapacityByUserIdEnabler;
