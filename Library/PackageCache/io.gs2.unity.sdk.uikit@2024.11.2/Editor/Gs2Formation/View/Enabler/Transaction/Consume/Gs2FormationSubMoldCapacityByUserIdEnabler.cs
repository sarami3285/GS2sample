...
{
    [CustomEditor(typeof(Gs2FormationSubMoldCapacityByUserIdEnabler))]
    public class Gs2FormationSubMoldCapacityByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationSubMoldCapacityByUserIdEnabler;
