...
{
    [CustomEditor(typeof(Gs2FormationAddMoldCapacityByUserIdValueEnabler))]
    public class Gs2FormationAddMoldCapacityByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationAddMoldCapacityByUserIdValueEnabler;
            ...
            if (original.expression == Gs2FormationAddMoldCapacityByUserIdValueEnabler.Expression.In || original.expression == Gs2FormationAddMoldCapacityByUserIdValueEnabler.Expression.NotIn) {
