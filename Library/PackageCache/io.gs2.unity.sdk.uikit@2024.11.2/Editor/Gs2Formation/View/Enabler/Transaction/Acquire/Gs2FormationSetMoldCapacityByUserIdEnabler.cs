...
{
    [CustomEditor(typeof(Gs2FormationSetMoldCapacityByUserIdEnabler))]
    public class Gs2FormationSetMoldCapacityByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationSetMoldCapacityByUserIdEnabler;
