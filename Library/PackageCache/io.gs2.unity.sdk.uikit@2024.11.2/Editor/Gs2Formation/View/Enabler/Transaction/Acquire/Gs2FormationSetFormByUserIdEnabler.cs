...
{
    [CustomEditor(typeof(Gs2FormationSetFormByUserIdEnabler))]
    public class Gs2FormationSetFormByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationSetFormByUserIdEnabler;
