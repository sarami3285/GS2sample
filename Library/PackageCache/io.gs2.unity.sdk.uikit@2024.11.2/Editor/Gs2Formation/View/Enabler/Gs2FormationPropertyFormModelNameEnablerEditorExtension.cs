...
{
    [CustomEditor(typeof(Gs2FormationPropertyFormModelNameEnabler))]
    public class Gs2FormationPropertyFormModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationPropertyFormModelNameEnabler;
            ...
            if (original.expression == Gs2FormationPropertyFormModelNameEnabler.Expression.In || original.expression == Gs2FormationPropertyFormModelNameEnabler.Expression.NotIn) {
