...
{
    [CustomEditor(typeof(Gs2FormationOwnSlotPropertyIdEnabler))]
    public class Gs2FormationOwnSlotPropertyIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnSlotPropertyIdEnabler;
            ...
            if (original.expression == Gs2FormationOwnSlotPropertyIdEnabler.Expression.In || original.expression == Gs2FormationOwnSlotPropertyIdEnabler.Expression.NotIn) {
