...
{
    [CustomEditor(typeof(Gs2FormationFormModelNameEnabler))]
    public class Gs2FormationFormModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationFormModelNameEnabler;
            ...
            if (original.expression == Gs2FormationFormModelNameEnabler.Expression.In || original.expression == Gs2FormationFormModelNameEnabler.Expression.NotIn) {
