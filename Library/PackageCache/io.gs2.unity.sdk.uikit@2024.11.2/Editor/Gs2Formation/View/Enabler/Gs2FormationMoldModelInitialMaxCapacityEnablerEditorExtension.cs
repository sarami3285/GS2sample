...
{
    [CustomEditor(typeof(Gs2FormationMoldModelInitialMaxCapacityEnabler))]
    public class Gs2FormationMoldModelInitialMaxCapacityEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldModelInitialMaxCapacityEnabler;
            ...
            if (original.expression == Gs2FormationMoldModelInitialMaxCapacityEnabler.Expression.In || original.expression == Gs2FormationMoldModelInitialMaxCapacityEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableInitialMaxCapacities"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableInitialMaxCapacity"), true);
            }
