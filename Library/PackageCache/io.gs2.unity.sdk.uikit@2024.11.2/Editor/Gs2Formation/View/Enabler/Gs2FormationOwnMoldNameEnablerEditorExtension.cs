...
{
    [CustomEditor(typeof(Gs2FormationOwnMoldNameEnabler))]
    public class Gs2FormationOwnMoldNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnMoldNameEnabler;
            ...
            if (original.expression == Gs2FormationOwnMoldNameEnabler.Expression.In || original.expression == Gs2FormationOwnMoldNameEnabler.Expression.NotIn) {
