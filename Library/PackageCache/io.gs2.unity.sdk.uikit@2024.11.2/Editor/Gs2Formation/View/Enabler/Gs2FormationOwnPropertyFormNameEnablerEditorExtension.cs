...
{
    [CustomEditor(typeof(Gs2FormationOwnPropertyFormNameEnabler))]
    public class Gs2FormationOwnPropertyFormNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnPropertyFormNameEnabler;
            ...
            if (original.expression == Gs2FormationOwnPropertyFormNameEnabler.Expression.In || original.expression == Gs2FormationOwnPropertyFormNameEnabler.Expression.NotIn) {
