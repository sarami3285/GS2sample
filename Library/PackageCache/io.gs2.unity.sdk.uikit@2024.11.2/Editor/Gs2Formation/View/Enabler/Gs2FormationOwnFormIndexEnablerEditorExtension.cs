...
{
    [CustomEditor(typeof(Gs2FormationOwnFormIndexEnabler))]
    public class Gs2FormationOwnFormIndexEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnFormIndexEnabler;
            ...
            if (original.expression == Gs2FormationOwnFormIndexEnabler.Expression.In || original.expression == Gs2FormationOwnFormIndexEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableIndexes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableIndex"), true);
            }
