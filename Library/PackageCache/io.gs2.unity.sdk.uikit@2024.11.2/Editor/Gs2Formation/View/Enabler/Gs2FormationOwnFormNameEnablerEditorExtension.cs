...
{
    [CustomEditor(typeof(Gs2FormationOwnFormNameEnabler))]
    public class Gs2FormationOwnFormNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnFormNameEnabler;
            ...
            if (original.expression == Gs2FormationOwnFormNameEnabler.Expression.In || original.expression == Gs2FormationOwnFormNameEnabler.Expression.NotIn) {
