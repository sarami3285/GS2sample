...
namespace Gs2.Unity.UiKit.Gs2Formation.Enabler.Editor
{
    ...
    public class Gs2FormationMoldModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldModelMetadataEnabler;
            ...
            if (original.expression == Gs2FormationMoldModelMetadataEnabler.Expression.In || original.expression == Gs2FormationMoldModelMetadataEnabler.Expression.NotIn) {
