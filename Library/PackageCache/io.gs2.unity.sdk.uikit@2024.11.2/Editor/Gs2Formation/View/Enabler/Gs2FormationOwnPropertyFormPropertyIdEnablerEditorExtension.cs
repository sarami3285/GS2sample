...
{
    [CustomEditor(typeof(Gs2FormationOwnPropertyFormPropertyIdEnabler))]
    public class Gs2FormationOwnPropertyFormPropertyIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationOwnPropertyFormPropertyIdEnabler;
            ...
            if (original.expression == Gs2FormationOwnPropertyFormPropertyIdEnabler.Expression.In || original.expression == Gs2FormationOwnPropertyFormPropertyIdEnabler.Expression.NotIn) {
