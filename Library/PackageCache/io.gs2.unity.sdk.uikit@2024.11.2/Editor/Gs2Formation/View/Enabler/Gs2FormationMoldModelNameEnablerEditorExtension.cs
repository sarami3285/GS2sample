...
{
    [CustomEditor(typeof(Gs2FormationMoldModelNameEnabler))]
    public class Gs2FormationMoldModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldModelNameEnabler;
            ...
            if (original.expression == Gs2FormationMoldModelNameEnabler.Expression.In || original.expression == Gs2FormationMoldModelNameEnabler.Expression.NotIn) {
