...
{
    [CustomEditor(typeof(Gs2FormationUserContext))]
    public class Gs2FormationUserContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationUserContext;
