...
{
    [CustomEditor(typeof(Gs2FormationNamespaceContext))]
    public class Gs2FormationNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationNamespaceContext;
