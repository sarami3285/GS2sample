...
{
    [CustomEditor(typeof(Gs2LoginRewardNamespaceContext))]
    public class Gs2LoginRewardNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardNamespaceContext;
