...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelRepeatEnabler))]
    public class Gs2LoginRewardBonusModelRepeatEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelRepeatEnabler;
            ...
            if (original.expression == Gs2LoginRewardBonusModelRepeatEnabler.Expression.In || original.expression == Gs2LoginRewardBonusModelRepeatEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRepeats"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRepeat"), true);
            }
