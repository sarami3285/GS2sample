...
{
    [CustomEditor(typeof(Gs2LoginRewardOwnReceiveStatusEnabler))]
    public class Gs2LoginRewardOwnReceiveStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardOwnReceiveStatusEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("ReceiveStatusFetcher not assigned.", MessageType.Error);
