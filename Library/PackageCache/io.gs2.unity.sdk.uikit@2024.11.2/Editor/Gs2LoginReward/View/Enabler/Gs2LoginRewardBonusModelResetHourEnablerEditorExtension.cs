...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelResetHourEnabler))]
    public class Gs2LoginRewardBonusModelResetHourEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelResetHourEnabler;
            ...
            if (original.expression == Gs2LoginRewardBonusModelResetHourEnabler.Expression.In || original.expression == Gs2LoginRewardBonusModelResetHourEnabler.Expression.NotIn) {
