...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelMissedReceiveReliefEnabler))]
    public class Gs2LoginRewardBonusModelMissedReceiveReliefEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelMissedReceiveReliefEnabler;
            ...
            if (original.expression == Gs2LoginRewardBonusModelMissedReceiveReliefEnabler.Expression.In || original.expression == Gs2LoginRewardBonusModelMissedReceiveReliefEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableMissedReceiveRelieves"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableMissedReceiveRelief"), true);
            }
