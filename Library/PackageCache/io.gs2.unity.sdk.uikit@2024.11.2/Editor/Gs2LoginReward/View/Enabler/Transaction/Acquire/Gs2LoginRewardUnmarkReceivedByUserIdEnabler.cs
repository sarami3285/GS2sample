...
{
    [CustomEditor(typeof(Gs2LoginRewardUnmarkReceivedByUserIdEnabler))]
    public class Gs2LoginRewardUnmarkReceivedByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardUnmarkReceivedByUserIdEnabler;
