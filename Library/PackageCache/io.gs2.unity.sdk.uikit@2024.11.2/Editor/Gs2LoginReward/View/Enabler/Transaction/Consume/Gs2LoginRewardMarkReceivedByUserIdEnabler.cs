...
{
    [CustomEditor(typeof(Gs2LoginRewardMarkReceivedByUserIdEnabler))]
    public class Gs2LoginRewardMarkReceivedByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardMarkReceivedByUserIdEnabler;
