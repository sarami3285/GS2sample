...
{
    [CustomEditor(typeof(Gs2LoginRewardDeleteReceiveStatusByUserIdEnabler))]
    public class Gs2LoginRewardDeleteReceiveStatusByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardDeleteReceiveStatusByUserIdEnabler;
