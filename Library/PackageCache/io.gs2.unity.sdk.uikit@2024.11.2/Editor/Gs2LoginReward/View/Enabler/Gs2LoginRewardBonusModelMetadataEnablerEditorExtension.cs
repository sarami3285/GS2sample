...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelMetadataEnabler))]
    public class Gs2LoginRewardBonusModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelMetadataEnabler;
            ...
            if (original.expression == Gs2LoginRewardBonusModelMetadataEnabler.Expression.In || original.expression == Gs2LoginRewardBonusModelMetadataEnabler.Expression.NotIn) {
