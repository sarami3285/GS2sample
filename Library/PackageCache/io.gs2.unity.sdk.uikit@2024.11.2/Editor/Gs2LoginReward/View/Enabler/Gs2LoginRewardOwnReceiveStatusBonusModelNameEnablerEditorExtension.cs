...
{
    [CustomEditor(typeof(Gs2LoginRewardOwnReceiveStatusBonusModelNameEnabler))]
    public class Gs2LoginRewardOwnReceiveStatusBonusModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardOwnReceiveStatusBonusModelNameEnabler;
            ...
            if (original.expression == Gs2LoginRewardOwnReceiveStatusBonusModelNameEnabler.Expression.In || original.expression == Gs2LoginRewardOwnReceiveStatusBonusModelNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableBonusModelNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableBonusModelName"), true);
            }
