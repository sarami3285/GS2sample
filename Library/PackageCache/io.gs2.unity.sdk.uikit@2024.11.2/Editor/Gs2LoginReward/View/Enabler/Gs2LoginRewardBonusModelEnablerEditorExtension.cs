...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelEnabler))]
    public class Gs2LoginRewardBonusModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("BonusModelFetcher not assigned.", MessageType.Error);
