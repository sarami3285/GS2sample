...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelNameEnabler))]
    public class Gs2LoginRewardBonusModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelNameEnabler;
            ...
            if (original.expression == Gs2LoginRewardBonusModelNameEnabler.Expression.In || original.expression == Gs2LoginRewardBonusModelNameEnabler.Expression.NotIn) {
