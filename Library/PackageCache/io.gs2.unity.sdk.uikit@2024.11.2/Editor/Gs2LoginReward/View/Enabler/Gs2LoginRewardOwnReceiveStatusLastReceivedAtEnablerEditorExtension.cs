...
{
    [CustomEditor(typeof(Gs2LoginRewardOwnReceiveStatusLastReceivedAtEnabler))]
    public class Gs2LoginRewardOwnReceiveStatusLastReceivedAtEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardOwnReceiveStatusLastReceivedAtEnabler;
            ...
            if (original.expression == Gs2LoginRewardOwnReceiveStatusLastReceivedAtEnabler.Expression.In || original.expression == Gs2LoginRewardOwnReceiveStatusLastReceivedAtEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableLastReceivedAts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableLastReceivedAt"), true);
            }
