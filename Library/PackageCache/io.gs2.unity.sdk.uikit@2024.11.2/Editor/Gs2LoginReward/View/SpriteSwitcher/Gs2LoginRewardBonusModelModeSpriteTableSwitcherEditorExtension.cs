...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelModeSpriteTableSwitcher))]
    public class Gs2LoginRewardBonusModelModeSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelModeSpriteTableSwitcher;
