...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelMissedReceiveReliefSpriteSwitcher))]
    public class Gs2LoginRewardBonusModelMissedReceiveReliefSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelMissedReceiveReliefSpriteSwitcher;
            ...
            if (original.expression == Gs2LoginRewardBonusModelMissedReceiveReliefSpriteSwitcher.Expression.In || original.expression == Gs2LoginRewardBonusModelMissedReceiveReliefSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMissedReceiveRelieves"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMissedReceiveRelief"), true);
            }
