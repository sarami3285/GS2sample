...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelMetadataSpriteTableSwitcher))]
    public class Gs2LoginRewardBonusModelMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelMetadataSpriteTableSwitcher;
