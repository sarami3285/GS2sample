...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelModeSpriteSwitcher))]
    public class Gs2LoginRewardBonusModelModeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelModeSpriteSwitcher;
            ...
            if (original.expression == Gs2LoginRewardBonusModelModeSpriteSwitcher.Expression.In || original.expression == Gs2LoginRewardBonusModelModeSpriteSwitcher.Expression.NotIn) {
