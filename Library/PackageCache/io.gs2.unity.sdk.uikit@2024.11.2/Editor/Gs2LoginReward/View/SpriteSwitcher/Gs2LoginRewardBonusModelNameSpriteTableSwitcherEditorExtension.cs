...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelNameSpriteTableSwitcher))]
    public class Gs2LoginRewardBonusModelNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelNameSpriteTableSwitcher;
