...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelResetHourSpriteSwitcher))]
    public class Gs2LoginRewardBonusModelResetHourSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelResetHourSpriteSwitcher;
            ...
            if (original.expression == Gs2LoginRewardBonusModelResetHourSpriteSwitcher.Expression.In || original.expression == Gs2LoginRewardBonusModelResetHourSpriteSwitcher.Expression.NotIn) {
