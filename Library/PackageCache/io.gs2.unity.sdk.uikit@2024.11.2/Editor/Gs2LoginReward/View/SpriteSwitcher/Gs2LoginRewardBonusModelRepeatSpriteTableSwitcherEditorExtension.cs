...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelRepeatSpriteTableSwitcher))]
    public class Gs2LoginRewardBonusModelRepeatSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelRepeatSpriteTableSwitcher;
