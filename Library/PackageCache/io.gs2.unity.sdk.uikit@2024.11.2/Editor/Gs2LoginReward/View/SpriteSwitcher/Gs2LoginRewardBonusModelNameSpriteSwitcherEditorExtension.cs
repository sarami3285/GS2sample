...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelNameSpriteSwitcher))]
    public class Gs2LoginRewardBonusModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2LoginRewardBonusModelNameSpriteSwitcher.Expression.In || original.expression == Gs2LoginRewardBonusModelNameSpriteSwitcher.Expression.NotIn) {
