...
{
    [CustomEditor(typeof(Gs2LoginRewardBonusModelMetadataSpriteSwitcher))]
    public class Gs2LoginRewardBonusModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardBonusModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2LoginRewardBonusModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2LoginRewardBonusModelMetadataSpriteSwitcher.Expression.NotIn) {
