...
{
    [CustomEditor(typeof(Gs2LoginRewardOwnReceiveStatusBonusModelNameSpriteSwitcher))]
    public class Gs2LoginRewardOwnReceiveStatusBonusModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardOwnReceiveStatusBonusModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2LoginRewardOwnReceiveStatusBonusModelNameSpriteSwitcher.Expression.In || original.expression == Gs2LoginRewardOwnReceiveStatusBonusModelNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyBonusModelNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyBonusModelName"), true);
            }
