...
{
    [CustomEditor(typeof(Gs2LoginRewardDeleteReceiveStatusByUserIdLabel))]
    public class Gs2LoginRewardDeleteReceiveStatusByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardDeleteReceiveStatusByUserIdLabel;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2LoginRewardDeleteReceiveStatusByUserIdFetcher>() ?? original.GetComponentInParent<Gs2LoginRewardDeleteReceiveStatusByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2LoginRewardDeleteReceiveStatusByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2LoginRewardDeleteReceiveStatusByUserIdFetcher>();
                }
            }
