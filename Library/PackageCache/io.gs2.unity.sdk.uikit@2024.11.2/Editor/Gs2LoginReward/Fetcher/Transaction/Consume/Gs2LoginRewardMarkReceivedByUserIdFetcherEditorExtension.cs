...
{
    [CustomEditor(typeof(Gs2LoginRewardMarkReceivedByUserIdFetcher))]
    public class Gs2LoginRewardMarkReceivedByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardMarkReceivedByUserIdFetcher;
