...
{
    [CustomEditor(typeof(Gs2LoginRewardUnmarkReceivedByUserIdFetcher))]
    public class Gs2LoginRewardUnmarkReceivedByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardUnmarkReceivedByUserIdFetcher;
