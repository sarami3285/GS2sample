...
namespace Gs2.Unity.UiKit.Gs2LoginReward.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2LoginRewardDeleteReceiveStatusByUserIdFetcher))]
    public class Gs2LoginRewardDeleteReceiveStatusByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardDeleteReceiveStatusByUserIdFetcher;
