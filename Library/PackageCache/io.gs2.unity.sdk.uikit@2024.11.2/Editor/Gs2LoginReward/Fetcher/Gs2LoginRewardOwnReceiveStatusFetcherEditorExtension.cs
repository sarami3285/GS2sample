...
{
    [CustomEditor(typeof(Gs2LoginRewardOwnReceiveStatusFetcher))]
    public class Gs2LoginRewardOwnReceiveStatusFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardOwnReceiveStatusFetcher;
            ...
            if (context == null) {
                ...
                if (context.gameObject.GetComponentInParent<Gs2LoginRewardOwnReceiveStatusList>(true) != null) {
                    ...
                    EditorGUILayout.ObjectField("ReceiveStatus", context.ReceiveStatus, typeof(OwnReceiveStatus), false);
