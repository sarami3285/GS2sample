...
{
    [CustomEditor(typeof(Gs2MegaFieldAreaModelMetadataEnabler))]
    public class Gs2MegaFieldAreaModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldAreaModelMetadataEnabler;
            ...
            if (original.expression == Gs2MegaFieldAreaModelMetadataEnabler.Expression.In || original.expression == Gs2MegaFieldAreaModelMetadataEnabler.Expression.NotIn) {
