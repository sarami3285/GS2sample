...
{
    [CustomEditor(typeof(Gs2MegaFieldOwnSpatialAreaModelNameEnabler))]
    public class Gs2MegaFieldOwnSpatialAreaModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldOwnSpatialAreaModelNameEnabler;
            ...
            if (original.expression == Gs2MegaFieldOwnSpatialAreaModelNameEnabler.Expression.In || original.expression == Gs2MegaFieldOwnSpatialAreaModelNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableAreaModelNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableAreaModelName"), true);
            }
