...
{
    [CustomEditor(typeof(Gs2MegaFieldOwnSpatialEnabler))]
    public class Gs2MegaFieldOwnSpatialEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldOwnSpatialEnabler;
