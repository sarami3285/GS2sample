...
{
    [CustomEditor(typeof(Gs2MegaFieldLayerModelEnabler))]
    public class Gs2MegaFieldLayerModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldLayerModelEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("LayerModelFetcher not assigned.", MessageType.Error);
