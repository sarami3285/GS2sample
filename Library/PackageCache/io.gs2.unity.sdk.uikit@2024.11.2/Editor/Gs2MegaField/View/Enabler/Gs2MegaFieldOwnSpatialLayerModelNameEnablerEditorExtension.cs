...
{
    [CustomEditor(typeof(Gs2MegaFieldOwnSpatialLayerModelNameEnabler))]
    public class Gs2MegaFieldOwnSpatialLayerModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldOwnSpatialLayerModelNameEnabler;
            ...
            if (original.expression == Gs2MegaFieldOwnSpatialLayerModelNameEnabler.Expression.In || original.expression == Gs2MegaFieldOwnSpatialLayerModelNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableLayerModelNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableLayerModelName"), true);
            }
