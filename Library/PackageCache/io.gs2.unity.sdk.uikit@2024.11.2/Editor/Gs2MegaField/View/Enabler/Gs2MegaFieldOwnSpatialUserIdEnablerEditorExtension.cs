...
{
    [CustomEditor(typeof(Gs2MegaFieldOwnSpatialUserIdEnabler))]
    public class Gs2MegaFieldOwnSpatialUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldOwnSpatialUserIdEnabler;
            ...
            if (original.expression == Gs2MegaFieldOwnSpatialUserIdEnabler.Expression.In || original.expression == Gs2MegaFieldOwnSpatialUserIdEnabler.Expression.NotIn) {
