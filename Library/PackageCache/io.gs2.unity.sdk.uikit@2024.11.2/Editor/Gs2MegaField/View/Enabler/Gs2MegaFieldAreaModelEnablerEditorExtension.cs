...
{
    [CustomEditor(typeof(Gs2MegaFieldAreaModelEnabler))]
    public class Gs2MegaFieldAreaModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldAreaModelEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("AreaModelFetcher not assigned.", MessageType.Error);
