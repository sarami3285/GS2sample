...
{
    [CustomEditor(typeof(Gs2MegaFieldLayerModelNameEnabler))]
    public class Gs2MegaFieldLayerModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldLayerModelNameEnabler;
            ...
            if (original.expression == Gs2MegaFieldLayerModelNameEnabler.Expression.In || original.expression == Gs2MegaFieldLayerModelNameEnabler.Expression.NotIn) {
