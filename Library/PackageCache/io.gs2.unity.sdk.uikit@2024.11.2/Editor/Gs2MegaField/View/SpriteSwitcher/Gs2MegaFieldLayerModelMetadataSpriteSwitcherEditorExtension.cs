...
{
    [CustomEditor(typeof(Gs2MegaFieldLayerModelMetadataSpriteSwitcher))]
    public class Gs2MegaFieldLayerModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldLayerModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2MegaFieldLayerModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2MegaFieldLayerModelMetadataSpriteSwitcher.Expression.NotIn) {
