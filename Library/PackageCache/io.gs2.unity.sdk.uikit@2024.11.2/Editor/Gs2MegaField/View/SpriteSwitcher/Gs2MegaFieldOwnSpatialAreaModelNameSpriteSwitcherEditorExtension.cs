...
{
    [CustomEditor(typeof(Gs2MegaFieldOwnSpatialAreaModelNameSpriteSwitcher))]
    public class Gs2MegaFieldOwnSpatialAreaModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldOwnSpatialAreaModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MegaFieldOwnSpatialAreaModelNameSpriteSwitcher.Expression.In || original.expression == Gs2MegaFieldOwnSpatialAreaModelNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyAreaModelNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyAreaModelName"), true);
            }
