...
{
    [CustomEditor(typeof(Gs2MegaFieldOwnSpatialUserIdSpriteSwitcher))]
    public class Gs2MegaFieldOwnSpatialUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldOwnSpatialUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2MegaFieldOwnSpatialUserIdSpriteSwitcher.Expression.In || original.expression == Gs2MegaFieldOwnSpatialUserIdSpriteSwitcher.Expression.NotIn) {
