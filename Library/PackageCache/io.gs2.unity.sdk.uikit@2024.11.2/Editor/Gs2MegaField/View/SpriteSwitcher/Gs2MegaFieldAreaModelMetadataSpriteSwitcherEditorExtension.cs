...
{
    [CustomEditor(typeof(Gs2MegaFieldAreaModelMetadataSpriteSwitcher))]
    public class Gs2MegaFieldAreaModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldAreaModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2MegaFieldAreaModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2MegaFieldAreaModelMetadataSpriteSwitcher.Expression.NotIn) {
