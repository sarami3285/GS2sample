...
{
    [CustomEditor(typeof(Gs2MegaFieldAreaModelNameSpriteSwitcher))]
    public class Gs2MegaFieldAreaModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldAreaModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MegaFieldAreaModelNameSpriteSwitcher.Expression.In || original.expression == Gs2MegaFieldAreaModelNameSpriteSwitcher.Expression.NotIn) {
