...
{
    [CustomEditor(typeof(Gs2MegaFieldLayerModelNameSpriteSwitcher))]
    public class Gs2MegaFieldLayerModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldLayerModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MegaFieldLayerModelNameSpriteSwitcher.Expression.In || original.expression == Gs2MegaFieldLayerModelNameSpriteSwitcher.Expression.NotIn) {
