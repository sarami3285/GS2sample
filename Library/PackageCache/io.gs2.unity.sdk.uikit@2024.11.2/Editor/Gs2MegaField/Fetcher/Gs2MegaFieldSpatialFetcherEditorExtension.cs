...
{
    [CustomEditor(typeof(Gs2MegaFieldSpatialFetcher))]
    public class Gs2MegaFieldSpatialFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldSpatialFetcher;
