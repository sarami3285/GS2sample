...
{
    [CustomEditor(typeof(Gs2MegaFieldAreaModelListFetcher))]
    public class Gs2MegaFieldAreaModelListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldAreaModelListFetcher;
            ...
            if (context == null) {
                ...
                if (GUILayout.Button("Add Context")) {
                    original.gameObject.AddComponent<Gs2MegaFieldNamespaceContext>();
                }
            }
            else {
                EditorGUI.BeginDisabledGroup(true);
                EditorGUILayout.ObjectField("Context", context.gameObject, typeof(Gs2MegaFieldNamespaceContext), false);
