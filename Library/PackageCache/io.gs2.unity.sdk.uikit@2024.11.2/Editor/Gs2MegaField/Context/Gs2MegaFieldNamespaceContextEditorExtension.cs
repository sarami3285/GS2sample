...
{
    [CustomEditor(typeof(Gs2MegaFieldNamespaceContext))]
    public class Gs2MegaFieldNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldNamespaceContext;
