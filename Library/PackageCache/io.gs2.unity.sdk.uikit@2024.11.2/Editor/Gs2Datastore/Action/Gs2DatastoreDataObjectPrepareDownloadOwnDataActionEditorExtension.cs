...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectPrepareDownloadOwnDataAction))]
    public class Gs2DatastoreDataObjectPrepareDownloadOwnDataActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectPrepareDownloadOwnDataAction;
            ...
            if (context == null) {
                ...
                if (context.transform.GetComponentInParent<Gs2DatastoreOwnDataObjectList>(true) != null) {
