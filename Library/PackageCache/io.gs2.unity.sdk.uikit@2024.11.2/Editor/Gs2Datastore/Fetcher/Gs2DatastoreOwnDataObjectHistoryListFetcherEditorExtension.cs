...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectHistoryListFetcher))]
    public class Gs2DatastoreOwnDataObjectHistoryListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectHistoryListFetcher;
