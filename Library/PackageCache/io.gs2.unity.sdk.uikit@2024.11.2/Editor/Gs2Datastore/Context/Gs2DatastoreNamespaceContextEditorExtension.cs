...
{
    [CustomEditor(typeof(Gs2DatastoreNamespaceContext))]
    public class Gs2DatastoreNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreNamespaceContext;
