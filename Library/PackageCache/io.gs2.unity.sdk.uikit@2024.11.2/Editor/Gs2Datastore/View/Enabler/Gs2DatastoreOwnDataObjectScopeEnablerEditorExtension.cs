...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectScopeEnabler))]
    public class Gs2DatastoreOwnDataObjectScopeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectScopeEnabler;
            ...
            if (original.expression == Gs2DatastoreOwnDataObjectScopeEnabler.Expression.In || original.expression == Gs2DatastoreOwnDataObjectScopeEnabler.Expression.NotIn) {
