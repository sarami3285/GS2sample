...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectHistoryEnabler))]
    public class Gs2DatastoreOwnDataObjectHistoryEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectHistoryEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("DataObjectHistoryFetcher not assigned.", MessageType.Error);
