...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectUserIdEnabler))]
    public class Gs2DatastoreOwnDataObjectUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectUserIdEnabler;
            ...
            if (original.expression == Gs2DatastoreOwnDataObjectUserIdEnabler.Expression.In || original.expression == Gs2DatastoreOwnDataObjectUserIdEnabler.Expression.NotIn) {
