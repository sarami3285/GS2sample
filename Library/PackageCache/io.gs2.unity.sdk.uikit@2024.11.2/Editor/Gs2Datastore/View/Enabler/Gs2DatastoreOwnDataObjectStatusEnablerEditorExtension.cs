...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectStatusEnabler))]
    public class Gs2DatastoreOwnDataObjectStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectStatusEnabler;
            ...
            if (original.expression == Gs2DatastoreOwnDataObjectStatusEnabler.Expression.In || original.expression == Gs2DatastoreOwnDataObjectStatusEnabler.Expression.NotIn) {
