...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectEnabler))]
    public class Gs2DatastoreDataObjectEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectEnabler;
