...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectStatusEnabler))]
    public class Gs2DatastoreDataObjectStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectStatusEnabler;
            ...
            if (original.expression == Gs2DatastoreDataObjectStatusEnabler.Expression.In || original.expression == Gs2DatastoreDataObjectStatusEnabler.Expression.NotIn) {
