...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectScopeEnabler))]
    public class Gs2DatastoreDataObjectScopeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectScopeEnabler;
            ...
            if (original.expression == Gs2DatastoreDataObjectScopeEnabler.Expression.In || original.expression == Gs2DatastoreDataObjectScopeEnabler.Expression.NotIn) {
