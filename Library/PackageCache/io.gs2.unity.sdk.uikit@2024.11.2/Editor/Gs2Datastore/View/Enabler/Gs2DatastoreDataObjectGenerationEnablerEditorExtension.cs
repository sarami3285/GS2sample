...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectGenerationEnabler))]
    public class Gs2DatastoreDataObjectGenerationEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectGenerationEnabler;
            ...
            if (original.expression == Gs2DatastoreDataObjectGenerationEnabler.Expression.In || original.expression == Gs2DatastoreDataObjectGenerationEnabler.Expression.NotIn) {
