...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectGenerationEnabler))]
    public class Gs2DatastoreOwnDataObjectGenerationEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectGenerationEnabler;
            ...
            if (original.expression == Gs2DatastoreOwnDataObjectGenerationEnabler.Expression.In || original.expression == Gs2DatastoreOwnDataObjectGenerationEnabler.Expression.NotIn) {
