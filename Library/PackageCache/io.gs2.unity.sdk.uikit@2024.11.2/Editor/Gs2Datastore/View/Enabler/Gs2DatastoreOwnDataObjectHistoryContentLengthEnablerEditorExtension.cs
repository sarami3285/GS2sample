...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectHistoryContentLengthEnabler))]
    public class Gs2DatastoreOwnDataObjectHistoryContentLengthEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectHistoryContentLengthEnabler;
            ...
            if (original.expression == Gs2DatastoreOwnDataObjectHistoryContentLengthEnabler.Expression.In || original.expression == Gs2DatastoreOwnDataObjectHistoryContentLengthEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableContentLengths"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableContentLength"), true);
            }
