...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectNameEnabler))]
    public class Gs2DatastoreOwnDataObjectNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectNameEnabler;
            ...
            if (original.expression == Gs2DatastoreOwnDataObjectNameEnabler.Expression.In || original.expression == Gs2DatastoreOwnDataObjectNameEnabler.Expression.NotIn) {
