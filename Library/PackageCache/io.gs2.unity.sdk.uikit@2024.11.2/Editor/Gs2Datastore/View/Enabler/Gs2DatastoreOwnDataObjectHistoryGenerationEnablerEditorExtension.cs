...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectHistoryGenerationEnabler))]
    public class Gs2DatastoreOwnDataObjectHistoryGenerationEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectHistoryGenerationEnabler;
            ...
            if (original.expression == Gs2DatastoreOwnDataObjectHistoryGenerationEnabler.Expression.In || original.expression == Gs2DatastoreOwnDataObjectHistoryGenerationEnabler.Expression.NotIn) {
