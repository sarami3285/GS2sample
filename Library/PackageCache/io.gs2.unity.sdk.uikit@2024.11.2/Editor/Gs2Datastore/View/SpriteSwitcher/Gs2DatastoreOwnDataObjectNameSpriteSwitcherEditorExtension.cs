...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectNameSpriteSwitcher))]
    public class Gs2DatastoreOwnDataObjectNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectNameSpriteSwitcher;
            ...
            if (original.expression == Gs2DatastoreOwnDataObjectNameSpriteSwitcher.Expression.In || original.expression == Gs2DatastoreOwnDataObjectNameSpriteSwitcher.Expression.NotIn) {
