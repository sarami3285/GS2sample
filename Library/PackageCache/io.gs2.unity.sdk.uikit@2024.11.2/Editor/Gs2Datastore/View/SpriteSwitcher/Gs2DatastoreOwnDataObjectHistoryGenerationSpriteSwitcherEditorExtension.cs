...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectHistoryGenerationSpriteSwitcher))]
    public class Gs2DatastoreOwnDataObjectHistoryGenerationSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectHistoryGenerationSpriteSwitcher;
            ...
            if (original.expression == Gs2DatastoreOwnDataObjectHistoryGenerationSpriteSwitcher.Expression.In || original.expression == Gs2DatastoreOwnDataObjectHistoryGenerationSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyGenerations"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyGeneration"), true);
            }
