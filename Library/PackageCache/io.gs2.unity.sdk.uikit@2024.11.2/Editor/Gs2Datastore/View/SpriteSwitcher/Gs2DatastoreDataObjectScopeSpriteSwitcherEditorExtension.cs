...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectScopeSpriteSwitcher))]
    public class Gs2DatastoreDataObjectScopeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectScopeSpriteSwitcher;
            ...
            if (original.expression == Gs2DatastoreDataObjectScopeSpriteSwitcher.Expression.In || original.expression == Gs2DatastoreDataObjectScopeSpriteSwitcher.Expression.NotIn) {
