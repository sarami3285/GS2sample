...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectStatusSpriteSwitcher))]
    public class Gs2DatastoreOwnDataObjectStatusSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectStatusSpriteSwitcher;
            ...
            if (original.expression == Gs2DatastoreOwnDataObjectStatusSpriteSwitcher.Expression.In || original.expression == Gs2DatastoreOwnDataObjectStatusSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyStatuses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyStatus"), true);
            }
