...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectGenerationSpriteSwitcher))]
    public class Gs2DatastoreOwnDataObjectGenerationSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectGenerationSpriteSwitcher;
            ...
            if (original.expression == Gs2DatastoreOwnDataObjectGenerationSpriteSwitcher.Expression.In || original.expression == Gs2DatastoreOwnDataObjectGenerationSpriteSwitcher.Expression.NotIn) {
