...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectUserIdSpriteSwitcher))]
    public class Gs2DatastoreOwnDataObjectUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2DatastoreOwnDataObjectUserIdSpriteSwitcher.Expression.In || original.expression == Gs2DatastoreOwnDataObjectUserIdSpriteSwitcher.Expression.NotIn) {
