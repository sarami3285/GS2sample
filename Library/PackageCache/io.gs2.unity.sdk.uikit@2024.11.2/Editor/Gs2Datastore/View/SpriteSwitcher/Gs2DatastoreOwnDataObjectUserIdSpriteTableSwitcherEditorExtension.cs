...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectUserIdSpriteTableSwitcher))]
    public class Gs2DatastoreOwnDataObjectUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectUserIdSpriteTableSwitcher;
