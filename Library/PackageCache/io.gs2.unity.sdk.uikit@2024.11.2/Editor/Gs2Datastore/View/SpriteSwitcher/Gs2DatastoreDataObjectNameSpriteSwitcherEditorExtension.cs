...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectNameSpriteSwitcher))]
    public class Gs2DatastoreDataObjectNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectNameSpriteSwitcher;
            ...
            if (original.expression == Gs2DatastoreDataObjectNameSpriteSwitcher.Expression.In || original.expression == Gs2DatastoreDataObjectNameSpriteSwitcher.Expression.NotIn) {
