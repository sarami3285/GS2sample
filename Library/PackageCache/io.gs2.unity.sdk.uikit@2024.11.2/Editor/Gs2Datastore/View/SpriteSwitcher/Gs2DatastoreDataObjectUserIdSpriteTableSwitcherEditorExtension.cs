...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectUserIdSpriteTableSwitcher))]
    public class Gs2DatastoreDataObjectUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectUserIdSpriteTableSwitcher;
