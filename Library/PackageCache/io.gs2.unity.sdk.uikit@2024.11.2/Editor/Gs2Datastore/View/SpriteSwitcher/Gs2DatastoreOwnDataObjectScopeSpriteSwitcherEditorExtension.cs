...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectScopeSpriteSwitcher))]
    public class Gs2DatastoreOwnDataObjectScopeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectScopeSpriteSwitcher;
            ...
            if (original.expression == Gs2DatastoreOwnDataObjectScopeSpriteSwitcher.Expression.In || original.expression == Gs2DatastoreOwnDataObjectScopeSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyScopes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyScope"), true);
            }
