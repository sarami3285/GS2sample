...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectStatusSpriteSwitcher))]
    public class Gs2DatastoreDataObjectStatusSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectStatusSpriteSwitcher;
            ...
            if (original.expression == Gs2DatastoreDataObjectStatusSpriteSwitcher.Expression.In || original.expression == Gs2DatastoreDataObjectStatusSpriteSwitcher.Expression.NotIn) {
