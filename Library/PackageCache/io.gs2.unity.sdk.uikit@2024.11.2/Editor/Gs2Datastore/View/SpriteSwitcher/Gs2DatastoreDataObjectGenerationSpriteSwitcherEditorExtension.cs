...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectGenerationSpriteSwitcher))]
    public class Gs2DatastoreDataObjectGenerationSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectGenerationSpriteSwitcher;
            ...
            if (original.expression == Gs2DatastoreDataObjectGenerationSpriteSwitcher.Expression.In || original.expression == Gs2DatastoreDataObjectGenerationSpriteSwitcher.Expression.NotIn) {
