...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectStatusSpriteTableSwitcher))]
    public class Gs2DatastoreOwnDataObjectStatusSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectStatusSpriteTableSwitcher;
