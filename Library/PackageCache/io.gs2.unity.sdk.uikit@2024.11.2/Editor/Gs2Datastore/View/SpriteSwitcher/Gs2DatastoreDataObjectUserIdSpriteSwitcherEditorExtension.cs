...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectUserIdSpriteSwitcher))]
    public class Gs2DatastoreDataObjectUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2DatastoreDataObjectUserIdSpriteSwitcher.Expression.In || original.expression == Gs2DatastoreDataObjectUserIdSpriteSwitcher.Expression.NotIn) {
