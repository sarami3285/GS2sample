...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectScopeSpriteTableSwitcher))]
    public class Gs2DatastoreDataObjectScopeSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectScopeSpriteTableSwitcher;
