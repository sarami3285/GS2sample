...
{
    [CustomEditor(typeof(Gs2DatastoreOwnDataObjectLabel))]
    public class Gs2DatastoreOwnDataObjectLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreOwnDataObjectLabel;
            ...
            if (fetcher == null) {
                ...
                if (fetcher.gameObject.GetComponentInParent<Gs2DatastoreOwnDataObjectList>(true) != null) {
                    ...
                    if (fetcher.Context != null) {
                        EditorGUILayout.ObjectField("DataObject", fetcher.Context.DataObject, typeof(OwnDataObject), false);
                        EditorGUI.indentLevel++;
