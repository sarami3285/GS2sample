...
{
    [CustomEditor(typeof(Gs2SerialKeyNamespaceContext))]
    public class Gs2SerialKeyNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyNamespaceContext;
