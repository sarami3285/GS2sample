...
{
    [CustomEditor(typeof(Gs2SerialKeyOwnSerialKeyContext))]
    public class Gs2SerialKeyOwnSerialKeyContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyOwnSerialKeyContext;
            ...
            if (original.SerialKey == null) {
                EditorGUILayout.HelpBox("OwnSerialKey not assigned.", MessageType.Error);
