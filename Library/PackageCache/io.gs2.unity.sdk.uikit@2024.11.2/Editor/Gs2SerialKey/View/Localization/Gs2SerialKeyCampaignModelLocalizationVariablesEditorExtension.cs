...
{
    [CustomEditor(typeof(Gs2SerialKeyCampaignModelLocalizationVariables))]
    public class Gs2SerialKeyCampaignModelLocalizationVariablesEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyCampaignModelLocalizationVariables;
