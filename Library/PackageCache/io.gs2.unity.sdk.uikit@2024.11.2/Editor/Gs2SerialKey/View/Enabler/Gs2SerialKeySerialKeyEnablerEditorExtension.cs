...
{
    [CustomEditor(typeof(Gs2SerialKeySerialKeyEnabler))]
    public class Gs2SerialKeySerialKeyEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeySerialKeyEnabler;
