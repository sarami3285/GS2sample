...
{
    [CustomEditor(typeof(Gs2SerialKeySerialKeyCampaignModelNameEnabler))]
    public class Gs2SerialKeySerialKeyCampaignModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeySerialKeyCampaignModelNameEnabler;
            ...
            if (original.expression == Gs2SerialKeySerialKeyCampaignModelNameEnabler.Expression.In || original.expression == Gs2SerialKeySerialKeyCampaignModelNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableCampaignModelNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableCampaignModelName"), true);
            }
