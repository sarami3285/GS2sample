...
{
    [CustomEditor(typeof(Gs2SerialKeySerialKeyMetadataEnabler))]
    public class Gs2SerialKeySerialKeyMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeySerialKeyMetadataEnabler;
            ...
            if (original.expression == Gs2SerialKeySerialKeyMetadataEnabler.Expression.In || original.expression == Gs2SerialKeySerialKeyMetadataEnabler.Expression.NotIn) {
