...
{
    [CustomEditor(typeof(Gs2SerialKeyVerifyCodeByUserIdEnabler))]
    public class Gs2SerialKeyVerifyCodeByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyVerifyCodeByUserIdEnabler;
