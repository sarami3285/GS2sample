...
{
    [CustomEditor(typeof(Gs2SerialKeyUseByUserIdEnabler))]
    public class Gs2SerialKeyUseByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyUseByUserIdEnabler;
