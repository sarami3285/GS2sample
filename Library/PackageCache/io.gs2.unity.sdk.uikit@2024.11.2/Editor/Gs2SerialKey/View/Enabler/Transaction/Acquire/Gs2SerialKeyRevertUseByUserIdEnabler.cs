...
{
    [CustomEditor(typeof(Gs2SerialKeyRevertUseByUserIdEnabler))]
    public class Gs2SerialKeyRevertUseByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyRevertUseByUserIdEnabler;
