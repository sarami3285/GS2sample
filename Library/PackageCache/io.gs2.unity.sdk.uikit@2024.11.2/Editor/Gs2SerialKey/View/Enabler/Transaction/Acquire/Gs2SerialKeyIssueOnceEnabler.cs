...
{
    [CustomEditor(typeof(Gs2SerialKeyIssueOnceEnabler))]
    public class Gs2SerialKeyIssueOnceEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyIssueOnceEnabler;
