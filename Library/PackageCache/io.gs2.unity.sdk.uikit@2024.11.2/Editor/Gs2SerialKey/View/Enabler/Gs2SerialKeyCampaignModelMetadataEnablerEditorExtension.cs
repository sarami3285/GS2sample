...
{
    [CustomEditor(typeof(Gs2SerialKeyCampaignModelMetadataEnabler))]
    public class Gs2SerialKeyCampaignModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyCampaignModelMetadataEnabler;
            ...
            if (original.expression == Gs2SerialKeyCampaignModelMetadataEnabler.Expression.In || original.expression == Gs2SerialKeyCampaignModelMetadataEnabler.Expression.NotIn) {
