...
namespace Gs2.Unity.UiKit.Gs2SerialKey.Enabler.Editor
{
    ...
    public class Gs2SerialKeySerialKeyCodeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeySerialKeyCodeEnabler;
            ...
            if (original.expression == Gs2SerialKeySerialKeyCodeEnabler.Expression.In || original.expression == Gs2SerialKeySerialKeyCodeEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableCodes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableCode"), true);
            }
