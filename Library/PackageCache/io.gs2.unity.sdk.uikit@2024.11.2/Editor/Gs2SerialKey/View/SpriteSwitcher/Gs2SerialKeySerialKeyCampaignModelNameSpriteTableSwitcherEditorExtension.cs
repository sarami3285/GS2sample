...
{
    [CustomEditor(typeof(Gs2SerialKeySerialKeyCampaignModelNameSpriteTableSwitcher))]
    public class Gs2SerialKeySerialKeyCampaignModelNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeySerialKeyCampaignModelNameSpriteTableSwitcher;
