...
{
    [CustomEditor(typeof(Gs2SerialKeyCampaignModelMetadataSpriteSwitcher))]
    public class Gs2SerialKeyCampaignModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyCampaignModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2SerialKeyCampaignModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2SerialKeyCampaignModelMetadataSpriteSwitcher.Expression.NotIn) {
