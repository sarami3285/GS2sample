...
{
    [CustomEditor(typeof(Gs2SerialKeySerialKeyCampaignModelNameSpriteSwitcher))]
    public class Gs2SerialKeySerialKeyCampaignModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeySerialKeyCampaignModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2SerialKeySerialKeyCampaignModelNameSpriteSwitcher.Expression.In || original.expression == Gs2SerialKeySerialKeyCampaignModelNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCampaignModelNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCampaignModelName"), true);
            }
