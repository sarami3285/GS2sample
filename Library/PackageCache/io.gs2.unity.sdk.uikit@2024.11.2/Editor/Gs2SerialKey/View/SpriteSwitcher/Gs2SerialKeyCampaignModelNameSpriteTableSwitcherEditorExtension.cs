...
{
    [CustomEditor(typeof(Gs2SerialKeyCampaignModelNameSpriteTableSwitcher))]
    public class Gs2SerialKeyCampaignModelNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyCampaignModelNameSpriteTableSwitcher;
