...
{
    [CustomEditor(typeof(Gs2SerialKeySerialKeyMetadataSpriteSwitcher))]
    public class Gs2SerialKeySerialKeyMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeySerialKeyMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2SerialKeySerialKeyMetadataSpriteSwitcher.Expression.In || original.expression == Gs2SerialKeySerialKeyMetadataSpriteSwitcher.Expression.NotIn) {
