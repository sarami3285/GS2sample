...
{
    [CustomEditor(typeof(Gs2SerialKeySerialKeyStatusSpriteSwitcher))]
    public class Gs2SerialKeySerialKeyStatusSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeySerialKeyStatusSpriteSwitcher;
            ...
            if (original.expression == Gs2SerialKeySerialKeyStatusSpriteSwitcher.Expression.In || original.expression == Gs2SerialKeySerialKeyStatusSpriteSwitcher.Expression.NotIn) {
