...
{
    [CustomEditor(typeof(Gs2SerialKeyCampaignModelMetadataSpriteTableSwitcher))]
    public class Gs2SerialKeyCampaignModelMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyCampaignModelMetadataSpriteTableSwitcher;
