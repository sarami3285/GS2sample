...
{
    [CustomEditor(typeof(Gs2SerialKeySerialKeyStatusSpriteTableSwitcher))]
    public class Gs2SerialKeySerialKeyStatusSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeySerialKeyStatusSpriteTableSwitcher;
