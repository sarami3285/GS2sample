...
{
    [CustomEditor(typeof(Gs2SerialKeySerialKeyMetadataSpriteTableSwitcher))]
    public class Gs2SerialKeySerialKeyMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeySerialKeyMetadataSpriteTableSwitcher;
