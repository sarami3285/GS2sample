...
{
    [CustomEditor(typeof(Gs2SerialKeyCampaignModelNameSpriteSwitcher))]
    public class Gs2SerialKeyCampaignModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyCampaignModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2SerialKeyCampaignModelNameSpriteSwitcher.Expression.In || original.expression == Gs2SerialKeyCampaignModelNameSpriteSwitcher.Expression.NotIn) {
