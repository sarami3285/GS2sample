...
{
    [CustomEditor(typeof(Gs2SerialKeySerialKeyCodeSpriteTableSwitcher))]
    public class Gs2SerialKeySerialKeyCodeSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeySerialKeyCodeSpriteTableSwitcher;
