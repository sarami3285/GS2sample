...
{
    [CustomEditor(typeof(Gs2SerialKeyIssueOnceFetcher))]
    public class Gs2SerialKeyIssueOnceFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyIssueOnceFetcher;
