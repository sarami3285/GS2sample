...
{
    [CustomEditor(typeof(Gs2SerialKeyRevertUseByUserIdFetcher))]
    public class Gs2SerialKeyRevertUseByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyRevertUseByUserIdFetcher;
