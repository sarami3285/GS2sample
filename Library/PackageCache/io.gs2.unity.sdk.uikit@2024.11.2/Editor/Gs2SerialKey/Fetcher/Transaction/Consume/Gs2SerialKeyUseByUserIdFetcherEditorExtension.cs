...
{
    [CustomEditor(typeof(Gs2SerialKeyUseByUserIdFetcher))]
    public class Gs2SerialKeyUseByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyUseByUserIdFetcher;
