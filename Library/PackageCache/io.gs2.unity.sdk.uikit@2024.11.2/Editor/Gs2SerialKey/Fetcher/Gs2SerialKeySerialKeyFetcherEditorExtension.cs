...
{
    [CustomEditor(typeof(Gs2SerialKeySerialKeyFetcher))]
    public class Gs2SerialKeySerialKeyFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeySerialKeyFetcher;
