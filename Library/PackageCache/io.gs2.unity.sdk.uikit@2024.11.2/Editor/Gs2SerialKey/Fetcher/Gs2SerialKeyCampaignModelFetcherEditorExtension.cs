...
{
    [CustomEditor(typeof(Gs2SerialKeyCampaignModelFetcher))]
    public class Gs2SerialKeyCampaignModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyCampaignModelFetcher;
