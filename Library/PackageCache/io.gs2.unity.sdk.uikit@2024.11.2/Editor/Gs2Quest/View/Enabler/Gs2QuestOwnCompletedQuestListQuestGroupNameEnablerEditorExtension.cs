...
{
    [CustomEditor(typeof(Gs2QuestOwnCompletedQuestListQuestGroupNameEnabler))]
    public class Gs2QuestOwnCompletedQuestListQuestGroupNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestOwnCompletedQuestListQuestGroupNameEnabler;
            ...
            if (original.expression == Gs2QuestOwnCompletedQuestListQuestGroupNameEnabler.Expression.In || original.expression == Gs2QuestOwnCompletedQuestListQuestGroupNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableQuestGroupNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableQuestGroupName"), true);
            }
