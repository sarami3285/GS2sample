...
{
    [CustomEditor(typeof(Gs2QuestOwnProgressRandomSeedEnabler))]
    public class Gs2QuestOwnProgressRandomSeedEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestOwnProgressRandomSeedEnabler;
            ...
            if (original.expression == Gs2QuestOwnProgressRandomSeedEnabler.Expression.In || original.expression == Gs2QuestOwnProgressRandomSeedEnabler.Expression.NotIn) {
