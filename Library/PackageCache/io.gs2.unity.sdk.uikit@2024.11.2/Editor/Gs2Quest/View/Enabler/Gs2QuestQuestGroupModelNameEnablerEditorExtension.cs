...
{
    [CustomEditor(typeof(Gs2QuestQuestGroupModelNameEnabler))]
    public class Gs2QuestQuestGroupModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestQuestGroupModelNameEnabler;
            ...
            if (original.expression == Gs2QuestQuestGroupModelNameEnabler.Expression.In || original.expression == Gs2QuestQuestGroupModelNameEnabler.Expression.NotIn) {
