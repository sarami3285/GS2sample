...
{
    [CustomEditor(typeof(Gs2QuestCreateProgressByUserIdEnabler))]
    public class Gs2QuestCreateProgressByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestCreateProgressByUserIdEnabler;
