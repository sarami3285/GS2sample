...
{
    [CustomEditor(typeof(Gs2QuestDeleteProgressByUserIdEnabler))]
    public class Gs2QuestDeleteProgressByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestDeleteProgressByUserIdEnabler;
