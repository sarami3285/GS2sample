...
{
    [CustomEditor(typeof(Gs2QuestOwnProgressTransactionIdEnabler))]
    public class Gs2QuestOwnProgressTransactionIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestOwnProgressTransactionIdEnabler;
            ...
            if (original.expression == Gs2QuestOwnProgressTransactionIdEnabler.Expression.In || original.expression == Gs2QuestOwnProgressTransactionIdEnabler.Expression.NotIn) {
