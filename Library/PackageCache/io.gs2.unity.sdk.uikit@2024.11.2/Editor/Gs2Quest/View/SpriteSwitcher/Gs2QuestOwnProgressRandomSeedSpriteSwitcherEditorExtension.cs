...
{
    [CustomEditor(typeof(Gs2QuestOwnProgressRandomSeedSpriteSwitcher))]
    public class Gs2QuestOwnProgressRandomSeedSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestOwnProgressRandomSeedSpriteSwitcher;
            ...
            if (original.expression == Gs2QuestOwnProgressRandomSeedSpriteSwitcher.Expression.In || original.expression == Gs2QuestOwnProgressRandomSeedSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRandomSeeds"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRandomSeed"), true);
            }
