...
{
    [CustomEditor(typeof(Gs2QuestOwnCompletedQuestListQuestGroupNameSpriteSwitcher))]
    public class Gs2QuestOwnCompletedQuestListQuestGroupNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestOwnCompletedQuestListQuestGroupNameSpriteSwitcher;
            ...
            if (original.expression == Gs2QuestOwnCompletedQuestListQuestGroupNameSpriteSwitcher.Expression.In || original.expression == Gs2QuestOwnCompletedQuestListQuestGroupNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyQuestGroupNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyQuestGroupName"), true);
            }
