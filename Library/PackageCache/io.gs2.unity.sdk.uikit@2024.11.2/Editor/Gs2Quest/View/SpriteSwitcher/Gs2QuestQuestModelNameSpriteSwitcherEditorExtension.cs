...
{
    [CustomEditor(typeof(Gs2QuestQuestModelNameSpriteSwitcher))]
    public class Gs2QuestQuestModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestQuestModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2QuestQuestModelNameSpriteSwitcher.Expression.In || original.expression == Gs2QuestQuestModelNameSpriteSwitcher.Expression.NotIn) {
