...
{
    [CustomEditor(typeof(Gs2QuestQuestModelMetadataSpriteSwitcher))]
    public class Gs2QuestQuestModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestQuestModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2QuestQuestModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2QuestQuestModelMetadataSpriteSwitcher.Expression.NotIn) {
