...
{
    [CustomEditor(typeof(Gs2QuestQuestGroupModelMetadataSpriteSwitcher))]
    public class Gs2QuestQuestGroupModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestQuestGroupModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2QuestQuestGroupModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2QuestQuestGroupModelMetadataSpriteSwitcher.Expression.NotIn) {
