...
{
    [CustomEditor(typeof(Gs2QuestOwnProgressTransactionIdSpriteSwitcher))]
    public class Gs2QuestOwnProgressTransactionIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestOwnProgressTransactionIdSpriteSwitcher;
            ...
            if (original.expression == Gs2QuestOwnProgressTransactionIdSpriteSwitcher.Expression.In || original.expression == Gs2QuestOwnProgressTransactionIdSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTransactionIds"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTransactionId"), true);
            }
