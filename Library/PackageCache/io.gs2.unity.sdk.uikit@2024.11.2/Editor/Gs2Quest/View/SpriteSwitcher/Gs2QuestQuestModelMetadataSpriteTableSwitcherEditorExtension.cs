...
{
    [CustomEditor(typeof(Gs2QuestQuestModelMetadataSpriteTableSwitcher))]
    public class Gs2QuestQuestModelMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestQuestModelMetadataSpriteTableSwitcher;
