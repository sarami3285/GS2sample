...
{
    [CustomEditor(typeof(Gs2QuestQuestGroupModelFetcher))]
    public class Gs2QuestQuestGroupModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestQuestGroupModelFetcher;
