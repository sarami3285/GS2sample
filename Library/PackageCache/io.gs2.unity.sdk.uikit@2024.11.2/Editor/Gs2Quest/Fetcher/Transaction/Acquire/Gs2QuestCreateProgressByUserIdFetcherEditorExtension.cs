...
namespace Gs2.Unity.UiKit.Gs2Quest.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2QuestCreateProgressByUserIdFetcher))]
    public class Gs2QuestCreateProgressByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestCreateProgressByUserIdFetcher;
