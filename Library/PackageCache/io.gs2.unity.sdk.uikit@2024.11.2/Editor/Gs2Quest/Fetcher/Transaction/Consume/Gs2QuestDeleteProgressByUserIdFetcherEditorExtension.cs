...
{
    [CustomEditor(typeof(Gs2QuestDeleteProgressByUserIdFetcher))]
    public class Gs2QuestDeleteProgressByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestDeleteProgressByUserIdFetcher;
