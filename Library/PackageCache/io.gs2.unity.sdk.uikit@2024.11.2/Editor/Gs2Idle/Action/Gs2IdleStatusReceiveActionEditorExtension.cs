...
{
    [CustomEditor(typeof(Gs2IdleStatusReceiveAction))]
    public class Gs2IdleStatusReceiveActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleStatusReceiveAction;
