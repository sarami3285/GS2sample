...
{
    [CustomEditor(typeof(Gs2IdleReceiveByUserIdFetcher))]
    public class Gs2IdleReceiveByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleReceiveByUserIdFetcher;
