...
namespace Gs2.Unity.UiKit.Gs2Idle.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2IdleIncreaseMaximumIdleMinutesByUserIdFetcher))]
    public class Gs2IdleIncreaseMaximumIdleMinutesByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleIncreaseMaximumIdleMinutesByUserIdFetcher;
