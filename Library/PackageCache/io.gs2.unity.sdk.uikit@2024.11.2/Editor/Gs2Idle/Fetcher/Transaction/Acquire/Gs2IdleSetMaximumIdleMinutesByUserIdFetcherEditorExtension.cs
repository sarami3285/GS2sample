...
{
    [CustomEditor(typeof(Gs2IdleSetMaximumIdleMinutesByUserIdFetcher))]
    public class Gs2IdleSetMaximumIdleMinutesByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleSetMaximumIdleMinutesByUserIdFetcher;
