...
{
    [CustomEditor(typeof(Gs2IdleDecreaseMaximumIdleMinutesByUserIdFetcher))]
    public class Gs2IdleDecreaseMaximumIdleMinutesByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleDecreaseMaximumIdleMinutesByUserIdFetcher;
