...
{
    [CustomEditor(typeof(Gs2IdleCategoryModelFetcher))]
    public class Gs2IdleCategoryModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleCategoryModelFetcher;
            ...
            if (context == null) {
                ...
                if (context.gameObject.GetComponentInParent<Gs2IdleCategoryModelList>(true) != null) {
                    ...
                    EditorGUILayout.ObjectField("CategoryModel", context.CategoryModel, typeof(CategoryModel), false);
