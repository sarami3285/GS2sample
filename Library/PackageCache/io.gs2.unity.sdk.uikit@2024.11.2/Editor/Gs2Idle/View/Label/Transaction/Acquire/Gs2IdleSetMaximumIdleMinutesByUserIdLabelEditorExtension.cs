...
{
    [CustomEditor(typeof(Gs2IdleSetMaximumIdleMinutesByUserIdLabel))]
    public class Gs2IdleSetMaximumIdleMinutesByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleSetMaximumIdleMinutesByUserIdLabel;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2IdleSetMaximumIdleMinutesByUserIdFetcher>() ?? original.GetComponentInParent<Gs2IdleSetMaximumIdleMinutesByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2IdleSetMaximumIdleMinutesByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2IdleSetMaximumIdleMinutesByUserIdFetcher>();
                }
            }
