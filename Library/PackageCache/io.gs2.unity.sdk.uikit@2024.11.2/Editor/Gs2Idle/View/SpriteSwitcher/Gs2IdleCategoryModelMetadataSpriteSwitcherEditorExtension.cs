...
{
    [CustomEditor(typeof(Gs2IdleCategoryModelMetadataSpriteSwitcher))]
    public class Gs2IdleCategoryModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleCategoryModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2IdleCategoryModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2IdleCategoryModelMetadataSpriteSwitcher.Expression.NotIn) {
