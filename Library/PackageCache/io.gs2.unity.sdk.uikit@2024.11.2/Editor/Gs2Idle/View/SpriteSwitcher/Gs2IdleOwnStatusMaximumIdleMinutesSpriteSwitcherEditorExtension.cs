...
{
    [CustomEditor(typeof(Gs2IdleOwnStatusMaximumIdleMinutesSpriteSwitcher))]
    public class Gs2IdleOwnStatusMaximumIdleMinutesSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleOwnStatusMaximumIdleMinutesSpriteSwitcher;
            ...
            if (original.expression == Gs2IdleOwnStatusMaximumIdleMinutesSpriteSwitcher.Expression.In || original.expression == Gs2IdleOwnStatusMaximumIdleMinutesSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMaximumIdleMinuteses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMaximumIdleMinutes"), true);
            }
