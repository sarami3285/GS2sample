...
{
    [CustomEditor(typeof(Gs2IdleCategoryModelNameSpriteSwitcher))]
    public class Gs2IdleCategoryModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleCategoryModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2IdleCategoryModelNameSpriteSwitcher.Expression.In || original.expression == Gs2IdleCategoryModelNameSpriteSwitcher.Expression.NotIn) {
