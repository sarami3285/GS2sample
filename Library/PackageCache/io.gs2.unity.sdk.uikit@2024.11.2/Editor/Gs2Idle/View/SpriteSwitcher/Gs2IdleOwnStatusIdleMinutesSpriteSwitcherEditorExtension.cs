...
{
    [CustomEditor(typeof(Gs2IdleOwnStatusIdleMinutesSpriteSwitcher))]
    public class Gs2IdleOwnStatusIdleMinutesSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleOwnStatusIdleMinutesSpriteSwitcher;
            ...
            if (original.expression == Gs2IdleOwnStatusIdleMinutesSpriteSwitcher.Expression.In || original.expression == Gs2IdleOwnStatusIdleMinutesSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyIdleMinuteses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyIdleMinutes"), true);
            }
