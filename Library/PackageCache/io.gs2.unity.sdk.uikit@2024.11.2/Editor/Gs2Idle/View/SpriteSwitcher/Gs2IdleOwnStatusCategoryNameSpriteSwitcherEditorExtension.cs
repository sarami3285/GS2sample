...
namespace Gs2.Unity.UiKit.Gs2Idle.SpriteSwitcher.Editor
{
    [CustomEditor(typeof(Gs2IdleOwnStatusCategoryNameSpriteSwitcher))]
    public class Gs2IdleOwnStatusCategoryNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleOwnStatusCategoryNameSpriteSwitcher;
            ...
            if (original.expression == Gs2IdleOwnStatusCategoryNameSpriteSwitcher.Expression.In || original.expression == Gs2IdleOwnStatusCategoryNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCategoryNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCategoryName"), true);
            }
