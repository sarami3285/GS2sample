...
{
    [CustomEditor(typeof(Gs2IdleCategoryModelRewardIntervalMinutesSpriteSwitcher))]
    public class Gs2IdleCategoryModelRewardIntervalMinutesSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleCategoryModelRewardIntervalMinutesSpriteSwitcher;
            ...
            if (original.expression == Gs2IdleCategoryModelRewardIntervalMinutesSpriteSwitcher.Expression.In || original.expression == Gs2IdleCategoryModelRewardIntervalMinutesSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRewardIntervalMinuteses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyRewardIntervalMinutes"), true);
            }
