...
{
    [CustomEditor(typeof(Gs2IdleCategoryModelDefaultMaximumIdleMinutesSpriteSwitcher))]
    public class Gs2IdleCategoryModelDefaultMaximumIdleMinutesSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleCategoryModelDefaultMaximumIdleMinutesSpriteSwitcher;
            ...
            if (original.expression == Gs2IdleCategoryModelDefaultMaximumIdleMinutesSpriteSwitcher.Expression.In || original.expression == Gs2IdleCategoryModelDefaultMaximumIdleMinutesSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyDefaultMaximumIdleMinuteses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyDefaultMaximumIdleMinutes"), true);
            }
