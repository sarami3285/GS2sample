...
{
    [CustomEditor(typeof(Gs2IdleOwnStatusRandomSeedSpriteSwitcher))]
    public class Gs2IdleOwnStatusRandomSeedSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleOwnStatusRandomSeedSpriteSwitcher;
            ...
            if (original.expression == Gs2IdleOwnStatusRandomSeedSpriteSwitcher.Expression.In || original.expression == Gs2IdleOwnStatusRandomSeedSpriteSwitcher.Expression.NotIn) {
