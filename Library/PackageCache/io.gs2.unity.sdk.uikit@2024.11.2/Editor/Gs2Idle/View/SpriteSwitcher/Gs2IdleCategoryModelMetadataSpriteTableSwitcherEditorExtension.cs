...
{
    [CustomEditor(typeof(Gs2IdleCategoryModelMetadataSpriteTableSwitcher))]
    public class Gs2IdleCategoryModelMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleCategoryModelMetadataSpriteTableSwitcher;
