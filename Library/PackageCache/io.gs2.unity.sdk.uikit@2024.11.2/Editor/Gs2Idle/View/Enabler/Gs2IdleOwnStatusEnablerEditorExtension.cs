...
{
    [CustomEditor(typeof(Gs2IdleOwnStatusEnabler))]
    public class Gs2IdleOwnStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleOwnStatusEnabler;
