...
{
    [CustomEditor(typeof(Gs2IdleOwnStatusCategoryNameEnabler))]
    public class Gs2IdleOwnStatusCategoryNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleOwnStatusCategoryNameEnabler;
            ...
            if (original.expression == Gs2IdleOwnStatusCategoryNameEnabler.Expression.In || original.expression == Gs2IdleOwnStatusCategoryNameEnabler.Expression.NotIn) {
