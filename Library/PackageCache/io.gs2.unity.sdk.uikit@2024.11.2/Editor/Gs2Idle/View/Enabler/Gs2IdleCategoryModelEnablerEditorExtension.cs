...
{
    [CustomEditor(typeof(Gs2IdleCategoryModelEnabler))]
    public class Gs2IdleCategoryModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleCategoryModelEnabler;
