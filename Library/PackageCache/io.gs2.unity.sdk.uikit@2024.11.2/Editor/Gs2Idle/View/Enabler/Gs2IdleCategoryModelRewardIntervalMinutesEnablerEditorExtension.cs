...
{
    [CustomEditor(typeof(Gs2IdleCategoryModelRewardIntervalMinutesEnabler))]
    public class Gs2IdleCategoryModelRewardIntervalMinutesEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleCategoryModelRewardIntervalMinutesEnabler;
            ...
            if (original.expression == Gs2IdleCategoryModelRewardIntervalMinutesEnabler.Expression.In || original.expression == Gs2IdleCategoryModelRewardIntervalMinutesEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRewardIntervalMinuteses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableRewardIntervalMinutes"), true);
            }
