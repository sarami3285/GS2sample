...
{
    [CustomEditor(typeof(Gs2IdleOwnStatusMaximumIdleMinutesEnabler))]
    public class Gs2IdleOwnStatusMaximumIdleMinutesEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleOwnStatusMaximumIdleMinutesEnabler;
            ...
            if (original.expression == Gs2IdleOwnStatusMaximumIdleMinutesEnabler.Expression.In || original.expression == Gs2IdleOwnStatusMaximumIdleMinutesEnabler.Expression.NotIn) {
