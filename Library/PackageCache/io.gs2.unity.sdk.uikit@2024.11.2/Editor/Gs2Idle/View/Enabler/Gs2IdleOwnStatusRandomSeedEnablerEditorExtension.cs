...
{
    [CustomEditor(typeof(Gs2IdleOwnStatusRandomSeedEnabler))]
    public class Gs2IdleOwnStatusRandomSeedEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleOwnStatusRandomSeedEnabler;
            ...
            if (original.expression == Gs2IdleOwnStatusRandomSeedEnabler.Expression.In || original.expression == Gs2IdleOwnStatusRandomSeedEnabler.Expression.NotIn) {
