...
{
    [CustomEditor(typeof(Gs2IdleIncreaseMaximumIdleMinutesByUserIdEnabler))]
    public class Gs2IdleIncreaseMaximumIdleMinutesByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleIncreaseMaximumIdleMinutesByUserIdEnabler;
