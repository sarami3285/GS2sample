...
{
    [CustomEditor(typeof(Gs2IdleReceiveByUserIdEnabler))]
    public class Gs2IdleReceiveByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleReceiveByUserIdEnabler;
