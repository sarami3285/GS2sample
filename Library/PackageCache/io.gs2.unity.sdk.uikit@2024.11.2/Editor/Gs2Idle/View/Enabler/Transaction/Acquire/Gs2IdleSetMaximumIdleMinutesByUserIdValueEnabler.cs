...
{
    [CustomEditor(typeof(Gs2IdleSetMaximumIdleMinutesByUserIdValueEnabler))]
    public class Gs2IdleSetMaximumIdleMinutesByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleSetMaximumIdleMinutesByUserIdValueEnabler;
            ...
            if (original.expression == Gs2IdleSetMaximumIdleMinutesByUserIdValueEnabler.Expression.In || original.expression == Gs2IdleSetMaximumIdleMinutesByUserIdValueEnabler.Expression.NotIn) {
