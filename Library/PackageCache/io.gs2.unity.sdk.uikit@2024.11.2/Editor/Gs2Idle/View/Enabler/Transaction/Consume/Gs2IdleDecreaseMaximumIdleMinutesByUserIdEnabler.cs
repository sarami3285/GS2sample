...
{
    [CustomEditor(typeof(Gs2IdleDecreaseMaximumIdleMinutesByUserIdEnabler))]
    public class Gs2IdleDecreaseMaximumIdleMinutesByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleDecreaseMaximumIdleMinutesByUserIdEnabler;
