...
{
    [CustomEditor(typeof(Gs2IdleOwnStatusIdleMinutesEnabler))]
    public class Gs2IdleOwnStatusIdleMinutesEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleOwnStatusIdleMinutesEnabler;
            ...
            if (original.expression == Gs2IdleOwnStatusIdleMinutesEnabler.Expression.In || original.expression == Gs2IdleOwnStatusIdleMinutesEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableIdleMinuteses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableIdleMinutes"), true);
            }
