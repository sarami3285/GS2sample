...
{
    [CustomEditor(typeof(Gs2IdleCategoryModelNameEnabler))]
    public class Gs2IdleCategoryModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleCategoryModelNameEnabler;
            ...
            if (original.expression == Gs2IdleCategoryModelNameEnabler.Expression.In || original.expression == Gs2IdleCategoryModelNameEnabler.Expression.NotIn) {
