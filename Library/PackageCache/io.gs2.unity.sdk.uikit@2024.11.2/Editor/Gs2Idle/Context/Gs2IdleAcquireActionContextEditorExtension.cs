...
{
    [CustomEditor(typeof(Gs2IdleAcquireActionContext))]
    public class Gs2IdleAcquireActionContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleAcquireActionContext;
