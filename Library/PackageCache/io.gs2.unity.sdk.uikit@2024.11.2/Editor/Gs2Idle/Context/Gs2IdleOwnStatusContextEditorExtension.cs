...
{
    [CustomEditor(typeof(Gs2IdleOwnStatusContext))]
    public class Gs2IdleOwnStatusContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleOwnStatusContext;
            ...
            if (original.Status == null) {
                ...
                if (original.Status != null) {
                    ...
                    EditorGUILayout.TextField("CategoryName", original.Status?.CategoryName?.ToString());
                    EditorGUI.indentLevel--;
                }
                EditorGUI.EndDisabledGroup();
            }
