...
{
    [CustomEditor(typeof(Gs2LotteryOwnBoxItemsPrizeTableNameEnabler))]
    public class Gs2LotteryOwnBoxItemsPrizeTableNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryOwnBoxItemsPrizeTableNameEnabler;
            ...
            if (original.expression == Gs2LotteryOwnBoxItemsPrizeTableNameEnabler.Expression.In || original.expression == Gs2LotteryOwnBoxItemsPrizeTableNameEnabler.Expression.NotIn) {
