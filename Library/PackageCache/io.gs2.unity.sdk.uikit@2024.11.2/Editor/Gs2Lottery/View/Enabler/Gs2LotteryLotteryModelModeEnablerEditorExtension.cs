...
{
    [CustomEditor(typeof(Gs2LotteryLotteryModelModeEnabler))]
    public class Gs2LotteryLotteryModelModeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryLotteryModelModeEnabler;
            ...
            if (original.expression == Gs2LotteryLotteryModelModeEnabler.Expression.In || original.expression == Gs2LotteryLotteryModelModeEnabler.Expression.NotIn) {
