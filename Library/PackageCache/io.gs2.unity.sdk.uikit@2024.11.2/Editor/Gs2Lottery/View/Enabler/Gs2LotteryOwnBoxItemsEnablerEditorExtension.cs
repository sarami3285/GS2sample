...
{
    [CustomEditor(typeof(Gs2LotteryOwnBoxItemsEnabler))]
    public class Gs2LotteryOwnBoxItemsEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryOwnBoxItemsEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("BoxItemsFetcher not assigned.", MessageType.Error);
