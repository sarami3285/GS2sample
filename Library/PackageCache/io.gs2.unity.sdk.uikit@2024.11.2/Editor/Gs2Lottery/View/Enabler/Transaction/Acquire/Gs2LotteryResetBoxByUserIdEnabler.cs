...
{
    [CustomEditor(typeof(Gs2LotteryResetBoxByUserIdEnabler))]
    public class Gs2LotteryResetBoxByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryResetBoxByUserIdEnabler;
