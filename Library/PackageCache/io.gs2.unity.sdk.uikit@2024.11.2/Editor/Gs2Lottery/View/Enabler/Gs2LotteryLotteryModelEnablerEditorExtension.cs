...
{
    [CustomEditor(typeof(Gs2LotteryLotteryModelEnabler))]
    public class Gs2LotteryLotteryModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryLotteryModelEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("LotteryModelFetcher not assigned.", MessageType.Error);
