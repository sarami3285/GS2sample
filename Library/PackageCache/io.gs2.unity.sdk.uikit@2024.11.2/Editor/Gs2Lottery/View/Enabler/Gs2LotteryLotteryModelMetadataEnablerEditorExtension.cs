...
{
    [CustomEditor(typeof(Gs2LotteryLotteryModelMetadataEnabler))]
    public class Gs2LotteryLotteryModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryLotteryModelMetadataEnabler;
            ...
            if (original.expression == Gs2LotteryLotteryModelMetadataEnabler.Expression.In || original.expression == Gs2LotteryLotteryModelMetadataEnabler.Expression.NotIn) {
