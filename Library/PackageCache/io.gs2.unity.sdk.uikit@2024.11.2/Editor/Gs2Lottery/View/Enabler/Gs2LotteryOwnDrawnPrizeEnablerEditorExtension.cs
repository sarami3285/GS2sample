...
{
    [CustomEditor(typeof(Gs2LotteryOwnDrawnPrizeEnabler))]
    public class Gs2LotteryOwnDrawnPrizeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryOwnDrawnPrizeEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("DrawnPrizeFetcher not assigned.", MessageType.Error);
