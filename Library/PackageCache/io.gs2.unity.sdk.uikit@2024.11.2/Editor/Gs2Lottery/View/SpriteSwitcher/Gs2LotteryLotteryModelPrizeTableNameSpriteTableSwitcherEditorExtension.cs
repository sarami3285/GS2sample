...
{
    [CustomEditor(typeof(Gs2LotteryLotteryModelPrizeTableNameSpriteTableSwitcher))]
    public class Gs2LotteryLotteryModelPrizeTableNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryLotteryModelPrizeTableNameSpriteTableSwitcher;
