...
{
    [CustomEditor(typeof(Gs2LotteryLotteryModelNameSpriteSwitcher))]
    public class Gs2LotteryLotteryModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryLotteryModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2LotteryLotteryModelNameSpriteSwitcher.Expression.In || original.expression == Gs2LotteryLotteryModelNameSpriteSwitcher.Expression.NotIn) {
