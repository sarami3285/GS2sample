...
{
    [CustomEditor(typeof(Gs2LotteryLotteryModelModeSpriteTableSwitcher))]
    public class Gs2LotteryLotteryModelModeSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryLotteryModelModeSpriteTableSwitcher;
