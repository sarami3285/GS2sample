...
{
    [CustomEditor(typeof(Gs2LotteryLotteryModelPrizeTableNameSpriteSwitcher))]
    public class Gs2LotteryLotteryModelPrizeTableNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryLotteryModelPrizeTableNameSpriteSwitcher;
            ...
            if (original.expression == Gs2LotteryLotteryModelPrizeTableNameSpriteSwitcher.Expression.In || original.expression == Gs2LotteryLotteryModelPrizeTableNameSpriteSwitcher.Expression.NotIn) {
