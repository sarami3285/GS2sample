...
{
    [CustomEditor(typeof(Gs2LotteryLotteryModelMetadataSpriteSwitcher))]
    public class Gs2LotteryLotteryModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryLotteryModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2LotteryLotteryModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2LotteryLotteryModelMetadataSpriteSwitcher.Expression.NotIn) {
