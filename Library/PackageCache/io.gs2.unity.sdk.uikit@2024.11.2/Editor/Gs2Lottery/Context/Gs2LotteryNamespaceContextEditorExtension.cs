...
{
    [CustomEditor(typeof(Gs2LotteryNamespaceContext))]
    public class Gs2LotteryNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryNamespaceContext;
