...
{
    [CustomEditor(typeof(Gs2LotteryLotteryModelListFetcher))]
    public class Gs2LotteryLotteryModelListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryLotteryModelListFetcher;
