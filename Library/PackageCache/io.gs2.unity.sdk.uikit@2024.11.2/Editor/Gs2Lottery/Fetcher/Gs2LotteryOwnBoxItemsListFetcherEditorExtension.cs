...
{
    [CustomEditor(typeof(Gs2LotteryOwnBoxItemsListFetcher))]
    public class Gs2LotteryOwnBoxItemsListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryOwnBoxItemsListFetcher;
