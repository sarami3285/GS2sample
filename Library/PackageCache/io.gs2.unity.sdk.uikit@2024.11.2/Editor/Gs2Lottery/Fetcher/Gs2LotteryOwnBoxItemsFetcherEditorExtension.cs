...
{
    [CustomEditor(typeof(Gs2LotteryOwnBoxItemsFetcher))]
    public class Gs2LotteryOwnBoxItemsFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryOwnBoxItemsFetcher;
