...
namespace Gs2.Unity.UiKit.Gs2Lottery.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2LotteryResetBoxByUserIdFetcher))]
    public class Gs2LotteryResetBoxByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryResetBoxByUserIdFetcher;
