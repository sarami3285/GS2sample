...
{
    [CustomEditor(typeof(Gs2LotteryLotteryModelFetcher))]
    public class Gs2LotteryLotteryModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryLotteryModelFetcher;
