...
{
    [CustomEditor(typeof(Gs2MoneyDepositByUserIdFetcher))]
    public class Gs2MoneyDepositByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyDepositByUserIdFetcher;
