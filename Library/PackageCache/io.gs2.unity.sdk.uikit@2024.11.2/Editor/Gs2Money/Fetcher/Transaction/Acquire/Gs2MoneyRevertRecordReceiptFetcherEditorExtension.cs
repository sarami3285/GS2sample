...
{
    [CustomEditor(typeof(Gs2MoneyRevertRecordReceiptFetcher))]
    public class Gs2MoneyRevertRecordReceiptFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyRevertRecordReceiptFetcher;
