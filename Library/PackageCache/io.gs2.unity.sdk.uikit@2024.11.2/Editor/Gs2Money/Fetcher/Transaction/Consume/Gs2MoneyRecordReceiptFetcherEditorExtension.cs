...
{
    [CustomEditor(typeof(Gs2MoneyRecordReceiptFetcher))]
    public class Gs2MoneyRecordReceiptFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyRecordReceiptFetcher;
