...
{
    [CustomEditor(typeof(Gs2MoneyOwnWalletFetcher))]
    public class Gs2MoneyOwnWalletFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyOwnWalletFetcher;
