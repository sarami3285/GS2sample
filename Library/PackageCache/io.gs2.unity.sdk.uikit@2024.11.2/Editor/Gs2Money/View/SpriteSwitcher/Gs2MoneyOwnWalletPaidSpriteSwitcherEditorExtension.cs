...
{
    [CustomEditor(typeof(Gs2MoneyOwnWalletPaidSpriteSwitcher))]
    public class Gs2MoneyOwnWalletPaidSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyOwnWalletPaidSpriteSwitcher;
            ...
            if (original.expression == Gs2MoneyOwnWalletPaidSpriteSwitcher.Expression.In || original.expression == Gs2MoneyOwnWalletPaidSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyPaids"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyPaid"), true);
            }
