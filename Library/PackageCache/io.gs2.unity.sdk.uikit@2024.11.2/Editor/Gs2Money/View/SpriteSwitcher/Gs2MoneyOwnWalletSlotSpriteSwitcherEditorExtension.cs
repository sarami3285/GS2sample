...
{
    [CustomEditor(typeof(Gs2MoneyOwnWalletSlotSpriteSwitcher))]
    public class Gs2MoneyOwnWalletSlotSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyOwnWalletSlotSpriteSwitcher;
            ...
            if (original.expression == Gs2MoneyOwnWalletSlotSpriteSwitcher.Expression.In || original.expression == Gs2MoneyOwnWalletSlotSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applySlots"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applySlot"), true);
            }
