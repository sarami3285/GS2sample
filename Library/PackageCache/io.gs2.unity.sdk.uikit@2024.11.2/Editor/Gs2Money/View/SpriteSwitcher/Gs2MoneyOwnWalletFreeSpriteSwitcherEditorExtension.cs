...
{
    [CustomEditor(typeof(Gs2MoneyOwnWalletFreeSpriteSwitcher))]
    public class Gs2MoneyOwnWalletFreeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyOwnWalletFreeSpriteSwitcher;
            ...
            if (original.expression == Gs2MoneyOwnWalletFreeSpriteSwitcher.Expression.In || original.expression == Gs2MoneyOwnWalletFreeSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyFrees"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyFree"), true);
            }
