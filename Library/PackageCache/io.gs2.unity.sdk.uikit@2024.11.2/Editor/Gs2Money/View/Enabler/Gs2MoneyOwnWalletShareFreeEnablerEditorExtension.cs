...
{
    [CustomEditor(typeof(Gs2MoneyOwnWalletShareFreeEnabler))]
    public class Gs2MoneyOwnWalletShareFreeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyOwnWalletShareFreeEnabler;
