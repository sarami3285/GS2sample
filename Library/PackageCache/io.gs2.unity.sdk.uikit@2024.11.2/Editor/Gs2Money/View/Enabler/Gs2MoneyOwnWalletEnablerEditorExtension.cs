...
{
    [CustomEditor(typeof(Gs2MoneyOwnWalletEnabler))]
    public class Gs2MoneyOwnWalletEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyOwnWalletEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("WalletFetcher not assigned.", MessageType.Error);
