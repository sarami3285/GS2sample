...
{
    [CustomEditor(typeof(Gs2MoneyRecordReceiptEnabler))]
    public class Gs2MoneyRecordReceiptEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyRecordReceiptEnabler;
