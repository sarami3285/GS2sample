...
{
    [CustomEditor(typeof(Gs2MoneyDepositByUserIdValueEnabler))]
    public class Gs2MoneyDepositByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyDepositByUserIdValueEnabler;
            ...
            if (original.expression == Gs2MoneyDepositByUserIdValueEnabler.Expression.In || original.expression == Gs2MoneyDepositByUserIdValueEnabler.Expression.NotIn) {
