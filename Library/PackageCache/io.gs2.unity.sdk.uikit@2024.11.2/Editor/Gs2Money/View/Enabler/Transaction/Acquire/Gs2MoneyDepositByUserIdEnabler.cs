...
{
    [CustomEditor(typeof(Gs2MoneyDepositByUserIdEnabler))]
    public class Gs2MoneyDepositByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyDepositByUserIdEnabler;
