...
{
    [CustomEditor(typeof(Gs2MoneyWithdrawByUserIdEnabler))]
    public class Gs2MoneyWithdrawByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyWithdrawByUserIdEnabler;
