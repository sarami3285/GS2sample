...
{
    [CustomEditor(typeof(Gs2MoneyRevertRecordReceiptEnabler))]
    public class Gs2MoneyRevertRecordReceiptEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyRevertRecordReceiptEnabler;
