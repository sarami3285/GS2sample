...
{
    [CustomEditor(typeof(Gs2MoneyOwnWalletPaidEnabler))]
    public class Gs2MoneyOwnWalletPaidEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyOwnWalletPaidEnabler;
            ...
            if (original.expression == Gs2MoneyOwnWalletPaidEnabler.Expression.In || original.expression == Gs2MoneyOwnWalletPaidEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enablePaids"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enablePaid"), true);
            }
