...
{
    [CustomEditor(typeof(Gs2MoneyOwnWalletFreeEnabler))]
    public class Gs2MoneyOwnWalletFreeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyOwnWalletFreeEnabler;
            ...
            if (original.expression == Gs2MoneyOwnWalletFreeEnabler.Expression.In || original.expression == Gs2MoneyOwnWalletFreeEnabler.Expression.NotIn) {
