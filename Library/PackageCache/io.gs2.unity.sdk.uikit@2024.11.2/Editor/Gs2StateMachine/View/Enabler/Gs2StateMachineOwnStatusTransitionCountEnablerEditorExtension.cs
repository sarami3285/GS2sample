...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusTransitionCountEnabler))]
    public class Gs2StateMachineOwnStatusTransitionCountEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusTransitionCountEnabler;
            ...
            if (original.expression == Gs2StateMachineOwnStatusTransitionCountEnabler.Expression.In || original.expression == Gs2StateMachineOwnStatusTransitionCountEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTransitionCounts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTransitionCount"), true);
            }
