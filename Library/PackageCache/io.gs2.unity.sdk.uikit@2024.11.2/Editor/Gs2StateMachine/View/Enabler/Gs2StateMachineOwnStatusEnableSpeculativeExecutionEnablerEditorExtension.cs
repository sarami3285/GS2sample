...
namespace Gs2.Unity.UiKit.Gs2StateMachine.Enabler.Editor
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusEnableSpeculativeExecutionEnabler))]
    public class Gs2StateMachineOwnStatusEnableSpeculativeExecutionEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusEnableSpeculativeExecutionEnabler;
            ...
            if (original.expression == Gs2StateMachineOwnStatusEnableSpeculativeExecutionEnabler.Expression.In || original.expression == Gs2StateMachineOwnStatusEnableSpeculativeExecutionEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableEnableSpeculativeExecutions"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableEnableSpeculativeExecution"), true);
            }
