...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusStateMachineDefinitionEnabler))]
    public class Gs2StateMachineOwnStatusStateMachineDefinitionEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusStateMachineDefinitionEnabler;
            ...
            if (original.expression == Gs2StateMachineOwnStatusStateMachineDefinitionEnabler.Expression.In || original.expression == Gs2StateMachineOwnStatusStateMachineDefinitionEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableStateMachineDefinitions"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableStateMachineDefinition"), true);
            }
