...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusEnabler))]
    public class Gs2StateMachineOwnStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusEnabler;
