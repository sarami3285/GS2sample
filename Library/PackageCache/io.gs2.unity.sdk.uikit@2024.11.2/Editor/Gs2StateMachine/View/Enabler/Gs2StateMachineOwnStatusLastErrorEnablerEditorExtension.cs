...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusLastErrorEnabler))]
    public class Gs2StateMachineOwnStatusLastErrorEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusLastErrorEnabler;
            ...
            if (original.expression == Gs2StateMachineOwnStatusLastErrorEnabler.Expression.In || original.expression == Gs2StateMachineOwnStatusLastErrorEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableLastErrors"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableLastError"), true);
            }
