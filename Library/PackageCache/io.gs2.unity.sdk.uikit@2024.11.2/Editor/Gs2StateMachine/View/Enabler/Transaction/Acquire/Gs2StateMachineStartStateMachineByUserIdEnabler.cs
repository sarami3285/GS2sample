...
{
    [CustomEditor(typeof(Gs2StateMachineStartStateMachineByUserIdEnabler))]
    public class Gs2StateMachineStartStateMachineByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStartStateMachineByUserIdEnabler;
