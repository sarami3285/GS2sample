...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusStatusEnabler))]
    public class Gs2StateMachineOwnStatusStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusStatusEnabler;
            ...
            if (original.expression == Gs2StateMachineOwnStatusStatusEnabler.Expression.In || original.expression == Gs2StateMachineOwnStatusStatusEnabler.Expression.NotIn) {
