...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusNameEnabler))]
    public class Gs2StateMachineOwnStatusNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusNameEnabler;
            ...
            if (original.expression == Gs2StateMachineOwnStatusNameEnabler.Expression.In || original.expression == Gs2StateMachineOwnStatusNameEnabler.Expression.NotIn) {
