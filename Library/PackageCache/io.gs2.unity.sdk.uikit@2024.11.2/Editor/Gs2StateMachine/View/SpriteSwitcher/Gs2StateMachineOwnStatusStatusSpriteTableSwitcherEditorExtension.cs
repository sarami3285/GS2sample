...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusStatusSpriteTableSwitcher))]
    public class Gs2StateMachineOwnStatusStatusSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusStatusSpriteTableSwitcher;
