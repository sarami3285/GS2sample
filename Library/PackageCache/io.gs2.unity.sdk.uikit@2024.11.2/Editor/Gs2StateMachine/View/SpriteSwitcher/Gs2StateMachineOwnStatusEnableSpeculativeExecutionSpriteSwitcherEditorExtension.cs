...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusEnableSpeculativeExecutionSpriteSwitcher))]
    public class Gs2StateMachineOwnStatusEnableSpeculativeExecutionSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusEnableSpeculativeExecutionSpriteSwitcher;
            ...
            if (original.expression == Gs2StateMachineOwnStatusEnableSpeculativeExecutionSpriteSwitcher.Expression.In || original.expression == Gs2StateMachineOwnStatusEnableSpeculativeExecutionSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyEnableSpeculativeExecutions"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyEnableSpeculativeExecution"), true);
            }
