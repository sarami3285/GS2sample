...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusNameSpriteSwitcher))]
    public class Gs2StateMachineOwnStatusNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusNameSpriteSwitcher;
            ...
            if (original.expression == Gs2StateMachineOwnStatusNameSpriteSwitcher.Expression.In || original.expression == Gs2StateMachineOwnStatusNameSpriteSwitcher.Expression.NotIn) {
