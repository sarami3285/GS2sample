...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusLastErrorSpriteSwitcher))]
    public class Gs2StateMachineOwnStatusLastErrorSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusLastErrorSpriteSwitcher;
            ...
            if (original.expression == Gs2StateMachineOwnStatusLastErrorSpriteSwitcher.Expression.In || original.expression == Gs2StateMachineOwnStatusLastErrorSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyLastErrors"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyLastError"), true);
            }
