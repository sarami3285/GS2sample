...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusLastErrorSpriteTableSwitcher))]
    public class Gs2StateMachineOwnStatusLastErrorSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusLastErrorSpriteTableSwitcher;
