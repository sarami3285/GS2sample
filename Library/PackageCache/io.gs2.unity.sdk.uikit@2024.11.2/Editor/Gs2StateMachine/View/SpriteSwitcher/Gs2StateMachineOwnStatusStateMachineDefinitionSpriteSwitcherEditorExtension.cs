...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusStateMachineDefinitionSpriteSwitcher))]
    public class Gs2StateMachineOwnStatusStateMachineDefinitionSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusStateMachineDefinitionSpriteSwitcher;
            ...
            if (original.expression == Gs2StateMachineOwnStatusStateMachineDefinitionSpriteSwitcher.Expression.In || original.expression == Gs2StateMachineOwnStatusStateMachineDefinitionSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyStateMachineDefinitions"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyStateMachineDefinition"), true);
            }
