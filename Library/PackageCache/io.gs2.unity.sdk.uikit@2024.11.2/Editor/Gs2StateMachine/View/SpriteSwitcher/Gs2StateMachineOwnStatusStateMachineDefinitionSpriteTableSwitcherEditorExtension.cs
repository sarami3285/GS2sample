...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusStateMachineDefinitionSpriteTableSwitcher))]
    public class Gs2StateMachineOwnStatusStateMachineDefinitionSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusStateMachineDefinitionSpriteTableSwitcher;
