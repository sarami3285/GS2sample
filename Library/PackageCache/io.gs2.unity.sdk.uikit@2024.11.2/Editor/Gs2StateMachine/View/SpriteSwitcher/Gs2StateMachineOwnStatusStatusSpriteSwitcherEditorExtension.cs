...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusStatusSpriteSwitcher))]
    public class Gs2StateMachineOwnStatusStatusSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusStatusSpriteSwitcher;
            ...
            if (original.expression == Gs2StateMachineOwnStatusStatusSpriteSwitcher.Expression.In || original.expression == Gs2StateMachineOwnStatusStatusSpriteSwitcher.Expression.NotIn) {
