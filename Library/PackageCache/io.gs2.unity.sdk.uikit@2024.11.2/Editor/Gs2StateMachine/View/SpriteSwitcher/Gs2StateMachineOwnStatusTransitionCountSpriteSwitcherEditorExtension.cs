...
{
    [CustomEditor(typeof(Gs2StateMachineOwnStatusTransitionCountSpriteSwitcher))]
    public class Gs2StateMachineOwnStatusTransitionCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineOwnStatusTransitionCountSpriteSwitcher;
            ...
            if (original.expression == Gs2StateMachineOwnStatusTransitionCountSpriteSwitcher.Expression.In || original.expression == Gs2StateMachineOwnStatusTransitionCountSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTransitionCounts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTransitionCount"), true);
            }
