...
namespace Gs2.Unity.UiKit.Gs2StateMachine.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2StateMachineStartStateMachineByUserIdFetcher))]
    public class Gs2StateMachineStartStateMachineByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStartStateMachineByUserIdFetcher;
