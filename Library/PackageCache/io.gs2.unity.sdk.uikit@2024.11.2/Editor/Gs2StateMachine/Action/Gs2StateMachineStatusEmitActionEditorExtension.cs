...
{
    [CustomEditor(typeof(Gs2StateMachineStatusEmitAction))]
    public class Gs2StateMachineStatusEmitActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStatusEmitAction;
