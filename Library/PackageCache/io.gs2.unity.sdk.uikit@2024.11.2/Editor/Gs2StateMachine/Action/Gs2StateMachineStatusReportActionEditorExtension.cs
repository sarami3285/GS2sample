...
{
    [CustomEditor(typeof(Gs2StateMachineStatusReportAction))]
    public class Gs2StateMachineStatusReportActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStatusReportAction;
            ...
            if (context == null) {
                ...
                if (context.transform.GetComponentInParent<Gs2StateMachineOwnStatusList>(true) != null) {
                    EditorGUI.BeginDisabledGroup(true);
                    EditorGUILayout.ObjectField("Context", context.gameObject, typeof(Gs2StateMachineOwnStatusContext), false);
                    EditorGUI.EndDisabledGroup();
                    EditorGUILayout.HelpBox("Status is auto assign from Gs2StateMachineStatusList.", MessageType.Info);
                }
                else {
                    EditorGUI.BeginDisabledGroup(true);
                    EditorGUILayout.ObjectField("Context", context.gameObject, typeof(Gs2StateMachineOwnStatusContext), false);
