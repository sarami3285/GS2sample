...
{
    [CustomEditor(typeof(Gs2StateMachineStatusExitAction))]
    public class Gs2StateMachineStatusExitActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStatusExitAction;
