...
{
    [CustomEditor(typeof(Gs2StateMachineUserContext))]
    public class Gs2StateMachineUserContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineUserContext;
