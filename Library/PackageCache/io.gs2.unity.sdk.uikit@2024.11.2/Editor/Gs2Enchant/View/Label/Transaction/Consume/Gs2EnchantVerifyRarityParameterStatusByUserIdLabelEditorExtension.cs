...
{
    [CustomEditor(typeof(Gs2EnchantVerifyRarityParameterStatusByUserIdLabel))]
    public class Gs2EnchantVerifyRarityParameterStatusByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantVerifyRarityParameterStatusByUserIdLabel;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2EnchantVerifyRarityParameterStatusByUserIdFetcher>() ?? original.GetComponentInParent<Gs2EnchantVerifyRarityParameterStatusByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2EnchantVerifyRarityParameterStatusByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2EnchantVerifyRarityParameterStatusByUserIdFetcher>();
                }
            }
