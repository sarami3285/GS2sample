...
{
    [CustomEditor(typeof(Gs2EnchantReDrawBalanceParameterStatusByUserIdEnabler))]
    public class Gs2EnchantReDrawBalanceParameterStatusByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantReDrawBalanceParameterStatusByUserIdEnabler;
