...
{
    [CustomEditor(typeof(Gs2EnchantSetBalanceParameterStatusByUserIdEnabler))]
    public class Gs2EnchantSetBalanceParameterStatusByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantSetBalanceParameterStatusByUserIdEnabler;
