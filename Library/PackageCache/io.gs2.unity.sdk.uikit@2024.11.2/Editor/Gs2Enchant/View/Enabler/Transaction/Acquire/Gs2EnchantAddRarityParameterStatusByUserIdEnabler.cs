...
{
    [CustomEditor(typeof(Gs2EnchantAddRarityParameterStatusByUserIdEnabler))]
    public class Gs2EnchantAddRarityParameterStatusByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantAddRarityParameterStatusByUserIdEnabler;
