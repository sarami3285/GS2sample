...
{
    [CustomEditor(typeof(Gs2EnchantAddRarityParameterStatusByUserIdValueEnabler))]
    public class Gs2EnchantAddRarityParameterStatusByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantAddRarityParameterStatusByUserIdValueEnabler;
            ...
            if (original.expression == Gs2EnchantAddRarityParameterStatusByUserIdValueEnabler.Expression.In || original.expression == Gs2EnchantAddRarityParameterStatusByUserIdValueEnabler.Expression.NotIn) {
