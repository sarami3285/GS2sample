...
{
    [CustomEditor(typeof(Gs2EnchantVerifyRarityParameterStatusByUserIdEnabler))]
    public class Gs2EnchantVerifyRarityParameterStatusByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantVerifyRarityParameterStatusByUserIdEnabler;
