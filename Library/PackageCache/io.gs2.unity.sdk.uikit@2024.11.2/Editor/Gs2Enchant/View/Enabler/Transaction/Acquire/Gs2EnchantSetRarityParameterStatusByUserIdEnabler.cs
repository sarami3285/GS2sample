...
{
    [CustomEditor(typeof(Gs2EnchantSetRarityParameterStatusByUserIdEnabler))]
    public class Gs2EnchantSetRarityParameterStatusByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantSetRarityParameterStatusByUserIdEnabler;
