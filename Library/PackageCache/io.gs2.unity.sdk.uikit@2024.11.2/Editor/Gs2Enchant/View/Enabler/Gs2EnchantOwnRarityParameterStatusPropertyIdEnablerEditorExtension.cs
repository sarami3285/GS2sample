...
{
    [CustomEditor(typeof(Gs2EnchantOwnRarityParameterStatusPropertyIdEnabler))]
    public class Gs2EnchantOwnRarityParameterStatusPropertyIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantOwnRarityParameterStatusPropertyIdEnabler;
            ...
            if (original.expression == Gs2EnchantOwnRarityParameterStatusPropertyIdEnabler.Expression.In || original.expression == Gs2EnchantOwnRarityParameterStatusPropertyIdEnabler.Expression.NotIn) {
