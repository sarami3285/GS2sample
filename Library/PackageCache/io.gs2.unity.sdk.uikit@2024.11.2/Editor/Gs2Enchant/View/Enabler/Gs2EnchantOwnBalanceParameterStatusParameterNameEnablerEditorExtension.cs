...
{
    [CustomEditor(typeof(Gs2EnchantOwnBalanceParameterStatusParameterNameEnabler))]
    public class Gs2EnchantOwnBalanceParameterStatusParameterNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantOwnBalanceParameterStatusParameterNameEnabler;
            ...
            if (original.expression == Gs2EnchantOwnBalanceParameterStatusParameterNameEnabler.Expression.In || original.expression == Gs2EnchantOwnBalanceParameterStatusParameterNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableParameterNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableParameterName"), true);
            }
