...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterModelInitialValueStrategyEnabler))]
    public class Gs2EnchantBalanceParameterModelInitialValueStrategyEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterModelInitialValueStrategyEnabler;
            ...
            if (original.expression == Gs2EnchantBalanceParameterModelInitialValueStrategyEnabler.Expression.In || original.expression == Gs2EnchantBalanceParameterModelInitialValueStrategyEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableInitialValueStrategies"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableInitialValueStrategy"), true);
            }
