...
{
    [CustomEditor(typeof(Gs2EnchantOwnBalanceParameterStatusPropertyIdEnabler))]
    public class Gs2EnchantOwnBalanceParameterStatusPropertyIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantOwnBalanceParameterStatusPropertyIdEnabler;
            ...
            if (original.expression == Gs2EnchantOwnBalanceParameterStatusPropertyIdEnabler.Expression.In || original.expression == Gs2EnchantOwnBalanceParameterStatusPropertyIdEnabler.Expression.NotIn) {
