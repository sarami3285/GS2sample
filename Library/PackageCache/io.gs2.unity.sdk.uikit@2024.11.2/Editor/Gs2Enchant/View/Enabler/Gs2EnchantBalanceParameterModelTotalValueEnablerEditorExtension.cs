...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterModelTotalValueEnabler))]
    public class Gs2EnchantBalanceParameterModelTotalValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterModelTotalValueEnabler;
            ...
            if (original.expression == Gs2EnchantBalanceParameterModelTotalValueEnabler.Expression.In || original.expression == Gs2EnchantBalanceParameterModelTotalValueEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTotalValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTotalValue"), true);
            }
