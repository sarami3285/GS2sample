...
{
    [CustomEditor(typeof(Gs2EnchantOwnRarityParameterStatusEnabler))]
    public class Gs2EnchantOwnRarityParameterStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantOwnRarityParameterStatusEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("RarityParameterStatusFetcher not assigned.", MessageType.Error);
