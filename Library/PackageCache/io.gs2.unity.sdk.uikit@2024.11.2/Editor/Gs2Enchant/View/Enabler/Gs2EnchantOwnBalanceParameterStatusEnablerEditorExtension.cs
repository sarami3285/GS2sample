...
{
    [CustomEditor(typeof(Gs2EnchantOwnBalanceParameterStatusEnabler))]
    public class Gs2EnchantOwnBalanceParameterStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantOwnBalanceParameterStatusEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("BalanceParameterStatusFetcher not assigned.", MessageType.Error);
