...
{
    [CustomEditor(typeof(Gs2EnchantOwnRarityParameterStatusParameterNameEnabler))]
    public class Gs2EnchantOwnRarityParameterStatusParameterNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantOwnRarityParameterStatusParameterNameEnabler;
            ...
            if (original.expression == Gs2EnchantOwnRarityParameterStatusParameterNameEnabler.Expression.In || original.expression == Gs2EnchantOwnRarityParameterStatusParameterNameEnabler.Expression.NotIn) {
