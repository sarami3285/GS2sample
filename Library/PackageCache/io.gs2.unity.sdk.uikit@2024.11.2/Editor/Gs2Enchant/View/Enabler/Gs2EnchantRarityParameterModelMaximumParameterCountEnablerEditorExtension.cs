...
{
    [CustomEditor(typeof(Gs2EnchantRarityParameterModelMaximumParameterCountEnabler))]
    public class Gs2EnchantRarityParameterModelMaximumParameterCountEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantRarityParameterModelMaximumParameterCountEnabler;
            ...
            if (original.expression == Gs2EnchantRarityParameterModelMaximumParameterCountEnabler.Expression.In || original.expression == Gs2EnchantRarityParameterModelMaximumParameterCountEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableMaximumParameterCounts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableMaximumParameterCount"), true);
            }
