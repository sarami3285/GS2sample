...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterModelNameEnabler))]
    public class Gs2EnchantBalanceParameterModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterModelNameEnabler;
            ...
            if (original.expression == Gs2EnchantBalanceParameterModelNameEnabler.Expression.In || original.expression == Gs2EnchantBalanceParameterModelNameEnabler.Expression.NotIn) {
