...
{
    [CustomEditor(typeof(Gs2EnchantRarityParameterModelNameEnabler))]
    public class Gs2EnchantRarityParameterModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantRarityParameterModelNameEnabler;
            ...
            if (original.expression == Gs2EnchantRarityParameterModelNameEnabler.Expression.In || original.expression == Gs2EnchantRarityParameterModelNameEnabler.Expression.NotIn) {
