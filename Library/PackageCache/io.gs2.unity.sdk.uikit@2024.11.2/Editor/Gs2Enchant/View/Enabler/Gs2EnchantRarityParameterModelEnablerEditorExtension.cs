...
{
    [CustomEditor(typeof(Gs2EnchantRarityParameterModelEnabler))]
    public class Gs2EnchantRarityParameterModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantRarityParameterModelEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("RarityParameterModelFetcher not assigned.", MessageType.Error);
