...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterStatusLocalizationVariables))]
    public class Gs2EnchantBalanceParameterStatusLocalizationVariablesEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterStatusLocalizationVariables;
