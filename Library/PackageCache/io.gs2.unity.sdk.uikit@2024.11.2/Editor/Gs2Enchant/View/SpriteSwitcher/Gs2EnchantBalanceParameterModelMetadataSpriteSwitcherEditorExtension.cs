...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterModelMetadataSpriteSwitcher))]
    public class Gs2EnchantBalanceParameterModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2EnchantBalanceParameterModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2EnchantBalanceParameterModelMetadataSpriteSwitcher.Expression.NotIn) {
