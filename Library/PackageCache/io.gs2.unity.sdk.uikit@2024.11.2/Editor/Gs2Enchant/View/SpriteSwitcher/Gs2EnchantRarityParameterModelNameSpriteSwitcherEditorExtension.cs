...
{
    [CustomEditor(typeof(Gs2EnchantRarityParameterModelNameSpriteSwitcher))]
    public class Gs2EnchantRarityParameterModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantRarityParameterModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2EnchantRarityParameterModelNameSpriteSwitcher.Expression.In || original.expression == Gs2EnchantRarityParameterModelNameSpriteSwitcher.Expression.NotIn) {
