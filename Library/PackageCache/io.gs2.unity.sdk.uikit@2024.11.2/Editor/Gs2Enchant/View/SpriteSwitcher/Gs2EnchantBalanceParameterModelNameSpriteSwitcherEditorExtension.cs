...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterModelNameSpriteSwitcher))]
    public class Gs2EnchantBalanceParameterModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2EnchantBalanceParameterModelNameSpriteSwitcher.Expression.In || original.expression == Gs2EnchantBalanceParameterModelNameSpriteSwitcher.Expression.NotIn) {
