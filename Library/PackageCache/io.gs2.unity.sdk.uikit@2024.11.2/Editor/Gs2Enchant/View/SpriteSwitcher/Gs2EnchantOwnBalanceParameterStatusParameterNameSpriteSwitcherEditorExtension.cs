...
{
    [CustomEditor(typeof(Gs2EnchantOwnBalanceParameterStatusParameterNameSpriteSwitcher))]
    public class Gs2EnchantOwnBalanceParameterStatusParameterNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantOwnBalanceParameterStatusParameterNameSpriteSwitcher;
            ...
            if (original.expression == Gs2EnchantOwnBalanceParameterStatusParameterNameSpriteSwitcher.Expression.In || original.expression == Gs2EnchantOwnBalanceParameterStatusParameterNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyParameterNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyParameterName"), true);
            }
