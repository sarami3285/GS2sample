...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterModelInitialValueStrategySpriteSwitcher))]
    public class Gs2EnchantBalanceParameterModelInitialValueStrategySpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterModelInitialValueStrategySpriteSwitcher;
            ...
            if (original.expression == Gs2EnchantBalanceParameterModelInitialValueStrategySpriteSwitcher.Expression.In || original.expression == Gs2EnchantBalanceParameterModelInitialValueStrategySpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyInitialValueStrategies"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyInitialValueStrategy"), true);
            }
