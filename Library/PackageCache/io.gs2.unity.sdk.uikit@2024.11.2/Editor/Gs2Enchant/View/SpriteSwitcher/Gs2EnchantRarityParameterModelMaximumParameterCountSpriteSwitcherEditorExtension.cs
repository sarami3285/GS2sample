...
{
    [CustomEditor(typeof(Gs2EnchantRarityParameterModelMaximumParameterCountSpriteSwitcher))]
    public class Gs2EnchantRarityParameterModelMaximumParameterCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantRarityParameterModelMaximumParameterCountSpriteSwitcher;
            ...
            if (original.expression == Gs2EnchantRarityParameterModelMaximumParameterCountSpriteSwitcher.Expression.In || original.expression == Gs2EnchantRarityParameterModelMaximumParameterCountSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMaximumParameterCounts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMaximumParameterCount"), true);
            }
