...
{
    [CustomEditor(typeof(Gs2EnchantRarityParameterModelMetadataSpriteSwitcher))]
    public class Gs2EnchantRarityParameterModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantRarityParameterModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2EnchantRarityParameterModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2EnchantRarityParameterModelMetadataSpriteSwitcher.Expression.NotIn) {
