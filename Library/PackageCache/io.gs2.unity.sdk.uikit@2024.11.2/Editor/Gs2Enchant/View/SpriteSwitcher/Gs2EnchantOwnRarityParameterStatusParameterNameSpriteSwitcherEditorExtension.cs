...
{
    [CustomEditor(typeof(Gs2EnchantOwnRarityParameterStatusParameterNameSpriteSwitcher))]
    public class Gs2EnchantOwnRarityParameterStatusParameterNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantOwnRarityParameterStatusParameterNameSpriteSwitcher;
            ...
            if (original.expression == Gs2EnchantOwnRarityParameterStatusParameterNameSpriteSwitcher.Expression.In || original.expression == Gs2EnchantOwnRarityParameterStatusParameterNameSpriteSwitcher.Expression.NotIn) {
