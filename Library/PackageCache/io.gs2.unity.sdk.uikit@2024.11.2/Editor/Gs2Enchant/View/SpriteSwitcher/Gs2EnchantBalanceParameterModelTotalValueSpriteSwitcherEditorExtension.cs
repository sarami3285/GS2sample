...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterModelTotalValueSpriteSwitcher))]
    public class Gs2EnchantBalanceParameterModelTotalValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterModelTotalValueSpriteSwitcher;
            ...
            if (original.expression == Gs2EnchantBalanceParameterModelTotalValueSpriteSwitcher.Expression.In || original.expression == Gs2EnchantBalanceParameterModelTotalValueSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTotalValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTotalValue"), true);
            }
