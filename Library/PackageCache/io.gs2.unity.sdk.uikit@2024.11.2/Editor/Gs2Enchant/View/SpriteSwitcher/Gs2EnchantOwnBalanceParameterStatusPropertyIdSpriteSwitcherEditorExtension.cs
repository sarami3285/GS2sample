...
{
    [CustomEditor(typeof(Gs2EnchantOwnBalanceParameterStatusPropertyIdSpriteSwitcher))]
    public class Gs2EnchantOwnBalanceParameterStatusPropertyIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantOwnBalanceParameterStatusPropertyIdSpriteSwitcher;
            ...
            if (original.expression == Gs2EnchantOwnBalanceParameterStatusPropertyIdSpriteSwitcher.Expression.In || original.expression == Gs2EnchantOwnBalanceParameterStatusPropertyIdSpriteSwitcher.Expression.NotIn) {
