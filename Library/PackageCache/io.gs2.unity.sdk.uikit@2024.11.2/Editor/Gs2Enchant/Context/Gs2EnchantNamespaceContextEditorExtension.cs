...
{
    [CustomEditor(typeof(Gs2EnchantNamespaceContext))]
    public class Gs2EnchantNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantNamespaceContext;
