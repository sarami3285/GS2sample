...
{
    [CustomEditor(typeof(Gs2EnchantUserContext))]
    public class Gs2EnchantUserContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantUserContext;
