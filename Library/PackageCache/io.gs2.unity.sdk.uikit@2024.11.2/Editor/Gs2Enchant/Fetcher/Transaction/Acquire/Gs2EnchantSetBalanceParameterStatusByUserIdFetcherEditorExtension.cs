...
{
    [CustomEditor(typeof(Gs2EnchantSetBalanceParameterStatusByUserIdFetcher))]
    public class Gs2EnchantSetBalanceParameterStatusByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantSetBalanceParameterStatusByUserIdFetcher;
