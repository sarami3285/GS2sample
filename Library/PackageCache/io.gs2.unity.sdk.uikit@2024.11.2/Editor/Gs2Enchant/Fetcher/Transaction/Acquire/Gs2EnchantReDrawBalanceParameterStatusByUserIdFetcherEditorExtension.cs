...
namespace Gs2.Unity.UiKit.Gs2Enchant.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2EnchantReDrawBalanceParameterStatusByUserIdFetcher))]
    public class Gs2EnchantReDrawBalanceParameterStatusByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantReDrawBalanceParameterStatusByUserIdFetcher;
