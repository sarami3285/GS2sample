...
{
    [CustomEditor(typeof(Gs2EnchantAddRarityParameterStatusByUserIdFetcher))]
    public class Gs2EnchantAddRarityParameterStatusByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantAddRarityParameterStatusByUserIdFetcher;
