...
{
    [CustomEditor(typeof(Gs2EnchantReDrawRarityParameterStatusByUserIdFetcher))]
    public class Gs2EnchantReDrawRarityParameterStatusByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantReDrawRarityParameterStatusByUserIdFetcher;
