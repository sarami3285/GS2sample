...
{
    [CustomEditor(typeof(Gs2EnchantSetRarityParameterStatusByUserIdFetcher))]
    public class Gs2EnchantSetRarityParameterStatusByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantSetRarityParameterStatusByUserIdFetcher;
