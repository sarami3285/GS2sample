...
{
    [CustomEditor(typeof(Gs2EnchantVerifyRarityParameterStatusByUserIdFetcher))]
    public class Gs2EnchantVerifyRarityParameterStatusByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantVerifyRarityParameterStatusByUserIdFetcher;
