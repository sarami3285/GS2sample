...
{
    [CustomEditor(typeof(Gs2JobQueueOwnJobResultResultSpriteSwitcher))]
    public class Gs2JobQueueOwnJobResultResultSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueOwnJobResultResultSpriteSwitcher;
            ...
            if (original.expression == Gs2JobQueueOwnJobResultResultSpriteSwitcher.Expression.In || original.expression == Gs2JobQueueOwnJobResultResultSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyResults"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyResult"), true);
            }
