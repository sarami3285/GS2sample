...
{
    [CustomEditor(typeof(Gs2JobQueueOwnJobMaxTryCountSpriteSwitcher))]
    public class Gs2JobQueueOwnJobMaxTryCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueOwnJobMaxTryCountSpriteSwitcher;
            ...
            if (original.expression == Gs2JobQueueOwnJobMaxTryCountSpriteSwitcher.Expression.In || original.expression == Gs2JobQueueOwnJobMaxTryCountSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMaxTryCounts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMaxTryCount"), true);
            }
