...
{
    [CustomEditor(typeof(Gs2JobQueueOwnJobArgsSpriteTableSwitcher))]
    public class Gs2JobQueueOwnJobArgsSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueOwnJobArgsSpriteTableSwitcher;
