...
{
    [CustomEditor(typeof(Gs2JobQueueOwnJobResultStatusCodeSpriteSwitcher))]
    public class Gs2JobQueueOwnJobResultStatusCodeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueOwnJobResultStatusCodeSpriteSwitcher;
            ...
            if (original.expression == Gs2JobQueueOwnJobResultStatusCodeSpriteSwitcher.Expression.In || original.expression == Gs2JobQueueOwnJobResultStatusCodeSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyStatusCodes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyStatusCode"), true);
            }
