...
{
    [CustomEditor(typeof(Gs2JobQueueOwnJobArgsSpriteSwitcher))]
    public class Gs2JobQueueOwnJobArgsSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueOwnJobArgsSpriteSwitcher;
            ...
            if (original.expression == Gs2JobQueueOwnJobArgsSpriteSwitcher.Expression.In || original.expression == Gs2JobQueueOwnJobArgsSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyArgses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyArgs"), true);
            }
