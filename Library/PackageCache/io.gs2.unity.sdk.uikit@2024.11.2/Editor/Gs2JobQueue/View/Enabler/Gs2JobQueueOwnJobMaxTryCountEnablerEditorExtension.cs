...
{
    [CustomEditor(typeof(Gs2JobQueueOwnJobMaxTryCountEnabler))]
    public class Gs2JobQueueOwnJobMaxTryCountEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueOwnJobMaxTryCountEnabler;
            ...
            if (original.expression == Gs2JobQueueOwnJobMaxTryCountEnabler.Expression.In || original.expression == Gs2JobQueueOwnJobMaxTryCountEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableMaxTryCounts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableMaxTryCount"), true);
            }
