...
{
    [CustomEditor(typeof(Gs2JobQueueOwnJobResultStatusCodeEnabler))]
    public class Gs2JobQueueOwnJobResultStatusCodeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueOwnJobResultStatusCodeEnabler;
            ...
            if (original.expression == Gs2JobQueueOwnJobResultStatusCodeEnabler.Expression.In || original.expression == Gs2JobQueueOwnJobResultStatusCodeEnabler.Expression.NotIn) {
