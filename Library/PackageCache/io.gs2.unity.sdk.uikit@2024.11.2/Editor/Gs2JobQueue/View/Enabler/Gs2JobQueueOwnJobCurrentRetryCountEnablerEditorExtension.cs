...
{
    [CustomEditor(typeof(Gs2JobQueueOwnJobCurrentRetryCountEnabler))]
    public class Gs2JobQueueOwnJobCurrentRetryCountEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueOwnJobCurrentRetryCountEnabler;
            ...
            if (original.expression == Gs2JobQueueOwnJobCurrentRetryCountEnabler.Expression.In || original.expression == Gs2JobQueueOwnJobCurrentRetryCountEnabler.Expression.NotIn) {
