...
{
    [CustomEditor(typeof(Gs2JobQueueOwnJobEnabler))]
    public class Gs2JobQueueOwnJobEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueOwnJobEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("JobFetcher not assigned.", MessageType.Error);
