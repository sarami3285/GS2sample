...
{
    [CustomEditor(typeof(Gs2JobQueueDeleteJobByUserIdEnabler))]
    public class Gs2JobQueueDeleteJobByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueDeleteJobByUserIdEnabler;
