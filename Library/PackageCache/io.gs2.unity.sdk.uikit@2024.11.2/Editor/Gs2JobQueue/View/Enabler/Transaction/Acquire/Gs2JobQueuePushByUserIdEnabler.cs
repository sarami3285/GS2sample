...
{
    [CustomEditor(typeof(Gs2JobQueuePushByUserIdEnabler))]
    public class Gs2JobQueuePushByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueuePushByUserIdEnabler;
