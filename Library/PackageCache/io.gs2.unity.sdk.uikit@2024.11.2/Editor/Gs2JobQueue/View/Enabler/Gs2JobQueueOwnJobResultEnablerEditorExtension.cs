...
{
    [CustomEditor(typeof(Gs2JobQueueOwnJobResultEnabler))]
    public class Gs2JobQueueOwnJobResultEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueOwnJobResultEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("JobResultFetcher not assigned.", MessageType.Error);
