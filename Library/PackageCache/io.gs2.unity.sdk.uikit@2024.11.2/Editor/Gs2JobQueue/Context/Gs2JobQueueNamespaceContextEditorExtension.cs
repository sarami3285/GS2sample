...
{
    [CustomEditor(typeof(Gs2JobQueueNamespaceContext))]
    public class Gs2JobQueueNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueNamespaceContext;
