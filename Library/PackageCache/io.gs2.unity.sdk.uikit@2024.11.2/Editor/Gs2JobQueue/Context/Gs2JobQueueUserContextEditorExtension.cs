...
{
    [CustomEditor(typeof(Gs2JobQueueUserContext))]
    public class Gs2JobQueueUserContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueUserContext;
