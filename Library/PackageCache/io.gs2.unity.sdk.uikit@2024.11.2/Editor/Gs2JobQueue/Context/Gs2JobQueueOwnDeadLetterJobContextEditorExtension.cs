...
{
    [CustomEditor(typeof(Gs2JobQueueOwnDeadLetterJobContext))]
    public class Gs2JobQueueOwnDeadLetterJobContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueOwnDeadLetterJobContext;
