...
{
    [CustomEditor(typeof(Gs2JobQueuePushByUserIdFetcher))]
    public class Gs2JobQueuePushByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueuePushByUserIdFetcher;
