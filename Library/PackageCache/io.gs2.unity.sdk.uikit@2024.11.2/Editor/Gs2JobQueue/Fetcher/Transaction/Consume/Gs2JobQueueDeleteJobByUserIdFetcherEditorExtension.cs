...
namespace Gs2.Unity.UiKit.Gs2JobQueue.Fetcher.Editor
{
    [CustomEditor(typeof(Gs2JobQueueDeleteJobByUserIdFetcher))]
    public class Gs2JobQueueDeleteJobByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueDeleteJobByUserIdFetcher;
