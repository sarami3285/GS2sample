...
{
    [CustomEditor(typeof(Gs2JobQueueOwnJobResultFetcher))]
    public class Gs2JobQueueOwnJobResultFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueOwnJobResultFetcher;
