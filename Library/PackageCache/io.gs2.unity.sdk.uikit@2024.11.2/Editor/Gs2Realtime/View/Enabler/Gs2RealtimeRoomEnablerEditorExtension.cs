...
{
    [CustomEditor(typeof(Gs2RealtimeRoomEnabler))]
    public class Gs2RealtimeRoomEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RealtimeRoomEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("RoomFetcher not assigned.", MessageType.Error);
