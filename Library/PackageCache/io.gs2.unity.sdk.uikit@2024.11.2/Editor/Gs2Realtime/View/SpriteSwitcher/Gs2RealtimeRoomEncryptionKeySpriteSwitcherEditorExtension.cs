...
{
    [CustomEditor(typeof(Gs2RealtimeRoomEncryptionKeySpriteSwitcher))]
    public class Gs2RealtimeRoomEncryptionKeySpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RealtimeRoomEncryptionKeySpriteSwitcher;
            ...
            if (original.expression == Gs2RealtimeRoomEncryptionKeySpriteSwitcher.Expression.In || original.expression == Gs2RealtimeRoomEncryptionKeySpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyEncryptionKeys"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyEncryptionKey"), true);
            }
