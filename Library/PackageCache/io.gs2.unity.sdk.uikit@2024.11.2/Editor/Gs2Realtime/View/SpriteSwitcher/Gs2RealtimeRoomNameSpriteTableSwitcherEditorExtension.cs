...
{
    [CustomEditor(typeof(Gs2RealtimeRoomNameSpriteTableSwitcher))]
    public class Gs2RealtimeRoomNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RealtimeRoomNameSpriteTableSwitcher;
