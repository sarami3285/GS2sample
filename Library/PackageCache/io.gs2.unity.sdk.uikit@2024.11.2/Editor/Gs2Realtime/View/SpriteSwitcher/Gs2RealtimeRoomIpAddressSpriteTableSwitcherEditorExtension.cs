...
{
    [CustomEditor(typeof(Gs2RealtimeRoomIpAddressSpriteTableSwitcher))]
    public class Gs2RealtimeRoomIpAddressSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RealtimeRoomIpAddressSpriteTableSwitcher;
