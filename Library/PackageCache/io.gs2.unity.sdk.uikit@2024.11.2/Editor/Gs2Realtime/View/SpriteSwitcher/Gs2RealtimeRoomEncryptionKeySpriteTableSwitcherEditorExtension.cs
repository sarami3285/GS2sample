...
{
    [CustomEditor(typeof(Gs2RealtimeRoomEncryptionKeySpriteTableSwitcher))]
    public class Gs2RealtimeRoomEncryptionKeySpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RealtimeRoomEncryptionKeySpriteTableSwitcher;
