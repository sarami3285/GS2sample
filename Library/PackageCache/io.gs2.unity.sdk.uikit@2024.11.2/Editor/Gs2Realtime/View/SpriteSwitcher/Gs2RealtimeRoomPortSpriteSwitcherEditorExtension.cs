...
{
    [CustomEditor(typeof(Gs2RealtimeRoomPortSpriteSwitcher))]
    public class Gs2RealtimeRoomPortSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RealtimeRoomPortSpriteSwitcher;
            ...
            if (original.expression == Gs2RealtimeRoomPortSpriteSwitcher.Expression.In || original.expression == Gs2RealtimeRoomPortSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyPorts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyPort"), true);
            }
