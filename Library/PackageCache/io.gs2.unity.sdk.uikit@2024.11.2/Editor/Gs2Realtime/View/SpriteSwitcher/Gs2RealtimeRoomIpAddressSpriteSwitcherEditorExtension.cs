...
{
    [CustomEditor(typeof(Gs2RealtimeRoomIpAddressSpriteSwitcher))]
    public class Gs2RealtimeRoomIpAddressSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RealtimeRoomIpAddressSpriteSwitcher;
            ...
            if (original.expression == Gs2RealtimeRoomIpAddressSpriteSwitcher.Expression.In || original.expression == Gs2RealtimeRoomIpAddressSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyIpAddresses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyIpAddress"), true);
            }
