...
{
    [CustomEditor(typeof(Gs2RealtimeNamespaceContext))]
    public class Gs2RealtimeNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RealtimeNamespaceContext;
