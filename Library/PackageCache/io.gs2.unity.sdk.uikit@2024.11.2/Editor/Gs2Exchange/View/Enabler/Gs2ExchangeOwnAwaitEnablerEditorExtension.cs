...
{
    [CustomEditor(typeof(Gs2ExchangeOwnAwaitEnabler))]
    public class Gs2ExchangeOwnAwaitEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeOwnAwaitEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("AwaitFetcher not assigned.", MessageType.Error);
