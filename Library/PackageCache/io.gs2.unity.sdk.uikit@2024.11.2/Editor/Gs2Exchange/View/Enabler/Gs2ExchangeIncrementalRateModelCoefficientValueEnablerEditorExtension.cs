...
{
    [CustomEditor(typeof(Gs2ExchangeIncrementalRateModelCoefficientValueEnabler))]
    public class Gs2ExchangeIncrementalRateModelCoefficientValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeIncrementalRateModelCoefficientValueEnabler;
            ...
            if (original.expression == Gs2ExchangeIncrementalRateModelCoefficientValueEnabler.Expression.In || original.expression == Gs2ExchangeIncrementalRateModelCoefficientValueEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableCoefficientValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableCoefficientValue"), true);
            }
