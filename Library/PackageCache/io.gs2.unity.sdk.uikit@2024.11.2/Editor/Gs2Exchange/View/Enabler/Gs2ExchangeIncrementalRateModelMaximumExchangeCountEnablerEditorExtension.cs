...
{
    [CustomEditor(typeof(Gs2ExchangeIncrementalRateModelMaximumExchangeCountEnabler))]
    public class Gs2ExchangeIncrementalRateModelMaximumExchangeCountEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeIncrementalRateModelMaximumExchangeCountEnabler;
            ...
            if (original.expression == Gs2ExchangeIncrementalRateModelMaximumExchangeCountEnabler.Expression.In || original.expression == Gs2ExchangeIncrementalRateModelMaximumExchangeCountEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableMaximumExchangeCounts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableMaximumExchangeCount"), true);
            }
