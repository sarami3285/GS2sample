...
{
    [CustomEditor(typeof(Gs2ExchangeOwnAwaitNameEnabler))]
    public class Gs2ExchangeOwnAwaitNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeOwnAwaitNameEnabler;
            ...
            if (original.expression == Gs2ExchangeOwnAwaitNameEnabler.Expression.In || original.expression == Gs2ExchangeOwnAwaitNameEnabler.Expression.NotIn) {
