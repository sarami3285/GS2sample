...
{
    [CustomEditor(typeof(Gs2ExchangeOwnAwaitUserIdEnabler))]
    public class Gs2ExchangeOwnAwaitUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeOwnAwaitUserIdEnabler;
            ...
            if (original.expression == Gs2ExchangeOwnAwaitUserIdEnabler.Expression.In || original.expression == Gs2ExchangeOwnAwaitUserIdEnabler.Expression.NotIn) {
