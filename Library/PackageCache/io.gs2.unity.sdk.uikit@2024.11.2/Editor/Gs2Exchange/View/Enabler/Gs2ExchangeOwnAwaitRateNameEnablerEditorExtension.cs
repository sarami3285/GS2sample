...
{
    [CustomEditor(typeof(Gs2ExchangeOwnAwaitRateNameEnabler))]
    public class Gs2ExchangeOwnAwaitRateNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeOwnAwaitRateNameEnabler;
            ...
            if (original.expression == Gs2ExchangeOwnAwaitRateNameEnabler.Expression.In || original.expression == Gs2ExchangeOwnAwaitRateNameEnabler.Expression.NotIn) {
