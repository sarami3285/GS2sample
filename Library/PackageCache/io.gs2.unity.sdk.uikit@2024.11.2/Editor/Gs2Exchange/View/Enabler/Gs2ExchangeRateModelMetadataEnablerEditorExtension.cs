...
{
    [CustomEditor(typeof(Gs2ExchangeRateModelMetadataEnabler))]
    public class Gs2ExchangeRateModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeRateModelMetadataEnabler;
            ...
            if (original.expression == Gs2ExchangeRateModelMetadataEnabler.Expression.In || original.expression == Gs2ExchangeRateModelMetadataEnabler.Expression.NotIn) {
