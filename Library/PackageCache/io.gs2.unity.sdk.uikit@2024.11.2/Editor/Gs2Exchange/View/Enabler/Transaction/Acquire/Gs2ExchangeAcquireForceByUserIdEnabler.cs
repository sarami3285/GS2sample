...
{
    [CustomEditor(typeof(Gs2ExchangeAcquireForceByUserIdEnabler))]
    public class Gs2ExchangeAcquireForceByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeAcquireForceByUserIdEnabler;
