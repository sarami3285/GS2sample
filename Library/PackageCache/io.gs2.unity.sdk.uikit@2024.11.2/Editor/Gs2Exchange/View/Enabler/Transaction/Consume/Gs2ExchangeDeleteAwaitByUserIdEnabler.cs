...
{
    [CustomEditor(typeof(Gs2ExchangeDeleteAwaitByUserIdEnabler))]
    public class Gs2ExchangeDeleteAwaitByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeDeleteAwaitByUserIdEnabler;
