...
{
    [CustomEditor(typeof(Gs2ExchangeCreateAwaitByUserIdValueEnabler))]
    public class Gs2ExchangeCreateAwaitByUserIdValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeCreateAwaitByUserIdValueEnabler;
            ...
            if (original.expression == Gs2ExchangeCreateAwaitByUserIdValueEnabler.Expression.In || original.expression == Gs2ExchangeCreateAwaitByUserIdValueEnabler.Expression.NotIn) {
