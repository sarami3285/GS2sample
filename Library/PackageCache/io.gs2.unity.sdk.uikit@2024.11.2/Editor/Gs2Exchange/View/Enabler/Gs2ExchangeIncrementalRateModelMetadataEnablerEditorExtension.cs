...
{
    [CustomEditor(typeof(Gs2ExchangeIncrementalRateModelMetadataEnabler))]
    public class Gs2ExchangeIncrementalRateModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeIncrementalRateModelMetadataEnabler;
            ...
            if (original.expression == Gs2ExchangeIncrementalRateModelMetadataEnabler.Expression.In || original.expression == Gs2ExchangeIncrementalRateModelMetadataEnabler.Expression.NotIn) {
