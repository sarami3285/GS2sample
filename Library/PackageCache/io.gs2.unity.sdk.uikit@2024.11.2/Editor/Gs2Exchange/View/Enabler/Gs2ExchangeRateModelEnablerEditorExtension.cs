...
{
    [CustomEditor(typeof(Gs2ExchangeRateModelEnabler))]
    public class Gs2ExchangeRateModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeRateModelEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("RateModelFetcher not assigned.", MessageType.Error);
