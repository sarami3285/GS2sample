...
{
    [CustomEditor(typeof(Gs2ExchangeOwnAwaitAcquirableAtEnabler))]
    public class Gs2ExchangeOwnAwaitAcquirableAtEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeOwnAwaitAcquirableAtEnabler;
            ...
            if (original.expression == Gs2ExchangeOwnAwaitAcquirableAtEnabler.Expression.In || original.expression == Gs2ExchangeOwnAwaitAcquirableAtEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableAcquirableAts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableAcquirableAt"), true);
            }
