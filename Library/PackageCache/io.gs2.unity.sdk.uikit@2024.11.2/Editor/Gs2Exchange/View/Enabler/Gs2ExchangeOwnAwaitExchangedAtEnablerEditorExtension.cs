...
{
    [CustomEditor(typeof(Gs2ExchangeOwnAwaitExchangedAtEnabler))]
    public class Gs2ExchangeOwnAwaitExchangedAtEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeOwnAwaitExchangedAtEnabler;
            ...
            if (original.expression == Gs2ExchangeOwnAwaitExchangedAtEnabler.Expression.In || original.expression == Gs2ExchangeOwnAwaitExchangedAtEnabler.Expression.NotIn) {
