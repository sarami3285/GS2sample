...
{
    [CustomEditor(typeof(Gs2ExchangeIncrementalRateModelBaseValueEnabler))]
    public class Gs2ExchangeIncrementalRateModelBaseValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeIncrementalRateModelBaseValueEnabler;
            ...
            if (original.expression == Gs2ExchangeIncrementalRateModelBaseValueEnabler.Expression.In || original.expression == Gs2ExchangeIncrementalRateModelBaseValueEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableBaseValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableBaseValue"), true);
            }
