...
{
    [CustomEditor(typeof(Gs2ExchangeIncrementalRateModelNameEnabler))]
    public class Gs2ExchangeIncrementalRateModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeIncrementalRateModelNameEnabler;
            ...
            if (original.expression == Gs2ExchangeIncrementalRateModelNameEnabler.Expression.In || original.expression == Gs2ExchangeIncrementalRateModelNameEnabler.Expression.NotIn) {
