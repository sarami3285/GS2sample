...
namespace Gs2.Unity.UiKit.Gs2Exchange.Enabler.Editor
{
    ...
    public class Gs2ExchangeRateModelTimingTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeRateModelTimingTypeEnabler;
            ...
            if (original.expression == Gs2ExchangeRateModelTimingTypeEnabler.Expression.In || original.expression == Gs2ExchangeRateModelTimingTypeEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTimingTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTimingType"), true);
            }
