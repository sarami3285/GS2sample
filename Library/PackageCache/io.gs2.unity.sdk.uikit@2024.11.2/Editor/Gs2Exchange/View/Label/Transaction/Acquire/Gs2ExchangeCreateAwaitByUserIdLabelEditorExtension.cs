...
namespace Gs2.Unity.UiKit.Gs2Exchange.Label.Editor
{
    ...
    public class Gs2ExchangeCreateAwaitByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            ...
            var fetcher = original.GetComponent<Gs2ExchangeCreateAwaitByUserIdFetcher>() ?? original.GetComponentInParent<Gs2ExchangeCreateAwaitByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2ExchangeCreateAwaitByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2ExchangeCreateAwaitByUserIdFetcher>();
                }
            }
