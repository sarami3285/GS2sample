...
{
    [CustomEditor(typeof(Gs2ExchangeAcquireForceByUserIdLabel))]
    public class Gs2ExchangeAcquireForceByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeAcquireForceByUserIdLabel;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2ExchangeAcquireForceByUserIdFetcher>() ?? original.GetComponentInParent<Gs2ExchangeAcquireForceByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2ExchangeAcquireForceByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2ExchangeAcquireForceByUserIdFetcher>();
                }
            }
