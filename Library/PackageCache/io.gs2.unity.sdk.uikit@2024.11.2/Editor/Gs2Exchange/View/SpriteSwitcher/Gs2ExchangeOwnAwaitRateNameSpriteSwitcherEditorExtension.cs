...
{
    [CustomEditor(typeof(Gs2ExchangeOwnAwaitRateNameSpriteSwitcher))]
    public class Gs2ExchangeOwnAwaitRateNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeOwnAwaitRateNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeOwnAwaitRateNameSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeOwnAwaitRateNameSpriteSwitcher.Expression.NotIn) {
