...
{
    [CustomEditor(typeof(Gs2ExchangeIncrementalRateModelMaximumExchangeCountSpriteSwitcher))]
    public class Gs2ExchangeIncrementalRateModelMaximumExchangeCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeIncrementalRateModelMaximumExchangeCountSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeIncrementalRateModelMaximumExchangeCountSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeIncrementalRateModelMaximumExchangeCountSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMaximumExchangeCounts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyMaximumExchangeCount"), true);
            }
