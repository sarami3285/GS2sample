...
{
    [CustomEditor(typeof(Gs2ExchangeIncrementalRateModelMetadataSpriteSwitcher))]
    public class Gs2ExchangeIncrementalRateModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeIncrementalRateModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeIncrementalRateModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeIncrementalRateModelMetadataSpriteSwitcher.Expression.NotIn) {
