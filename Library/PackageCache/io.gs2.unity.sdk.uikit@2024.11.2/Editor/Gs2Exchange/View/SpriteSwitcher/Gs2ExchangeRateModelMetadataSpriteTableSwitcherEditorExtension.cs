...
{
    [CustomEditor(typeof(Gs2ExchangeRateModelMetadataSpriteTableSwitcher))]
    public class Gs2ExchangeRateModelMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeRateModelMetadataSpriteTableSwitcher;
