...
{
    [CustomEditor(typeof(Gs2ExchangeOwnAwaitExchangedAtSpriteSwitcher))]
    public class Gs2ExchangeOwnAwaitExchangedAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeOwnAwaitExchangedAtSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeOwnAwaitExchangedAtSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeOwnAwaitExchangedAtSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyExchangedAts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyExchangedAt"), true);
            }
