...
{
    [CustomEditor(typeof(Gs2ExchangeRateModelLockTimeSpriteSwitcher))]
    public class Gs2ExchangeRateModelLockTimeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeRateModelLockTimeSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeRateModelLockTimeSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeRateModelLockTimeSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyLockTimes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyLockTime"), true);
            }
