...
{
    [CustomEditor(typeof(Gs2ExchangeOwnAwaitAcquirableAtSpriteSwitcher))]
    public class Gs2ExchangeOwnAwaitAcquirableAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeOwnAwaitAcquirableAtSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeOwnAwaitAcquirableAtSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeOwnAwaitAcquirableAtSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyAcquirableAts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyAcquirableAt"), true);
            }
