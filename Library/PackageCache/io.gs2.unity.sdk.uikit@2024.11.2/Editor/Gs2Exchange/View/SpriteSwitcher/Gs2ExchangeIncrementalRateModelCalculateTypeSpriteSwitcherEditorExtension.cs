...
{
    [CustomEditor(typeof(Gs2ExchangeIncrementalRateModelCalculateTypeSpriteSwitcher))]
    public class Gs2ExchangeIncrementalRateModelCalculateTypeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeIncrementalRateModelCalculateTypeSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeIncrementalRateModelCalculateTypeSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeIncrementalRateModelCalculateTypeSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCalculateTypes"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCalculateType"), true);
            }
