...
{
    [CustomEditor(typeof(Gs2ExchangeIncrementalRateModelBaseValueSpriteSwitcher))]
    public class Gs2ExchangeIncrementalRateModelBaseValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeIncrementalRateModelBaseValueSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeIncrementalRateModelBaseValueSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeIncrementalRateModelBaseValueSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyBaseValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyBaseValue"), true);
            }
