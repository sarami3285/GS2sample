...
{
    [CustomEditor(typeof(Gs2ExchangeOwnAwaitUserIdSpriteSwitcher))]
    public class Gs2ExchangeOwnAwaitUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeOwnAwaitUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeOwnAwaitUserIdSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeOwnAwaitUserIdSpriteSwitcher.Expression.NotIn) {
