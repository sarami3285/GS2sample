...
{
    [CustomEditor(typeof(Gs2ExchangeRateModelNameSpriteSwitcher))]
    public class Gs2ExchangeRateModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeRateModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeRateModelNameSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeRateModelNameSpriteSwitcher.Expression.NotIn) {
