...
{
    [CustomEditor(typeof(Gs2ExchangeIncrementalRateModelCoefficientValueSpriteSwitcher))]
    public class Gs2ExchangeIncrementalRateModelCoefficientValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeIncrementalRateModelCoefficientValueSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeIncrementalRateModelCoefficientValueSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeIncrementalRateModelCoefficientValueSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCoefficientValues"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyCoefficientValue"), true);
            }
