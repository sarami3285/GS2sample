...
{
    [CustomEditor(typeof(Gs2ExchangeIncrementalRateModelNameSpriteSwitcher))]
    public class Gs2ExchangeIncrementalRateModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeIncrementalRateModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeIncrementalRateModelNameSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeIncrementalRateModelNameSpriteSwitcher.Expression.NotIn) {
