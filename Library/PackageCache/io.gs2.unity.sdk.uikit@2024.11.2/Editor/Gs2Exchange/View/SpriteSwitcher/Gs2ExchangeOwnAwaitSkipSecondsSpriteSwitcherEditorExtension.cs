...
{
    [CustomEditor(typeof(Gs2ExchangeOwnAwaitSkipSecondsSpriteSwitcher))]
    public class Gs2ExchangeOwnAwaitSkipSecondsSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeOwnAwaitSkipSecondsSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeOwnAwaitSkipSecondsSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeOwnAwaitSkipSecondsSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applySkipSecondses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applySkipSeconds"), true);
            }
