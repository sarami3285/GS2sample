...
{
    [CustomEditor(typeof(Gs2ExchangeOwnAwaitNameSpriteSwitcher))]
    public class Gs2ExchangeOwnAwaitNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeOwnAwaitNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeOwnAwaitNameSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeOwnAwaitNameSpriteSwitcher.Expression.NotIn) {
