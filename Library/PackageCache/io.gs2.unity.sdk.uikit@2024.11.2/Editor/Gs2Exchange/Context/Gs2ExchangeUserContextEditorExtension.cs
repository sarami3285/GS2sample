...
{
    [CustomEditor(typeof(Gs2ExchangeUserContext))]
    public class Gs2ExchangeUserContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeUserContext;
