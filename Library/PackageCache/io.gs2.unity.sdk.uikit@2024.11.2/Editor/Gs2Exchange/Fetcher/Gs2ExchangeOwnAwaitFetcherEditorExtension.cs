...
{
    [CustomEditor(typeof(Gs2ExchangeOwnAwaitFetcher))]
    public class Gs2ExchangeOwnAwaitFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeOwnAwaitFetcher;
            ...
            if (context == null) {
                ...
                if (context.gameObject.GetComponentInParent<Gs2ExchangeOwnAwaitList>(true) != null) {
                    ...
                    EditorGUILayout.ObjectField("Await", context.Await, typeof(OwnAwait), false);
