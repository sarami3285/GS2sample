...
{
    [CustomEditor(typeof(Gs2ExchangeIncrementalRateModelListFetcher))]
    public class Gs2ExchangeIncrementalRateModelListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeIncrementalRateModelListFetcher;
