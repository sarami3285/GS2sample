...
{
    [CustomEditor(typeof(Gs2ExchangeIncrementalRateModelFetcher))]
    public class Gs2ExchangeIncrementalRateModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeIncrementalRateModelFetcher;
