...
{
    [CustomEditor(typeof(Gs2ExchangeDeleteAwaitByUserIdFetcher))]
    public class Gs2ExchangeDeleteAwaitByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeDeleteAwaitByUserIdFetcher;
