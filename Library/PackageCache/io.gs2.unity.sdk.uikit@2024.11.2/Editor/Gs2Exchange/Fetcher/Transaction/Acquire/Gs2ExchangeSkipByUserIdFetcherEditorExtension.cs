...
{
    [CustomEditor(typeof(Gs2ExchangeSkipByUserIdFetcher))]
    public class Gs2ExchangeSkipByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeSkipByUserIdFetcher;
