...
{
    [CustomEditor(typeof(Gs2ExchangeCreateAwaitByUserIdFetcher))]
    public class Gs2ExchangeCreateAwaitByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeCreateAwaitByUserIdFetcher;
