...
{
    [CustomEditor(typeof(Gs2ExchangeRateModelFetcher))]
    public class Gs2ExchangeRateModelFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeRateModelFetcher;
