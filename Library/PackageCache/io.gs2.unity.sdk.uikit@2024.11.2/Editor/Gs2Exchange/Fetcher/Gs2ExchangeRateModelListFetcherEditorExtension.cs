...
{
    [CustomEditor(typeof(Gs2ExchangeRateModelListFetcher))]
    public class Gs2ExchangeRateModelListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeRateModelListFetcher;
