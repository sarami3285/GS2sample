...
{
    [CustomEditor(typeof(Gs2GatewayOwnWebSocketSessionNamespaceNameEnabler))]
    public class Gs2GatewayOwnWebSocketSessionNamespaceNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayOwnWebSocketSessionNamespaceNameEnabler;
            ...
            if (original.expression == Gs2GatewayOwnWebSocketSessionNamespaceNameEnabler.Expression.In || original.expression == Gs2GatewayOwnWebSocketSessionNamespaceNameEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableNamespaceNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableNamespaceName"), true);
            }
