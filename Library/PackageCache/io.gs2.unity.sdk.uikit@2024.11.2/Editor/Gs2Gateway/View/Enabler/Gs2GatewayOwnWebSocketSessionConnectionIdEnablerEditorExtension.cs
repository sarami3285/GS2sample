...
{
    [CustomEditor(typeof(Gs2GatewayOwnWebSocketSessionConnectionIdEnabler))]
    public class Gs2GatewayOwnWebSocketSessionConnectionIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayOwnWebSocketSessionConnectionIdEnabler;
            ...
            if (original.expression == Gs2GatewayOwnWebSocketSessionConnectionIdEnabler.Expression.In || original.expression == Gs2GatewayOwnWebSocketSessionConnectionIdEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableConnectionIds"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableConnectionId"), true);
            }
