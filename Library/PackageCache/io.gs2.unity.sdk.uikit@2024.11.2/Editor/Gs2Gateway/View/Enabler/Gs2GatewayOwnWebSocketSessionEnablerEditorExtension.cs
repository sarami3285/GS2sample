...
{
    [CustomEditor(typeof(Gs2GatewayOwnWebSocketSessionEnabler))]
    public class Gs2GatewayOwnWebSocketSessionEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayOwnWebSocketSessionEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("WebSocketSessionFetcher not assigned.", MessageType.Error);
