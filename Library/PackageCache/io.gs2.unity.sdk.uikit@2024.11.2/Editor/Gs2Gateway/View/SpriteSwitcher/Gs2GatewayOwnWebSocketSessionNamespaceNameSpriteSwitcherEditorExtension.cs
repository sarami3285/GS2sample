...
namespace Gs2.Unity.UiKit.Gs2Gateway.SpriteSwitcher.Editor
{
    [CustomEditor(typeof(Gs2GatewayOwnWebSocketSessionNamespaceNameSpriteSwitcher))]
    public class Gs2GatewayOwnWebSocketSessionNamespaceNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayOwnWebSocketSessionNamespaceNameSpriteSwitcher;
            ...
            if (original.expression == Gs2GatewayOwnWebSocketSessionNamespaceNameSpriteSwitcher.Expression.In || original.expression == Gs2GatewayOwnWebSocketSessionNamespaceNameSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyNamespaceNames"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyNamespaceName"), true);
            }
