...
{
    [CustomEditor(typeof(Gs2GatewayOwnWebSocketSessionUserIdSpriteSwitcher))]
    public class Gs2GatewayOwnWebSocketSessionUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayOwnWebSocketSessionUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2GatewayOwnWebSocketSessionUserIdSpriteSwitcher.Expression.In || original.expression == Gs2GatewayOwnWebSocketSessionUserIdSpriteSwitcher.Expression.NotIn) {
