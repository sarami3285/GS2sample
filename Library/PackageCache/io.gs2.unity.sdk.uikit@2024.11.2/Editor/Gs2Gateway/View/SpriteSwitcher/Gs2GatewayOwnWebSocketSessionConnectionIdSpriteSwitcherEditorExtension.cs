...
{
    [CustomEditor(typeof(Gs2GatewayOwnWebSocketSessionConnectionIdSpriteSwitcher))]
    public class Gs2GatewayOwnWebSocketSessionConnectionIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayOwnWebSocketSessionConnectionIdSpriteSwitcher;
            ...
            if (original.expression == Gs2GatewayOwnWebSocketSessionConnectionIdSpriteSwitcher.Expression.In || original.expression == Gs2GatewayOwnWebSocketSessionConnectionIdSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyConnectionIds"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyConnectionId"), true);
            }
