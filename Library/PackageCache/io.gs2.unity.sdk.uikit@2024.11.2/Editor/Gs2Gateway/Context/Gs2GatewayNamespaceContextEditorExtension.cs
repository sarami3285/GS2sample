...
{
    [CustomEditor(typeof(Gs2GatewayNamespaceContext))]
    public class Gs2GatewayNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayNamespaceContext;
