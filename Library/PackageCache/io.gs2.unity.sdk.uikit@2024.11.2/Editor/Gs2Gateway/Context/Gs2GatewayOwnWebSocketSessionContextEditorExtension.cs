...
{
    [CustomEditor(typeof(Gs2GatewayOwnWebSocketSessionContext))]
    public class Gs2GatewayOwnWebSocketSessionContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayOwnWebSocketSessionContext;
            ...
            if (original.WebSocketSession == null) {
                ...
                if (original.WebSocketSession != null) {
                    ...
                    EditorGUILayout.TextField("ConnectionId", original.WebSocketSession?.ConnectionId?.ToString());
                    EditorGUI.indentLevel--;
                }
