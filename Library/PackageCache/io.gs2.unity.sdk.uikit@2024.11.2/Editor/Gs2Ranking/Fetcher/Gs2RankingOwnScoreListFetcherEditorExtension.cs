...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreListFetcher))]
    public class Gs2RankingOwnScoreListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreListFetcher;
