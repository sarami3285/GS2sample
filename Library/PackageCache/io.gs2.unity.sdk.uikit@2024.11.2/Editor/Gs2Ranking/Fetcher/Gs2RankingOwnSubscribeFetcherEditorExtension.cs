...
{
    [CustomEditor(typeof(Gs2RankingOwnSubscribeFetcher))]
    public class Gs2RankingOwnSubscribeFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnSubscribeFetcher;
