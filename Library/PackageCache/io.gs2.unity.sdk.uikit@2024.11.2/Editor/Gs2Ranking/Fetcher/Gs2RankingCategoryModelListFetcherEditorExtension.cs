...
{
    [CustomEditor(typeof(Gs2RankingCategoryModelListFetcher))]
    public class Gs2RankingCategoryModelListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingCategoryModelListFetcher;
            ...
            if (context == null) {
                ...
                if (GUILayout.Button("Add Context")) {
                    original.gameObject.AddComponent<Gs2RankingNamespaceContext>();
                }
            }
            else {
                EditorGUI.BeginDisabledGroup(true);
                EditorGUILayout.ObjectField("Context", context.gameObject, typeof(Gs2RankingNamespaceContext), false);
