...
{
    [CustomEditor(typeof(Gs2RankingCategoryModelMetadataEnabler))]
    public class Gs2RankingCategoryModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingCategoryModelMetadataEnabler;
            ...
            if (original.expression == Gs2RankingCategoryModelMetadataEnabler.Expression.In || original.expression == Gs2RankingCategoryModelMetadataEnabler.Expression.NotIn) {
