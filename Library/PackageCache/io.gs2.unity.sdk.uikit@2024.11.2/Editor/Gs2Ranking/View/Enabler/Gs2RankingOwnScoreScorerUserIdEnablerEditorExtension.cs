...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreScorerUserIdEnabler))]
    public class Gs2RankingOwnScoreScorerUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreScorerUserIdEnabler;
            ...
            if (original.expression == Gs2RankingOwnScoreScorerUserIdEnabler.Expression.In || original.expression == Gs2RankingOwnScoreScorerUserIdEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableScorerUserIds"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableScorerUserId"), true);
            }
