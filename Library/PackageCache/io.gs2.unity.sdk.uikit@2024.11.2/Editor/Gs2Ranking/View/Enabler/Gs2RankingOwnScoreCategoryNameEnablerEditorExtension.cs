...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreCategoryNameEnabler))]
    public class Gs2RankingOwnScoreCategoryNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreCategoryNameEnabler;
            ...
            if (original.expression == Gs2RankingOwnScoreCategoryNameEnabler.Expression.In || original.expression == Gs2RankingOwnScoreCategoryNameEnabler.Expression.NotIn) {
