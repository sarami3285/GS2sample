...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreMetadataEnabler))]
    public class Gs2RankingOwnScoreMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreMetadataEnabler;
            ...
            if (original.expression == Gs2RankingOwnScoreMetadataEnabler.Expression.In || original.expression == Gs2RankingOwnScoreMetadataEnabler.Expression.NotIn) {
