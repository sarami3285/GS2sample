...
{
    [CustomEditor(typeof(Gs2RankingOwnSubscribeUserEnabler))]
    public class Gs2RankingOwnSubscribeUserEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnSubscribeUserEnabler;
