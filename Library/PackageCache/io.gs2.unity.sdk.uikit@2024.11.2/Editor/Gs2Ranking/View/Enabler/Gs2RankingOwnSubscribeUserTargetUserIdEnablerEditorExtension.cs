...
{
    [CustomEditor(typeof(Gs2RankingOwnSubscribeUserTargetUserIdEnabler))]
    public class Gs2RankingOwnSubscribeUserTargetUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnSubscribeUserTargetUserIdEnabler;
            ...
            if (original.expression == Gs2RankingOwnSubscribeUserTargetUserIdEnabler.Expression.In || original.expression == Gs2RankingOwnSubscribeUserTargetUserIdEnabler.Expression.NotIn) {
