...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreScoreEnabler))]
    public class Gs2RankingOwnScoreScoreEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreScoreEnabler;
            ...
            if (original.expression == Gs2RankingOwnScoreScoreEnabler.Expression.In || original.expression == Gs2RankingOwnScoreScoreEnabler.Expression.NotIn) {
