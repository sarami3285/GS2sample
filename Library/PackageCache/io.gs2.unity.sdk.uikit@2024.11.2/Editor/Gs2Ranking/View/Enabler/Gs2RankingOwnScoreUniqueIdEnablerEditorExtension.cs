...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreUniqueIdEnabler))]
    public class Gs2RankingOwnScoreUniqueIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreUniqueIdEnabler;
            ...
            if (original.expression == Gs2RankingOwnScoreUniqueIdEnabler.Expression.In || original.expression == Gs2RankingOwnScoreUniqueIdEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableUniqueIds"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableUniqueId"), true);
            }
