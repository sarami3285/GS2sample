...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreUserIdEnabler))]
    public class Gs2RankingOwnScoreUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreUserIdEnabler;
            ...
            if (original.expression == Gs2RankingOwnScoreUserIdEnabler.Expression.In || original.expression == Gs2RankingOwnScoreUserIdEnabler.Expression.NotIn) {
