...
{
    [CustomEditor(typeof(Gs2RankingCategoryModelScopeEnabler))]
    public class Gs2RankingCategoryModelScopeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingCategoryModelScopeEnabler;
            ...
            if (original.expression == Gs2RankingCategoryModelScopeEnabler.Expression.In || original.expression == Gs2RankingCategoryModelScopeEnabler.Expression.NotIn) {
