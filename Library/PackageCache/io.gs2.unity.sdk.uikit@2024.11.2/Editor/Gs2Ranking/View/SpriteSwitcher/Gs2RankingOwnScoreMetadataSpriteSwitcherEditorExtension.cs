...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreMetadataSpriteSwitcher))]
    public class Gs2RankingOwnScoreMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingOwnScoreMetadataSpriteSwitcher.Expression.In || original.expression == Gs2RankingOwnScoreMetadataSpriteSwitcher.Expression.NotIn) {
