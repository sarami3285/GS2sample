...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreUserIdSpriteSwitcher))]
    public class Gs2RankingOwnScoreUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingOwnScoreUserIdSpriteSwitcher.Expression.In || original.expression == Gs2RankingOwnScoreUserIdSpriteSwitcher.Expression.NotIn) {
