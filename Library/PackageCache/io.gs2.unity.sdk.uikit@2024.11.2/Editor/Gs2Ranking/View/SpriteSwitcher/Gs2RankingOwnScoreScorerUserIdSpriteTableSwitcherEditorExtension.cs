...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreScorerUserIdSpriteTableSwitcher))]
    public class Gs2RankingOwnScoreScorerUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreScorerUserIdSpriteTableSwitcher;
