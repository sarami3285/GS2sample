...
{
    [CustomEditor(typeof(Gs2RankingOwnSubscribeUserTargetUserIdSpriteTableSwitcher))]
    public class Gs2RankingOwnSubscribeUserTargetUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnSubscribeUserTargetUserIdSpriteTableSwitcher;
