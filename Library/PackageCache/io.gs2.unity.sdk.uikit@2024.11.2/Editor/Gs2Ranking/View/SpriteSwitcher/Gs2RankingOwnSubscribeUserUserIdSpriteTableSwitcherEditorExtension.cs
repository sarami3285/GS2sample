...
{
    [CustomEditor(typeof(Gs2RankingOwnSubscribeUserUserIdSpriteTableSwitcher))]
    public class Gs2RankingOwnSubscribeUserUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnSubscribeUserUserIdSpriteTableSwitcher;
