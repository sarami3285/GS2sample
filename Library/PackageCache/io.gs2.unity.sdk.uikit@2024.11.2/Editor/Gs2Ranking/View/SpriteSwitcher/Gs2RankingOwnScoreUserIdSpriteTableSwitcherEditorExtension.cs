...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreUserIdSpriteTableSwitcher))]
    public class Gs2RankingOwnScoreUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreUserIdSpriteTableSwitcher;
