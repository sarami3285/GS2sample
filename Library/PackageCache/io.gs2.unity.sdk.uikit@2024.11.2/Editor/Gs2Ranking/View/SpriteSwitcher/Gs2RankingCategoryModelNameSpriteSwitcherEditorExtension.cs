...
{
    [CustomEditor(typeof(Gs2RankingCategoryModelNameSpriteSwitcher))]
    public class Gs2RankingCategoryModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingCategoryModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingCategoryModelNameSpriteSwitcher.Expression.In || original.expression == Gs2RankingCategoryModelNameSpriteSwitcher.Expression.NotIn) {
