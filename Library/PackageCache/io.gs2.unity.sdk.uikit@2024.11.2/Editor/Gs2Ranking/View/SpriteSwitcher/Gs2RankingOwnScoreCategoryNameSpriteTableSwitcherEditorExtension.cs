...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreCategoryNameSpriteTableSwitcher))]
    public class Gs2RankingOwnScoreCategoryNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreCategoryNameSpriteTableSwitcher;
