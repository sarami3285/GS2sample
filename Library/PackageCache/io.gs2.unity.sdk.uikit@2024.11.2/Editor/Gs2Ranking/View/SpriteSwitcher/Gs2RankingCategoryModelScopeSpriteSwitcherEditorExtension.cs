...
{
    [CustomEditor(typeof(Gs2RankingCategoryModelScopeSpriteSwitcher))]
    public class Gs2RankingCategoryModelScopeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingCategoryModelScopeSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingCategoryModelScopeSpriteSwitcher.Expression.In || original.expression == Gs2RankingCategoryModelScopeSpriteSwitcher.Expression.NotIn) {
