...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreMetadataSpriteTableSwitcher))]
    public class Gs2RankingOwnScoreMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreMetadataSpriteTableSwitcher;
