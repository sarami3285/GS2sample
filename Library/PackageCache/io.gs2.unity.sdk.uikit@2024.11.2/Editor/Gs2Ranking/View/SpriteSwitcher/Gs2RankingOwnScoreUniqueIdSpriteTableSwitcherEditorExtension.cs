...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreUniqueIdSpriteTableSwitcher))]
    public class Gs2RankingOwnScoreUniqueIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreUniqueIdSpriteTableSwitcher;
