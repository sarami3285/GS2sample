...
{
    [CustomEditor(typeof(Gs2RankingCategoryModelScopeSpriteTableSwitcher))]
    public class Gs2RankingCategoryModelScopeSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingCategoryModelScopeSpriteTableSwitcher;
