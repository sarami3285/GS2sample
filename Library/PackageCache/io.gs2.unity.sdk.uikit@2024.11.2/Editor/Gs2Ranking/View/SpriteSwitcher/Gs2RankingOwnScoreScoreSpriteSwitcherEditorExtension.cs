...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreScoreSpriteSwitcher))]
    public class Gs2RankingOwnScoreScoreSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreScoreSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingOwnScoreScoreSpriteSwitcher.Expression.In || original.expression == Gs2RankingOwnScoreScoreSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyScores"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyScore"), true);
            }
