...
{
    [CustomEditor(typeof(Gs2RankingCategoryModelMetadataSpriteSwitcher))]
    public class Gs2RankingCategoryModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingCategoryModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingCategoryModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2RankingCategoryModelMetadataSpriteSwitcher.Expression.NotIn) {
