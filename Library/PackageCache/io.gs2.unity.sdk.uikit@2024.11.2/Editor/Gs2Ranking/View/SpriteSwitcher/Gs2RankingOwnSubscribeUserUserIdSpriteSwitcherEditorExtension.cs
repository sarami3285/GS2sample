...
{
    [CustomEditor(typeof(Gs2RankingOwnSubscribeUserUserIdSpriteSwitcher))]
    public class Gs2RankingOwnSubscribeUserUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnSubscribeUserUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingOwnSubscribeUserUserIdSpriteSwitcher.Expression.In || original.expression == Gs2RankingOwnSubscribeUserUserIdSpriteSwitcher.Expression.NotIn) {
