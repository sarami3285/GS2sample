...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreUniqueIdSpriteSwitcher))]
    public class Gs2RankingOwnScoreUniqueIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreUniqueIdSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingOwnScoreUniqueIdSpriteSwitcher.Expression.In || original.expression == Gs2RankingOwnScoreUniqueIdSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyUniqueIds"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyUniqueId"), true);
            }
