...
{
    [CustomEditor(typeof(Gs2RankingOwnScoreCategoryNameSpriteSwitcher))]
    public class Gs2RankingOwnScoreCategoryNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingOwnScoreCategoryNameSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingOwnScoreCategoryNameSpriteSwitcher.Expression.In || original.expression == Gs2RankingOwnScoreCategoryNameSpriteSwitcher.Expression.NotIn) {
