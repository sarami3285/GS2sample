...
{
    [CustomEditor(typeof(Gs2RankingNamespaceContext))]
    public class Gs2RankingNamespaceContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingNamespaceContext;
