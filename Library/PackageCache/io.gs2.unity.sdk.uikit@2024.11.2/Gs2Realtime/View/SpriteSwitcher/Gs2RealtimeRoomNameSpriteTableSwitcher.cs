...
namespace Gs2.Unity.UiKit.Gs2Realtime.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Realtime/Room/View/SpriteSwitcher/Properties/Name/Gs2RealtimeRoomNameSpriteTableSwitcher")]
    public partial class Gs2RealtimeRoomNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Room.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Room.Name).sprite);
            }
            else {
    ...
    public partial class Gs2RealtimeRoomNameSpriteTableSwitcher
    {
