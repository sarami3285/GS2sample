...
namespace Gs2.Unity.UiKit.Gs2Realtime.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Realtime/Room/View/SpriteSwitcher/Properties/EncryptionKey/Gs2RealtimeRoomEncryptionKeySpriteTableSwitcher")]
    public partial class Gs2RealtimeRoomEncryptionKeySpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Room.EncryptionKey) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Room.EncryptionKey).sprite);
            }
            else {
    ...
    public partial class Gs2RealtimeRoomEncryptionKeySpriteTableSwitcher
    {
