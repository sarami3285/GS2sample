...
namespace Gs2.Unity.UiKit.Gs2Realtime.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Realtime/Room/View/SpriteSwitcher/Properties/Name/Gs2RealtimeRoomNameSpriteSwitcher")]
    public partial class Gs2RealtimeRoomNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.Room?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.Room?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.Room?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2RealtimeRoomNameSpriteSwitcher
    {
