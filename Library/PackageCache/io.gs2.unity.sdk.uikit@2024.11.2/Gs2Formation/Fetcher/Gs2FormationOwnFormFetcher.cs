...
namespace Gs2.Unity.UiKit.Gs2Formation.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Form/Fetcher/Gs2FormationOwnFormFetcher")]
    public partial class Gs2FormationOwnFormFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Fetch()
        {
            ...
            yield return new WaitUntil(() => Context != null && this.Context.Form != null);
        ...
        public void SetTemporaryForm(
            Gs2.Unity.Gs2Formation.Model.EzForm form
        ) {
            Form = form;
            this.OnFetched.Invoke();
        }

        public void RollbackTemporaryForm(
        ) {
            OnUpdateContext();
        }
    }
