...
namespace Gs2.Unity.UiKit.Gs2Formation.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Mold/Fetcher/Gs2FormationOwnMoldListFetcher")]
    public partial class Gs2FormationOwnMoldListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeMolds(
                items =>
                {
                    Molds = items.ToList();
                    this.OnFetched.Invoke();
    ...
    public partial class Gs2FormationOwnMoldListFetcher
    {
        public Gs2FormationNamespaceContext Context;
