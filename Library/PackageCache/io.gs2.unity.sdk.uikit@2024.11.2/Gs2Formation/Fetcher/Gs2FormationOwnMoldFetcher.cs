...
namespace Gs2.Unity.UiKit.Gs2Formation.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Mold/Fetcher/Gs2FormationOwnMoldFetcher")]
    public partial class Gs2FormationOwnMoldFetcher : MonoBehaviour
    {
        private EzMoldGameSessionDomain _domain;
        ...
        private IEnumerator Fetch()
        {
            ...
            yield return new WaitUntil(() => Context != null && this.Context.Mold != null);
        ...
        public void SetTemporaryMold(
            Gs2.Unity.Gs2Formation.Model.EzMold mold
        ) {
            Mold = mold;
            this.OnFetched.Invoke();
        }

        public void RollbackTemporaryMold(
        ) {
            OnUpdateContext();
        }
    }
    ...
    public partial class Gs2FormationOwnMoldFetcher
    {
