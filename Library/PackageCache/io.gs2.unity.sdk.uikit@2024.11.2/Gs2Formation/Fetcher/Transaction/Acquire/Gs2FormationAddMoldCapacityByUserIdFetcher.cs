...
namespace Gs2.Unity.UiKit.Gs2Formation.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Mold/Fetcher/Acquire/Gs2FormationAddMoldCapacityByUserIdFetcher")]
    public partial class Gs2FormationAddMoldCapacityByUserIdFetcher : Gs2FormationOwnMoldContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Formation:AddMoldCapacityByUserId") {
                    Request = AddMoldCapacityByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Mold == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Formation:AddMoldCapacityByUserId");
                if (action != null) {
    ...
    public partial class Gs2FormationAddMoldCapacityByUserIdFetcher
    {
    ...
    public partial class Gs2FormationAddMoldCapacityByUserIdFetcher
    {
        public AddMoldCapacityByUserIdRequest Request { get; protected set; }
