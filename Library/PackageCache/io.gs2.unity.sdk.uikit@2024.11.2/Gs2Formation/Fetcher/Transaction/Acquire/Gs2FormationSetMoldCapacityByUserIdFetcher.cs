...
namespace Gs2.Unity.UiKit.Gs2Formation.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Mold/Fetcher/Acquire/Gs2FormationSetMoldCapacityByUserIdFetcher")]
    public partial class Gs2FormationSetMoldCapacityByUserIdFetcher : Gs2FormationOwnMoldContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Formation:SetMoldCapacityByUserId") {
                    Request = SetMoldCapacityByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Mold == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Formation:SetMoldCapacityByUserId");
                if (action != null) {
                    Request = SetMoldCapacityByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Mold == null || (
                            Mold.NamespaceName == Request.NamespaceName &&
                            Mold.MoldModelName == Request.MoldModelName)
                    ) {
    ...
    public partial class Gs2FormationSetMoldCapacityByUserIdFetcher
    {
    ...
    public partial class Gs2FormationSetMoldCapacityByUserIdFetcher
    {
        public SetMoldCapacityByUserIdRequest Request { get; protected set; }
