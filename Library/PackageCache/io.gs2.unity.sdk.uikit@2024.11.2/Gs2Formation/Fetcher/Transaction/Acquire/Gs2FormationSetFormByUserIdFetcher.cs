...
namespace Gs2.Unity.UiKit.Gs2Formation.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Form/Fetcher/Acquire/Gs2FormationSetFormByUserIdFetcher")]
    public partial class Gs2FormationSetFormByUserIdFetcher : Gs2FormationOwnFormContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Formation:SetFormByUserId") {
                    Request = SetFormByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Form == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Formation:SetFormByUserId");
                if (action != null) {
                    Request = SetFormByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Form == null || (
                            Form.NamespaceName == Request.NamespaceName &&
                            Form.MoldModelName == Request.MoldModelName &&
                            Form.Index == Request.Index)
    ...
    public partial class Gs2FormationSetFormByUserIdFetcher
    {
    ...
    public partial class Gs2FormationSetFormByUserIdFetcher
    {
        public SetFormByUserIdRequest Request { get; protected set; }
