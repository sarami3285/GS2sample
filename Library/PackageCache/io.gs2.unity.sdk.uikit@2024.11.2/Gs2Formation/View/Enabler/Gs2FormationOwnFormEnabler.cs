...
namespace Gs2.Unity.UiKit.Gs2Formation
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Form/View/Enabler/Gs2FormationOwnFormEnabler")]
    public partial class Gs2FormationOwnFormEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Form == null)
            {
    ...
    public partial class Gs2FormationOwnFormEnabler
    {
