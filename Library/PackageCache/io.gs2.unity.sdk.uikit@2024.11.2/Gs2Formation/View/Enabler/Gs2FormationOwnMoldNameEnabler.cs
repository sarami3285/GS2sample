...
namespace Gs2.Unity.UiKit.Gs2Formation.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Mold/View/Enabler/Properties/Name/Gs2FormationOwnMoldNameEnabler")]
    public partial class Gs2FormationOwnMoldNameEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableNames.Contains(this._fetcher.Mold?.Name ?? ""));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableNames.Contains(this._fetcher.Mold?.Name ?? ""));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive((this._fetcher.Mold?.Name ?? "").StartsWith(this.enableName));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive((this._fetcher.Mold?.Name ?? "").EndsWith(this.enableName));
                    break;
                default:
    ...
    public partial class Gs2FormationOwnMoldNameEnabler
    {
