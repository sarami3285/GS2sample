...
namespace Gs2.Unity.UiKit.Gs2Formation
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Mold/View/Enabler/Transaction/Gs2FormationSubMoldCapacityByUserIdEnabler")]
    public partial class Gs2FormationSubMoldCapacityByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Formation:SubMoldCapacityByUserId") == 0) {
    ...
    public partial class Gs2FormationSubMoldCapacityByUserIdEnabler
    {
