...
namespace Gs2.Unity.UiKit.Gs2Formation
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Form/View/Enabler/Transaction/Gs2FormationAcquireActionsToFormPropertiesEnabler")]
    public partial class Gs2FormationAcquireActionsToFormPropertiesEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Formation:AcquireActionsToFormProperties") == 0) {
    ...
    public partial class Gs2FormationAcquireActionsToFormPropertiesEnabler
    {
