...
namespace Gs2.Unity.UiKit.Gs2Formation
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/PropertyForm/View/Enabler/Transaction/Gs2FormationAcquireActionsToPropertyFormPropertiesEnabler")]
    public partial class Gs2FormationAcquireActionsToPropertyFormPropertiesEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Formation:AcquireActionsToPropertyFormProperties") == 0) {
    ...
    public partial class Gs2FormationAcquireActionsToPropertyFormPropertiesEnabler
    {
