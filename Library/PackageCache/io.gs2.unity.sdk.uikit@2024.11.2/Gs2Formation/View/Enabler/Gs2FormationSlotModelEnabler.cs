...
namespace Gs2.Unity.UiKit.Gs2Formation
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/SlotModel/View/Enabler/Gs2FormationSlotModelEnabler")]
    public partial class Gs2FormationSlotModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.SlotModel == null)
            {
    ...
    public partial class Gs2FormationSlotModelEnabler
    {
