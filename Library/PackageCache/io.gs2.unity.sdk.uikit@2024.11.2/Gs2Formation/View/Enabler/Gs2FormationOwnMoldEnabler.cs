...
namespace Gs2.Unity.UiKit.Gs2Formation
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Mold/View/Enabler/Gs2FormationOwnMoldEnabler")]
    public partial class Gs2FormationOwnMoldEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Mold == null)
            {
    ...
    public partial class Gs2FormationOwnMoldEnabler
    {
