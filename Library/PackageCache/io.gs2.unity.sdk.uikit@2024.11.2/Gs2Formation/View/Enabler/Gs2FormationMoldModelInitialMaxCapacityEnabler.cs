...
namespace Gs2.Unity.UiKit.Gs2Formation
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/MoldModel/View/Enabler/Properties/InitialMaxCapacity/Gs2FormationMoldModelInitialMaxCapacityEnabler")]
    public partial class Gs2FormationMoldModelInitialMaxCapacityEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableInitialMaxCapacities.Contains(this._fetcher.MoldModel.InitialMaxCapacity));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableInitialMaxCapacities.Contains(this._fetcher.MoldModel.InitialMaxCapacity));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableInitialMaxCapacity > this._fetcher.MoldModel.InitialMaxCapacity);
                    break;
