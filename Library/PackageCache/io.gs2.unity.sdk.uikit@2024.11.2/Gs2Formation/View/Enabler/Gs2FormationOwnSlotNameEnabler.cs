...
namespace Gs2.Unity.UiKit.Gs2Formation.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Slot/View/Enabler/Properties/Name/Gs2FormationOwnSlotNameEnabler")]
    public partial class Gs2FormationOwnSlotNameEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableNames.Contains(this._fetcher.Slot.Name));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableNames.Contains(this._fetcher.Slot.Name));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive(this._fetcher.Slot.Name.StartsWith(this.enableName));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive(this._fetcher.Slot.Name.EndsWith(this.enableName));
                    break;
            }
        }
    }
    ...
    public partial class Gs2FormationOwnSlotNameEnabler
    {
