...
namespace Gs2.Unity.UiKit.Gs2Formation.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Form/View/Enabler/Properties/Name/Gs2FormationOwnFormNameEnabler")]
    public partial class Gs2FormationOwnFormNameEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableNames.Contains(this._fetcher.Form?.Name ?? ""));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableNames.Contains(this._fetcher.Form?.Name ?? ""));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive((this._fetcher.Form?.Name ?? "").StartsWith(this.enableName));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive((this._fetcher.Form?.Name ?? "").EndsWith(this.enableName));
                    break;
                default:
    ...
    public partial class Gs2FormationOwnFormNameEnabler
    {
