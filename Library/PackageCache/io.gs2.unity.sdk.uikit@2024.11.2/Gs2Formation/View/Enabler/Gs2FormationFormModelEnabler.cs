...
namespace Gs2.Unity.UiKit.Gs2Formation
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/FormModel/View/Enabler/Gs2FormationFormModelEnabler")]
    public partial class Gs2FormationFormModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.FormModel == null)
            {
    ...
    public partial class Gs2FormationFormModelEnabler
    {
