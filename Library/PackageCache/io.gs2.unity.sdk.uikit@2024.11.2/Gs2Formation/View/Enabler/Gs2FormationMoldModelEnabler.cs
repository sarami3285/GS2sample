...
namespace Gs2.Unity.UiKit.Gs2Formation
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/MoldModel/View/Enabler/Gs2FormationMoldModelEnabler")]
    public partial class Gs2FormationMoldModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.MoldModel == null)
            {
    ...
    public partial class Gs2FormationMoldModelEnabler
    {
