...
namespace Gs2.Unity.UiKit.Gs2Formation
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Slot/View/Enabler/Gs2FormationOwnSlotEnabler")]
    public partial class Gs2FormationOwnSlotEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Slot == null)
            {
    ...
    public partial class Gs2FormationOwnSlotEnabler
    {
