...
namespace Gs2.Unity.UiKit.Gs2Formation
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/PropertyForm/View/Enabler/Gs2FormationOwnPropertyFormEnabler")]
    public partial class Gs2FormationOwnPropertyFormEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.PropertyForm == null)
            {
    ...
    public partial class Gs2FormationOwnPropertyFormEnabler
    {
