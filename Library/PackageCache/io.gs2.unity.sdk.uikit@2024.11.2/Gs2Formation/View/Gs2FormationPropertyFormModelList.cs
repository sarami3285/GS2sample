...
namespace Gs2.Unity.UiKit.Gs2Formation
{
        ...
        private void OnFetched() {
            for (var i = 0; i < this._children.Count; i++) {
                if (i < this._fetcher.PropertyFormModels.Count) {
                    this._children[i].SetPropertyFormModel(
    ...
    public partial class Gs2FormationPropertyFormModelList
    {
        ...
        public void Awake()
        {
            ...
            this._fetcher = GetComponent<Gs2FormationPropertyFormModelListFetcher>() ?? GetComponentInParent<Gs2FormationPropertyFormModelListFetcher>();
            if (this._fetcher == null) {
                Debug.LogError($"{gameObject.GetFullPath()}: Couldn't find the Gs2FormationPropertyFormModelListFetcher.");
                enabled = false;
            }

            this._children = new List<Gs2FormationPropertyFormModelContext>();
        ...
        public virtual bool HasError()
        {
            ...
            this._fetcher = GetComponent<Gs2FormationPropertyFormModelListFetcher>() ?? GetComponentInParent<Gs2FormationPropertyFormModelListFetcher>(true);
            if (this._fetcher == null) {
                return true;
            }
            return false;
