...
namespace Gs2.Unity.UiKit.Gs2Formation.Localization
{
    ...
    [AddComponentMenu("GS2 UIKit/Formation/FormModel/View/Localization/Gs2FormationFormModelLocalizationVariables")]
    public partial class Gs2FormationFormModelLocalizationVariables : MonoBehaviour
    {
        private void OnFetched()
        {
            this.target.StringReference["name"] = new StringVariable {
                Value = _fetcher?.FormModel?.Name ?? "",
            };
            this.target.StringReference["metadata"] = new StringVariable {
                Value = _fetcher?.FormModel?.Metadata ?? "",
            };
    ...
    public partial class Gs2FormationFormModelLocalizationVariables
    {
