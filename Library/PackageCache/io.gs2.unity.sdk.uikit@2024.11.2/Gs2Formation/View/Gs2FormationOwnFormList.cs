...
namespace Gs2.Unity.UiKit.Gs2Formation
{
    ...
    public partial class Gs2FormationOwnFormList
    {
        ...
        public void Awake()
        {
            ...
            this._fetcher = GetComponent<Gs2FormationOwnFormListFetcher>() ?? GetComponentInParent<Gs2FormationOwnFormListFetcher>();
            if (this._fetcher == null) {
                Debug.LogError($"{gameObject.GetFullPath()}: Couldn't find the Gs2FormationOwnFormListFetcher.");
                enabled = false;
            }

            this._children = new List<Gs2FormationOwnFormContext>();
        ...
        public virtual bool HasError()
        {
            ...
            this._fetcher = GetComponent<Gs2FormationOwnFormListFetcher>() ?? GetComponentInParent<Gs2FormationOwnFormListFetcher>(true);
            if (this._fetcher == null) {
                return true;
            }
            return false;
