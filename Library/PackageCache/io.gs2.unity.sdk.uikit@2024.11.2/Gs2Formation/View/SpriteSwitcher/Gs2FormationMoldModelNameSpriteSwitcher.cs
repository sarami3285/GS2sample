...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/MoldModel/View/SpriteSwitcher/Properties/Name/Gs2FormationMoldModelNameSpriteSwitcher")]
    public partial class Gs2FormationMoldModelNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.MoldModel?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.MoldModel?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.MoldModel?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2FormationMoldModelNameSpriteSwitcher
    {
