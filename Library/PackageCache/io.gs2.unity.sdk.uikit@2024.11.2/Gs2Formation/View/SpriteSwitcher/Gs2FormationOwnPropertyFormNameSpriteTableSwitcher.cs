...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
    ...
    public partial class Gs2FormationOwnPropertyFormNameSpriteTableSwitcher : MonoBehaviour
    {
        ...
        {
            if (this.sprites.Count(v => v.value == _fetcher.PropertyForm.Name) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.PropertyForm.Name).sprite);
            }
            else {
    ...
    public partial class Gs2FormationOwnPropertyFormNameSpriteTableSwitcher
    {
