...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/MoldModel/View/SpriteSwitcher/Properties/Metadata/Gs2FormationMoldModelMetadataSpriteTableSwitcher")]
    public partial class Gs2FormationMoldModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.MoldModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.MoldModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2FormationMoldModelMetadataSpriteTableSwitcher
    {
