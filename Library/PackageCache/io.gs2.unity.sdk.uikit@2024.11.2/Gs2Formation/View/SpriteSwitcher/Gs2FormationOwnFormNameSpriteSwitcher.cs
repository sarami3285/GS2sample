...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Form/View/SpriteSwitcher/Properties/Name/Gs2FormationOwnFormNameSpriteSwitcher")]
    public partial class Gs2FormationOwnFormNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.Form?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.Form?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.Form?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2FormationOwnFormNameSpriteSwitcher
    {
