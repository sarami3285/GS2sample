...
namespace Gs2.Unity.UiKit.Gs2Formation
{
    ...
    public partial class Gs2FormationOwnFormIndexSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyIndexes.Contains(this._fetcher.Form.Index)) {
                ...
                case Expression.Less:
                    if (this.applyIndex > this._fetcher.Form.Index) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
    ...
    public partial class Gs2FormationOwnFormIndexSpriteSwitcher
    {
