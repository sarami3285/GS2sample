...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Mold/View/SpriteSwitcher/Properties/Name/Gs2FormationOwnMoldNameSpriteTableSwitcher")]
    public partial class Gs2FormationOwnMoldNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Mold.Name) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Mold.Name).sprite);
            }
            else {
    ...
    public partial class Gs2FormationOwnMoldNameSpriteTableSwitcher
    {
