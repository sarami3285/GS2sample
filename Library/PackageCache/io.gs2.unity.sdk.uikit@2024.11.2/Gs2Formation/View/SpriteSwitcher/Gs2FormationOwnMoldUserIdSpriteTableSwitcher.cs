...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Mold/View/SpriteSwitcher/Properties/UserId/Gs2FormationOwnMoldUserIdSpriteTableSwitcher")]
    public partial class Gs2FormationOwnMoldUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Mold.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Mold.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2FormationOwnMoldUserIdSpriteTableSwitcher
    {
