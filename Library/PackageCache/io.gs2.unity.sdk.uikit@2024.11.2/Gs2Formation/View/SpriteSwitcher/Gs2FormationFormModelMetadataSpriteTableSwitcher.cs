...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/FormModel/View/SpriteSwitcher/Properties/Metadata/Gs2FormationFormModelMetadataSpriteTableSwitcher")]
    public partial class Gs2FormationFormModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.FormModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.FormModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2FormationFormModelMetadataSpriteTableSwitcher
    {
