...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/PropertyForm/View/SpriteSwitcher/Transaction/Properties/PropertyFormModelName/Gs2FormationAcquireActionsToPropertyFormPropertiesPropertyFormModelNameSpriteTableSwitcher")]
    public partial class Gs2FormationAcquireActionsToPropertyFormPropertiesPropertyFormModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.PropertyFormModelName) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.PropertyFormModelName).sprite);
            }
            else {
    ...
    public partial class Gs2FormationAcquireActionsToPropertyFormPropertiesPropertyFormModelNameSpriteTableSwitcher
    {
