...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/FormModel/View/SpriteSwitcher/Properties/Name/Gs2FormationFormModelNameSpriteSwitcher")]
    public partial class Gs2FormationFormModelNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.FormModel?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.FormModel?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.FormModel?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2FormationFormModelNameSpriteSwitcher
    {
