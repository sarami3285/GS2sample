...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Form/View/SpriteSwitcher/Properties/Name/Gs2FormationOwnFormNameSpriteTableSwitcher")]
    public partial class Gs2FormationOwnFormNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Form.Name) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Form.Name).sprite);
            }
            else {
    ...
    public partial class Gs2FormationOwnFormNameSpriteTableSwitcher
    {
