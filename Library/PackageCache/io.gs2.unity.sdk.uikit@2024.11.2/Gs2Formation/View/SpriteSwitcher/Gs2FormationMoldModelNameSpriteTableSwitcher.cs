...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/MoldModel/View/SpriteSwitcher/Properties/Name/Gs2FormationMoldModelNameSpriteTableSwitcher")]
    public partial class Gs2FormationMoldModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.MoldModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.MoldModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2FormationMoldModelNameSpriteTableSwitcher
    {
