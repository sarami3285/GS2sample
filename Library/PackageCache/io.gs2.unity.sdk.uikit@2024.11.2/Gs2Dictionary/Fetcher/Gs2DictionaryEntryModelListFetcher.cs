...
namespace Gs2.Unity.UiKit.Gs2Dictionary.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/EntryModel/Fetcher/Gs2DictionaryEntryModelListFetcher")]
    public partial class Gs2DictionaryEntryModelListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var items = new List<Gs2.Unity.Gs2Dictionary.Model.EzEntryModel>();
            while (it.HasNext())
            {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeEntryModels(
                items =>
                {
                    EntryModels = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2DictionaryEntryModelListFetcher
    {
        public Gs2DictionaryNamespaceContext Context { get; private set; }
    ...
    public partial class Gs2DictionaryEntryModelListFetcher
    {
        public List<Gs2.Unity.Gs2Dictionary.Model.EzEntryModel> EntryModels { get; private set; }
