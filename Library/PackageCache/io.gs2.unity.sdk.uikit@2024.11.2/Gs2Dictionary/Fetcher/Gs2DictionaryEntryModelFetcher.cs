...
namespace Gs2.Unity.UiKit.Gs2Dictionary.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/EntryModel/Fetcher/Gs2DictionaryEntryModelFetcher")]
    public partial class Gs2DictionaryEntryModelFetcher : MonoBehaviour
    {
        private EzEntryModelDomain _domain;
        ...
        private IEnumerator Fetch()
        {
            ...
            yield return new WaitUntil(() => Context != null && this.Context.EntryModel != null);
    ...
    public partial class Gs2DictionaryEntryModelFetcher
    {
    ...
    public partial class Gs2DictionaryEntryModelFetcher
    {
        public Gs2.Unity.Gs2Dictionary.Model.EzEntryModel EntryModel { get; protected set; }
