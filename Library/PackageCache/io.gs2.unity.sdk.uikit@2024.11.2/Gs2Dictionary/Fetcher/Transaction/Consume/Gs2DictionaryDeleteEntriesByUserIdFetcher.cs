...
namespace Gs2.Unity.UiKit.Gs2Dictionary.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/Entry/Fetcher/Consume/Gs2DictionaryDeleteEntriesByUserIdFetcher")]
    public partial class Gs2DictionaryDeleteEntriesByUserIdFetcher : Gs2DictionaryNamespaceContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Dictionary:DeleteEntriesByUserId") {
                    Request = DeleteEntriesByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Namespace == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Dictionary:DeleteEntriesByUserId");
                if (action != null) {
                    Request = DeleteEntriesByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Namespace == null || (
                            Namespace.NamespaceName == Request.NamespaceName)
                    ) {
                        Namespace = Namespace.New(
    ...
    public partial class Gs2DictionaryDeleteEntriesByUserIdFetcher
    {
    ...
    public partial class Gs2DictionaryDeleteEntriesByUserIdFetcher
    {
        public DeleteEntriesByUserIdRequest Request { get; protected set; }
