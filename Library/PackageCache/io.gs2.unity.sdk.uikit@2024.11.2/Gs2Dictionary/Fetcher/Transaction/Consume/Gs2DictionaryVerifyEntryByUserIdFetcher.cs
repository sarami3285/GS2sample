...
namespace Gs2.Unity.UiKit.Gs2Dictionary.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/Entry/Fetcher/Consume/Gs2DictionaryVerifyEntryByUserIdFetcher")]
    public partial class Gs2DictionaryVerifyEntryByUserIdFetcher : Gs2DictionaryNamespaceContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Dictionary:VerifyEntryByUserId") {
                    Request = VerifyEntryByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Namespace == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Dictionary:VerifyEntryByUserId");
                if (action != null) {
                    Request = VerifyEntryByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Namespace == null || (
                            Namespace.NamespaceName == Request.NamespaceName)
                    ) {
                        Namespace = Namespace.New(
    ...
    public partial class Gs2DictionaryVerifyEntryByUserIdFetcher
    {
    ...
    public partial class Gs2DictionaryVerifyEntryByUserIdFetcher
    {
        public VerifyEntryByUserIdRequest Request { get; protected set; }
