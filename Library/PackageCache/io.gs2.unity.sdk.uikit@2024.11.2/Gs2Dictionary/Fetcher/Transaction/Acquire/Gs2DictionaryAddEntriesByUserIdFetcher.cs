    ...
    public partial class Gs2DictionaryAddEntriesByUserIdFetcher : Gs2DictionaryNamespaceContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Dictionary:AddEntriesByUserId") {
                    Request = AddEntriesByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Namespace == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Dictionary:AddEntriesByUserId");
                if (action != null) {
