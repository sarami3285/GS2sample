...
namespace Gs2.Unity.UiKit.Gs2Dictionary
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/Entry/View/Enabler/Transaction/Gs2DictionaryAddEntriesByUserIdEnabler")]
    public partial class Gs2DictionaryAddEntriesByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Dictionary:AddEntriesByUserId") == 0) {
    ...
    public partial class Gs2DictionaryAddEntriesByUserIdEnabler
    {
