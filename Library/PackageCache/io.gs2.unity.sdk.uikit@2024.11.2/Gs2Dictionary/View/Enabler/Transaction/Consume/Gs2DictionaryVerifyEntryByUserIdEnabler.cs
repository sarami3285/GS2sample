...
namespace Gs2.Unity.UiKit.Gs2Dictionary
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/Entry/View/Enabler/Transaction/Gs2DictionaryVerifyEntryByUserIdEnabler")]
    public partial class Gs2DictionaryVerifyEntryByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Dictionary:VerifyEntryByUserId") == 0) {
    ...
    public partial class Gs2DictionaryVerifyEntryByUserIdEnabler
    {
