...
namespace Gs2.Unity.UiKit.Gs2Dictionary
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/Entry/View/Enabler/Gs2DictionaryOwnEntryEnabler")]
    public partial class Gs2DictionaryOwnEntryEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Entry == null)
            {
    ...
    public partial class Gs2DictionaryOwnEntryEnabler
    {
