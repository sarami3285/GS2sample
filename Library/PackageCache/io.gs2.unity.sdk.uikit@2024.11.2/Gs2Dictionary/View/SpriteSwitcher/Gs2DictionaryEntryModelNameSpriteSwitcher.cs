...
namespace Gs2.Unity.UiKit.Gs2Dictionary.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/EntryModel/View/SpriteSwitcher/Properties/Name/Gs2DictionaryEntryModelNameSpriteSwitcher")]
    public partial class Gs2DictionaryEntryModelNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.EntryModel?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.EntryModel?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.EntryModel?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2DictionaryEntryModelNameSpriteSwitcher
    {
