...
namespace Gs2.Unity.UiKit.Gs2Dictionary.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/Entry/View/SpriteSwitcher/Properties/Name/Gs2DictionaryOwnEntryNameSpriteTableSwitcher")]
    public partial class Gs2DictionaryOwnEntryNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Entry.Name) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Entry.Name).sprite);
            }
            else {
    ...
    public partial class Gs2DictionaryOwnEntryNameSpriteTableSwitcher
    {
