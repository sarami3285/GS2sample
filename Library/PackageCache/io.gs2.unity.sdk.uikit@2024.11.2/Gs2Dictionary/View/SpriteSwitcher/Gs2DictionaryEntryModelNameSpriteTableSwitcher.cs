...
namespace Gs2.Unity.UiKit.Gs2Dictionary.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/EntryModel/View/SpriteSwitcher/Properties/Name/Gs2DictionaryEntryModelNameSpriteTableSwitcher")]
    public partial class Gs2DictionaryEntryModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.EntryModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.EntryModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2DictionaryEntryModelNameSpriteTableSwitcher
    {
