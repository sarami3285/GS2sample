...
namespace Gs2.Unity.UiKit.Gs2Dictionary.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/Entry/View/SpriteSwitcher/Properties/UserId/Gs2DictionaryOwnEntryUserIdSpriteSwitcher")]
    public partial class Gs2DictionaryOwnEntryUserIdSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyUserIds.Contains(this._fetcher.Entry?.UserId ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.Entry?.UserId ?? "").StartsWith(this.applyUserId)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.Entry?.UserId ?? "").EndsWith(this.applyUserId)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2DictionaryOwnEntryUserIdSpriteSwitcher
    {
