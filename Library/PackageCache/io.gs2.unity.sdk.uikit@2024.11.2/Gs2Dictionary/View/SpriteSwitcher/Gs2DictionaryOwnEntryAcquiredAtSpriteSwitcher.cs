...
namespace Gs2.Unity.UiKit.Gs2Dictionary
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/Entry/View/SpriteSwitcher/Properties/AcquiredAt/Gs2DictionaryOwnEntryAcquiredAtSpriteSwitcher")]
    public partial class Gs2DictionaryOwnEntryAcquiredAtSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyAcquiredAts.Contains(this._fetcher.Entry.AcquiredAt)) {
                ...
                case Expression.Less:
                    if (this.applyAcquiredAt > this._fetcher.Entry.AcquiredAt) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
    ...
    public partial class Gs2DictionaryOwnEntryAcquiredAtSpriteSwitcher
    {
