    ...
    public partial class Gs2MoneyDepositByUserIdFetcher : Gs2MoneyOwnWalletContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Money:DepositByUserId") {
                    Request = DepositByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Wallet == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Money:DepositByUserId");
                if (action != null) {
