    ...
    public partial class Gs2MoneyWithdrawByUserIdFetcher : Gs2MoneyOwnWalletContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Money:WithdrawByUserId") {
                    Request = WithdrawByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Wallet == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Money:WithdrawByUserId");
                if (action != null) {
