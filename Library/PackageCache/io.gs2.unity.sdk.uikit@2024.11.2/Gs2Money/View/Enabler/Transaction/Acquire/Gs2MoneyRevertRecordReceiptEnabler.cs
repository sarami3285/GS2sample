...
namespace Gs2.Unity.UiKit.Gs2Money
{
	...
	[AddComponentMenu("GS2 UIKit/Money/Receipt/View/Enabler/Transaction/Gs2MoneyRevertRecordReceiptEnabler")]
    public partial class Gs2MoneyRevertRecordReceiptEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Money:RevertRecordReceipt") == 0) {
    ...
    public partial class Gs2MoneyRevertRecordReceiptEnabler
    {
