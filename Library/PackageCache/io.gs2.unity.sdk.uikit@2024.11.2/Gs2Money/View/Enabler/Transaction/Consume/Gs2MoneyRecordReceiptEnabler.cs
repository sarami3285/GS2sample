...
namespace Gs2.Unity.UiKit.Gs2Money
{
	...
	[AddComponentMenu("GS2 UIKit/Money/Receipt/View/Enabler/Transaction/Gs2MoneyRecordReceiptEnabler")]
    public partial class Gs2MoneyRecordReceiptEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Money:RecordReceipt") == 0) {
    ...
    public partial class Gs2MoneyRecordReceiptEnabler
    {
