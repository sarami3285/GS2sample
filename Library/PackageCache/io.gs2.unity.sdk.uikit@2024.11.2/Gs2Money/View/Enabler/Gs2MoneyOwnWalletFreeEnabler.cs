...
namespace Gs2.Unity.UiKit.Gs2Money
{
	...
	[AddComponentMenu("GS2 UIKit/Money/Wallet/View/Enabler/Properties/Free/Gs2MoneyOwnWalletFreeEnabler")]
    public partial class Gs2MoneyOwnWalletFreeEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableFrees.Contains(this._fetcher.Wallet.Free));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableFrees.Contains(this._fetcher.Wallet.Free));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableFree > this._fetcher.Wallet.Free);
                    break;
    ...
    public partial class Gs2MoneyOwnWalletFreeEnabler
    {
