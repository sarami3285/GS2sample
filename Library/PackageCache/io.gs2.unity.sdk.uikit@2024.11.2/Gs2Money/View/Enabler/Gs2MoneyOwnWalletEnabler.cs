...
namespace Gs2.Unity.UiKit.Gs2Money
{
	...
	[AddComponentMenu("GS2 UIKit/Money/Wallet/View/Enabler/Gs2MoneyOwnWalletEnabler")]
    public partial class Gs2MoneyOwnWalletEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Wallet == null)
            {
    ...
    public partial class Gs2MoneyOwnWalletEnabler
    {
