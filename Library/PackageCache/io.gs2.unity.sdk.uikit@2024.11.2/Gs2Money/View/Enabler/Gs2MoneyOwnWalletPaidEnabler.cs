...
namespace Gs2.Unity.UiKit.Gs2Money
{
	...
	[AddComponentMenu("GS2 UIKit/Money/Wallet/View/Enabler/Properties/Paid/Gs2MoneyOwnWalletPaidEnabler")]
    public partial class Gs2MoneyOwnWalletPaidEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enablePaids.Contains(this._fetcher.Wallet.Paid));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enablePaids.Contains(this._fetcher.Wallet.Paid));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enablePaid > this._fetcher.Wallet.Paid);
                    break;
    ...
    public partial class Gs2MoneyOwnWalletPaidEnabler
    {
