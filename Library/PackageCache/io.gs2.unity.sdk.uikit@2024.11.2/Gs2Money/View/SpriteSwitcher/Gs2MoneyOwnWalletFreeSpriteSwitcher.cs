...
namespace Gs2.Unity.UiKit.Gs2Money
{
	...
	[AddComponentMenu("GS2 UIKit/Money/Wallet/View/SpriteSwitcher/Properties/Free/Gs2MoneyOwnWalletFreeSpriteSwitcher")]
    public partial class Gs2MoneyOwnWalletFreeSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyFrees.Contains(this._fetcher.Wallet.Free)) {
                ...
                case Expression.Less:
                    if (this.applyFree > this._fetcher.Wallet.Free) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
    ...
    public partial class Gs2MoneyOwnWalletFreeSpriteSwitcher
    {
