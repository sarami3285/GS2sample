...
namespace Gs2.Unity.UiKit.Gs2SeasonRating.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/SeasonRating/SeasonModel/View/SpriteSwitcher/Properties/Metadata/Gs2SeasonRatingSeasonModelMetadataSpriteTableSwitcher")]
    public partial class Gs2SeasonRatingSeasonModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.SeasonModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.SeasonModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2SeasonRatingSeasonModelMetadataSpriteTableSwitcher
    {
