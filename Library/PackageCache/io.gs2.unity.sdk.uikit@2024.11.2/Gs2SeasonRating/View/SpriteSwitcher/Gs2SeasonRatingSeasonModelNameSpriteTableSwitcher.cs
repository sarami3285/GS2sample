...
namespace Gs2.Unity.UiKit.Gs2SeasonRating.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/SeasonRating/SeasonModel/View/SpriteSwitcher/Properties/Name/Gs2SeasonRatingSeasonModelNameSpriteTableSwitcher")]
    public partial class Gs2SeasonRatingSeasonModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.SeasonModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.SeasonModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2SeasonRatingSeasonModelNameSpriteTableSwitcher
    {
