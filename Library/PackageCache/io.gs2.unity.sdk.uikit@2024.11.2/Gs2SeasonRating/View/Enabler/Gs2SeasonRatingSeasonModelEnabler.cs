...
namespace Gs2.Unity.UiKit.Gs2SeasonRating
{
	...
	[AddComponentMenu("GS2 UIKit/SeasonRating/SeasonModel/View/Enabler/Gs2SeasonRatingSeasonModelEnabler")]
    public partial class Gs2SeasonRatingSeasonModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.SeasonModel == null)
            {
    ...
    public partial class Gs2SeasonRatingSeasonModelEnabler
    {
