...
namespace Gs2.Unity.UiKit.Gs2SeasonRating.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/SeasonRating/SeasonModel/View/Enabler/Properties/Metadata/Gs2SeasonRatingSeasonModelMetadataEnabler")]
    public partial class Gs2SeasonRatingSeasonModelMetadataEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableMetadatas.Contains(this._fetcher.SeasonModel?.Metadata ?? ""));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableMetadatas.Contains(this._fetcher.SeasonModel?.Metadata ?? ""));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive((this._fetcher.SeasonModel?.Metadata ?? "").StartsWith(this.enableMetadata));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive((this._fetcher.SeasonModel?.Metadata ?? "").EndsWith(this.enableMetadata));
                    break;
                default:
    ...
    public partial class Gs2SeasonRatingSeasonModelMetadataEnabler
    {
