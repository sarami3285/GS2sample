...
namespace Gs2.Unity.UiKit.Gs2SeasonRating
{
	...
	[AddComponentMenu("GS2 UIKit/SeasonRating/SeasonModel/View/Label/Gs2SeasonRatingSeasonModelLabel")]
    public partial class Gs2SeasonRatingSeasonModelLabel : MonoBehaviour
    {
        private void OnFetched()
        {
            this.onUpdate?.Invoke(
                this.format.Replace(
                    ...
                    "{tiers}", $"{this._fetcher?.SeasonModel?.Tiers}"
                ).Replace(
    ...
    public partial class Gs2SeasonRatingSeasonModelLabel
    {
