...
namespace Gs2.Unity.UiKit.Gs2Datastore.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Datastore/DataObject/View/SpriteSwitcher/Properties/Status/Gs2DatastoreOwnDataObjectStatusSpriteSwitcher")]
    public partial class Gs2DatastoreOwnDataObjectStatusSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyStatuses.Contains(this._fetcher.DataObject?.Status ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.DataObject?.Status ?? "").StartsWith(this.applyStatus)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.DataObject?.Status ?? "").EndsWith(this.applyStatus)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2DatastoreOwnDataObjectStatusSpriteSwitcher
    {
