...
namespace Gs2.Unity.UiKit.Gs2Datastore.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Datastore/DataObjectHistory/View/SpriteSwitcher/Properties/Generation/Gs2DatastoreOwnDataObjectHistoryGenerationSpriteTableSwitcher")]
    public partial class Gs2DatastoreOwnDataObjectHistoryGenerationSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.DataObjectHistory.Generation) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.DataObjectHistory.Generation).sprite);
            }
            else {
    ...
    public partial class Gs2DatastoreOwnDataObjectHistoryGenerationSpriteTableSwitcher
    {
