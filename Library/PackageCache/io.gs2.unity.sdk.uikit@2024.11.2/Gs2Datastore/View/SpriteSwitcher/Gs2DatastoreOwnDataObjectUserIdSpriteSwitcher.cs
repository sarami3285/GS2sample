...
namespace Gs2.Unity.UiKit.Gs2Datastore.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Datastore/DataObject/View/SpriteSwitcher/Properties/UserId/Gs2DatastoreOwnDataObjectUserIdSpriteSwitcher")]
    public partial class Gs2DatastoreOwnDataObjectUserIdSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyUserIds.Contains(this._fetcher.DataObject?.UserId ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.DataObject?.UserId ?? "").StartsWith(this.applyUserId)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.DataObject?.UserId ?? "").EndsWith(this.applyUserId)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2DatastoreOwnDataObjectUserIdSpriteSwitcher
    {
