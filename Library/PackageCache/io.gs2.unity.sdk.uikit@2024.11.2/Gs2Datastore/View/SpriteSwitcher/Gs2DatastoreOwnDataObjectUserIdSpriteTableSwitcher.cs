...
namespace Gs2.Unity.UiKit.Gs2Datastore.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Datastore/DataObject/View/SpriteSwitcher/Properties/UserId/Gs2DatastoreOwnDataObjectUserIdSpriteTableSwitcher")]
    public partial class Gs2DatastoreOwnDataObjectUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.DataObject.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.DataObject.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2DatastoreOwnDataObjectUserIdSpriteTableSwitcher
    {
