...
namespace Gs2.Unity.UiKit.Gs2Datastore.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Datastore/DataObject/View/SpriteSwitcher/Properties/Scope/Gs2DatastoreOwnDataObjectScopeSpriteTableSwitcher")]
    public partial class Gs2DatastoreOwnDataObjectScopeSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.DataObject.Scope) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.DataObject.Scope).sprite);
            }
            else {
    ...
    public partial class Gs2DatastoreOwnDataObjectScopeSpriteTableSwitcher
    {
