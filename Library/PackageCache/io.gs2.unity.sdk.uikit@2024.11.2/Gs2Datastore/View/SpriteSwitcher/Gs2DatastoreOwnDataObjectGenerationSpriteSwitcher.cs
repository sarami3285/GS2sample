...
namespace Gs2.Unity.UiKit.Gs2Datastore.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Datastore/DataObject/View/SpriteSwitcher/Properties/Generation/Gs2DatastoreOwnDataObjectGenerationSpriteSwitcher")]
    public partial class Gs2DatastoreOwnDataObjectGenerationSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyGenerations.Contains(this._fetcher.DataObject?.Generation ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.DataObject?.Generation ?? "").StartsWith(this.applyGeneration)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.DataObject?.Generation ?? "").EndsWith(this.applyGeneration)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2DatastoreOwnDataObjectGenerationSpriteSwitcher
    {
