...
namespace Gs2.Unity.UiKit.Gs2Datastore.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Datastore/DataObject/View/SpriteSwitcher/Properties/Status/Gs2DatastoreOwnDataObjectStatusSpriteTableSwitcher")]
    public partial class Gs2DatastoreOwnDataObjectStatusSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.DataObject.Status) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.DataObject.Status).sprite);
            }
            else {
    ...
    public partial class Gs2DatastoreOwnDataObjectStatusSpriteTableSwitcher
    {
