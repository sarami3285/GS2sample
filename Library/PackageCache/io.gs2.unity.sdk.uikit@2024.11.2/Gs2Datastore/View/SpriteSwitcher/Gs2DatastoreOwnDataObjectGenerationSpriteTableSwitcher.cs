...
namespace Gs2.Unity.UiKit.Gs2Datastore.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Datastore/DataObject/View/SpriteSwitcher/Properties/Generation/Gs2DatastoreOwnDataObjectGenerationSpriteTableSwitcher")]
    public partial class Gs2DatastoreOwnDataObjectGenerationSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.DataObject.Generation) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.DataObject.Generation).sprite);
            }
            else {
    ...
    public partial class Gs2DatastoreOwnDataObjectGenerationSpriteTableSwitcher
    {
