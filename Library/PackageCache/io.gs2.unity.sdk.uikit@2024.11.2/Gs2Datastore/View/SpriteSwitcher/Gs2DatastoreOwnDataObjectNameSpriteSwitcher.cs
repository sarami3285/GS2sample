...
namespace Gs2.Unity.UiKit.Gs2Datastore.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Datastore/DataObject/View/SpriteSwitcher/Properties/Name/Gs2DatastoreOwnDataObjectNameSpriteSwitcher")]
    public partial class Gs2DatastoreOwnDataObjectNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.DataObject?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.DataObject?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.DataObject?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2DatastoreOwnDataObjectNameSpriteSwitcher
    {
