...
namespace Gs2.Unity.UiKit.Gs2Datastore.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Datastore/DataObject/View/SpriteSwitcher/Properties/Name/Gs2DatastoreOwnDataObjectNameSpriteTableSwitcher")]
    public partial class Gs2DatastoreOwnDataObjectNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.DataObject.Name) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.DataObject.Name).sprite);
            }
            else {
    ...
    public partial class Gs2DatastoreOwnDataObjectNameSpriteTableSwitcher
    {
