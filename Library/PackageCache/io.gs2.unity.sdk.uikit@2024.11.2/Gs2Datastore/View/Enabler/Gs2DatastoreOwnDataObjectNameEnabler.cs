...
namespace Gs2.Unity.UiKit.Gs2Datastore.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Datastore/DataObject/View/Enabler/Properties/Name/Gs2DatastoreOwnDataObjectNameEnabler")]
    public partial class Gs2DatastoreOwnDataObjectNameEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableNames.Contains(this._fetcher.DataObject?.Name ?? ""));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableNames.Contains(this._fetcher.DataObject?.Name ?? ""));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive((this._fetcher.DataObject?.Name ?? "").StartsWith(this.enableName));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive((this._fetcher.DataObject?.Name ?? "").EndsWith(this.enableName));
                    break;
                default:
    ...
    public partial class Gs2DatastoreOwnDataObjectNameEnabler
    {
