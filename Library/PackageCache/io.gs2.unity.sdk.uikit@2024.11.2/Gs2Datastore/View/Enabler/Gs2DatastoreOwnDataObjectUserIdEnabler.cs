...
namespace Gs2.Unity.UiKit.Gs2Datastore.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Datastore/DataObject/View/Enabler/Properties/UserId/Gs2DatastoreOwnDataObjectUserIdEnabler")]
    public partial class Gs2DatastoreOwnDataObjectUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableUserIds.Contains(this._fetcher.DataObject?.UserId ?? ""));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableUserIds.Contains(this._fetcher.DataObject?.UserId ?? ""));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive((this._fetcher.DataObject?.UserId ?? "").StartsWith(this.enableUserId));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive((this._fetcher.DataObject?.UserId ?? "").EndsWith(this.enableUserId));
                    break;
                default:
    ...
    public partial class Gs2DatastoreOwnDataObjectUserIdEnabler
    {
