...
namespace Gs2.Unity.UiKit.Gs2Datastore
{
	...
	[AddComponentMenu("GS2 UIKit/Datastore/DataObjectHistory/View/Enabler/Gs2DatastoreOwnDataObjectHistoryEnabler")]
    public partial class Gs2DatastoreOwnDataObjectHistoryEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.DataObjectHistory == null)
            {
    ...
    public partial class Gs2DatastoreOwnDataObjectHistoryEnabler
    {
