...
namespace Gs2.Unity.UiKit.Gs2Enchant.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/RarityParameterStatus/Fetcher/Gs2EnchantOwnRarityParameterStatusListFetcher")]
    public partial class Gs2EnchantOwnRarityParameterStatusListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var it = _domain.RarityParameterStatuses();
            var items = new List<Gs2.Unity.Gs2Enchant.Model.EzRarityParameterStatus>();
            while (it.HasNext())
            {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeRarityParameterStatuses(
                items =>
                {
                    RarityParameterStatuses = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2EnchantOwnRarityParameterStatusListFetcher
    {
    ...
    public partial class Gs2EnchantOwnRarityParameterStatusListFetcher
    {
        public List<Gs2.Unity.Gs2Enchant.Model.EzRarityParameterStatus> RarityParameterStatuses { get; private set; }
