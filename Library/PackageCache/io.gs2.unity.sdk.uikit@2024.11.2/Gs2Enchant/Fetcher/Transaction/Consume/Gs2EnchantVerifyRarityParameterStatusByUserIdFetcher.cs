    ...
    public partial class Gs2EnchantVerifyRarityParameterStatusByUserIdFetcher : Gs2EnchantOwnRarityParameterStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Enchant:VerifyRarityParameterStatusByUserId") {
                    Request = VerifyRarityParameterStatusByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Enchant:VerifyRarityParameterStatusByUserId");
                if (action != null) {
