...
namespace Gs2.Unity.UiKit.Gs2Enchant.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/RarityParameterStatus/Fetcher/Acquire/Gs2EnchantSetRarityParameterStatusByUserIdFetcher")]
    public partial class Gs2EnchantSetRarityParameterStatusByUserIdFetcher : Gs2EnchantOwnRarityParameterStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Enchant:SetRarityParameterStatusByUserId") {
                    Request = SetRarityParameterStatusByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Enchant:SetRarityParameterStatusByUserId");
                if (action != null) {
                    Request = SetRarityParameterStatusByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (RarityParameterStatus == null || (
                            RarityParameterStatus.NamespaceName == Request.NamespaceName &&
                            RarityParameterStatus.ParameterName == Request.ParameterName &&
                            RarityParameterStatus.PropertyId == Request.PropertyId)
    ...
    public partial class Gs2EnchantSetRarityParameterStatusByUserIdFetcher
    {
    ...
    public partial class Gs2EnchantSetRarityParameterStatusByUserIdFetcher
    {
        public SetRarityParameterStatusByUserIdRequest Request { get; protected set; }
