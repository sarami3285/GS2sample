    ...
    public partial class Gs2EnchantSetBalanceParameterStatusByUserIdFetcher : Gs2EnchantOwnBalanceParameterStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Enchant:SetBalanceParameterStatusByUserId") {
                    Request = SetBalanceParameterStatusByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Enchant:SetBalanceParameterStatusByUserId");
                if (action != null) {
