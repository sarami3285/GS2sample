    ...
    public partial class Gs2EnchantReDrawRarityParameterStatusByUserIdFetcher : Gs2EnchantOwnRarityParameterStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Enchant:ReDrawRarityParameterStatusByUserId") {
                    Request = ReDrawRarityParameterStatusByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Enchant:ReDrawRarityParameterStatusByUserId");
                if (action != null) {
