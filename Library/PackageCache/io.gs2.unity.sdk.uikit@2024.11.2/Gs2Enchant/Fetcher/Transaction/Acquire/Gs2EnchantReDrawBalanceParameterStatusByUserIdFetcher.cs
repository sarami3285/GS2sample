...
namespace Gs2.Unity.UiKit.Gs2Enchant.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterStatus/Fetcher/Acquire/Gs2EnchantReDrawBalanceParameterStatusByUserIdFetcher")]
    public partial class Gs2EnchantReDrawBalanceParameterStatusByUserIdFetcher : Gs2EnchantOwnBalanceParameterStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Enchant:ReDrawBalanceParameterStatusByUserId") {
                    Request = ReDrawBalanceParameterStatusByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Enchant:ReDrawBalanceParameterStatusByUserId");
                if (action != null) {
                    Request = ReDrawBalanceParameterStatusByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (BalanceParameterStatus == null || (
                            BalanceParameterStatus.NamespaceName == Request.NamespaceName &&
                            BalanceParameterStatus.ParameterName == Request.ParameterName &&
                            BalanceParameterStatus.PropertyId == Request.PropertyId)
    ...
    public partial class Gs2EnchantReDrawBalanceParameterStatusByUserIdFetcher
    {
    ...
    public partial class Gs2EnchantReDrawBalanceParameterStatusByUserIdFetcher
    {
        public ReDrawBalanceParameterStatusByUserIdRequest Request { get; protected set; }
