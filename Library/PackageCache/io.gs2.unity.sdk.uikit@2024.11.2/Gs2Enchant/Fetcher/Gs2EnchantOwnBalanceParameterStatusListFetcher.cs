...
namespace Gs2.Unity.UiKit.Gs2Enchant.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterStatus/Fetcher/Gs2EnchantOwnBalanceParameterStatusListFetcher")]
    public partial class Gs2EnchantOwnBalanceParameterStatusListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var it = _domain.BalanceParameterStatuses();
            var items = new List<Gs2.Unity.Gs2Enchant.Model.EzBalanceParameterStatus>();
            while (it.HasNext())
            {
            ...
            retryWaitSecond = 1;
            BalanceParameterStatuses = items;
            Fetched = true;
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeBalanceParameterStatuses(
                items =>
                {
                    BalanceParameterStatuses = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2EnchantOwnBalanceParameterStatusListFetcher
    {
        public Gs2EnchantNamespaceContext Context;
    ...
    public partial class Gs2EnchantOwnBalanceParameterStatusListFetcher
    {
        public List<Gs2.Unity.Gs2Enchant.Model.EzBalanceParameterStatus> BalanceParameterStatuses { get; private set; }
