...
namespace Gs2.Unity.UiKit.Gs2Enchant
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/RarityParameterStatus/View/Enabler/Transaction/Gs2EnchantVerifyRarityParameterStatusByUserIdEnabler")]
    public partial class Gs2EnchantVerifyRarityParameterStatusByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Enchant:VerifyRarityParameterStatusByUserId") == 0) {
    ...
    public partial class Gs2EnchantVerifyRarityParameterStatusByUserIdEnabler
    {
