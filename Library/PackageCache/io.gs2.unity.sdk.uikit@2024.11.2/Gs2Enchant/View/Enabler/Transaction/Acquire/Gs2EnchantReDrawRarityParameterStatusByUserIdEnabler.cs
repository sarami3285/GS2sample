...
namespace Gs2.Unity.UiKit.Gs2Enchant
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/RarityParameterStatus/View/Enabler/Transaction/Gs2EnchantReDrawRarityParameterStatusByUserIdEnabler")]
    public partial class Gs2EnchantReDrawRarityParameterStatusByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Enchant:ReDrawRarityParameterStatusByUserId") == 0) {
    ...
    public partial class Gs2EnchantReDrawRarityParameterStatusByUserIdEnabler
    {
