...
namespace Gs2.Unity.UiKit.Gs2Enchant
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/RarityParameterStatus/View/Enabler/Transaction/Gs2EnchantSetRarityParameterStatusByUserIdEnabler")]
    public partial class Gs2EnchantSetRarityParameterStatusByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Enchant:SetRarityParameterStatusByUserId") == 0) {
    ...
    public partial class Gs2EnchantSetRarityParameterStatusByUserIdEnabler
    {
