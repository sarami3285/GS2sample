...
namespace Gs2.Unity.UiKit.Gs2Enchant
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterStatus/View/Enabler/Transaction/Gs2EnchantSetBalanceParameterStatusByUserIdEnabler")]
    public partial class Gs2EnchantSetBalanceParameterStatusByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Enchant:SetBalanceParameterStatusByUserId") == 0) {
    ...
    public partial class Gs2EnchantSetBalanceParameterStatusByUserIdEnabler
    {
