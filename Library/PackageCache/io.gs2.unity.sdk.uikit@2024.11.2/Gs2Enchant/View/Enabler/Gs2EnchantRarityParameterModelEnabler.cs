...
namespace Gs2.Unity.UiKit.Gs2Enchant
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/RarityParameterModel/View/Enabler/Gs2EnchantRarityParameterModelEnabler")]
    public partial class Gs2EnchantRarityParameterModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.RarityParameterModel == null)
            {
    ...
    public partial class Gs2EnchantRarityParameterModelEnabler
    {
