...
namespace Gs2.Unity.UiKit.Gs2Enchant
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterModel/View/Enabler/Gs2EnchantBalanceParameterModelEnabler")]
    public partial class Gs2EnchantBalanceParameterModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.BalanceParameterModel == null)
            {
    ...
    public partial class Gs2EnchantBalanceParameterModelEnabler
    {
