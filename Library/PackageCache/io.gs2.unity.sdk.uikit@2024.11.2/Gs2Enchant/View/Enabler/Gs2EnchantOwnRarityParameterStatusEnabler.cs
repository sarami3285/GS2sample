...
namespace Gs2.Unity.UiKit.Gs2Enchant
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/RarityParameterStatus/View/Enabler/Gs2EnchantOwnRarityParameterStatusEnabler")]
    public partial class Gs2EnchantOwnRarityParameterStatusEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.RarityParameterStatus == null)
            {
    ...
    public partial class Gs2EnchantOwnRarityParameterStatusEnabler
    {
