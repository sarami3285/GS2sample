...
namespace Gs2.Unity.UiKit.Gs2Enchant.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterModel/View/Enabler/Properties/Name/Gs2EnchantBalanceParameterModelNameEnabler")]
    public partial class Gs2EnchantBalanceParameterModelNameEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableNames.Contains(this._fetcher.BalanceParameterModel?.Name ?? ""));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableNames.Contains(this._fetcher.BalanceParameterModel?.Name ?? ""));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive((this._fetcher.BalanceParameterModel?.Name ?? "").StartsWith(this.enableName));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive((this._fetcher.BalanceParameterModel?.Name ?? "").EndsWith(this.enableName));
                    break;
                default:
    ...
    public partial class Gs2EnchantBalanceParameterModelNameEnabler
    {
