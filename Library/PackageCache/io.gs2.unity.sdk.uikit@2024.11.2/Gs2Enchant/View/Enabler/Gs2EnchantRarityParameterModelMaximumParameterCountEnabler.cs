...
namespace Gs2.Unity.UiKit.Gs2Enchant
{
    ...
    public partial class Gs2EnchantRarityParameterModelMaximumParameterCountEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableMaximumParameterCounts.Contains(this._fetcher.RarityParameterModel.MaximumParameterCount));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableMaximumParameterCounts.Contains(this._fetcher.RarityParameterModel.MaximumParameterCount));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableMaximumParameterCount > this._fetcher.RarityParameterModel.MaximumParameterCount);
                    break;
