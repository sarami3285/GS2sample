...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterStatus/View/SpriteSwitcher/Properties/PropertyId/Gs2EnchantOwnBalanceParameterStatusPropertyIdSpriteTableSwitcher")]
    public partial class Gs2EnchantOwnBalanceParameterStatusPropertyIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.BalanceParameterStatus.PropertyId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.BalanceParameterStatus.PropertyId).sprite);
            }
            else {
    ...
    public partial class Gs2EnchantOwnBalanceParameterStatusPropertyIdSpriteTableSwitcher
    {
