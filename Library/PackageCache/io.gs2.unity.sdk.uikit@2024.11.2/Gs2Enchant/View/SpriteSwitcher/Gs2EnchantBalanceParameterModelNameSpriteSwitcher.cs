...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterModel/View/SpriteSwitcher/Properties/Name/Gs2EnchantBalanceParameterModelNameSpriteSwitcher")]
    public partial class Gs2EnchantBalanceParameterModelNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.BalanceParameterModel?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.BalanceParameterModel?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.BalanceParameterModel?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2EnchantBalanceParameterModelNameSpriteSwitcher
    {
