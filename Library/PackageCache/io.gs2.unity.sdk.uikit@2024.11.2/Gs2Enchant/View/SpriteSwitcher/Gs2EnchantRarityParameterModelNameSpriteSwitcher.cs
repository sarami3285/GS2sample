...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/RarityParameterModel/View/SpriteSwitcher/Properties/Name/Gs2EnchantRarityParameterModelNameSpriteSwitcher")]
    public partial class Gs2EnchantRarityParameterModelNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.RarityParameterModel?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.RarityParameterModel?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.RarityParameterModel?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2EnchantRarityParameterModelNameSpriteSwitcher
    {
