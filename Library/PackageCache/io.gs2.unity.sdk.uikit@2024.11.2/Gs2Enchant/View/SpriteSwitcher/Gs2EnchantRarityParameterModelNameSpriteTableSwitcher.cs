...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/RarityParameterModel/View/SpriteSwitcher/Properties/Name/Gs2EnchantRarityParameterModelNameSpriteTableSwitcher")]
    public partial class Gs2EnchantRarityParameterModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.RarityParameterModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.RarityParameterModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2EnchantRarityParameterModelNameSpriteTableSwitcher
    {
