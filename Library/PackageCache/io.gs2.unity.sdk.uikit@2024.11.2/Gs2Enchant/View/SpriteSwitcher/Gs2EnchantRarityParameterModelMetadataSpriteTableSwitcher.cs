...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/RarityParameterModel/View/SpriteSwitcher/Properties/Metadata/Gs2EnchantRarityParameterModelMetadataSpriteTableSwitcher")]
    public partial class Gs2EnchantRarityParameterModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.RarityParameterModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.RarityParameterModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2EnchantRarityParameterModelMetadataSpriteTableSwitcher
    {
