...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterStatus/View/SpriteSwitcher/Properties/ParameterName/Gs2EnchantOwnBalanceParameterStatusParameterNameSpriteTableSwitcher")]
    public partial class Gs2EnchantOwnBalanceParameterStatusParameterNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.BalanceParameterStatus.ParameterName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.BalanceParameterStatus.ParameterName).sprite);
            }
            else {
    ...
    public partial class Gs2EnchantOwnBalanceParameterStatusParameterNameSpriteTableSwitcher
    {
