...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/RarityParameterStatus/View/SpriteSwitcher/Transaction/Properties/ParameterValueName/Gs2EnchantVerifyRarityParameterStatusByUserIdParameterValueNameSpriteTableSwitcher")]
    public partial class Gs2EnchantVerifyRarityParameterStatusByUserIdParameterValueNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.ParameterValueName) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.ParameterValueName).sprite);
            }
            else {
    ...
    public partial class Gs2EnchantVerifyRarityParameterStatusByUserIdParameterValueNameSpriteTableSwitcher
    {
