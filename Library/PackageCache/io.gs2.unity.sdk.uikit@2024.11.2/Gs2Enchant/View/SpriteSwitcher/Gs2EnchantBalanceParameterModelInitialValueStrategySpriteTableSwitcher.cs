...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterModel/View/SpriteSwitcher/Properties/InitialValueStrategy/Gs2EnchantBalanceParameterModelInitialValueStrategySpriteTableSwitcher")]
    public partial class Gs2EnchantBalanceParameterModelInitialValueStrategySpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.BalanceParameterModel.InitialValueStrategy) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.BalanceParameterModel.InitialValueStrategy).sprite);
            }
            else {
    ...
    public partial class Gs2EnchantBalanceParameterModelInitialValueStrategySpriteTableSwitcher
    {
