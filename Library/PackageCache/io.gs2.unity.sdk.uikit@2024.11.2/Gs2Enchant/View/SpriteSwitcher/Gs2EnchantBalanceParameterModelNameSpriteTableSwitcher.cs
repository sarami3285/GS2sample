...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterModel/View/SpriteSwitcher/Properties/Name/Gs2EnchantBalanceParameterModelNameSpriteTableSwitcher")]
    public partial class Gs2EnchantBalanceParameterModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.BalanceParameterModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.BalanceParameterModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2EnchantBalanceParameterModelNameSpriteTableSwitcher
    {
