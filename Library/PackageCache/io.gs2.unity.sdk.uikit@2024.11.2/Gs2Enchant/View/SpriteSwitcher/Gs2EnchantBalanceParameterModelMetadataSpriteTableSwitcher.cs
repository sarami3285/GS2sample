...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterModel/View/SpriteSwitcher/Properties/Metadata/Gs2EnchantBalanceParameterModelMetadataSpriteTableSwitcher")]
    public partial class Gs2EnchantBalanceParameterModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.BalanceParameterModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.BalanceParameterModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2EnchantBalanceParameterModelMetadataSpriteTableSwitcher
    {
