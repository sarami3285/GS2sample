...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
    ...
    public partial class Gs2EnchantOwnRarityParameterStatusPropertyIdSpriteTableSwitcher : MonoBehaviour
    {
        ...
        {
            if (this.sprites.Count(v => v.value == _fetcher.RarityParameterStatus.PropertyId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.RarityParameterStatus.PropertyId).sprite);
            }
            else {
