...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterStatus/View/SpriteSwitcher/Properties/PropertyId/Gs2EnchantOwnBalanceParameterStatusPropertyIdSpriteSwitcher")]
    public partial class Gs2EnchantOwnBalanceParameterStatusPropertyIdSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyPropertyIds.Contains(this._fetcher.BalanceParameterStatus?.PropertyId ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.BalanceParameterStatus?.PropertyId ?? "").StartsWith(this.applyPropertyId)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.BalanceParameterStatus?.PropertyId ?? "").EndsWith(this.applyPropertyId)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2EnchantOwnBalanceParameterStatusPropertyIdSpriteSwitcher
    {
