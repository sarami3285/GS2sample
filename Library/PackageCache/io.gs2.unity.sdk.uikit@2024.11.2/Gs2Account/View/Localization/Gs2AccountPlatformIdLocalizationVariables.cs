...
namespace Gs2.Unity.UiKit.Gs2Account.Localization
{
    ...
    [AddComponentMenu("GS2 UIKit/Account/PlatformId/View/Localization/Gs2AccountPlatformIdLocalizationVariables")]
    public partial class Gs2AccountPlatformIdLocalizationVariables : MonoBehaviour
    {
        private void OnFetched()
        {
            this.target.StringReference["type"] = new IntVariable {
                Value = _fetcher?.PlatformId?.Type ?? 0,
            };
            this.target.StringReference["userIdentifier"] = new StringVariable {
                Value = _fetcher?.PlatformId?.UserIdentifier ?? "",
            };
    ...
    public partial class Gs2AccountPlatformIdLocalizationVariables
    {
