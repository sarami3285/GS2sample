...
namespace Gs2.Unity.UiKit.Gs2Account
{
	...
	[AddComponentMenu("GS2 UIKit/Account/TakeOver/View/Enabler/Properties/Type/Gs2AccountOwnTakeOverTypeEnabler")]
    public partial class Gs2AccountOwnTakeOverTypeEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableTypes.Contains(this._fetcher.TakeOver.Type));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableTypes.Contains(this._fetcher.TakeOver.Type));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableType > this._fetcher.TakeOver.Type);
                    break;
    ...
    public partial class Gs2AccountOwnTakeOverTypeEnabler
    {
