...
namespace Gs2.Unity.UiKit.Gs2Account
{
	...
	[AddComponentMenu("GS2 UIKit/Account/PlatformId/View/Enabler/Properties/Type/Gs2AccountOwnPlatformIdTypeEnabler")]
    public partial class Gs2AccountOwnPlatformIdTypeEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableTypes.Contains(this._fetcher.PlatformId.Type));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableTypes.Contains(this._fetcher.PlatformId.Type));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableType > this._fetcher.PlatformId.Type);
                    break;
    ...
    public partial class Gs2AccountOwnPlatformIdTypeEnabler
    {
