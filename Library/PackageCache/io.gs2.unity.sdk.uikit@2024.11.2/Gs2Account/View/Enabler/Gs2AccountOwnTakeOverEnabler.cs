...
namespace Gs2.Unity.UiKit.Gs2Account
{
	...
	[AddComponentMenu("GS2 UIKit/Account/TakeOver/View/Enabler/Gs2AccountOwnTakeOverEnabler")]
    public partial class Gs2AccountOwnTakeOverEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.TakeOver == null)
            {
    ...
    public partial class Gs2AccountOwnTakeOverEnabler
    {
