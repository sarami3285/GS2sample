...
namespace Gs2.Unity.UiKit.Gs2Account.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Account/PlatformId/View/SpriteSwitcher/Properties/UserId/Gs2AccountOwnPlatformIdUserIdSpriteTableSwitcher")]
    public partial class Gs2AccountOwnPlatformIdUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.PlatformId.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.PlatformId.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2AccountOwnPlatformIdUserIdSpriteTableSwitcher
    {
