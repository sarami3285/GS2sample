...
namespace Gs2.Unity.UiKit.Gs2Account.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Account/Account/View/SpriteSwitcher/Properties/UserId/Gs2AccountOwnAccountUserIdSpriteTableSwitcher")]
    public partial class Gs2AccountOwnAccountUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Account.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Account.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2AccountOwnAccountUserIdSpriteTableSwitcher
    {
