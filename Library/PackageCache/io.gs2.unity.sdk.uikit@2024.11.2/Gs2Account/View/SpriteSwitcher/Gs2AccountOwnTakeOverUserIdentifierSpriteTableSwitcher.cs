...
namespace Gs2.Unity.UiKit.Gs2Account.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Account/TakeOver/View/SpriteSwitcher/Properties/UserIdentifier/Gs2AccountOwnTakeOverUserIdentifierSpriteTableSwitcher")]
    public partial class Gs2AccountOwnTakeOverUserIdentifierSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.TakeOver.UserIdentifier) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.TakeOver.UserIdentifier).sprite);
            }
            else {
    ...
    public partial class Gs2AccountOwnTakeOverUserIdentifierSpriteTableSwitcher
    {
