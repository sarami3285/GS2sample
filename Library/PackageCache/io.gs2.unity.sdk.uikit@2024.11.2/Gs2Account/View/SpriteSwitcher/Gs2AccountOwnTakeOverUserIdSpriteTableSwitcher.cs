...
namespace Gs2.Unity.UiKit.Gs2Account.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Account/TakeOver/View/SpriteSwitcher/Properties/UserId/Gs2AccountOwnTakeOverUserIdSpriteTableSwitcher")]
    public partial class Gs2AccountOwnTakeOverUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.TakeOver.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.TakeOver.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2AccountOwnTakeOverUserIdSpriteTableSwitcher
    {
