...
namespace Gs2.Unity.UiKit.Gs2Account.Context
{
	...
	[AddComponentMenu("GS2 UIKit/Account/Namespace/Context/Gs2AccountNamespaceContext")]
    public partial class Gs2AccountNamespaceContext : MonoBehaviour
    {
        public void Start() {
            if (Namespace == null) {
                Debug.LogWarning($"{gameObject.GetFullPath()}: Namespace is not set in Gs2AccountNamespaceContext.");
            }
        }
    ...
    public partial class Gs2AccountNamespaceContext
    {
