...
namespace Gs2.Unity.UiKit.Gs2Account.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Account/TakeOver/Fetcher/Gs2AccountOwnTakeOverListFetcher")]
    public partial class Gs2AccountOwnTakeOverListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeTakeOvers(
                items =>
                {
                    TakeOvers = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2AccountOwnTakeOverListFetcher
    {
