...
namespace Gs2.Unity.UiKit.Gs2Showcase.Fetcher
{
    ...
    public partial class Gs2ShowcaseOwnRandomDisplayItemFetcher : MonoBehaviour, IAcquireActionsFetcher, IConsumeActionsFetcher, IVerifyActionsFetcher
    {
        ...
        public List<Unity.Core.Model.EzVerifyAction> VerifyActions(string context = "default") {
            ...
            return RandomDisplayItem.VerifyActions.Denormalize();
        }
