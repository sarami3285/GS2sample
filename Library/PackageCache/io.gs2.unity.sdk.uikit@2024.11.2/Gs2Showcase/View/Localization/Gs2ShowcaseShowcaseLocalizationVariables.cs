...
namespace Gs2.Unity.UiKit.Gs2Showcase.Localization
{
    ...
    [AddComponentMenu("GS2 UIKit/Showcase/Showcase/View/Localization/Gs2ShowcaseShowcaseLocalizationVariables")]
    public partial class Gs2ShowcaseShowcaseLocalizationVariables : MonoBehaviour
    {
        private void OnFetched()
        {
            this.target.StringReference["name"] = new StringVariable {
                Value = _fetcher?.Showcase?.Name ?? "",
            };
    ...
    public partial class Gs2ShowcaseShowcaseLocalizationVariables
    {
