...
namespace Gs2.Unity.UiKit.Gs2Showcase.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/DisplayItem/View/SpriteSwitcher/Properties/Type/Gs2ShowcaseOwnDisplayItemTypeSpriteTableSwitcher")]
    public partial class Gs2ShowcaseOwnDisplayItemTypeSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.DisplayItem.Type) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.DisplayItem.Type).sprite);
            }
            else {
    ...
    public partial class Gs2ShowcaseOwnDisplayItemTypeSpriteTableSwitcher
    {
