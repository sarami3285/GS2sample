...
namespace Gs2.Unity.UiKit.Gs2Showcase.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/DisplayItem/View/SpriteSwitcher/Properties/DisplayItemId/Gs2ShowcaseOwnDisplayItemDisplayItemIdSpriteTableSwitcher")]
    public partial class Gs2ShowcaseOwnDisplayItemDisplayItemIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.DisplayItem.DisplayItemId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.DisplayItem.DisplayItemId).sprite);
            }
            else {
    ...
    public partial class Gs2ShowcaseOwnDisplayItemDisplayItemIdSpriteTableSwitcher
    {
