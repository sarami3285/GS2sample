...
namespace Gs2.Unity.UiKit.Gs2Showcase.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/Showcase/View/SpriteSwitcher/Properties/Name/Gs2ShowcaseOwnShowcaseNameSpriteTableSwitcher")]
    public partial class Gs2ShowcaseOwnShowcaseNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Showcase.Name) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Showcase.Name).sprite);
            }
            else {
    ...
    public partial class Gs2ShowcaseOwnShowcaseNameSpriteTableSwitcher
    {
