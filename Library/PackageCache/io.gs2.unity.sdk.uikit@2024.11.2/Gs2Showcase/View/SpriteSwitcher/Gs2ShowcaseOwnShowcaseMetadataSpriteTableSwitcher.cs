...
namespace Gs2.Unity.UiKit.Gs2Showcase.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/Showcase/View/SpriteSwitcher/Properties/Metadata/Gs2ShowcaseOwnShowcaseMetadataSpriteTableSwitcher")]
    public partial class Gs2ShowcaseOwnShowcaseMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Showcase.Metadata) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Showcase.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2ShowcaseOwnShowcaseMetadataSpriteTableSwitcher
    {
