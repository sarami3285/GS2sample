...
namespace Gs2.Unity.UiKit.Gs2Showcase
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/Showcase/View/Enabler/Gs2ShowcaseOwnShowcaseEnabler")]
    public partial class Gs2ShowcaseOwnShowcaseEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Showcase == null)
            {
    ...
    public partial class Gs2ShowcaseOwnShowcaseEnabler
    {
