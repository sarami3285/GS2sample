...
namespace Gs2.Unity.UiKit.Gs2Showcase.Context
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/DisplayItem/Context/Gs2ShowcaseOwnDisplayItemContext")]
    public partial class Gs2ShowcaseOwnDisplayItemContext : MonoBehaviour
    {
        public void Start() {
            if (DisplayItem == null) {
