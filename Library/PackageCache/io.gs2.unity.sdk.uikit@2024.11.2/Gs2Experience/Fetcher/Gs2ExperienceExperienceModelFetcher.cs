...
namespace Gs2.Unity.UiKit.Gs2Experience.Fetcher
{
    ...
    {
        private EzExperienceModelDomain _domain;
        ...
        private IEnumerator Fetch()
        {
            ...
            yield return new WaitUntil(() => Context != null && this.Context.ExperienceModel != null);
        ...
        public void SetTemporaryExperienceModel(
        ...
        public void RollbackTemporaryExperienceModel(
        ) {
            OnUpdateContext();
        }
    }
