...
namespace Gs2.Unity.UiKit.Gs2Experience.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/Status/Fetcher/Acquire/Gs2ExperienceSetExperienceByUserIdFetcher")]
    public partial class Gs2ExperienceSetExperienceByUserIdFetcher : Gs2ExperienceOwnStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Experience:SetExperienceByUserId") {
                    Request = SetExperienceByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Status == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Experience:SetExperienceByUserId");
                if (action != null) {
                    Request = SetExperienceByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Status == null || (
                            Status.NamespaceName == Request.NamespaceName &&
                            Status.ExperienceName == Request.ExperienceName &&
                            Status.PropertyId == Request.PropertyId)
    ...
    public partial class Gs2ExperienceSetExperienceByUserIdFetcher
    {
    ...
    public partial class Gs2ExperienceSetExperienceByUserIdFetcher
    {
        public SetExperienceByUserIdRequest Request { get; protected set; }
