...
namespace Gs2.Unity.UiKit.Gs2Experience.Fetcher
{
    ...
    public partial class Gs2ExperienceSetRankCapByUserIdFetcher : Gs2ExperienceOwnStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Experience:SetRankCapByUserId") {
                    Request = SetRankCapByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Status == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Experience:SetRankCapByUserId");
                if (action != null) {
    ...
    public partial class Gs2ExperienceSetRankCapByUserIdFetcher
    {
        public SetRankCapByUserIdRequest Request { get; protected set; }
