...
namespace Gs2.Unity.UiKit.Gs2Experience.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/Status/Fetcher/Acquire/Gs2ExperienceAddRankCapByUserIdFetcher")]
    public partial class Gs2ExperienceAddRankCapByUserIdFetcher : Gs2ExperienceOwnStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Experience:AddRankCapByUserId") {
                    Request = AddRankCapByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Status == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Experience:AddRankCapByUserId");
                if (action != null) {
                    Request = AddRankCapByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Status == null || (
                            Status.NamespaceName == Request.NamespaceName &&
                            Status.ExperienceName == Request.ExperienceName &&
                            Status.PropertyId == Request.PropertyId)
    ...
    public partial class Gs2ExperienceAddRankCapByUserIdFetcher
    {
    ...
    public partial class Gs2ExperienceAddRankCapByUserIdFetcher
    {
        public AddRankCapByUserIdRequest Request { get; protected set; }
