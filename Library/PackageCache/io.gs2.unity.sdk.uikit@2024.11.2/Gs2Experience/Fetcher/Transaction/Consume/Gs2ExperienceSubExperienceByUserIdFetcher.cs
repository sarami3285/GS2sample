...
namespace Gs2.Unity.UiKit.Gs2Experience.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/Status/Fetcher/Consume/Gs2ExperienceSubExperienceByUserIdFetcher")]
    public partial class Gs2ExperienceSubExperienceByUserIdFetcher : Gs2ExperienceOwnStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Experience:SubExperienceByUserId") {
                    Request = SubExperienceByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Status == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Experience:SubExperienceByUserId");
                if (action != null) {
                    Request = SubExperienceByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Status == null || (
                            Status.NamespaceName == Request.NamespaceName &&
                            Status.ExperienceName == Request.ExperienceName &&
                            Status.PropertyId == Request.PropertyId)
    ...
    public partial class Gs2ExperienceSubExperienceByUserIdFetcher
    {
    ...
    public partial class Gs2ExperienceSubExperienceByUserIdFetcher
    {
        public SubExperienceByUserIdRequest Request { get; protected set; }
