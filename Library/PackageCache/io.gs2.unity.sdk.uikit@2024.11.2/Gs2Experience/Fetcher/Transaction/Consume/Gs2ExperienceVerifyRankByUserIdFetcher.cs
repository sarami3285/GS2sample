...
namespace Gs2.Unity.UiKit.Gs2Experience.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/Status/Fetcher/Consume/Gs2ExperienceVerifyRankByUserIdFetcher")]
    public partial class Gs2ExperienceVerifyRankByUserIdFetcher : Gs2ExperienceOwnStatusContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Experience:VerifyRankByUserId") {
                    Request = VerifyRankByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Status == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Experience:VerifyRankByUserId");
                if (action != null) {
                    Request = VerifyRankByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Status == null || (
                            Status.NamespaceName == Request.NamespaceName &&
                            Status.ExperienceName == Request.ExperienceName &&
                            Status.PropertyId == Request.PropertyId)
    ...
    public partial class Gs2ExperienceVerifyRankByUserIdFetcher
    {
    ...
    public partial class Gs2ExperienceVerifyRankByUserIdFetcher
    {
        public VerifyRankByUserIdRequest Request { get; protected set; }
