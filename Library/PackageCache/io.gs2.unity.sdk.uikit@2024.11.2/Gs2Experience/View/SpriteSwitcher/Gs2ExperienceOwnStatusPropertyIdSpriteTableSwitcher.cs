...
namespace Gs2.Unity.UiKit.Gs2Experience.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/Status/View/SpriteSwitcher/Properties/PropertyId/Gs2ExperienceOwnStatusPropertyIdSpriteTableSwitcher")]
    public partial class Gs2ExperienceOwnStatusPropertyIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Status.PropertyId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Status.PropertyId).sprite);
            }
            else {
    ...
    public partial class Gs2ExperienceOwnStatusPropertyIdSpriteTableSwitcher
    {
