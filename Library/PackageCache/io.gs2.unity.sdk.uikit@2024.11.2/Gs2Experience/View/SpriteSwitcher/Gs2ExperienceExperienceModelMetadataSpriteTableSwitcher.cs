...
namespace Gs2.Unity.UiKit.Gs2Experience.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/ExperienceModel/View/SpriteSwitcher/Properties/Metadata/Gs2ExperienceExperienceModelMetadataSpriteTableSwitcher")]
    public partial class Gs2ExperienceExperienceModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.ExperienceModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.ExperienceModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2ExperienceExperienceModelMetadataSpriteTableSwitcher
    {
