...
namespace Gs2.Unity.UiKit.Gs2Experience.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/Status/View/SpriteSwitcher/Properties/ExperienceName/Gs2ExperienceOwnStatusExperienceNameSpriteTableSwitcher")]
    public partial class Gs2ExperienceOwnStatusExperienceNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Status.ExperienceName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Status.ExperienceName).sprite);
            }
            else {
    ...
    public partial class Gs2ExperienceOwnStatusExperienceNameSpriteTableSwitcher
    {
