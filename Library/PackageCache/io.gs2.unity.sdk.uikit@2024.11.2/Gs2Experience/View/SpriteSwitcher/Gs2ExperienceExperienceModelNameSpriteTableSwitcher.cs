...
namespace Gs2.Unity.UiKit.Gs2Experience.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/ExperienceModel/View/SpriteSwitcher/Properties/Name/Gs2ExperienceExperienceModelNameSpriteTableSwitcher")]
    public partial class Gs2ExperienceExperienceModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.ExperienceModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.ExperienceModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2ExperienceExperienceModelNameSpriteTableSwitcher
    {
