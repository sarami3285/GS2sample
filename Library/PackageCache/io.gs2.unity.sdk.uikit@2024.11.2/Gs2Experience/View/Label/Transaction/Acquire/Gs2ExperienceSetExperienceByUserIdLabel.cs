...
namespace Gs2.Unity.UiKit.Gs2Experience.Label
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/Status/View/Label/Transaction/Gs2ExperienceSetExperienceByUserIdLabel")]
    public partial class Gs2ExperienceSetExperienceByUserIdLabel : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            this.onUpdate?.Invoke(
                this.format.Replace(
                    ...
                    $"{this._userDataFetcher.Status.ExperienceValue + this._fetcher.Request.ExperienceValue}"
                ).Replace(
                    "{userData:rankValue}",
    ...
    public partial class Gs2ExperienceSetExperienceByUserIdLabel
    {
