...
namespace Gs2.Unity.UiKit.Gs2Experience
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/ExperienceModel/View/Enabler/Properties/DefaultExperience/Gs2ExperienceExperienceModelDefaultExperienceEnabler")]
    public partial class Gs2ExperienceExperienceModelDefaultExperienceEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableDefaultExperiences.Contains(this._fetcher.ExperienceModel.DefaultExperience));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableDefaultExperiences.Contains(this._fetcher.ExperienceModel.DefaultExperience));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableDefaultExperience > this._fetcher.ExperienceModel.DefaultExperience);
                    break;
