...
namespace Gs2.Unity.UiKit.Gs2Experience
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/Status/View/Enabler/Transaction/Gs2ExperienceSubRankCapByUserIdEnabler")]
    public partial class Gs2ExperienceSubRankCapByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Experience:SubRankCapByUserId") == 0) {
    ...
    public partial class Gs2ExperienceSubRankCapByUserIdEnabler
    {
