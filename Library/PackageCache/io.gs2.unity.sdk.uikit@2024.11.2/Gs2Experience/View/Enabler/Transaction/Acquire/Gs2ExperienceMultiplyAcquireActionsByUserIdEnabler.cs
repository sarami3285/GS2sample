...
namespace Gs2.Unity.UiKit.Gs2Experience
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/Status/View/Enabler/Transaction/Gs2ExperienceMultiplyAcquireActionsByUserIdEnabler")]
    public partial class Gs2ExperienceMultiplyAcquireActionsByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Experience:MultiplyAcquireActionsByUserId") == 0) {
    ...
    public partial class Gs2ExperienceMultiplyAcquireActionsByUserIdEnabler
    {
