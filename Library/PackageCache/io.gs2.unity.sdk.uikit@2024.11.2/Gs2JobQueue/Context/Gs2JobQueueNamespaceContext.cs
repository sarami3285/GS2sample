...
namespace Gs2.Unity.UiKit.Gs2JobQueue.Context
{
	...
	[AddComponentMenu("GS2 UIKit/JobQueue/Namespace/Context/Gs2JobQueueNamespaceContext")]
    public partial class Gs2JobQueueNamespaceContext : MonoBehaviour
    {
        public void Start() {
            if (Namespace == null) {
                Debug.LogWarning($"{gameObject.GetFullPath()}: Namespace is not set in Gs2JobQueueNamespaceContext.");
            }
        }
