...
namespace Gs2.Unity.UiKit.Gs2JobQueue.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/JobQueue/Job/Fetcher/Consume/Gs2JobQueueDeleteJobByUserIdFetcher")]
    public partial class Gs2JobQueueDeleteJobByUserIdFetcher : Gs2JobQueueOwnJobContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2JobQueue:DeleteJobByUserId") {
                    Request = DeleteJobByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Job == null || (
                            Job.NamespaceName == Request.NamespaceName &&
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2JobQueue:DeleteJobByUserId");
                if (action != null) {
                    Request = DeleteJobByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Job == null || (
                            Job.NamespaceName == Request.NamespaceName &&
                            Job.JobName == Request.JobName)
                    ) {
    ...
    public partial class Gs2JobQueueDeleteJobByUserIdFetcher
    {
    ...
    public partial class Gs2JobQueueDeleteJobByUserIdFetcher
    {
        public DeleteJobByUserIdRequest Request { get; protected set; }
