...
namespace Gs2.Unity.UiKit.Gs2JobQueue.Fetcher
{
    ...
    public partial class Gs2JobQueuePushByUserIdFetcher : Gs2JobQueueNamespaceContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2JobQueue:PushByUserId") {
                    Request = PushByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Namespace == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2JobQueue:PushByUserId");
                if (action != null) {
    ...
    public partial class Gs2JobQueuePushByUserIdFetcher
    {
        public PushByUserIdRequest Request { get; protected set; }
