...
namespace Gs2.Unity.UiKit.Gs2JobQueue.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/JobQueue/Job/View/SpriteSwitcher/Transaction/Properties/JobName/Gs2JobQueueDeleteJobByUserIdJobNameSpriteTableSwitcher")]
    public partial class Gs2JobQueueDeleteJobByUserIdJobNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.JobName) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.JobName).sprite);
            }
            else {
    ...
    public partial class Gs2JobQueueDeleteJobByUserIdJobNameSpriteTableSwitcher
    {
