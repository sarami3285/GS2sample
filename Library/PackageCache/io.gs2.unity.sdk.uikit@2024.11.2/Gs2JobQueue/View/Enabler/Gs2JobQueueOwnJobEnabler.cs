...
namespace Gs2.Unity.UiKit.Gs2JobQueue
{
	...
	[AddComponentMenu("GS2 UIKit/JobQueue/Job/View/Enabler/Gs2JobQueueOwnJobEnabler")]
    public partial class Gs2JobQueueOwnJobEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Job == null)
            {
    ...
    public partial class Gs2JobQueueOwnJobEnabler
    {
