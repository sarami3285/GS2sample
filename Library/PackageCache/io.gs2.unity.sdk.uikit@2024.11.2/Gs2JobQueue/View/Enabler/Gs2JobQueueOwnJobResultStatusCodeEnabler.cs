...
namespace Gs2.Unity.UiKit.Gs2JobQueue
{
    ...
    public partial class Gs2JobQueueOwnJobResultStatusCodeEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableStatusCodes.Contains(this._fetcher.JobResult.StatusCode));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableStatusCodes.Contains(this._fetcher.JobResult.StatusCode));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableStatusCode > this._fetcher.JobResult.StatusCode);
                    break;
