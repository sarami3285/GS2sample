...
namespace Gs2.Unity.UiKit.Gs2JobQueue
{
	...
	[AddComponentMenu("GS2 UIKit/JobQueue/Job/View/Enabler/Transaction/Gs2JobQueuePushByUserIdEnabler")]
    public partial class Gs2JobQueuePushByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2JobQueue:PushByUserId") == 0) {
    ...
    public partial class Gs2JobQueuePushByUserIdEnabler
    {
