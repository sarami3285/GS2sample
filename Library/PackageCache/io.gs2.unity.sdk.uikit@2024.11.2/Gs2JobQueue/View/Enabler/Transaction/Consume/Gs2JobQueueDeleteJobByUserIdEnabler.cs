...
namespace Gs2.Unity.UiKit.Gs2JobQueue
{
	...
	[AddComponentMenu("GS2 UIKit/JobQueue/Job/View/Enabler/Transaction/Gs2JobQueueDeleteJobByUserIdEnabler")]
    public partial class Gs2JobQueueDeleteJobByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2JobQueue:DeleteJobByUserId") == 0) {
    ...
    public partial class Gs2JobQueueDeleteJobByUserIdEnabler
    {
