...
namespace Gs2.Unity.UiKit.Gs2JobQueue
{
	...
	[AddComponentMenu("GS2 UIKit/JobQueue/JobResult/View/Enabler/Gs2JobQueueOwnJobResultEnabler")]
    public partial class Gs2JobQueueOwnJobResultEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.JobResult == null)
            {
    ...
    public partial class Gs2JobQueueOwnJobResultEnabler
    {
