...
namespace Gs2.Unity.UiKit.Gs2JobQueue
{
	...
	[AddComponentMenu("GS2 UIKit/JobQueue/Job/View/Enabler/Properties/CurrentRetryCount/Gs2JobQueueOwnJobCurrentRetryCountEnabler")]
    public partial class Gs2JobQueueOwnJobCurrentRetryCountEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableCurrentRetryCounts.Contains(this._fetcher.Job.CurrentRetryCount));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableCurrentRetryCounts.Contains(this._fetcher.Job.CurrentRetryCount));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableCurrentRetryCount > this._fetcher.Job.CurrentRetryCount);
                    break;
    ...
    public partial class Gs2JobQueueOwnJobCurrentRetryCountEnabler
    {
