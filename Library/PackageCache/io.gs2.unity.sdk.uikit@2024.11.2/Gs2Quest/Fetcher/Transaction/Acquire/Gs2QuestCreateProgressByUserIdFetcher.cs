...
namespace Gs2.Unity.UiKit.Gs2Quest.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Quest/Progress/Fetcher/Acquire/Gs2QuestCreateProgressByUserIdFetcher")]
    public partial class Gs2QuestCreateProgressByUserIdFetcher : Gs2QuestNamespaceContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Quest:CreateProgressByUserId") {
                    Request = CreateProgressByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Namespace == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Quest:CreateProgressByUserId");
                if (action != null) {
    ...
    public partial class Gs2QuestCreateProgressByUserIdFetcher
    {
    ...
    public partial class Gs2QuestCreateProgressByUserIdFetcher
    {
        public CreateProgressByUserIdRequest Request { get; protected set; }
