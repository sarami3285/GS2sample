...
namespace Gs2.Unity.UiKit.Gs2Quest
{
	...
	[AddComponentMenu("GS2 UIKit/Quest/Progress/View/Enabler/Transaction/Gs2QuestDeleteProgressByUserIdEnabler")]
    public partial class Gs2QuestDeleteProgressByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Quest:DeleteProgressByUserId") == 0) {
    ...
    public partial class Gs2QuestDeleteProgressByUserIdEnabler
    {
