...
namespace Gs2.Unity.UiKit.Gs2Quest
{
	...
	[AddComponentMenu("GS2 UIKit/Quest/QuestGroupModel/View/Enabler/Gs2QuestQuestGroupModelEnabler")]
    public partial class Gs2QuestQuestGroupModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.QuestGroupModel == null)
            {
    ...
    public partial class Gs2QuestQuestGroupModelEnabler
    {
