...
namespace Gs2.Unity.UiKit.Gs2Quest
{
	...
	[AddComponentMenu("GS2 UIKit/Quest/CompletedQuestList/View/Enabler/Gs2QuestOwnCompletedQuestListEnabler")]
    public partial class Gs2QuestOwnCompletedQuestListEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.CompletedQuestList == null)
            {
    ...
    public partial class Gs2QuestOwnCompletedQuestListEnabler
    {
