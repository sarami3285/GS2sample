...
namespace Gs2.Unity.UiKit.Gs2Quest
{
	...
	[AddComponentMenu("GS2 UIKit/Quest/Progress/View/SpriteSwitcher/Properties/RandomSeed/Gs2QuestOwnProgressRandomSeedSpriteSwitcher")]
    public partial class Gs2QuestOwnProgressRandomSeedSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyRandomSeeds.Contains(this._fetcher.Progress.RandomSeed)) {
                ...
                case Expression.Less:
                    if (this.applyRandomSeed > this._fetcher.Progress.RandomSeed) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
    ...
    public partial class Gs2QuestOwnProgressRandomSeedSpriteSwitcher
    {
