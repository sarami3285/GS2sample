...
namespace Gs2.Unity.UiKit.Gs2Quest.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Quest/QuestGroupModel/View/SpriteSwitcher/Properties/Name/Gs2QuestQuestGroupModelNameSpriteTableSwitcher")]
    public partial class Gs2QuestQuestGroupModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.QuestGroupModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.QuestGroupModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2QuestQuestGroupModelNameSpriteTableSwitcher
    {
