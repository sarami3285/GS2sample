...
namespace Gs2.Unity.UiKit.Gs2Quest.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Quest/Progress/View/SpriteSwitcher/Properties/TransactionId/Gs2QuestOwnProgressTransactionIdSpriteTableSwitcher")]
    public partial class Gs2QuestOwnProgressTransactionIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Progress.TransactionId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Progress.TransactionId).sprite);
            }
            else {
    ...
    public partial class Gs2QuestOwnProgressTransactionIdSpriteTableSwitcher
    {
