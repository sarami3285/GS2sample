...
namespace Gs2.Unity.UiKit.Gs2Quest
{
    ...
    public partial class Gs2QuestProgressDeleteProgressAction
    {
        [MenuItem("GameObject/Game Server Services/Quest/Progress/Action/DeleteProgress", priority = 0)]
        private static void CreateButton()
        {
            var prefab = AssetDatabase.LoadAssetAtPath<Gs2QuestProgressDeleteProgressAction>(
                "Packages/io.gs2.unity.sdk.uikit/Gs2Quest/Prefabs/Action/Gs2QuestProgressDeleteProgressAction.prefab"
            );
