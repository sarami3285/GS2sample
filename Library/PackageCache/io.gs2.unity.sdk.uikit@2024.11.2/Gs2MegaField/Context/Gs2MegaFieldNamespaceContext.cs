...
namespace Gs2.Unity.UiKit.Gs2MegaField.Context
{
	...
	[AddComponentMenu("GS2 UIKit/MegaField/Namespace/Context/Gs2MegaFieldNamespaceContext")]
    public partial class Gs2MegaFieldNamespaceContext : MonoBehaviour
    {
        public void Start() {
            if (Namespace == null) {
                Debug.LogWarning($"{gameObject.GetFullPath()}: Namespace is not set in Gs2MegaFieldNamespaceContext.");
            }
        }
    ...
    public partial class Gs2MegaFieldNamespaceContext
    {
