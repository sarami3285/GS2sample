...
namespace Gs2.Unity.UiKit.Gs2MegaField.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/MegaField/LayerModel/Fetcher/Gs2MegaFieldLayerModelListFetcher")]
    public partial class Gs2MegaFieldLayerModelListFetcher : MonoBehaviour
    {
        private EzAreaModelDomain _domain;
        private ulong? _callbackId;

        private IEnumerator Load() {
            var retryWaitSecond = 1;
            var it = _domain.LayerModels();
        ...
        private IEnumerator Fetch()
        {
            ...
            yield return new WaitUntil(() => Context != null && Context.AreaModel != null);
            ...
            this._callbackId = this._domain.SubscribeLayerModels(
                items =>
                {
                    LayerModels = items.ToList();
                    this.OnFetched.Invoke();
                }
            );
    ...
    public partial class Gs2MegaFieldLayerModelListFetcher
    {
    ...
    public partial class Gs2MegaFieldLayerModelListFetcher
    {
        public List<Gs2.Unity.Gs2MegaField.Model.EzLayerModel> LayerModels { get; private set; }
