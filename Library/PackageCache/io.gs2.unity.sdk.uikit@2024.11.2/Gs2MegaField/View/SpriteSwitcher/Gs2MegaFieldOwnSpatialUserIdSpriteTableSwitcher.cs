...
namespace Gs2.Unity.UiKit.Gs2MegaField.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/MegaField/Spatial/View/SpriteSwitcher/Properties/UserId/Gs2MegaFieldOwnSpatialUserIdSpriteTableSwitcher")]
    public partial class Gs2MegaFieldOwnSpatialUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Spatial.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Spatial.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2MegaFieldOwnSpatialUserIdSpriteTableSwitcher
    {
