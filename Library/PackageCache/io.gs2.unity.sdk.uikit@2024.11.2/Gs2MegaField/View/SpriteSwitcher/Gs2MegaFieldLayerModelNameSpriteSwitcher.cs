...
namespace Gs2.Unity.UiKit.Gs2MegaField.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/MegaField/LayerModel/View/SpriteSwitcher/Properties/Name/Gs2MegaFieldLayerModelNameSpriteSwitcher")]
    public partial class Gs2MegaFieldLayerModelNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.LayerModel?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.LayerModel?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.LayerModel?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2MegaFieldLayerModelNameSpriteSwitcher
    {
