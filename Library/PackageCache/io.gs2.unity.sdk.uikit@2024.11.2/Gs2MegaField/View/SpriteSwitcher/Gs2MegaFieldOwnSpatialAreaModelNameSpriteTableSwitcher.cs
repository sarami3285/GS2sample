...
namespace Gs2.Unity.UiKit.Gs2MegaField.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/MegaField/Spatial/View/SpriteSwitcher/Properties/AreaModelName/Gs2MegaFieldOwnSpatialAreaModelNameSpriteTableSwitcher")]
    public partial class Gs2MegaFieldOwnSpatialAreaModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Spatial.AreaModelName) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Spatial.AreaModelName).sprite);
            }
            else {
    ...
    public partial class Gs2MegaFieldOwnSpatialAreaModelNameSpriteTableSwitcher
    {
