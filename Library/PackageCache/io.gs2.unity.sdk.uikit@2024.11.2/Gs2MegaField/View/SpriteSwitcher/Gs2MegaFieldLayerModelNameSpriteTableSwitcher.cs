...
namespace Gs2.Unity.UiKit.Gs2MegaField.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/MegaField/LayerModel/View/SpriteSwitcher/Properties/Name/Gs2MegaFieldLayerModelNameSpriteTableSwitcher")]
    public partial class Gs2MegaFieldLayerModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.LayerModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.LayerModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2MegaFieldLayerModelNameSpriteTableSwitcher
    {
