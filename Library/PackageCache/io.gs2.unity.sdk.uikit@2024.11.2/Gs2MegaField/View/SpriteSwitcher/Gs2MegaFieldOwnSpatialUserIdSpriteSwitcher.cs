...
namespace Gs2.Unity.UiKit.Gs2MegaField.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/MegaField/Spatial/View/SpriteSwitcher/Properties/UserId/Gs2MegaFieldOwnSpatialUserIdSpriteSwitcher")]
    public partial class Gs2MegaFieldOwnSpatialUserIdSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyUserIds.Contains(this._fetcher.Spatial?.UserId ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.Spatial?.UserId ?? "").StartsWith(this.applyUserId)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.Spatial?.UserId ?? "").EndsWith(this.applyUserId)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2MegaFieldOwnSpatialUserIdSpriteSwitcher
    {
