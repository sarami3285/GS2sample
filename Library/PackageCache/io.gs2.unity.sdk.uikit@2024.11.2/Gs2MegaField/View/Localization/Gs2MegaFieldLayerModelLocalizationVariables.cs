...
namespace Gs2.Unity.UiKit.Gs2MegaField.Localization
{
    ...
    [AddComponentMenu("GS2 UIKit/MegaField/LayerModel/View/Localization/Gs2MegaFieldLayerModelLocalizationVariables")]
    public partial class Gs2MegaFieldLayerModelLocalizationVariables : MonoBehaviour
    {
        private void OnFetched()
        {
            this.target.StringReference["name"] = new StringVariable {
                Value = _fetcher?.LayerModel?.Name ?? "",
            };
            this.target.StringReference["metadata"] = new StringVariable {
                Value = _fetcher?.LayerModel?.Metadata ?? "",
            };
    ...
    public partial class Gs2MegaFieldLayerModelLocalizationVariables
    {
