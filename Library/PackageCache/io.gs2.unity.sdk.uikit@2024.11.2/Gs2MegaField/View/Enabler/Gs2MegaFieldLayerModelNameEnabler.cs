...
namespace Gs2.Unity.UiKit.Gs2MegaField.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/MegaField/LayerModel/View/Enabler/Properties/Name/Gs2MegaFieldLayerModelNameEnabler")]
    public partial class Gs2MegaFieldLayerModelNameEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableNames.Contains(this._fetcher.LayerModel?.Name ?? ""));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableNames.Contains(this._fetcher.LayerModel?.Name ?? ""));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive((this._fetcher.LayerModel?.Name ?? "").StartsWith(this.enableName));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive((this._fetcher.LayerModel?.Name ?? "").EndsWith(this.enableName));
                    break;
                default:
    ...
    public partial class Gs2MegaFieldLayerModelNameEnabler
    {
