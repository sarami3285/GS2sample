...
namespace Gs2.Unity.UiKit.Gs2MegaField
{
	...
	[AddComponentMenu("GS2 UIKit/MegaField/Spatial/View/Enabler/Gs2MegaFieldOwnSpatialEnabler")]
    public partial class Gs2MegaFieldOwnSpatialEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Spatial == null)
            {
    ...
    public partial class Gs2MegaFieldOwnSpatialEnabler
    {
