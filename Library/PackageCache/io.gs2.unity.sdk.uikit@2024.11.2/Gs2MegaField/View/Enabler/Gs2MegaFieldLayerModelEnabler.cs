...
namespace Gs2.Unity.UiKit.Gs2MegaField
{
	...
	[AddComponentMenu("GS2 UIKit/MegaField/LayerModel/View/Enabler/Gs2MegaFieldLayerModelEnabler")]
    public partial class Gs2MegaFieldLayerModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.LayerModel == null)
            {
    ...
    public partial class Gs2MegaFieldLayerModelEnabler
    {
