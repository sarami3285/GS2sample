...
namespace Gs2.Unity.UiKit.Gs2SkillTree.Context
{
	...
	[AddComponentMenu("GS2 UIKit/SkillTree/Namespace/Context/Gs2SkillTreeNamespaceContext")]
    public partial class Gs2SkillTreeNamespaceContext : MonoBehaviour
    {
        public void Start() {
            if (Namespace == null) {
                Debug.LogWarning($"{gameObject.GetFullPath()}: Namespace is not set in Gs2SkillTreeNamespaceContext.");
            }
        }
