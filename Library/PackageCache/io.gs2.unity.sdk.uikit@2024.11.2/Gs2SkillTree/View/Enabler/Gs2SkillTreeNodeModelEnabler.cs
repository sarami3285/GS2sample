...
namespace Gs2.Unity.UiKit.Gs2SkillTree
{
	...
	[AddComponentMenu("GS2 UIKit/SkillTree/NodeModel/View/Enabler/Gs2SkillTreeNodeModelEnabler")]
    public partial class Gs2SkillTreeNodeModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.NodeModel == null)
            {
    ...
    public partial class Gs2SkillTreeNodeModelEnabler
    {
