...
namespace Gs2.Unity.UiKit.Gs2SkillTree.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/SkillTree/NodeModel/View/Enabler/Properties/Name/Gs2SkillTreeNodeModelNameEnabler")]
    public partial class Gs2SkillTreeNodeModelNameEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableNames.Contains(this._fetcher.NodeModel?.Name ?? ""));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableNames.Contains(this._fetcher.NodeModel?.Name ?? ""));
                    break;
                case Expression.StartsWith:
                    this.target.SetActive((this._fetcher.NodeModel?.Name ?? "").StartsWith(this.enableName));
                    break;
                case Expression.EndsWith:
                    this.target.SetActive((this._fetcher.NodeModel?.Name ?? "").EndsWith(this.enableName));
                    break;
                default:
    ...
    public partial class Gs2SkillTreeNodeModelNameEnabler
    {
