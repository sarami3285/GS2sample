...
namespace Gs2.Unity.UiKit.Gs2SkillTree
{
	...
	[AddComponentMenu("GS2 UIKit/SkillTree/Status/View/Enabler/Transaction/Gs2SkillTreeMarkReleaseByUserIdEnabler")]
    public partial class Gs2SkillTreeMarkReleaseByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2SkillTree:MarkReleaseByUserId") == 0) {
    ...
    public partial class Gs2SkillTreeMarkReleaseByUserIdEnabler
    {
