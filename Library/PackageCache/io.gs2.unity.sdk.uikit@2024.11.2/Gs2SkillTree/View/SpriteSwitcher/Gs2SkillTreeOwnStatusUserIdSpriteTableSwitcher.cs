...
namespace Gs2.Unity.UiKit.Gs2SkillTree.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/SkillTree/Status/View/SpriteSwitcher/Properties/UserId/Gs2SkillTreeOwnStatusUserIdSpriteTableSwitcher")]
    public partial class Gs2SkillTreeOwnStatusUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Status.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Status.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2SkillTreeOwnStatusUserIdSpriteTableSwitcher
    {
