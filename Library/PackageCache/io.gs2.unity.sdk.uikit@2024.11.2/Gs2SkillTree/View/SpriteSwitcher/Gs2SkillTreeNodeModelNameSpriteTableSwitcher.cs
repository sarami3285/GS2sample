...
namespace Gs2.Unity.UiKit.Gs2SkillTree.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/SkillTree/NodeModel/View/SpriteSwitcher/Properties/Name/Gs2SkillTreeNodeModelNameSpriteTableSwitcher")]
    public partial class Gs2SkillTreeNodeModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.NodeModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.NodeModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2SkillTreeNodeModelNameSpriteTableSwitcher
    {
