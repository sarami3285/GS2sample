    ...
    public partial class Gs2ExchangeDeleteAwaitByUserIdFetcher : Gs2ExchangeOwnAwaitContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.ConsumeAction.Action == "Gs2Exchange:DeleteAwaitByUserId") {
                    Request = DeleteAwaitByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.ConsumeAction.Request));
                    if (Await == null || (
                ...
                var action = this._fetcher.ConsumeActions().FirstOrDefault(v => v.Action == "Gs2Exchange:DeleteAwaitByUserId");
                if (action != null) {
