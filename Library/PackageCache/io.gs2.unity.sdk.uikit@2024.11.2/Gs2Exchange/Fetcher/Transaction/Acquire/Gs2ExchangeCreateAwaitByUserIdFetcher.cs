    ...
    public partial class Gs2ExchangeCreateAwaitByUserIdFetcher : Gs2ExchangeNamespaceContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Exchange:CreateAwaitByUserId") {
                    Request = CreateAwaitByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Namespace == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Exchange:CreateAwaitByUserId");
                if (action != null) {
