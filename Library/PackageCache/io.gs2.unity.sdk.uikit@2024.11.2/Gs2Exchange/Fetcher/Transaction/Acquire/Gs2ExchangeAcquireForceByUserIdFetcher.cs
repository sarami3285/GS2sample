...
namespace Gs2.Unity.UiKit.Gs2Exchange.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/Fetcher/Acquire/Gs2ExchangeAcquireForceByUserIdFetcher")]
    public partial class Gs2ExchangeAcquireForceByUserIdFetcher : Gs2ExchangeOwnAwaitContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Exchange:AcquireForceByUserId") {
                    Request = AcquireForceByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Await == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Exchange:AcquireForceByUserId");
                if (action != null) {
                    Request = AcquireForceByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Await == null || (
                            Await.NamespaceName == Request.NamespaceName &&
                            Await.AwaitName == Request.AwaitName)
                    ) {
    ...
    public partial class Gs2ExchangeAcquireForceByUserIdFetcher
    {
    ...
    public partial class Gs2ExchangeAcquireForceByUserIdFetcher
    {
        public AcquireForceByUserIdRequest Request { get; protected set; }
