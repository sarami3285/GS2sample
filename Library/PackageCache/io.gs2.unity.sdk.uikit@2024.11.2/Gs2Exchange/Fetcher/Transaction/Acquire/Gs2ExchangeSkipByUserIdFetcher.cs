...
namespace Gs2.Unity.UiKit.Gs2Exchange.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/Fetcher/Acquire/Gs2ExchangeSkipByUserIdFetcher")]
    public partial class Gs2ExchangeSkipByUserIdFetcher : Gs2ExchangeOwnAwaitContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Exchange:SkipByUserId") {
                    Request = SkipByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Await == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Exchange:SkipByUserId");
                if (action != null) {
                    Request = SkipByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Await == null || (
                            Await.NamespaceName == Request.NamespaceName &&
                            Await.AwaitName == Request.AwaitName)
                    ) {
    ...
    public partial class Gs2ExchangeSkipByUserIdFetcher
    {
    ...
    public partial class Gs2ExchangeSkipByUserIdFetcher
    {
        public SkipByUserIdRequest Request { get; protected set; }
