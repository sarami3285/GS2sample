...
namespace Gs2.Unity.UiKit.Gs2Exchange.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/RateModel/Fetcher/Gs2ExchangeRateModelListFetcher")]
    public partial class Gs2ExchangeRateModelListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var items = new List<Gs2.Unity.Gs2Exchange.Model.EzRateModel>();
            while (it.HasNext())
            {
    ...
    public partial class Gs2ExchangeRateModelListFetcher
    {
    ...
    public partial class Gs2ExchangeRateModelListFetcher
    {
        public List<Gs2.Unity.Gs2Exchange.Model.EzRateModel> RateModels { get; private set; }
