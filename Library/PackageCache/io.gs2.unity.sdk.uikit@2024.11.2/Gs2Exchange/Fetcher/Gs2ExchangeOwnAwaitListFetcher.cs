...
namespace Gs2.Unity.UiKit.Gs2Exchange.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/Fetcher/Gs2ExchangeOwnAwaitListFetcher")]
    public partial class Gs2ExchangeOwnAwaitListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var items = new List<Gs2.Unity.Gs2Exchange.Model.EzAwait>();
            while (it.HasNext())
            {
        ...
        private IEnumerator Fetch()
        {
            ...
            this._callbackId = this._domain.SubscribeAwaits(
                items =>
                {
                    Awaits = items.ToList();
                    this.OnFetched.Invoke();
    ...
    public partial class Gs2ExchangeOwnAwaitListFetcher
    {
        public Gs2ExchangeNamespaceContext Context;
    ...
    public partial class Gs2ExchangeOwnAwaitListFetcher
    {
        public List<Gs2.Unity.Gs2Exchange.Model.EzAwait> Awaits { get; private set; }
