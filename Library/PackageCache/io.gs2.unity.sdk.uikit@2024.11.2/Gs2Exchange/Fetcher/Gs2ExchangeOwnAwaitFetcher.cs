...
namespace Gs2.Unity.UiKit.Gs2Exchange.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/Fetcher/Gs2ExchangeOwnAwaitFetcher")]
    public partial class Gs2ExchangeOwnAwaitFetcher : MonoBehaviour
    {
        private EzAwaitGameSessionDomain _domain;
        ...
        public void SetTemporaryAwait(
            Gs2.Unity.Gs2Exchange.Model.EzAwait await_
        ) {
            Await = await_;
            this.OnFetched.Invoke();
        }

        public void RollbackTemporaryAwait(
        ) {
            OnUpdateContext();
        }
    }
