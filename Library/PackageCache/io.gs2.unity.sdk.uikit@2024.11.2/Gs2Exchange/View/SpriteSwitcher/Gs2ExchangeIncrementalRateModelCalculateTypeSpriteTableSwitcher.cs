...
namespace Gs2.Unity.UiKit.Gs2Exchange.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/IncrementalRateModel/View/SpriteSwitcher/Properties/CalculateType/Gs2ExchangeIncrementalRateModelCalculateTypeSpriteTableSwitcher")]
    public partial class Gs2ExchangeIncrementalRateModelCalculateTypeSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.IncrementalRateModel.CalculateType) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.IncrementalRateModel.CalculateType).sprite);
            }
            else {
    ...
    public partial class Gs2ExchangeIncrementalRateModelCalculateTypeSpriteTableSwitcher
    {
