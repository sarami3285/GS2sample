...
namespace Gs2.Unity.UiKit.Gs2Exchange.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/IncrementalRateModel/View/SpriteSwitcher/Properties/Metadata/Gs2ExchangeIncrementalRateModelMetadataSpriteTableSwitcher")]
    public partial class Gs2ExchangeIncrementalRateModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.IncrementalRateModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.IncrementalRateModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2ExchangeIncrementalRateModelMetadataSpriteTableSwitcher
    {
