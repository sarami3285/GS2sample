...
namespace Gs2.Unity.UiKit.Gs2Exchange.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/View/SpriteSwitcher/Transaction/Properties/SkipType/Gs2ExchangeSkipByUserIdSkipTypeSpriteTableSwitcher")]
    public partial class Gs2ExchangeSkipByUserIdSkipTypeSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.SkipType) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.SkipType).sprite);
            }
            else {
    ...
    public partial class Gs2ExchangeSkipByUserIdSkipTypeSpriteTableSwitcher
    {
