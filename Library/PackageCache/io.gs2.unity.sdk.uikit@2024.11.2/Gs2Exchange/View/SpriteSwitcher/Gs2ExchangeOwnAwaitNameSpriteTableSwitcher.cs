...
namespace Gs2.Unity.UiKit.Gs2Exchange.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/View/SpriteSwitcher/Properties/Name/Gs2ExchangeOwnAwaitNameSpriteTableSwitcher")]
    public partial class Gs2ExchangeOwnAwaitNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Await.Name) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Await.Name).sprite);
            }
            else {
    ...
    public partial class Gs2ExchangeOwnAwaitNameSpriteTableSwitcher
    {
