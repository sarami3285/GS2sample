...
namespace Gs2.Unity.UiKit.Gs2Exchange.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/View/SpriteSwitcher/Properties/Name/Gs2ExchangeOwnAwaitNameSpriteSwitcher")]
    public partial class Gs2ExchangeOwnAwaitNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.Await?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.Await?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.Await?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2ExchangeOwnAwaitNameSpriteSwitcher
    {
