...
namespace Gs2.Unity.UiKit.Gs2Exchange.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/IncrementalRateModel/View/SpriteSwitcher/Properties/Name/Gs2ExchangeIncrementalRateModelNameSpriteTableSwitcher")]
    public partial class Gs2ExchangeIncrementalRateModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.IncrementalRateModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.IncrementalRateModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2ExchangeIncrementalRateModelNameSpriteTableSwitcher
    {
