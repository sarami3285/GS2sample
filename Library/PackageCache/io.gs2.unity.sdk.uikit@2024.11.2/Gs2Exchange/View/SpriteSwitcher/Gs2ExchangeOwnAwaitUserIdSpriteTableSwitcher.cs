...
namespace Gs2.Unity.UiKit.Gs2Exchange.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/View/SpriteSwitcher/Properties/UserId/Gs2ExchangeOwnAwaitUserIdSpriteTableSwitcher")]
    public partial class Gs2ExchangeOwnAwaitUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Await.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Await.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2ExchangeOwnAwaitUserIdSpriteTableSwitcher
    {
