...
namespace Gs2.Unity.UiKit.Gs2Exchange.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/RateModel/View/SpriteSwitcher/Properties/Name/Gs2ExchangeRateModelNameSpriteTableSwitcher")]
    public partial class Gs2ExchangeRateModelNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.RateModel.Name) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.RateModel.Name).sprite);
            }
            else {
    ...
    public partial class Gs2ExchangeRateModelNameSpriteTableSwitcher
    {
