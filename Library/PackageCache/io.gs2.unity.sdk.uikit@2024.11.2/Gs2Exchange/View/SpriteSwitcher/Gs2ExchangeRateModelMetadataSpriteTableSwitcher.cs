...
namespace Gs2.Unity.UiKit.Gs2Exchange.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/RateModel/View/SpriteSwitcher/Properties/Metadata/Gs2ExchangeRateModelMetadataSpriteTableSwitcher")]
    public partial class Gs2ExchangeRateModelMetadataSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.RateModel.Metadata) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.RateModel.Metadata).sprite);
            }
            else {
    ...
    public partial class Gs2ExchangeRateModelMetadataSpriteTableSwitcher
    {
