...
namespace Gs2.Unity.UiKit.Gs2Exchange
{
    ...
    public partial class Gs2ExchangeOwnAwaitList
    {
        ...
        public void Awake()
        {
            ...
            this._fetcher = GetComponent<Gs2ExchangeOwnAwaitListFetcher>() ?? GetComponentInParent<Gs2ExchangeOwnAwaitListFetcher>();
            if (this._fetcher == null) {
                Debug.LogError($"{gameObject.GetFullPath()}: Couldn't find the Gs2ExchangeOwnAwaitListFetcher.");
                enabled = false;
            }

            this._children = new List<Gs2ExchangeOwnAwaitContext>();
        ...
        public virtual bool HasError()
        {
            ...
            this._fetcher = GetComponent<Gs2ExchangeOwnAwaitListFetcher>() ?? GetComponentInParent<Gs2ExchangeOwnAwaitListFetcher>(true);
            if (this._fetcher == null) {
                return true;
            }
            return false;
