...
namespace Gs2.Unity.UiKit.Gs2Exchange
{
    ...
    public partial class Gs2ExchangeIncrementalRateModelCoefficientValueEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableCoefficientValues.Contains(this._fetcher.IncrementalRateModel.CoefficientValue));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableCoefficientValues.Contains(this._fetcher.IncrementalRateModel.CoefficientValue));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableCoefficientValue > this._fetcher.IncrementalRateModel.CoefficientValue);
                    break;
