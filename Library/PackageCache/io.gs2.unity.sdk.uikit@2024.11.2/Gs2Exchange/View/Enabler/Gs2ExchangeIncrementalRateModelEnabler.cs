...
namespace Gs2.Unity.UiKit.Gs2Exchange
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/IncrementalRateModel/View/Enabler/Gs2ExchangeIncrementalRateModelEnabler")]
    public partial class Gs2ExchangeIncrementalRateModelEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.IncrementalRateModel == null)
            {
    ...
    public partial class Gs2ExchangeIncrementalRateModelEnabler
    {
