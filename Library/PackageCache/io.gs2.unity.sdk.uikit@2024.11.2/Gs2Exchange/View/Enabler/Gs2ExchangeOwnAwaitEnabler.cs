...
namespace Gs2.Unity.UiKit.Gs2Exchange
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/View/Enabler/Gs2ExchangeOwnAwaitEnabler")]
    public partial class Gs2ExchangeOwnAwaitEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Await == null)
            {
    ...
    public partial class Gs2ExchangeOwnAwaitEnabler
    {
