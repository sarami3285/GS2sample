...
namespace Gs2.Unity.UiKit.Gs2Exchange
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/View/Enabler/Transaction/Gs2ExchangeDeleteAwaitByUserIdEnabler")]
    public partial class Gs2ExchangeDeleteAwaitByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Exchange:DeleteAwaitByUserId") == 0) {
    ...
    public partial class Gs2ExchangeDeleteAwaitByUserIdEnabler
    {
