...
namespace Gs2.Unity.UiKit.Gs2Exchange
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/View/Enabler/Transaction/Gs2ExchangeAcquireForceByUserIdEnabler")]
    public partial class Gs2ExchangeAcquireForceByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Exchange:AcquireForceByUserId") == 0) {
    ...
    public partial class Gs2ExchangeAcquireForceByUserIdEnabler
    {
