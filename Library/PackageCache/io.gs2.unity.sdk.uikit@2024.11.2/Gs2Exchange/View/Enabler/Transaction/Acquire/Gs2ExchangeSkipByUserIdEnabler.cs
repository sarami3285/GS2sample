...
namespace Gs2.Unity.UiKit.Gs2Exchange
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/View/Enabler/Transaction/Gs2ExchangeSkipByUserIdEnabler")]
    public partial class Gs2ExchangeSkipByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Exchange:SkipByUserId") == 0) {
    ...
    public partial class Gs2ExchangeSkipByUserIdEnabler
    {
