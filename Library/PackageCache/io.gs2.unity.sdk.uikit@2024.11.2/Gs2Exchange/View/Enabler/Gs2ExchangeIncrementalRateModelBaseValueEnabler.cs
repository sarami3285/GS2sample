...
namespace Gs2.Unity.UiKit.Gs2Exchange
{
    ...
    public partial class Gs2ExchangeIncrementalRateModelBaseValueEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    this.target.SetActive(this.enableBaseValues.Contains(this._fetcher.IncrementalRateModel.BaseValue));
                    break;
                case Expression.NotIn:
                    this.target.SetActive(!this.enableBaseValues.Contains(this._fetcher.IncrementalRateModel.BaseValue));
                    break;
                case Expression.Less:
                    this.target.SetActive(this.enableBaseValue > this._fetcher.IncrementalRateModel.BaseValue);
                    break;
